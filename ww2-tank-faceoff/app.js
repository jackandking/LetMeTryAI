/**
 * 二战坦克对比 Survey Application
 * Logic for the "硬核对比：二战坦克你更看好谁？" survey
 */

const questionConfig = {
    "title": "硬核对比：二战坦克你更看好谁？",
    "question": "作为装备党，你更愿意把票投给哪辆二战坦克？",
    "options": [
        {
            "value": "t-34",
            "label": "T-34"
        ...
        {
            "value": "panzer-v-panther",
            "label": "Panther"
        }
    ],
    "storageKey": "ww2_tank_faceoff_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ww2-tank-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>二战坦克对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：二战坦克你更看好谁？”的最新态度</p>";
