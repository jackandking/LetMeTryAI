...
const questionConfig = {
    title: '看航天发射，你被哪个画面打动？',
    question: '看航天发射，你被哪个画面打动？',
    options: [
        { value: 'ignition-blaze', label: '点火升空的火光与浓烟' },
        { value: 'fairing-separation', label: '整流罩分离时的慢动作' },
        { value: 'astronaut-wave', label: '航天员驾驶舱里的微笑与挥手' },
        { value: 'booster-landing', label: '一级助推器回收落地的壮观' }
    ],
    storageKey: 'space_launch_emotion.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=space-launch-emotion'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看航天发射，你被哪个画面打动？结果</h2>';
