...
const questionConfig = {
    title: '外卖新规争议：你更关心哪点改进？',
    question: '面对外卖服务规则，你最希望改进哪一项？',
    options: [
        { value: 'delivery-time-guarantee', label: '配送时效保障' },
        { value: 'food-traceability', label: '食品安全溯源' },
        { value: 'merchant-rating-transparency', label: '商家评价与信用' },
        { value: 'refund-and-compensation', label: '退单与赔付流程' }
    ],
    storageKey: 'waimai_policy_debate.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=waimai-policy-debate'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>外卖新规争议：你更关心哪点改进？结果</h2>';
