...
const questionConfig = {
    title: '孩子看到卫星发射会好奇什么？',
    question: '孩子看到卫星发射会好奇什么？选出你家孩子会先问哪个',
    options: [
        { value: 'appearance-flight-principle', label: '它长什么样、怎么飞起来' },
        { value: 'purpose-and-use', label: '卫星是做什么用的' },
        { value: 'earth-impact', label: '会不会影响地球上的生活' },
        { value: 'humans-and-exploration', label: '和太空、宇航员有关的故事' }
    ],
    storageKey: 'kids_satellite_curiosity.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-satellite-curiosity'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看到卫星发射会好奇什么？结果</h2>';
