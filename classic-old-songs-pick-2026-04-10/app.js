 ...
 * Logic for the "关注：你更喜欢哪首经典老歌？" survey
 */

const questionConfig = {
    "title": "关注：你更喜欢哪首经典老歌？",
    "question": "亲，你最支持哪个选项：你更喜欢哪首经典老歌？",
    "options": [
        {
            "value": "tian-mi-mi",
            "label": "甜蜜蜜（邓丽君）"
    ...
    "storageKey": "classic_old_songs_pick_2026_04_10_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-pick-2026-04-10'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：你更喜欢哪首经典老歌？”的最新态度</p>";
