...
const questionConfig = {
    title: '哪位女明星的红毯造型让你一眼心动？',
    question: '哪位女明星的红毯造型让你一眼心动？',
    options: [
        { value: 'retro-hongkong', label: '复古港风' },
        { value: 'sweet-fairy', label: '甜美仙女' },
        { value: 'cool-suit', label: '酷飒西装' },
        { value: 'sequin-mermaid', label: '亮片美人鱼' }
    ],
    storageKey: 'red_carpet_heart_stealer.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=red-carpet-heart-stealer'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪位女明星的红毯造型让你一眼心动？结果</h2>';
