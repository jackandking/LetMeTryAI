 ...
 * Logic for the "家长话题：表扬哪种更能让孩子进步？" survey
 */

const questionConfig = {
    "title": "家长话题：表扬哪种更能让孩子进步？",
    "question": "站在家长视角，你会怎么选：表扬方式哪种更有效？",
    "options": [
        {
            "value": "immediate-verbal-praise",
            "label": "即时口头表扬"
        },
        {
            "value": "written-encouragement-card",
            "label": "书面鼓励（卡片）"
        },
        {
            "value": "public-praise-in-front-others",
            "label": "公开表扬（夸给别人听）"
        },
        {
            "value": "small-tangible-reward",
            "label": "小奖励（贴纸/零花）"
        }
    ],
    "storageKey": "praise_methods_vote_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=praise-methods-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：表扬哪种更能让孩子进步？”的最新态度</p>";
