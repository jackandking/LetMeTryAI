/**
 * 怀旧剧场投票 Survey Application
 * Logic for the "80年代最佳电视剧，你选哪部？" survey
 */

const questionConfig = {
    "title": "80年代最佳电视剧，你选哪部？",
    "question": "亲，你最支持哪部80年代电视剧？",
    "options": [
        {
            "value": "xiyouji",
            "label": "xiyouji"
        ...
        {
            "value": "shiediao-yingxiong-zhuan",
            "label": "shiediao-yingxiong-zhuan"
        },
        {
            "value": "classic-spring-festival-sketches",
            "label": "classic-spring-festival-sketches"
        }
    ],
    "storageKey": "80s_best_tv_dramas_2026_03_25_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=80s-best-tv-dramas-2026-03-25'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>怀旧剧场投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“80年代最佳电视剧，你选哪部？”的最新态度</p>";
