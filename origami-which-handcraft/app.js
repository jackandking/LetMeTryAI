...
const questionConfig = {
    title: '孩子沉迷折纸做到这程度，你会鼓励他继续做哪类手作？',
    question: '孩子沉迷折纸做到这程度，你会鼓励他继续做哪类手作？',
    options: [
        { value: 'art-origami', label: '艺术折纸' },
        { value: 'practical-crafts', label: '实用手作' },
        { value: 'maker-projects', label: '创客结合' },
        { value: 'social-showcase', label: '社交展示' }
    ],
    storageKey: 'origami_which_handcraft.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=origami-which-handcraft'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子沉迷折纸做到这程度，你会鼓励他继续做哪类手作？结果</h2>';
