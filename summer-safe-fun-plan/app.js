...
const questionConfig = {
    title: '暑假怎么安排，孩子既安全又不无聊？你会怎么安排一周日程？',
    question: '暑假怎么安排，孩子既安全又不无聊？选出你想试的周程：',
    options: [
        { value: 'daily-short-classes', label: '每天短课+固定作息' },
        { value: 'weekly-museum-days', label: '每周博物馆日+亲子探索' },
        { value: 'home-theme-days', label: '居家主题日+手作科学' },
        { value: 'short-trip-nature', label: '短途自然游+体验学习' }
    ],
    storageKey: 'summer_safe_fun_plan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-safe-fun-plan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>暑假怎么安排，孩子既安全又不无聊？你会怎么安排一周日程？结果</h2>';
