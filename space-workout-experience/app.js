...
const questionConfig = {
    title: '在太空健身是啥体验？',
    question: '在太空健身，你想先体验哪种训练？',
    options: [
        { value: 'treadmill-harness-run', label: '跑步机绑带跑' },
        { value: 'floating-dumbbell-lift', label: '漂浮举哑铃' },
        { value: 'space-stationary-bike', label: '太空动感单车' },
        { value: 'resistance-band-strength', label: '弹力带抗阻训练' }
    ],
    storageKey: 'space_workout_experience.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=space-workout-experience'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>在太空健身是啥体验？结果</h2>';
