...
const questionConfig = {
    title: '这件“进城办事”T你敢穿出街吗？',
    question: '看到这件“进城办事”T，你会怎么做？直接穿出街、只在家/活动穿，还是不会穿出街？',
    options: [
        { value: 'dare-wear', label: '敢穿出街' },
        { value: 'home-or-event', label: '只在家或特定活动穿' },
        { value: 'wont-wear', label: '不会穿出街' }
    ],
    storageKey: 'jincheng_banshi_t.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jincheng-banshi-t'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这件“进城办事”T你敢穿出街吗？结果</h2>';
