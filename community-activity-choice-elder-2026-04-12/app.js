 ...
 * Logic for the "参与社区活动，你更愿意选哪个？" survey
 */

const questionConfig = {
    "title": "参与社区活动，你更愿意选哪个？",
    "question": "亲，你最支持哪个社区活动？",
    "options": [
        {
            "value": "guangchangwu-xiaozu",
            "label": "广场舞小组"
        },
        {
        ...
        {
            "value": "senior-university-short-courses",
            "label": "老年大学短课"
        },
        {
            "value": "neighborhood-book-club",
            "label": "邻里读书会"
        }
    ],
    "storageKey": "community_activity_choice_elder_2026_04_12_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-elder-2026-04-12'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“参与社区活动，你更愿意选哪个？”的最新态度</p>";
