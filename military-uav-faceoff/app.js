/**
 * 无人机对决 Survey Application
 * Logic for the "硬核对比：哪款军用无人机更具战术价值？" survey
 */

const questionConfig = {
    "title": "硬核对比：哪款军用无人机更具战术价值？",
    "question": "作为硬核玩家，你更看好哪款军用无人机？",
    "options": [
        {
            "value": "mq-9-reaper",
            "label": "MQ-9 Reaper"
        ...
        {
            "value": "stealth-composite-wing",
            "label": "隐身复合翼无人机"
        }
    ],
    "storageKey": "military_uav_faceoff_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-uav-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>无人机对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：哪款军用无人机更具战术价值？”的最新态度</p>";
