/**
 * 旗舰拍照PK Survey Application
 * Logic for the "旗舰拍照对决：哪款手机更能拍大片？" survey
 */

const questionConfig = {
    "title": "旗舰拍照对决：哪款手机更能拍大片？",
    "question": "作为硬核玩家，你更认可哪家旗舰手机的拍照能力？",
    "options": [
        {
            "value": "iphone-flagship",
            "label": "苹果 旗舰"
        },
        {
            "value": "samsung-flagship",
            "label": "三星 旗舰"
        },
        {
            "value": "google-pixel-flagship",
            "label": "谷歌 Pixel 系列"
        },
        {
            "value": "oneplus-flagship",
            "label": "一加/国产旗舰"
        }
    ],
    "storageKey": "flagship_phone_camera_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-camera-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>旗舰拍照PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“旗舰拍照对决：哪款手机更能拍大片？”的最新态度</p>";
