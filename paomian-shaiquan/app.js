...
const questionConfig = {
    title: '你会为哪款泡面拍照晒圈？哪种画面更上镜？',
    question: '你会为哪款泡面拍照晒圈？更喜欢哪种上镜风格？',
    options: [
        { value: 'wanghong-baipai', label: '网红摆拍款' },
        { value: 'wenyi-bei-mian', label: '文艺杯面' },
        { value: 'haohua-baipan', label: '豪华摆盘款' },
        { value: 'yanhuo-jiachang', label: '烟火家常款' }
    ],
    storageKey: 'paomian_shaiquan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=paomian-shaiquan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你会为哪款泡面拍照晒圈？哪种画面更上镜？结果</h2>';
