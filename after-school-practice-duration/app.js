/**
 * 课外练习时长投票 Survey Application
 * Logic for the "家长爱话题：孩子每天课外练习多久合适？" survey
 */

const questionConfig = {
    "title": "家长爱话题：孩子每天课外练习多久合适？",
    "question": "站在家长爱用户视角，你会怎么选：孩子每天课外练习多久更合适？",
    "options": [
        {
            "value": "15-min",
            "label": "每天15分钟（短时高频）"
    ...
    "storageKey": "after_school_practice_duration_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=after-school-practice-duration'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>课外练习时长投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长爱话题：孩子每天课外练习多久合适？”的最新态度</p>";
