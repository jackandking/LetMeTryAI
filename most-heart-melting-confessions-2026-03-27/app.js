/**
 * 心动告白投票 Survey Application
 * Logic for the "女人爱热议：最让人心动的告白方式" survey
 */

const questionConfig = {
    "title": "女人爱热议：最让人心动的告白方式",
    "question": "你会把这一票投给哪种告白方式？",
    "options": [
        {
        ...
        {
            "value": "handwritten-letter",
            "label": "写信/手作"
        },
        {
            "value": "surprise-setup",
            "label": "惊喜布置"
        },
        {
            "value": "private-whisper",
            "label": "低调私聊"
        }
    ],
    "storageKey": "most_heart_melting_confessions_2026_03_27_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=most-heart-melting-confessions-2026-03-27'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>心动告白投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：最让人心动的告白方式”的最新态度</p>";
