...
const questionConfig = {
    ...
    question: '今天下班你更想怎么吃？',
    options: [
        { value: 'takeout-easy', label: '叫外卖 省事惬意' },
        { value: 'cook-at-home', label: '自己下厨 健康实惠' },
        { value: 'dine-with-friends', label: '约朋友 聚餐更带劲' }
    ],
    storageKey: 'afterwork_eat_what.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=afterwork-eat-what'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>下班饿了：外卖还是自己做？结果</h2>';
