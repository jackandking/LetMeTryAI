/**
 * 男人宝投票 Survey Application
 * Logic for the "男人宝热榜：旗舰手机夜拍对决" survey
 */

const questionConfig = {
    "title": "男人宝热榜：旗舰手机夜拍对决",
    "question": "亲，你更想把票投给谁：哪款旗舰手机夜景成像更打动你？",
    "options": [
        {
            "value": "iphone-15-pro",
            "label": "iPhone 15 Pro"
    ...
    "storageKey": "flagship_phone_night_photo_pk_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-night-photo-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>男人宝投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：旗舰手机夜拍对决”的最新态度</p>";
