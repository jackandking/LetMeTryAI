...
const questionConfig = {
    title: '连续下雨孩子只能待家里，你选哪种玩法？',
    question: '连续下雨孩子只能待家里，你选哪种玩法？',
    options: [
        { value: 'mini-museum-corner', label: '迷你博物馆角' },
        { value: 'science-experiments', label: '科学小实验' },
        { value: 'indoor-sports-challenge', label: '室内运动挑战' },
        { value: 'puppet-theater', label: '手工剧场' }
    ],
    storageKey: 'rainy_day_play_choices.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-day-play-choices'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>连续下雨孩子只能待家里，你选哪种玩法？结果</h2>';
