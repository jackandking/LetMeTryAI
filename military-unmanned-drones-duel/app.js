 ...
 * Logic for the "硬核对比：军用无人机谁更具战场优势？" survey
 */

const questionConfig = {
    "title": "硬核对比：军用无人机谁更具战场优势？",
    "question": "作为装备党，你更看好哪款军用无人机的实战能力？",
    "options": [
        {
            "value": "mq-9-reaper",
            "label": "MQ-9 Reaper"
    ...
    "storageKey": "military_unmanned_drones_duel_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-unmanned-drones-duel'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：军用无人机谁更具战场优势？”的最新态度</p>";
