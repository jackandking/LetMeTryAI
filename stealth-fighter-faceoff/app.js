/**
 * 隐身战机对比 Survey Application
 * Logic for the "男人宝热榜：现代隐身战斗机对比" survey
 */

const questionConfig = {
    "title": "男人宝热榜：现代隐身战斗机对比",
    "question": "亲，你更看好哪款隐身战斗机？",
    "options": [
        {
            "value": "f-22-raptor",
            "label": "F-22 Raptor"
    ...
    "storageKey": "stealth_fighter_faceoff_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=stealth-fighter-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>隐身战机对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：现代隐身战斗机对比”的最新态度</p>";
