/**
 * 显白口红榜 Survey Application
 * Logic for the "女人爱热议：春季最显白口红" survey
 */

const questionConfig = {
    "title": "女人爱热议：春季最显白口红",
    "question": "如果是女人爱用户，你会把这一票投给谁：春季最显白口红？",
    "options": [
        {
            "value": "coral-peach",
            "label": "珊瑚蜜桃"
        ...
        {
            "value": "warm-orange-brown",
            "label": "橘棕暖阳"
        }
    ],
    "storageKey": "spring_whitening_lipstick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-whitening-lipstick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>显白口红榜投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：春季最显白口红”的最新态度</p>";
