...
const questionConfig = {
    title: '机车赛场热议：你偏好哪种夺冠方式？',
    question: '在紧张的机车赛中，你更支持哪种夺冠方式？',
    options: [
        { value: 'technical-overtake', label: '技术超越' },
        { value: 'strategy-win', label: '策略制胜' },
        { value: 'speed-sprint', label: '速度冲刺' },
        { value: 'steady-control', label: '稳扎稳打' }
    ],
    storageKey: 'motor_race_win_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=motor-race-win-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机车赛场热议：你偏好哪种夺冠方式？结果</h2>';
