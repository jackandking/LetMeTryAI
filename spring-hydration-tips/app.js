...
const questionConfig = {
    title: '春季换季保湿，你常用哪种方法？',
    question: '换季时你更倾向哪种保湿方式？',
    options: [
        { value: 'serum-first', label: '精华打底' },
        { value: 'rich-cream', label: '滋润面霜' },
        { value: 'hydrating-mist', label: '补水喷雾' },
        { value: 'mask-boost', label: '密集面膜' }
    ],
    storageKey: 'spring_hydration_tips.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-hydration-tips'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季换季保湿，你常用哪种方法？结果</h2>';
