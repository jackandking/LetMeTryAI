...
const questionConfig = {
    title: '被带回家的国货美妆单品：你会选择哪种？',
    question: '出门旅行或逛街时，你最常把哪类国货美妆单品带回家？',
    options: [
        { value: 'skincare-serums-creams', label: '护肤精华/面霜' },
        { value: 'makeup-lips-cheeks', label: '彩妆口红/腮红' },
        { value: 'masks-quick-care', label: '面膜/急救护理' },
        { value: 'fragrance-body-care', label: '香氛/身体护理' }
    ],
    storageKey: 'bei_dai_hui_de_guomei_meizhuang.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=bei-dai-hui-de-guomei-meizhuang'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>被带回家的国货美妆单品：你会选择哪种？结果</h2>';
