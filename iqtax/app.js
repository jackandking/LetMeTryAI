/**
 * IQ Tax Survey Application - Survey/Quiz functionality
 * Handles user interaction for "Top 10 IQ Taxes" survey questions
 */
...
function attachRadioHandlers() {
    const radios = document.querySelectorAll('input[name="iqtax"]');
...
function createBarContainer(option, count, percentage, scale) {
    ...
    optionLabel.className = "iqtax-label";
