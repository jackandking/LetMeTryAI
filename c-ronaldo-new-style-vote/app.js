...
const questionConfig = {
    title: 'C罗新造型亮相，你被他哪一点帅到？',
    question: 'C罗新造型亮相，你被他哪一点帅到？',
    options: [
        { value: 'chiseled-profile', label: '棱角侧颜' },
        { value: 'new-hairstyle', label: '新发型' },
        { value: 'confident-aura', label: '自信气场' },
        { value: 'toned-figure', label: '挺拔身材' }
    ],
    storageKey: 'c_ronaldo_new_style_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=c-ronaldo-new-style-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗新造型亮相，你被他哪一点帅到？结果</h2>';
