/**
 * 放学规划投票 Survey Application
 * Logic for the "放学后：作业优先还是课外活动优先？" survey
 */

const questionConfig = {
    "title": "放学后：作业优先还是课外活动优先？",
    "question": "站在家长爱用户视角，你会怎么选：放学后先做作业还是先放松活动？",
    "options": [
        {
            "value": "homework-first",
            "label": "作业优先"
        },
        {
    ...
    "storageKey": "after_school_plan_v1.data"
};
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>放学规划投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“放学后：作业优先还是课外活动优先？”的最新态度</p>";
