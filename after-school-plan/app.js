/**
 * After School Plan Survey Application
 * Logic for the "放学后：作业优先还是课外活动优先？" voting page
 */
        ...
        if (!overlay) {
            ...
            overlay.innerHTML = `
                <div class="ad-content">
                    <h3>正在分析"放学后：作业优先还是课外活动优先？"的投票趋势...</h3>
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = `
        <h2>放学规划投票结果</h2>
        <p class="result-subtitle">看看大家对"放学后：作业优先还是课外活动优先？"的最新态度</p>
    `;
