 ...
 * Logic for the "恋爱中你最不能忍哪件事？" survey
 */

const questionConfig = {
    "title": "恋爱中你最不能忍哪件事？",
    "question": "恋爱中你最不能忍哪种行为？",
    "options": [
        {
    ...
    "storageKey": "love_dealbreakers_2026_03_22_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-dealbreakers-2026-03-22'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“恋爱中你最不能忍哪件事？”的最新态度</p>";
