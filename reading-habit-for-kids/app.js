/**
 * 儿童阅读习惯投票 Survey Application
 * Logic for the "哪种方法最能帮孩子养成阅读习惯？" survey
 */

const questionConfig = {
    "title": "哪种方法最能帮孩子养成阅读习惯？",
    "question": "站在家长视角，你会怎么选：如何培养孩子的阅读习惯？",
    "options": [
        {
            "value": "parent-child-daily-reading",
            "label": "亲子共读每日例行"
        },
        {
            "value": "home-reading-corner",
            "label": "家庭读书角+自由选书"
        },
        {
            "value": "reading-reward-chart",
            "label": "阅读奖励表/小目标"
        },
        {
            "value": "library-borrowing-routine",
            "label": "借阅+亲子图书馆行程"
        }
    ],
    "storageKey": "reading_habit_for_kids_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=reading-habit-for-kids'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>儿童阅读习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪种方法最能帮孩子养成阅读习惯？”的最新态度</p>";
