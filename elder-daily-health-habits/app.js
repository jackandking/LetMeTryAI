...
const questionConfig = {
    title: '老年人日常健康小习惯',
    question: '平时您更常做哪类有助于日常活力的习惯？',
    options: [
        { value: 'walking-exercise', label: '健步走或慢走' },
        { value: 'tai-chi-qigong', label: '太极或气功轻练' },
        { value: 'early-sleep', label: '规律作息早睡早起' },
        { value: 'regular-hydration', label: '定时喝水、均衡饮食' }
    ],
    storageKey: 'elder_daily_health_habits.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-daily-health-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老年人日常健康小习惯结果</h2>';
