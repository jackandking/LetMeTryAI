...
const questionConfig = {
    title: '博物馆里哪个文物的故事会让孩子眼睛亮？',
    question: '博物馆里哪个文物的故事会让孩子眼睛亮？',
    options: [
        { value: 'mysterious-bronze-mask', label: '神秘青铜面具' },
        { value: 'talking-clay-figurine', label: '会说话的彩绘陶俑' },
        { value: 'terracotta-warrior-secret', label: '整齐列队的兵马俑' },
        { value: 'ancient-bell-that-sings', label: '会发声的古代编钟' }
    ],
    storageKey: 'museum_treasure_for_kids.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-treasure-for-kids'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>博物馆里哪个文物的故事会让孩子眼睛亮？结果</h2>';
