/**
 * 发型灵感 Survey Application
 * Logic for the "约会前你会选哪种发型？" survey
 */

const questionConfig = {
    "title": "约会前你会选哪种发型？",
    "question": "你会把这一票投给谁：约会前你会选哪种发型？",
    "options": [
        {
            "value": "natural-straight-long",
            "label": "自然垂顺长发"
        },
        {
            "value": "low-ponytail",
        ...
        {
            "value": "air-bang-short",
            "label": "空气刘海短发"
        },
        {
            "value": "loose-big-curls",
            "label": "慵懒大波浪"
        }
    ],
    "storageKey": "date_hairstyle_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=date-hairstyle-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>发型灵感投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“约会前你会选哪种发型？”的最新态度</p>";
