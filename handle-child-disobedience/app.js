...
const questionConfig = {
    title: '遇到孩子不听话，你会怎么做？常见做法投票',
    question: '遇到孩子不听话，你会怎么做？',
    options: [
        { value: 'patient-communication', label: '耐心沟通' },
        { value: 'set-boundaries-and-consequences', label: '设立边界与后果' },
        { value: 'redirect-distraction', label: '转移注意力/换个活动' },
        { value: 'brief-timeout-and-discuss', label: '短暂冷静并讨论' }
    ],
    storageKey: 'handle_child_disobedience.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=handle-child-disobedience'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>遇到孩子不听话，你会怎么做？常见做法投票结果</h2>';
