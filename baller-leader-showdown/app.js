/**
 * 球星带队PK Survey Application
 * Logic for the "男人宝热榜：谁是最能带队的球星？" survey
 */
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=baller-leader-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>球星带队PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：谁是最能带队的球星？”的最新态度</p>";
