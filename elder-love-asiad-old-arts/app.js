...
const questionConfig = {
    title: '看亚运开幕式，你更怀念哪种老式文艺表演？',
    question: '看亚运开幕式，你更怀念哪种老式文艺表演？',
    options: [
        { value: 'jing-ju', label: '京剧唱段' },
        { value: 'minzu-wu', label: '民族舞表演' },
        { value: 'za-ji', label: '杂技绝技' },
        { value: 'he-chang', label: '合唱大联唱' }
    ],
    storageKey: 'elder_love_asiad_old_arts.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-love-asiad-old-arts'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看亚运开幕式，你更怀念哪种老式文艺表演？结果</h2>';
