...
const questionConfig = {
    title: '妈妈让人放心的一面：哪一种让你感到安心',
    question: '在生活中，妈妈展现哪些让你感到安心的特质？选一个并分享相关回忆或理由。',
    options: [
        { value: 'attentive-care', label: '细心照料' },
        { value: 'steady-dependable', label: '稳重可靠' },
        { value: 'wise-advice', label: '经验好建议' },
        { value: 'warm-humor', label: '幽默与乐观' }
    ],
    storageKey: 'mama_reassuring_side.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mama-reassuring-side'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>妈妈让人放心的一面：哪一种让你感到安心结果</h2>';
