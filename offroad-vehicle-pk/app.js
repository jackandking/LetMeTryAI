/**
 * 男人宝 Survey Application
 * Logic for the "装备党首选：硬派越野车通过性大PK" survey
 */

const questionConfig = {
    "title": "装备党首选：硬派越野车通过性大PK",
    "question": "全网热议：硬派越野车通过性大PK，你的选择是？",
    "options": [
        {
            "value": "mercedes-g-class",
            "label": "奔驰G级"
        },
        {
            "value": "jeep-wrangler",
    ...
    "storageKey": "offroad_vehicle_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=offroad-vehicle-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>男人宝投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“装备党首选：硬派越野车通过性大PK”的最新态度</p>";
