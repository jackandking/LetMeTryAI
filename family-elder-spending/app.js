...
const questionConfig = {
    title: '家中长辈花钱你会怎么做？',
    question: '当家中长辈想花一笔钱时，你通常会怎么处理？',
    options: [
        { value: 'respect-autonomy', label: '尊重长辈自主' },
        { value: 'discuss-budget', label: '事先沟通预算' },
        { value: 'help-manage-payments', label: '协助办理或代付' },
        { value: 'offer-guidance', label: '提供理财与防骗建议' }
    ],
    storageKey: 'family_elder_spending.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=family-elder-spending'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家中长辈花钱你会怎么做？结果</h2>';
