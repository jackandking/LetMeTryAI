/**
 * 春季发色PK Survey Application
 * Logic for the "女人爱热议：明星春季发色你更pick哪种？" survey
 */

const questionConfig = {
    "title": "女人爱热议：明星春季发色你更pick哪种？",
    "question": "如果是女人爱用户，你会把这一票投给谁：明星春季发色，你更pick哪种？",
    "options": [
        {
            "value": "natural-black",
            "label": "自然黑"
    ...
    "storageKey": "celebrity_hair_color_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-hair-color'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>春季发色PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：明星春季发色你更pick哪种？”的最新态度</p>";
