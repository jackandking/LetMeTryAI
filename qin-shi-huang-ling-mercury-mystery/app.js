...
const questionConfig = {
    title: '秦始皇陵的水银之谜，孩子会好奇哪一点？',
    question: '秦始皇陵的水银之谜，孩子会好奇哪一点？',
    options: [
        { value: 'how-much-mercury', label: '水银真的很多吗？' },
        { value: 'why-buried-mercury', label: '为什么会放水银？' },
        { value: 'can-see-mercury', label: '水银会流出来吗？能看到吗？' },
        { value: 'is-mercury-harmful', label: '水银会不会有危险？' }
    ],
    storageKey: 'qin_shi_huang_ling_mercury_mystery.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qin-shi-huang-ling-mercury-mystery'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>秦始皇陵的水银之谜，孩子会好奇哪一点？结果</h2>';
