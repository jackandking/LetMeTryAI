...
const questionConfig = {
    title: '上海男篮夺冠，你记得哪个庆祝瞬间？',
    question: '上海男篮夺冠，你记得哪个庆祝瞬间？',
    options: [
        { value: 'captain-run-to-stands', label: '队长抱球奔向看台' },
        { value: 'team-huddle-jump', label: '全队抱成一团起跳' },
        { value: 'player-hoist-trophy', label: '球员高举奖杯露笑容' }
    ],
    storageKey: 'shanghai_basketball_celebration.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=shanghai-basketball-celebration'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>上海男篮夺冠，你记得哪个庆祝瞬间？结果</h2>';
