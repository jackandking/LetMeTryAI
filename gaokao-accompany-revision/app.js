...
const questionConfig = {
    title: '高考前你会怎么陪孩子复习？',
    question: '高考前你会怎么陪孩子复习？',
    options: [
        { value: 'make-study-plan', label: '制定复习计划' },
        { value: 'do-practice-with-explanation', label: '做题即时讲解' },
        { value: 'emotional-support-and-breaks', label: '情绪支持与放松' },
        { value: 'hire-tutor-for-weak-subjects', label: '请老师强化薄弱科目' }
    ],
    storageKey: 'gaokao_accompany_revision.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gaokao-accompany-revision'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高考前你会怎么陪孩子复习？结果</h2>';
