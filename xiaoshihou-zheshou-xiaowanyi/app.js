...
const questionConfig = {
    title: '小时候你常折哪种小玩意儿？哪款一看就想起那个夏天',
    question: '小时候你常折哪种小玩意儿？选出你经常折的那款',
    options: [
        { value: 'zhi-feiji', label: '纸飞机' },
        { value: 'zhi-chuan', label: '纸船' },
        { value: 'zhi-mao', label: '纸帽' },
        { value: 'zhi-he', label: '纸鹤' }
    ],
    storageKey: 'xiaoshihou_zheshou_xiaowanyi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xiaoshihou-zheshou-xiaowanyi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小时候你常折哪种小玩意儿？哪款一看就想起那个夏天结果</h2>';
