/**
 * 坦克对比 Survey Application
 * Logic for the "二战坦克对决 — 谁更强？" survey
 */

const questionConfig = {
    "title": "二战坦克对决 — 谁更强？",
    "question": "二战中哪款坦克更值得你投票？",
    "options": [
        {
            "value": "t-34",
            "label": "苏联 T-34"
    ...
    "storageKey": "ww2_strongest_tanks_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ww2-strongest-tanks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>坦克对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“二战坦克对决 — 谁更强？”的最新态度</p>";
