...
const questionConfig = {
    title: '你心里想什么时候退休？',
    question: '你心里想什么时候退休？请选择与你想法接近的一项',
    options: [
        { value: 'early-retire', label: '提前退休（55岁前）' },
        { value: 'regular-retire', label: '按常规退休（60-65岁）' },
        { value: 'work-until-feel', label: '感觉合适再退休' },
        { value: 'no-plan', label: '没固定计划 / 随缘' }
    ],
    storageKey: 'when_to_retire.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=when-to-retire'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你心里想什么时候退休？结果</h2>';
