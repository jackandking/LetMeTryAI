...
const questionConfig = {
    title: '曾沛慈拿下浪姐冠军，哪套造型更让你心动？',
    question: '曾沛慈拿下浪姐冠军，哪套造型更让你心动？',
    options: [
        { value: 'fairy-white-dress', label: '仙女白纱' },
        { value: 'cool-suit-look', label: '酷飒西装' },
        { value: 'sequin-finale-gown', label: '亮片战袍' },
        { value: 'red-lips-retro', label: '红唇复古' }
    ],
    storageKey: 'tseng_pei_ci_style_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tseng-pei-ci-style-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>曾沛慈拿下浪姐冠军，哪套造型更让你心动？结果</h2>';
