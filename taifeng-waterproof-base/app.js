...
const questionConfig = {
    title: '台风天出门，你会选哪种防水底妆？轻薄还是持久？',
    question: '台风天出门，你会选哪种防水底妆？',
    options: [
        { value: 'matte-longwear', label: '哑光持久派' },
        { value: 'light-breathable', label: '轻薄透气派' },
        { value: 'setting-spray', label: '定妆喷雾加持' },
        { value: 'spf-isolation-powder', label: '防晒隔离＋粉饼' }
    ],
    storageKey: 'taifeng_waterproof_base.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-waterproof-base'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天出门，你会选哪种防水底妆？轻薄还是持久？结果</h2>';
