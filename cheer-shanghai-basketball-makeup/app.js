...
const questionConfig = {
    title: '去现场为上海男篮庆祝，你会画哪种妆？哪个更有赛场感？',
    question: '去现场为上海男篮庆祝，你会画哪种妆？',
    options: [
        { value: 'vibrant-court-makeup', label: '活力元气球迷妆' },
        { value: 'team-color-glitter', label: '队色亮片应援妆' },
        { value: 'smoky-chic-game', label: '时髦烟熏赛场妆' },
        { value: 'natural-dewy-makeup', label: '自然清透耐汗妆' }
    ],
    storageKey: 'cheer_shanghai_basketball_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cheer-shanghai-basketball-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>去现场为上海男篮庆祝，你会画哪种妆？哪个更有赛场感？结果</h2>';
