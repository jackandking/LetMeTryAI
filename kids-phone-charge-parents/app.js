...
const questionConfig = {
    title: '孩子用长辈手机大额充值，你遇到过吗？',
    question: '孩子用长辈手机大额充值，你家遇到过吗？',
    options: [
        { value: 'strict-password-control', label: '严管支付密码' },
        { value: 'communication-education', label: '主要靠沟通' },
        { value: 'preventive-rules', label: '提前立规矩' },
        { value: 'self-disciplined-child', label: '孩子较自觉' }
    ],
    storageKey: 'kids_phone_charge_parents.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-phone-charge-parents'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子用长辈手机大额充值，你遇到过吗？结果</h2>';
