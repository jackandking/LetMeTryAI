...
const questionConfig = {
    title: '五一后衣橱更新投票：你要添哪类单品？',
    question: '五一过后你想为衣橱加入哪类单品？',
    options: [
        { value: 'light-jacket', label: '轻薄外套' },
        { value: 'bright-color-piece', label: '亮色单品' },
        { value: 'casual-set', label: '舒适休闲套装' },
        { value: 'accessory-upgrade', label: '配饰升级（包/围巾）' }
    ],
    storageKey: 'wu_yi_wardrobe_update.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wu-yi-wardrobe-update'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>五一后衣橱更新投票：你要添哪类单品？结果</h2>';
