/**
 * 无人机对比 Survey Application
 * Logic for the "硬核对比：军用无人机谁更适配战场？" survey
 */

const questionConfig = {
    "title": "硬核对比：军用无人机谁更适配战场？",
    "question": "作为硬核玩家，你更认可哪款无人机的战场适配？",
    "options": [
        {
            "value": "mq-9-reaper",
            "label": "MQ-9 Reaper"
    ...
    "storageKey": "military_uav_showdown_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-uav-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>无人机对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：军用无人机谁更适配战场？”的最新态度</p>";
