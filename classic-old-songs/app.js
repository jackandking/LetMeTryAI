 ...
 * Logic for the "关注：哪首老歌最能勾起你的回忆？" survey
 */

const questionConfig = {
    "title": "关注：哪首老歌最能勾起你的回忆？",
    "question": "亲，你最支持哪个选项：哪首老歌最能勾起你的回忆？",
    "options": [
        {
        ...
        {
            "value": "chang-hui-jia-kan-kan",
            "label": "常回家看看"
        }
    ],
    "storageKey": "classic_old_songs_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：哪首老歌最能勾起你的回忆？”的最新态度</p>";
