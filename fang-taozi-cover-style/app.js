...
const questionConfig = {
    title: '方桃子封面你更想看到哪种风格？',
    question: '你更想在方桃子封面看到哪种风格？',
    options: [
        { value: 'qingxin-shaonv', label: '清新少女感' },
        { value: 'gaoji-lengyan', label: '高级冷艳感' },
        { value: 'dianying-zhigan', label: '电影质感人像' },
        { value: 'keai-chaoliu-hua', label: '可爱潮流插画' }
    ],
    storageKey: 'fang_taozi_cover_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=fang-taozi-cover-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>方桃子封面你更想看到哪种风格？结果</h2>';
