...
const questionConfig = {
    title: '六一汇演，你家娃是主角还是观众？',
    question: '六一汇演，你家娃是主角还是观众？请选择符合你家情况的场景。',
    options: [
        { value: 'tai-shang-xiao-zhujue', label: '台上小主角' },
        { value: 'jinzhang-dan-yuanyi-changshi', label: '紧张但愿意尝试' },
        { value: 'geng-xihuan-dang-guanzhong', label: '更喜欢当观众' },
        { value: 'houtai-mumo-zhichi', label: '在后台默默支持' }
    ],
    storageKey: 'liuyi_huiyan_zhujuguanzhong.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=liuyi-huiyan-zhujuguanzhong'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>六一汇演，你家娃是主角还是观众？结果</h2>';
