/**
 * 作业陪伴投票 Survey Application
 * Logic for the "孩子写作业：你的陪伴方式" survey
 */

const questionConfig = {
    "title": "孩子写作业：你的陪伴方式",
    "question": "站在家长爱用户视角，你会怎么选：孩子写作业时你更偏向哪种陪伴方式？",
    "options": [
        {
            "value": "sit-next-and-supervise",
            "label": "陪在旁边督促"
        },
        {
            "value": "let-child-self-complete",
            "label": "放手自主完成"
        },
        {
            "value": "set-timer-and-check",
            "label": "设定定时复查"
        },
        {
            "value": "do-together-no-interfere",
            "label": "一起做但不干涉"
        }
    ],
    "storageKey": "children_homework_companion_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-homework-companion'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>作业陪伴投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子写作业：你的陪伴方式”的最新态度</p>";
