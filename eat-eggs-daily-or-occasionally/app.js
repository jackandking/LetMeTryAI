...
const questionConfig = {
    title: '天天吃鸡蛋还是偶尔吃？你早餐怎么安排',
    question: '天天吃鸡蛋还是偶尔吃？你早餐怎么安排',
    options: [
        { value: 'eat-eggs-everyday', label: '每天都吃' },
        { value: 'only-on-workdays', label: '工作日固定吃' },
        { value: 'sometimes-with-others', label: '偶尔吃，搭配其他' },
        { value: 'no-eggs-other', label: '不吃鸡蛋改别的' }
    ],
    storageKey: 'eat_eggs_daily_or_occasionally.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eat-eggs-daily-or-occasionally'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>天天吃鸡蛋还是偶尔吃？你早餐怎么安排结果</h2>';
