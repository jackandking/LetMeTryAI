...
const questionConfig = {
    title: '台风天，你会怎么帮家中老人稳住生活？',
    question: '台风来临时，你会选哪种方式帮家中老人稳住生活？',
    options: [
        { value: 'secure-doors-windows', label: '加固门窗' },
        { value: 'prepare-3day-kit', label: '备好三日生活包' },
        { value: 'move-to-safe-room', label: '安置到室内安全区' },
        { value: 'temporary-relocation', label: '短期转移到亲友或避风处' }
    ],
    storageKey: 'taifeng_elder_stable_life.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-elder-stable-life'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天，你会怎么帮家中老人稳住生活？结果</h2>';
