...
const questionConfig = {
    title: '夏天手上常起小水疱，你更在意哪个问题？',
    question: '夏天手上常起小水疱，你更在意哪个问题？',
    options: [
        { value: 'itchy-pain', label: '经常痒又疼，睡不好' },
        { value: 'affect-chores', label: '做家务时容易破溃出血' },
        { value: 'recur-frequently', label: '反复发作，总也好不了' },
        { value: 'worry-contagious', label: '担心会传给家人或传染' }
    ],
    storageKey: 'summer_hand_blisters.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-hand-blisters'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天手上常起小水疱，你更在意哪个问题？结果</h2>';
