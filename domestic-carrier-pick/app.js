...
const questionConfig = {
    title: '国产航母里，哪一艘让你热血沸腾？',
    question: '国产航母里，哪一艘让你热血沸腾？',
    options: [
        { value: 'liaoning-ship', label: '辽宁舰' },
        { value: 'shandong-ship', label: '山东舰' },
        { value: 'fujian-ship', label: '福建舰' },
        { value: 'hainan-ship', label: '海南舰' }
    ],
    storageKey: 'domestic_carrier_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=domestic-carrier-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产航母里，哪一艘让你热血沸腾？结果</h2>';
