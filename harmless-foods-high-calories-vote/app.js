...
const questionConfig = {
    title: '哪些看似无害的食物热量偏高，应少吃？',
    question: '哪些看似无害的食物热量偏高，应少吃？',
    options: [
        { value: 'nuts-and-seeds', label: '坚果与果仁' },
        { value: 'baked-sweets', label: '蛋糕与烘焙甜点' },
        { value: 'sweet-drinks-juices', label: '果汁与甜饮料' },
        { value: 'processed-snacks-energy-bars', label: '能量棒与加工零食' }
    ],
    storageKey: 'harmless_foods_high_calories_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=harmless-foods-high-calories-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪些看似无害的食物热量偏高，应少吃？结果</h2>';
