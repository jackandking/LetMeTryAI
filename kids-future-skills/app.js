...
const questionConfig = {
    title: '孩子长大后，你更看重哪种能力？',
    question: '孩子长大后，你更看重哪种能力？',
    options: [
        { value: 'independent-living', label: '独立生活能力' },
        { value: 'communication-empathy', label: '沟通与情绪管理' },
        { value: 'self-learning', label: '学习与自学能力' },
        { value: 'problem-solving', label: '抗挫与解决问题能力' }
    ],
    storageKey: 'kids_future_skills.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-future-skills'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子长大后，你更看重哪种能力？结果</h2>';
