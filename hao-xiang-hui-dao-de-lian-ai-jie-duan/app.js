/**
 * 好想回到的恋爱阶段 Survey Application
 * Logic for the "好想回到的恋爱阶段 — 你最怀念哪一刻？" survey
 */

const questionConfig = {
    "title": "好想回到的恋爱阶段 — 你最怀念哪一刻？",
    "question": "你最想回到哪一个恋爱阶段？选出让你最怀念的一刻",
    "options": [
        {
            "value": "chu-xi-de-xin-dong-yue-hui",
            "label": "初识的心动约会：第一次见面的小心机"
        },
        {
            "value": "re-lian-qi-da-ka-tian-mi",
            "label": "热恋期的打卡甜蜜：早安晚安不停讯息"
        },
        {
            "value": "cheng-nuo-yu-lv-xing-yi-qi-jian-fu-mu",
            "label": "承诺与旅行期：一起订票见父母那次"
        },
        {
            "value": "wen-ding-xiang-chu-an-xin-ri-chang-pei-ban",
            "label": "稳定相处的安心日常：平淡却最踏实的陪伴"
        }
    ],
    "storageKey": "hao_xiang_hui_dao_de_lian_ai_jie_duan_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hao-xiang-hui-dao-de-lian-ai-jie-duan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>好想回到的恋爱阶段投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“好想回到的恋爱阶段 — 你最怀念哪一刻？”的最新态度</p>";
