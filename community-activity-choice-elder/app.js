 ...
 * Logic for the "参与社区活动，你会选哪种？" survey
 */
...
const questionConfig = {
    ...
    "storageKey": "community_activity_choice_elder_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-elder'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“参与社区活动，你会选哪种？”的最新态度</p>";
