...
const questionConfig = {
    title: '看中国男篮输给日本，球场哪个画面更触动你？',
    question: '看中国男篮输给日本，球场哪个画面更触动你？',
    options: [
        { value: 'captain-sitting-alone', label: '队长孤坐场边' },
        { value: 'fans-applauding', label: '球迷久久鼓掌' },
        { value: 'opponent-celebration', label: '对方庆祝瞬间' },
        { value: 'bench-comfort', label: '替补席互相安慰' }
    ],
    storageKey: 'china_men_basketball_loss_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=china-men-basketball-loss-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看中国男篮输给日本，球场哪个画面更触动你？结果</h2>';
