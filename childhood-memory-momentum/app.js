...
const questionConfig = {
    title: '小时候哪段记忆，让现在日子更有奔头？',
    question: '小时候哪段记忆，让现在日子更有奔头？',
    options: [
        { value: 'parent-listened-once', label: '被父母认真听一次' },
        { value: 'first-small-win', label: '独立完成一件小事' },
        { value: 'summer-friends-play', label: '和小伙伴疯玩的夏天' },
        { value: 'elder-old-story', label: '长辈讲的一个老故事' }
    ],
    storageKey: 'childhood_memory_momentum.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=childhood-memory-momentum'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小时候哪段记忆，让现在日子更有奔头？结果</h2>';
