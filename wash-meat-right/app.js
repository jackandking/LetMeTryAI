...
const questionConfig = {
    title: '洗生肉这件小事，你家做对了吗？',
    question: '洗生肉这件小事，你家做对了吗？',
    options: [
        { value: 'faucet-rinse', label: '水龙头直冲' },
        { value: 'bowl-soak', label: '盆里浸泡洗' },
        { value: 'paper-wipe', label: '厨房纸擦拭' },
        { value: 'cook-directly', label: '不洗直接烹饪' }
    ],
    storageKey: 'wash_meat_right.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wash-meat-right'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>洗生肉这件小事，你家做对了吗？结果</h2>';
