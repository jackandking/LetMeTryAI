/**
 * 孩子发脾气怎么回应 Survey Application
 * Logic for the "家长话题：孩子发脾气你会怎么回应？" survey
 */

const questionConfig = {
    "title": "家长话题：孩子发脾气你会怎么回应？",
    "question": "站在家长视角，你会怎么选：孩子发脾气时通常如何回应？",
    "options": [
        {
            "value": "calm-talk-listen-first",
            "label": "冷静沟通，听完再讲道理"
        },
        {
            "value": "give-space-then-talk",
            "label": "先给空间，让情绪平复后再谈"
        },
        {
            "value": "set-limits-and-consequences",
            "label": "设置明确界限并给出后果"
        },
        {
            "value": "distract-with-activity",
            "label": "用转移或替代活动化解情绪"
        }
    ],
    "storageKey": "how_to_handle_kid_tantrums_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=how-to-handle-kid-tantrums'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子发脾气怎么回应投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子发脾气你会怎么回应？”的最新态度</p>";
