...
const questionConfig = {
    title: '梅雨季接送娃，你的必备神器是啥？',
    question: '梅雨季接送娃，你的必备神器是啥？',
    options: [
        { value: 'oversized-double-umbrella', label: '超大号双人伞' },
        { value: 'kids-raincoat-boots-set', label: '儿童雨衣雨鞋套装' },
        { value: 'waterproof-diaper-bag', label: '防水妈咪包' },
        { value: 'e-bike-rain-windshield', label: '电动车挡风防雨棚' }
    ],
    storageKey: 'rainy_school_pickup_gear.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-school-pickup-gear'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>梅雨季接送娃，你的必备神器是啥？结果</h2>';
