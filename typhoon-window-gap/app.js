...
const questionConfig = {
    title: '台风天，家里窗户留条缝你会怎么做？',
    question: '台风天，家里窗户留条缝你会怎么做？',
    options: [
        { value: 'seal-window-gap', label: '把缝彻底堵好' },
        { value: 'small-gap-with-barrier', label: '留小缝并加挡水' },
        { value: 'close-and-secure', label: '关窗并检查固定物' },
        { value: 'leave-and-ask-neighbor', label: '先离开窗边求助邻居' }
    ],
    storageKey: 'typhoon_window_gap.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=typhoon-window-gap'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天，家里窗户留条缝你会怎么做？结果</h2>';
