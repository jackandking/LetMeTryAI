...
const questionConfig = {
    title: '孩子的零花钱你会怎么存？罐子、卡还是小金库？',
    question: '孩子的零花钱你会怎么存？',
    options: [
        { value: 'cash-jar', label: '现金罐子' },
        { value: 'bank-card', label: '银行卡/储蓄卡' },
        { value: 'parent-managed-pocket', label: '家长管理的奖励账户' }
    ],
    storageKey: 'kids_pocket_money_storage.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-pocket-money-storage'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子的零花钱你会怎么存？罐子、卡还是小金库？结果</h2>';
