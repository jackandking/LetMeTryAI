/**
 * 跑车声浪PK Survey Application
 * Logic for the "装备党首选：跑车声浪终极PK" survey
 */

const questionConfig = {
    "title": "装备党首选：跑车声浪终极PK",
    "question": "亲，你更愿意把票投给哪种跑车声浪？",
    "options": [
        {
            "value": "ferrari-v8",
            "label": "法拉利 V8 怒吼"
        ...
        {
            "value": "lamborghini-v10",
            "label": "兰博基尼 V10 咆哮"
        },
        {
            "value": "porsche-flat-six",
            "label": "保时捷 平六 劲爆"
        },
        {
            "value": "mclaren-v8",
    ...
    "storageKey": "supercar_exhaust_pk_2026_04_05_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supercar-exhaust-pk-2026-04-05'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>跑车声浪PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“装备党首选：跑车声浪终极PK”的最新态度</p>";
