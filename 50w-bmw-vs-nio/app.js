...
const questionConfig = {
    title: '50万预算，你会买宝马燃油车还是蔚来电动车？',
    question: '50万预算，你会买宝马燃油车还是蔚来电动车？',
    options: [
        { value: 'bmw-fuel', label: '买宝马燃油车' },
        { value: 'nio-ev', label: '买蔚来电动车' },
        { value: 'wait-or-other', label: '继续观望或买其他品牌' }
    ],
    storageKey: '50w_bmw_vs_nio.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=50w-bmw-vs-nio'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>50万预算，你会买宝马燃油车还是蔚来电动车？结果</h2>';
