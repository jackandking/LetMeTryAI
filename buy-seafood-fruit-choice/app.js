...
const questionConfig = {
    title: '买海鲜和贵价水果时你会怎么选？',
    question: '买海鲜和贵价水果时你会怎么选？',
    options: [
        { value: 'prioritize-freshness', label: '优先新鲜' },
        { value: 'choose-by-price', label: '看价格促销' },
        { value: 'buy-small-more-often', label: '少量多次' },
        { value: 'choose-preserved-or-alternatives', label: '选易保鲜或替代' }
    ],
    storageKey: 'buy_seafood_fruit_choice.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=buy-seafood-fruit-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>买海鲜和贵价水果时你会怎么选？结果</h2>';
