/**
 * 养生习惯投票 Survey Application
 * Logic for the "爱老人关注：日常养生习惯投票" survey
 */

const questionConfig = {
    "title": "爱老人关注：日常养生习惯投票",
    "question": "如果是爱老人用户，你最支持哪个日常养生习惯？",
    "options": [
        {
            "value": "foot-soak-morning-evening",
            "label": "早晚泡脚"
        },
        {
            "value": "daily-warm-water",
            "label": "每天一杯温开水"
        },
        {
            "value": "short-afternoon-nap",
            "label": "午休不超过30分钟"
        },
        {
            "value": "walk-30-minutes",
            "label": "每天散步半小时"
        }
    ],
    "storageKey": "daily_wellness_habit_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=daily-wellness-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>养生习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“爱老人关注：日常养生习惯投票”的最新态度</p>";
