...
const questionConfig = {
    title: '风扇帽这么火，你会戴哪种去散步？',
    question: '风扇帽这么火，你会戴哪种去散步？',
    options: [
        { value: 'breathable-hat', label: '轻薄透气帽（无风扇）' },
        { value: 'built-in-fan-hat', label: '内置微风扇帽（电池式）' },
        { value: 'solar-fan-hat', label: '太阳能小风扇帽' },
        { value: 'handheld-fan-with-hat', label: '手持小风扇配宽檐帽' }
    ],
    storageKey: 'fan_hat_walk.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=fan-hat-walk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>风扇帽这么火，你会戴哪种去散步？结果</h2>';
