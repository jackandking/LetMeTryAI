...
const questionConfig = {
    title: '车停两年回家发现车内发霉，你会怎么处理？',
    question: '车停两年回家发现车内发霉，你会怎么处理？',
    options: [
        { value: 'deep-clean-and-sun', label: '彻底清洁并晾晒' },
        { value: 'professional-mold-service', label: '请专业除霉消毒' },
        { value: 'replace-upholstery', label: '替换受潮的坐垫和布物' },
        { value: 'air-and-cover-odor', label: '先通风暂时遮味观察' }
    ],
    storageKey: 'car_mold_return.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=car-mold-return'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>车停两年回家发现车内发霉，你会怎么处理？结果</h2>';
