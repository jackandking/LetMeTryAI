...
const questionConfig = {
    title: '天天吃鸡蛋还是偶尔吃，你会怎么选？',
    question: '天天吃鸡蛋还是偶尔吃，你会怎么选？',
    options: [
        { value: 'eat-everyday', label: '天天吃' },
        { value: 'eat-occasionally', label: '偶尔吃' },
        { value: 'rarely-eat', label: '很少吃/替代' }
    ],
    storageKey: 'eggs_daily_or_occasionally.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eggs-daily-or-occasionally'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>天天吃鸡蛋还是偶尔吃，你会怎么选？结果</h2>';
