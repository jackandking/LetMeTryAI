...
const questionConfig = {
    title: '一年级真不用写书面作业？你支持还是有点担心？',
    question: '一年级真不用写书面作业？你支持还是有点担心？',
    options: [
        { value: 'support-let-kids-relax', label: '支持，让孩子轻松学' },
        { value: 'worry-foundation', label: '有点担心，怕基础不足' },
        { value: 'depends-school-arrangement', label: '看学校安排，要平衡' },
        { value: 'trial-observe', label: '短期试行，观察效果' }
    ],
    storageKey: 'grade1_no_written_homework.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grade1-no-written-homework'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>一年级真不用写书面作业？你支持还是有点担心？结果</h2>';
