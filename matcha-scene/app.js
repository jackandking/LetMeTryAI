...
const questionConfig = {
    title: '抹茶这么火，你更爱哪种抹茶画面？',
    question: '抹茶这么火，你更喜欢哪种画面？',
    options: [
        { value: 'matcha-latte', label: '抹茶拿铁' },
        { value: 'traditional-matcha', label: '传统抹茶' },
        { value: 'matcha-dessert', label: '抹茶甜点' },
        { value: 'matcha-ice', label: '抹茶冰品' }
    ],
    storageKey: 'matcha_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=matcha-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>抹茶这么火，你更爱哪种抹茶画面？结果</h2>';
