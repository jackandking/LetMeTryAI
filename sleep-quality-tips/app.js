 ...
 * Logic for the "睡得更好：哪种方法对你最有效？" survey
 */

const questionConfig = {
    "title": "睡得更好：哪种方法对你最有效？",
    ...
    "options": [
        ...
        {
            "value": "adjust-bedding",
            "label": "调整卧具（枕头/床垫）"
        }
    ],
    "storageKey": "sleep_quality_tips_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-quality-tips'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“睡得更好：哪种方法对你最有效？”的最新态度</p>";
