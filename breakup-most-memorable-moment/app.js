...
const questionConfig = {
    ...
    "options": [
        ...
        {
            "value": "noticed-new-relationship",
            "label": "发现他/她开始新关系"
        },
        {
        ...
        {
            "value": "song-or-scent-trigger",
            "label": "某首歌/气味触发回忆"
        }
    ],
    "storageKey": "breakup_most_memorable_moment_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=breakup-most-memorable-moment'
        });
        return;
    }
