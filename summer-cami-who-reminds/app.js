...
const questionConfig = {
    title: '夏天穿吊带出门，你更想被谁温柔提醒？',
    question: '夏天穿吊带出门，你更想被谁温柔提醒？',
    options: [
        { value: 'gui-mi', label: '闺蜜' },
        { value: 'nan-you', label: '男友' },
        { value: 'ma-ma', label: '妈妈' },
        { value: 'kind-stranger', label: '好心路人' }
    ],
    storageKey: 'summer_cami_who_reminds.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-cami-who-reminds'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天穿吊带出门，你更想被谁温柔提醒？结果</h2>';
