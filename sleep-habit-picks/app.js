 ...
 * Logic for the "改善睡眠：你更倾向哪种睡前小习惯？" survey
 */

const questionConfig = {
    "title": "改善睡眠：你更倾向哪种睡前小习惯？",
    "question": "亲，你认为哪种睡前习惯最有助于入睡？",
    "options": [
        {
            "value": "warm-milk",
            "label": "喝一杯温牛奶"
    ...
    "storageKey": "sleep_habit_picks_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-habit-picks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“改善睡眠：你更倾向哪种睡前小习惯？”的最新态度</p>";
