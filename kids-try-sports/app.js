...
const questionConfig = {
    title: '孩子看运动员，会想试哪种运动？',
    question: '孩子看运动员，会想试哪种运动？看到哪个动作会忍不住模仿？',
    options: [
    ...
    storageKey: 'kids_try_sports.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-try-sports'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看运动员，会想试哪种运动？结果</h2>';
