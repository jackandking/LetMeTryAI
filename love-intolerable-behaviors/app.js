/**
 * 情感热议 Survey Application
 * Logic for the "恋爱中最不能忍的行为" survey
 */

const questionConfig = {
    "title": "恋爱中最不能忍的行为",
    "question": "恋爱中哪种行为最让你无法忍受？",
    "options": [
        {
        ...
        {
            "value": "cheating-or-betrayal",
            "label": "背叛/劈腿"
        },
        {
            "value": "silent-treatment-no-communication",
            "label": "冷暴力/不沟通"
        },
        {
            "value": "controlling-or-restricting",
            "label": "过度控制/限制自由"
        }
    ],
    "storageKey": "love_intolerable_behaviors_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-intolerable-behaviors'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>情感热议投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“恋爱中最不能忍的行为”的最新态度</p>";
