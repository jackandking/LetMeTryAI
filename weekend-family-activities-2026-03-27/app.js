/**
 * 周末亲子活动 Survey Application
 * Logic for the "家长话题：周末亲子活动怎么安排" survey
 */

const questionConfig = {
    "title": "家长话题：周末亲子活动怎么安排",
    "question": "站在家长视角，你会怎么选：周末带孩子最想做什么？",
    "options": [
        {
            "value": "short-day-trip",
            "label": "短程一日游（近郊踏青）"
        },
        {
            "value": "home-crafts-baking",
            "label": "在家手工或亲子烘焙"
        },
        {
        ...
        },
        {
            ...
            "label": "社区/志愿体验（陪长者、环境清洁）"
        }
    ],
    "storageKey": "weekend_family_activities_2026_03_27_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=weekend-family-activities-2026-03-27'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>周末亲子活动投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：周末亲子活动怎么安排”的最新态度</p>";
