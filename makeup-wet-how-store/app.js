...
const questionConfig = {
    title: '化妆品潮湿了你怎么收？',
    question: '化妆品潮湿了你会怎么收着或处理？',
    options: [
        { value: 'paper-towel-air-dry', label: '纸巾吸干 + 自然风干' },
        { value: 'desiccant-rice', label: '放干燥剂或米袋密封吸潮' },
        { value: 'low-heat-blow-dry', label: '低温吹风机快速吹干' },
        { value: 'throw-away-replace', label: '直接丢掉换新的' }
    ],
    storageKey: 'makeup_wet_how_store.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=makeup-wet-how-store'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>化妆品潮湿了你怎么收？结果</h2>';
