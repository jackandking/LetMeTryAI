...
const questionConfig = {
    title: '台风夜，哪种陪护方式会让孩子更安心？',
    question: '台风夜，哪种陪护方式会让孩子更安心？',
    options: [
        { value: 'chuangbian-peiban', label: '床边陪伴' },
        { value: 'tongfang-gongshui', label: '同房共睡' },
        { value: 'nearby-out-of-room', label: '房外待命' },
        { value: 'prepare-comfort-tools', label: '准备安抚工具' }
    ],
    storageKey: 'taifeng_night_accompany.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-night-accompany'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风夜，哪种陪护方式会让孩子更安心？结果</h2>';
