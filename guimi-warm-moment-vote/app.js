/**
 * 闺蜜暖心瞬间投票 Survey Application
 * Logic for the "闺蜜暖心瞬间 — 你最感动哪一幕？" survey
 */

const questionConfig = {
    "title": "闺蜜暖心瞬间 — 你最感动哪一幕？",
    "question": "在闺蜜给你做过的暖心瞬间里，你最想把一票投给哪一项？",
    "options": [
        {
            "value": "late-night-noodles",
            "label": "深夜立刻起床陪你吃宵夜"
        },
        {
            "value": "shield-embarrassment",
            "label": "当众帮你化解尴尬场面"
        },
        {
            "value": "take-bad-news",
            "label": "替你向家人/领导传达难说的话"
        },
        {
            "value": "surprise-mini-party",
            "label": "偷偷准备小惊喜为你庆祝"
        }
    ],
    "storageKey": "guimi_warm_moment_vote_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guimi-warm-moment-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>闺蜜暖心瞬间投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜暖心瞬间 — 你最感动哪一幕？”的最新态度</p>";
