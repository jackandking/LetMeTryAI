...
const questionConfig = {
    title: '带孩子逛博物馆，哪类镇馆之宝让他眼前一亮？',
    question: '带孩子逛博物馆，哪类镇馆之宝让他眼前一亮？',
    options: [
        { value: 'bronze-treasures', label: '青铜重器' },
        { value: 'dinosaur-fossils', label: '恐龙化石' },
        { value: 'gold-mask', label: '黄金面具' },
        { value: 'ancient-weapons', label: '古代兵器' }
    ],
    storageKey: 'parent_museum_treasures.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parent-museum-treasures'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子逛博物馆，哪类镇馆之宝让他眼前一亮？结果</h2>';
