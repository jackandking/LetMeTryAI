...
const questionConfig = {
    title: '定制旗袍穿上身，你被哪款惊艳到？',
    question: '定制旗袍穿上身，你被哪款惊艳到？选出最让你多看几眼的一款',
    options: [
        { value: 'yuebai-xiuhua-kuan', label: '月白绣花款' },
        { value: 'anhong-sirong-gudian-kuan', label: '暗红丝绒古典款' },
        { value: 'gailiang-modeng-duanxiu-kuan', label: '改良摩登短袖款' },
        { value: 'mibai-wenyi-yinhua-kuan', label: '米白文艺印花款' }
    ],
    storageKey: 'dingzhi_qipao_jingyan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dingzhi-qipao-jingyan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>定制旗袍穿上身，你被哪款惊艳到？结果</h2>';
