...
const questionConfig = {
    title: '世界杯熬夜看球，你的快乐标配是什么？',
    question: '世界杯熬夜看球，你的快乐标配是什么？',
    options: [
        { value: 'beer-bbq', label: '冰镇啤酒配烤串' },
        { value: 'cola-chips', label: '肥宅快乐水配薯片' },
        { value: 'coffee-chicken', label: '咖啡炸鸡配外卖' },
        { value: 'goji-seeds', label: '养生枸杞配瓜子' }
    ],
    storageKey: 'world_cup_night_snack.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=world-cup-night-snack'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>世界杯熬夜看球，你的快乐标配是什么？结果</h2>';
