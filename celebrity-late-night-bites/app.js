...
const questionConfig = {
    title: '哪个明星的夜宵让你想吃？',
    question: '看这些明星的夜宵图，你会选哪一种？',
    options: [
        { value: 'chicken-beer', label: '炸鸡啤酒组合' },
        { value: 'seafood-hotpot', label: '火锅涮海鲜' },
        { value: 'late-night-bento', label: '便当冷面简单吃' }
    ],
    storageKey: 'celebrity_late_night_bites.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-late-night-bites'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪个明星的夜宵让你想吃？结果</h2>';
