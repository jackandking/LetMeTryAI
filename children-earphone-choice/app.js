/**
 * 儿童耳机选购 Survey Application
 * Logic for the "家长话题：儿童耳机选购 — 有线还是无线？" survey
 */

const questionConfig = {
    "title": "家长话题：儿童耳机选购 — 有线还是无线？",
    "question": "站在家长视角，你会怎么选：儿童耳机 — 有线还是无线？",
    "options": [
        {
        ...
        {
            "value": "age-based-choice",
            "label": "按年龄/用途来选"
        }
    ],
    "storageKey": "children_earphone_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-earphone-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>儿童耳机选购投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：儿童耳机选购 — 有线还是无线？”的最新态度</p>";
