 ...
 * Logic for the "孩子发脾气时你会怎么回应？" survey
 */
...
const questionConfig = {
    ...
    "storageKey": "kid_tantrum_response_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kid-tantrum-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子发脾气时你会怎么回应？”的最新态度</p>";
