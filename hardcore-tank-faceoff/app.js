 ...
 * Logic for the "当代主战坦克对比投票" survey
 */

const questionConfig = {
    "title": "当代主战坦克对比投票",
    "question": "作为硬核玩家，你更认可哪款主战坦克？",
    "options": [
        {
            "value": "m1a2-abrams",
            "label": "M1A2 Abrams"
    ...
    "storageKey": "hardcore_tank_faceoff_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hardcore-tank-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“当代主战坦克对比投票”的最新态度</p>";
