...
const questionConfig = {
    title: '手机越来越贵，你还在用哪款自拍妆？',
    question: '手机越来越贵，你还在用哪款自拍妆？',
    options: [
        { value: 'qingtou-kongqi', label: '轻透空气感' },
        { value: 'mopi-lvjing', label: '磨皮滤镜感' },
        { value: 'ziran-luozhuang', label: '自然裸妆派' },
        { value: 'gaoguang-liti', label: '高光立体派' }
    ],
    storageKey: 'phone_selfie_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=phone-selfie-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>手机越来越贵，你还在用哪款自拍妆？结果</h2>';
