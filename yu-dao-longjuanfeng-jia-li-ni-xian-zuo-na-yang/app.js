...
const questionConfig = {
    title: '遇到龙卷风，家里你先做哪样？',
    question: '遇到龙卷风，家里你先做哪样？',
    options: [
        { value: 'dai-qu-dixia-shi', label: '先带大家去地下室或避难间' },
        { value: 'duo-ru-nei-shi', label: '躲到房屋中央的无窗内室（如卫生间）' },
        { value: 'zuan-jiaju-xia', label: '钻到结实家具下并用枕被护头' },
        { value: 'jiti-zhongxin-fangjian', label: '把家人集中到同一安全房间并互相照应' }
    ],
    storageKey: 'yu_dao_longjuanfeng_jia_li_ni_xian_zuo_na_yang.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yu-dao-longjuanfeng-jia-li-ni-xian-zuo-na-yang'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>遇到龙卷风，家里你先做哪样？结果</h2>';
