...
const questionConfig = {
    title: '雅阁降到10万级，你还会选合资燃油车吗？',
    question: '雅阁降到10万级，你还会选合资燃油车吗？',
    options: [
        { value: 'accord-still-buy', label: '必选雅阁，真香' },
        { value: 'switch-new-energy', label: '转头新能源，不犹豫' },
        { value: 'cheapest-wins', label: '看优惠力度，价低者赢' },
        { value: 'loyal-fuel-fan', label: '怀旧老车主，再来一辆' }
    ],
    storageKey: 'accord_100k_fuel_car_choice.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=accord-100k-fuel-car-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>雅阁降到10万级，你还会选合资燃油车吗？结果</h2>';
