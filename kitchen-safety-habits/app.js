/**
 * 厨房好习惯 - 爱老人 Survey Application
 * Logic for the "洗菜做饭，哪个细节更该留意" survey
 */

const questionConfig = {
    "title": "洗菜做饭，哪个细节更该留意",
    "question": "亲，洗菜做饭，哪个细节更该留意？",
    "options": [
        {
            "value": "no-rinse-raw-meat",
            "label": "生肉不直接用水冲"
        },
        {
            "value": "separate-cutting-boards",
            "label": "砧板生熟分开用"
        },
        {
            "value": "cool-leftovers-first",
            "label": "剩菜放凉再冷藏"
        },
        {
            "value": "no-sprouted-potatoes",
            "label": "发芽土豆坚决不吃"
        }
    ],
    "storageKey": "kitchen_safety_habits_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kitchen-safety-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>厨房好习惯 - 爱老人投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“洗菜做饭，哪个细节更该留意”的最新态度</p>";
