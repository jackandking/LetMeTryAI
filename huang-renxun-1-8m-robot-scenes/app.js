...
const questionConfig = {
    title: '黄仁勋联手宇树造1.8米人形机器人，你会在哪个场景遇到它？',
    question: '黄仁勋联手宇树造1.8米人形机器人，你会在哪个场景遇到它？',
    options: [
        { value: 'tech-expo-demo', label: '科技展台现场演示' },
        { value: 'shopping-mall-demo', label: '商场中庭体验店' },
        { value: 'fancy-restaurant', label: '高端餐厅的服务员' },
        { value: 'outdoor-cafe', label: '露天咖啡馆街角' }
    ],
    storageKey: 'huang_renxun_1_8m_robot_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huang-renxun-1-8m-robot-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>黄仁勋联手宇树造1.8米人形机器人，你会在哪个场景遇到它？结果</h2>';
