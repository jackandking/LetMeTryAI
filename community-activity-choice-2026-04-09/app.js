 ...
 * Logic for the "关注：社区活动你更愿意参加哪类？" survey
 */

const questionConfig = {
    "title": "关注：社区活动你更愿意参加哪类？",
    "question": "亲，你最支持哪个社区活动类型：社区活动你更愿意参加哪类？",
    "options": [
        {
    ...
    "storageKey": "community_activity_choice_2026_04_09_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-09'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：社区活动你更愿意参加哪类？”的最新态度</p>";
