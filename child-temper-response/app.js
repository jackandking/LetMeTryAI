/**
 * 孩子发脾气如何回应 Survey Application
 * Logic for the "家长话题：孩子发脾气时你怎么回应？" survey
 */

const questionConfig = {
    "title": "家长话题：孩子发脾气时你怎么回应？",
    "question": "站在家长视角，你会怎么选：孩子发脾气时最常用的回应方式？",
    "options": [
        {
            "value": "give-space-calm-down",
            "label": "先冷处理，给孩子空间"
        },
        {
            "value": "listen-name-feelings",
            "label": "耐心倾听并为情绪命名"
        },
        {
            "value": "set-boundaries-offer-choices",
            "label": "设定界限并提供选择"
        },
        {
            "value": "soothe-physical-presence",
            "label": "及时安抚并身体陪伴"
        }
    ],
    "storageKey": "child_temper_response_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-temper-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子发脾气如何回应投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子发脾气时你怎么回应？”的最新态度</p>";
