...
const questionConfig = {
    title: '轻松晨练选择',
    question: '早晨你更愿意选择哪种轻松晨练方式？',
    options: [
        { value: 'chenjian-sanbu', label: '晨间散步' },
        { value: 'taiji-huanlian', label: '太极缓练' },
        { value: 'yizuo-shenzhan', label: '椅上伸展' },
        { value: 'huxi-fangsong', label: '呼吸与放松' }
    ],
    storageKey: 'qingsong_chenlian_xuanze.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qingsong-chenlian-xuanze'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>轻松晨练选择结果</h2>';
