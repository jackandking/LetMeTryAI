...
const questionConfig = {
    title: '孩子在学校遇到突发情况，你会先教TA哪件事？',
    question: '孩子在学校遇到突发情况，你会先教TA哪件事？',
    options: [
        { value: 'ask-teacher', label: '先找老师或值班成人' },
        { value: 'self-evacuate', label: '先跑开/躲避并保护自己' },
        { value: 'shout-and-locate', label: '先大声呼救并说明位置' },
        { value: 'call-parent-or-emergency', label: '先用手机联系家长或紧急电话' }
    ],
    storageKey: 'school_emergency_priority.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=school-emergency-priority'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子在学校遇到突发情况，你会先教TA哪件事？结果</h2>';
