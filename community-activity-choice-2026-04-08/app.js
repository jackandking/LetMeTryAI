 ...
 * Logic for the "社区活动投票｜你更想参加哪类活动？" survey
 */

const questionConfig = {
    "title": "社区活动投票｜你更想参加哪类活动？",
    "question": "亲，你最支持哪个社区活动类型？",
    "options": [
        {
            "value": "neighborhood-gathering",
            "label": "邻里联谊"
        },
        {
            "value": "hobby-groups",
    ...
    "storageKey": "community_activity_choice_2026_04_08_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-08'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“社区活动投票｜你更想参加哪类活动？”的最新态度</p>";
