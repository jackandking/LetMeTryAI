...
const questionConfig = {
    title: '“关岛快递”东风-26首次裸弹亮相，哪个画面更让你热血沸腾？',
    question: '“关岛快递”东风-26首次裸弹亮相，哪个画面更让你热血沸腾？',
    options: [
        { value: 'close-up-nude-missile', label: '裸弹近景特写' },
        { value: 'tels-on-the-move', label: '发射车机动' },
        { value: 'launch-flame-trail', label: '实弹发射尾焰' },
        { value: 'parade-square-display', label: '阅兵方阵展示' }
    ],
    storageKey: 'dongfeng_26_first_nude_missile_debut.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dongfeng-26-first-nude-missile-debut'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>“关岛快递”东风-26首次裸弹亮相，哪个画面更让你热血沸腾？结果</h2>';
