...
const questionConfig = {
    title: '中国机器人开始治沙，这操作你怎么看？',
    question: '中国机器人开始治沙，你站哪一派？',
    options: [
        { value: 'tech-pride-green-oasis', label: '科技牛，沙漠变绿洲' },
        { value: 'cost-practical-concern', label: '看着酷，成本是硬伤' },
        { value: 'green-mountains-support', label: '绿水青山就是金山银山' },
        { value: 'traditional-planting-better', label: '还是老法子更踏实' }
    ],
    storageKey: 'china_robot_sand_control.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=china-robot-sand-control'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>中国机器人开始治沙，这操作你怎么看？结果</h2>';
