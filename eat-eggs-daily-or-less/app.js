...
const questionConfig = {
    title: '天天吃鸡蛋还是少吃？你家长辈怎么吃蛋',
    question: '你家长辈是天天吃鸡蛋还是少吃？他们一般怎么吃蛋？',
    options: [
        { value: 'eat-one-daily', label: '天天吃一个' },
        { value: 'a-few-times-week', label: '隔天或每周几次' },
        { value: 'rarely-or-never', label: '很少吃或几乎不吃' },
        { value: 'depending-on-constitution', label: '看体质和习惯调整' }
    ],
    storageKey: 'eat_eggs_daily_or_less.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eat-eggs-daily-or-less'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>天天吃鸡蛋还是少吃？你家长辈怎么吃蛋结果</h2>';
