/**
 * 家务分工投票 Survey Application
 * Logic for the "家长话题：家务分工，孩子能做哪类？" survey
 */

const questionConfig = {
    "title": "家长话题：家务分工，孩子能做哪类？",
    "question": "站在家长视角，你会怎么选：你认为孩子最适合从哪类家务开始承担？",
    "options": [
        {
            "value": "tidy-toys-make-bed",
            "label": "收拾玩具与整理床铺"
        },
        {
            "value": "wash-veg-set-table",
            "label": "帮忙洗果蔬与摆餐具"
        },
        {
            "value": "simple-cleaning",
            "label": "简单清洁（擦桌/扫地）"
        },
        {
            "value": "pet-plant-care",
            "label": "照顾宠物或浇花"
        }
    ],
    "storageKey": "household_chore_split_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=household-chore-split'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家务分工投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：家务分工，孩子能做哪类？”的最新态度</p>";
