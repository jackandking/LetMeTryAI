/**
 * 口红色号投票 Survey Application
 * Logic for the "女人爱热议：今夏显白口红色号谁能拔得头筹？" survey
 */

const questionConfig = {
    "title": "女人爱热议：今夏显白口红色号谁能拔得头筹？",
    "question": "你会把这一票投给谁：今夏显白口红色号？",
    "options": [
        {
        ...
        {
            "value": "peach-blush-pink",
            "label": "桃花粉"
        }
    ],
    "storageKey": "summer_lip_color_poll_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-lip-color-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>口红色号投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：今夏显白口红色号谁能拔得头筹？”的最新态度</p>";
