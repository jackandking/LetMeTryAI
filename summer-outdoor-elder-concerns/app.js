...
const questionConfig = {
    title: '暑天出门，老人你在意哪点？',
    question: '暑天出门，老人你在意哪点？（可选一项）',
    options: [
        { value: 'sunscreen-shade', label: '防晒遮阳' },
        { value: 'cooling-ventilation', label: '降温通风' },
        { value: 'walking-safety', label: '走路安全' },
        { value: 'toilet-access', label: '方便如厕' }
    ],
    storageKey: 'summer_outdoor_elder_concerns.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-outdoor-elder-concerns'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>暑天出门，老人你在意哪点？结果</h2>';
