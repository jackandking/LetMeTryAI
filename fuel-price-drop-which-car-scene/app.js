...
const questionConfig = {
    title: '燃油车大降价，哪个买车画面更打动你？',
    question: '燃油车大降价，哪个买车画面更打动你？',
    options: [
        { value: 'take-key-moment', label: '拿钥匙那刻' },
        { value: 'drive-out-to-feast', label: '驶出店门去吃大餐' },
        { value: 'see-lower-fuel-price', label: '加油时看见油价降' },
        { value: 'save-for-offroad-trip', label: '省下钱去越野撒欢' }
    ],
    storageKey: 'fuel_price_drop_which_car_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=fuel-price-drop-which-car-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>燃油车大降价，哪个买车画面更打动你？结果</h2>';
