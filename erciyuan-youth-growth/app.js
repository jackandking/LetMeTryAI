...
const questionConfig = {
    title: '二次元文化与青少年成长，你怎么看？',
    question: '二次元文化与青少年成长，你怎么看？',
    options: [
        { value: 'positive-influence', label: '积极影响' },
        { value: 'excessive-addiction', label: '过度沉迷' },
        { value: 'interest-community', label: '兴趣社群促进成长' },
        { value: 'depends-on-person', label: '因人而异' }
    ],
    storageKey: 'erciyuan_youth_growth.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=erciyuan-youth-growth'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>二次元文化与青少年成长，你怎么看？结果</h2>';
