/**
 * 老歌投票 Survey Application
 * Logic for the "最经典的老歌你选哪首？" survey
 */

const questionConfig = {
    "title": "最经典的老歌你选哪首？",
    "question": "亲，你最怀念哪首经典老歌？",
    "options": [
        {
    ...
    "storageKey": "classic_old_songs_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>老歌投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“最经典的老歌你选哪首？”的最新态度</p>";
