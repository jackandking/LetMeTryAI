/**
 * 明星穿搭PK Survey Application
 * Logic for the "明星机场穿搭，你更爱哪种风格？" survey
 */

const questionConfig = {
    "title": "明星机场穿搭，你更爱哪种风格？",
    "question": "你更愿意把这一票投给谁的机场穿搭？",
    "options": [
        {
            "value": "minimal-chic",
            "label": "简约高级"
    ...
    "storageKey": "celebrity_airport_style_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-airport-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>明星穿搭PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“明星机场穿搭，你更爱哪种风格？”的最新态度</p>";
