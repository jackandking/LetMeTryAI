...
const questionConfig = {
    title: '跟着非遗魅力，带孩子先体验哪一项？',
    question: '跟着非遗魅力，带孩子先体验哪一项？',
    options: [
        { value: 'shadow-puppet-play', label: '皮影戏' },
        { value: 'paper-cutting', label: '剪纸' },
        { value: 'chinese-opera', label: '传统戏曲' },
        { value: 'folk-instrument', label: '民族器乐' }
    ],
    storageKey: 'feiyi_parent_experience.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=feiyi-parent-experience'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>跟着非遗魅力，带孩子先体验哪一项？结果</h2>';
