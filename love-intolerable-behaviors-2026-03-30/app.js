/**
 * 感情投票 Survey Application
 * Logic for the "女人爱热议：恋爱中最不能忍的行为" survey
 */

const questionConfig = {
    "title": "女人爱热议：恋爱中最不能忍的行为",
    "question": "恋爱中你最不能忍受哪种行为？",
    "options": [
        {
            "value": "lying-or-hiding",
            "label": "说谎/瞒着你"
        },
        {
        ...
        {
            "value": "flirting-with-others",
            "label": "暧昧不停/对别人不专一"
        },
        {
            "value": "no-responsibility",
            "label": "不承担/不分担责任"
        }
    ],
    "storageKey": "love_intolerable_behaviors_2026_03_30_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-intolerable-behaviors-2026-03-30'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>感情投票投票结果</h2>";
