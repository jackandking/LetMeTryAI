...
const questionConfig = {
    title: '生成式 AI 与职场变化',
    question: '在你看来，哪些类型的工作会较早感受到生成式 AI 的影响？',
    options: [
        { value: 'content-creation', label: '内容创作' },
        { value: 'customer-service', label: '客服与售后' },
        { value: 'data-analytics', label: '数据与分析' }
    ],
    storageKey: 'ai_work_impact.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-work-impact'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>生成式 AI 与职场变化结果</h2>';
