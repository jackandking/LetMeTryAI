...
const questionConfig = {
    title: '哪张太空画面更燃？红火星背光还是湛蓝星云？',
    question: '哪张太空画面更燃？',
    options: [
        { value: 'red-planet-backlight', label: '红色行星背光' },
        { value: 'blue-nebula-eruption', label: '湛蓝星云喷发' },
        { value: 'astronaut-earth-frame', label: '宇航员与地球同框' },
        { value: 'ship-lighttrail-warp', label: '光带穿梭航天器' }
    ],
    storageKey: 'which_space_scene_more_exciting.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=which-space-scene-more-exciting'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪张太空画面更燃？红火星背光还是湛蓝星云？结果</h2>';
