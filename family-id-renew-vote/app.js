...
const questionConfig = {
    title: '家庭身份证换证安排投票：哪种方式更适合你家？',
    question: '你会如何安排全家人的身份证换证？请选择最贴近你家的方案。',
    options: [
        { value: 'weekend-family-visit', label: '周末集中办理' },
        { value: 'weekday-staggered', label: '分散预约办理' },
        { value: 'community-mobile-service', label: '社区/移动服务办理' },
        { value: 'entrust-agent', label: '委托代办' }
    ],
    storageKey: 'family_id_renew_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=family-id-renew-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家庭身份证换证安排投票：哪种方式更适合你家？结果</h2>';
