...
const questionConfig = {
    title: '哪一幕会让你怀念起小时候看《94版三国》？',
    question: '哪一幕会让你怀念起小时候看《94版三国》？',
    options: [
        { value: 'san-gu-mao-lu', label: '三顾茅庐' },
        { value: 'cao-chuan-jie-jian', label: '草船借箭' },
        { value: 'chi-bi-huo-gong', label: '赤壁火攻' },
        { value: 'chang-ban-po-zhao-yun', label: '长坂坡赵云救主' }
    ],
    storageKey: 'which_scene_94_sanguo.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=which-scene-94-sanguo'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪一幕会让你怀念起小时候看《94版三国》？结果</h2>';
