/**
 * 兴趣重拾投票 Survey Application
 * Logic for the "退休后最想重拾的兴趣" survey
 */

const questionConfig = {
    "title": "退休后最想重拾的兴趣",
    "question": "如果是爱老人用户，你最支持哪个选项：退休后你最想重拾哪项兴趣？",
    "options": [
        {
    ...
    "storageKey": "retirement_hobby_pick_2026_03_18_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retirement-hobby-pick-2026-03-18'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>兴趣重拾投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“退休后最想重拾的兴趣”的最新态度</p>";
