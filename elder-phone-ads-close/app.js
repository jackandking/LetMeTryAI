...
const questionConfig = {
    title: '老人手机老弹广告，你会怎么帮TA关？',
    question: '老人手机老弹广告，你会怎么帮TA关？',
    options: [
        { value: 'close-notifications', label: '关通知／开免打扰' },
        { value: 'uninstall-ad-apps', label: '卸载常弹广告的APP' },
        { value: 'install-ad-blocker', label: '装拦截/清理软件并清缓存' },
        { value: 'teach-close-x', label: '教老人识别并点×或返回' }
    ],
    storageKey: 'elder_phone_ads_close.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-phone-ads-close'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老人手机老弹广告，你会怎么帮TA关？结果</h2>';
