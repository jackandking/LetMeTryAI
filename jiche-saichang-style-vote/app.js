...
const questionConfig = {
    title: '机车赛场风格：你偏好哪种赛场造型？',
    question: '在机车赛场风格中，你更偏向哪种造型？',
    options: [
        { value: 'modern-edge', label: '硬朗摩登' },
        { value: 'vintage-sweet', label: '甜美复古' },
        { value: 'black-knight', label: '酷感黑骑士' },
        { value: 'technical-sport', label: '机能运动' }
    ],
    storageKey: 'jiche_saichang_style_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jiche-saichang-style-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机车赛场风格：你偏好哪种赛场造型？结果</h2>';
