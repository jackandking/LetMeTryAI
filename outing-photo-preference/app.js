...
const questionConfig = {
    title: '出游拍照你更喜欢哪种方式？',
    question: '出游拍照你更喜欢哪种方式？',
    options: [
        { value: 'casual-candid', label: '随性抓拍（自然生活照）' },
        { value: 'posed-classic', label: '摆拍经典（认真构图）' },
        { value: 'family-group', label: '合家欢合照（多人互动）' },
        { value: 'scenery-focus', label: '风景为主（以风景为主，人物融入）' }
    ],
    storageKey: 'outing_photo_preference.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=outing-photo-preference'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>出游拍照你更喜欢哪种方式？结果</h2>';
