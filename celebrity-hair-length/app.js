/**
 * 明星对决 Survey Application
 * Logic for the "女人爱热议：女星短发 vs 长发，你更pick谁？" survey
 */

const questionConfig = {
    "title": "女人爱热议：女星短发 vs 长发，你更pick谁？",
    "question": "如果是女人爱用户，你会把这一票投给谁：女星短发 vs 长发？",
    "options": [
        {
            "value": "short-hair",
            "label": "短发更有气场"
    ...
    "storageKey": "celebrity_hair_length_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-hair-length'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>明星对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：女星短发 vs 长发，你更pick谁？”的最新态度</p>";
