...
const questionConfig = {
    title: '午睡时间您更偏向哪种安排',
    question: '午睡时间您更偏向哪种安排？',
    options: [
        { value: 'short-power-nap', label: '短暂补眠（20-30分钟）' },
        { value: 'moderate-nap', label: '中等午睡（40-60分钟）' },
        { value: 'no-nap-light-activity', label: '不睡午觉，做轻活动代替' }
    ],
    storageKey: 'nap_time_arrangement.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nap-time-arrangement'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>午睡时间您更偏向哪种安排结果</h2>';
