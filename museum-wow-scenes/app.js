...
const questionConfig = {
    title: '博物馆里，什么场景会让孩子蹦出“哇”？',
    question: '博物馆里，什么场景会让孩子蹦出“哇”？选出你家孩子最可能当场惊叹的那个画面：',
    options: [
        { value: 'dinosaur-skeleton', label: '恐龙骨架' },
        { value: 'interactive-light-installation', label: '互动光影装置' },
        { value: 'hands-on-dig', label: '动手考古体验' },
        { value: 'life-size-diorama', label: '生活场景复原' }
    ],
    storageKey: 'museum_wow_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-wow-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>博物馆里，什么场景会让孩子蹦出“哇”？结果</h2>';
