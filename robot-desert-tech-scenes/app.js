...
const questionConfig = {
    title: '机器人治沙漠上热搜，暑假你会带娃去体验哪种科技场景？',
    question: '暑假你会带娃去体验哪种科技场景？',
    options: [
        { value: 'desert-robot-base', label: '沙漠机器人治沙基地' },
        { value: 'ai-agriculture-park', label: 'AI农业采摘园' },
        { value: 'self-driving-car', label: '无人车自动驾驶体验' },
        { value: 'science-museum-robots', label: '科技馆机器人互动展' }
    ],
    storageKey: 'robot_desert_tech_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=robot-desert-tech-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机器人治沙漠上热搜，暑假你会带娃去体验哪种科技场景？结果</h2>';
