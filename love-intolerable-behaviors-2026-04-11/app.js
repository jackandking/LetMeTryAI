/**
 * 恋爱忍耐度投票 Survey Application
 * Logic for the "女人爱热议：恋爱里让你更受不了的行为" survey
 */

const questionConfig = {
    "title": "女人爱热议：恋爱里让你更受不了的行为",
    "question": "你会把这一票投给谁：恋爱里哪种行为最让你受不了？",
    "options": [
        {
            "value": "lying-conceal",
            "label": "说谎或隐瞒重要事"
    ...
    "storageKey": "love_intolerable_behaviors_2026_04_11_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-intolerable-behaviors-2026-04-11'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>恋爱忍耐度投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：恋爱里让你更受不了的行为”的最新态度</p>";
