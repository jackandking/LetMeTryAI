...
const questionConfig = {
    title: '一条龙舟背后的中华文明，你知道几个？',
    question: '一条龙舟里，藏着哪一种中华文明？',
    options: [
        { value: 'dragon-head-symbol', label: '龙首图腾' },
        { value: 'duanwu-origin', label: '端午起源' },
        { value: 'racing-spirit', label: '竞渡精神' },
        { value: 'intangible-heritage', label: '非遗传承' }
    ],
    storageKey: 'dragon_boat_civilization.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dragon-boat-civilization'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>一条龙舟背后的中华文明，你知道几个？结果</h2>';
