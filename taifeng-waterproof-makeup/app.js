...
const questionConfig = {
    title: '台风天出门，你会选哪种防水妆？',
    question: '台风天出门，你会选哪种防水妆？',
    options: [
        { value: 'light-longwear', label: '轻薄持久底妆' },
        { value: 'matte-oil-control', label: '哑光控油型' },
        { value: 'dewy-hydrate', label: '水光保湿型' },
        { value: 'spray-set-lock', label: '定妆喷雾+局部加固' }
    ],
    storageKey: 'taifeng_waterproof_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-waterproof-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天出门，你会选哪种防水妆？结果</h2>';
