...
const questionConfig = {
    title: '老旧小区改造，你盼着哪样先变好？',
    question: '老旧小区改造，你盼着哪样先变好？',
    options: [
        { value: 'add-elevator', label: '加装电梯' },
        { value: 'more-parking', label: '停车位' },
        { value: 'pipe-safety', label: '管网安全' },
        { value: 'garden-square', label: '小花园广场' }
    ],
    storageKey: 'old_community_upgrade_hope.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=old-community-upgrade-hope'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老旧小区改造，你盼着哪样先变好？结果</h2>';
