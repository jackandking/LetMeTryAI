/**
 * 健康养生投票 Survey Application
 * Logic for the "爱老人关注：每天你最愿意坚持哪种养生习惯？" survey
 */

const questionConfig = {
    "title": "爱老人关注：每天你最愿意坚持哪种养生习惯？",
    "question": "在日常生活中，你最想并且最容易坚持哪种养生习惯？",
    "options": [
        {
            "value": "morning-walk",
            "label": "每天早晨散步或慢跑"
        ...
        {
            "value": "light-home-cooking",
            "label": "坚持简单家常清淡饮食"
        },
        {
            "value": "stretching-or-taiji",
            "label": "每天做十分钟拉伸或太极"
        },
        {
    ...
    "storageKey": "daily_health_habit_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=daily-health-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>健康养生投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“爱老人关注：每天你最愿意坚持哪种养生习惯？”的最新态度</p>";
