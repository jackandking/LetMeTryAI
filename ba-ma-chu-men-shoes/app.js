...
const questionConfig = {
    title: '爸妈出门你更想他们穿哪种鞋？稳妥安全还是舒服自在？',
    question: '爸妈出门你更想他们穿哪种鞋？',
    options: [
        { value: 'non-slip-sneakers', label: '防滑运动鞋' },
        { value: 'comfortable-cloth-shoes', label: '舒适布鞋' },
        { value: 'light-sandals', label: '轻便凉鞋' }
    ],
    storageKey: 'ba_ma_chu_men_shoes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ba-ma-chu-men-shoes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爸妈出门你更想他们穿哪种鞋？稳妥安全还是舒服自在？结果</h2>';
