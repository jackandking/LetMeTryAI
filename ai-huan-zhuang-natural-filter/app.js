...
const questionConfig = {
    title: 'AI换妆：哪款滤镜看起来更自然？',
    question: 'AI换妆：哪款滤镜看起来更自然？选出你觉得更贴近真人的那款。',
    options: [
        { value: 'natural-nude-filter', label: '自然裸妆' },
        { value: 'soft-retouch-filter', label: '微修饰柔光' },
        { value: 'film-cinematic-filter', label: '电影胶片质感' }
    ],
    storageKey: 'ai_huan_zhuang_natural_filter.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-huan-zhuang-natural-filter'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI换妆：哪款滤镜看起来更自然？结果</h2>';
