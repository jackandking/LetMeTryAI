...
const questionConfig = {
    title: '大热天出门，你pick哪种不脱妆的清爽妆？轻薄防晒or控油定妆？',
    question: '大热天出门，你pick哪种不脱妆的清爽妆？',
    options: [
        { value: 'light-sunscreen-makeup', label: '轻薄防晒隔离妆' },
        { value: 'oil-control-powder-foundation', label: '控油定妆粉底妆' },
        { value: 'dewy-skin-mist-makeup', label: '水光亮肌喷雾妆' },
        { value: 'matte-longwear-makeup', label: '哑光薄透持妆妆' }
    ],
    storageKey: 'summer_no_melt_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-no-melt-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>大热天出门，你pick哪种不脱妆的清爽妆？轻薄防晒or控油定妆？结果</h2>';
