...
const questionConfig = {
    title: '机器人也上妆？哪款仿真肌妆感更打动你？',
    question: '机器人也上妆了，你被哪种仿真肌妆感惊艳到？',
    options: [
        { value: 'robot-water-glow', label: '水光润泽' },
        { value: 'robot-soft-matte', label: '柔雾哑光' },
        { value: 'robot-bare-skin', label: '薄透轻裸' },
        { value: 'robot-mirror-gloss', label: '镜面光泽' }
    ],
    storageKey: 'robot_skin_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=robot-skin-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机器人也上妆？哪款仿真肌妆感更打动你？结果</h2>';
