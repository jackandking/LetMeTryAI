 ...
 * Logic for the "最想参加的社区活动" survey
 */
...
const questionConfig = {
    ...
    "options": [
        {
            "value": "square-dance-tai-chi",
            "label": "广场舞 / 太极"
        },
        {
            "value": "handicraft-calligraphy-class",
            "label": "手工 / 书画班"
        },
        {
        ...
        {
            "value": "neighborhood-dinner-tea",
            "label": "邻里聚餐 / 茶话会"
        }
    ],
    "storageKey": "community_activity_choice_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“最想参加的社区活动”的最新态度</p>";
