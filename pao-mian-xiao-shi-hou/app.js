...
const questionConfig = {
    title: '泡面又火了，你还记得小时候吃的哪款？',
    question: '泡面又火了，你还怀念小时候吃过哪一款泡面？',
    options: [
        { value: 'kangshifu-hongshao-niurou', label: '康师傅红烧牛肉面' },
        { value: 'uni-laotan-suan-cai', label: '统一老坛酸菜牛肉面' },
        { value: 'jinmailang-xiangla-niurou', label: '今麦郎香辣牛肉面' },
        { value: 'mama-extra-egg-vegetable', label: '妈妈的家常加料（鸡蛋+青菜）' }
    ],
    storageKey: 'pao_mian_xiao_shi_hou.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=pao-mian-xiao-shi-hou'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>泡面又火了，你还记得小时候吃的哪款？结果</h2>';
