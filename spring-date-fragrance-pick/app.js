/**
 * 春日香氛投票 Survey Application
 * Logic for the "哪款春季香水更适合约会？" survey
 */

const questionConfig = {
    "title": "哪款春季香水更适合约会？",
    "question": "你会把这一票投给谁：哪款春季香水更适合约会？",
    "options": [
        {
    ...
    "storageKey": "spring_date_fragrance_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-date-fragrance-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>春日香氛投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪款春季香水更适合约会？”的最新态度</p>";
