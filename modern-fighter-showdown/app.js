 ...
 * Logic for the "硬核对比：现代战机制空力PK" survey
 */

const questionConfig = {
    "title": "硬核对比：现代战机制空力PK",
    "question": "作为硬核玩家，你更认可哪款战机的制空能力？",
    "options": [
        {
            "value": "j-20",
            "label": "歼-20"
    ...
    "storageKey": "modern_fighter_showdown_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-fighter-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代战机制空力PK”的最新态度</p>";
