 ...
 * Logic for the "关注：最想参加的社区活动" survey
 */
...
const questionConfig = {
    ...
    "options": [
        ...
        {
            "value": "hobby-club-calligraphy-crafts",
            "label": "兴趣小组（书画/手工）"
        },
        {
            "value": "short-group-trips",
            "label": "短途集体游"
        }
    ],
    "storageKey": "community_activity_pick_2026_03_31_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-pick-2026-03-31'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：最想参加的社区活动”的最新态度</p>";
