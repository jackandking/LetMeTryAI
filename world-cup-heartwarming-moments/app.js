...
const questionConfig = {
    title: '世界杯这些神仙画面，哪个让你心头一暖？',
    question: '世界杯这些神仙画面，哪个让你心头一暖？',
    options: [
        { value: 'celebrate-for-family', label: '献给家人' },
        { value: 'teammate-ties-shoelace', label: '队友系鞋带' },
        { value: 'player-hugs-young-fan', label: '抱小球迷合影' },
        { value: 'team-pile-celebration', label: '全队叠罗汉' }
    ],
    storageKey: 'world_cup_heartwarming_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=world-cup-heartwarming-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>世界杯这些神仙画面，哪个让你心头一暖？结果</h2>';
