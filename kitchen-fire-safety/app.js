...
const questionConfig = {
    title: '厨房里的安全小细节：油锅起火怎么办？',
    question: '如果炒菜时油锅突然起火了，你的第一反应是什么？',
    options: [
        { value: 'cover-with-lid', label: '盖上锅盖' },
        { value: 'add-vegetables', label: '倒入蔬菜' },
        { value: 'pour-water', label: '用水浇灭' },
        { value: 'carry-pot-away', label: '端锅离开' }
    ],
    storageKey: 'kitchen_fire_safety.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kitchen-fire-safety'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>厨房里的安全小细节：油锅起火怎么办？结果</h2>';
