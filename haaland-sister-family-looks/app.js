...
const questionConfig = {
    title: '哈兰德姐姐比哈兰德还像？你更偏哪种家族颜？',
    question: '哈兰德姐姐比哈兰德还像？你更偏哪种家族颜？',
    options: [
        { value: 'sister-gentle-face', label: '姐姐式温柔颜' },
        { value: 'erling-heroic-face', label: '哈兰德式硬朗颜' },
        { value: 'mixed-family-face', label: '混合家族颜' }
    ],
    storageKey: 'haaland_sister_family_looks.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=haaland-sister-family-looks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哈兰德姐姐比哈兰德还像？你更偏哪种家族颜？结果</h2>';
