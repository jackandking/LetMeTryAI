...
const questionConfig = {
    title: '买手机时你更信哪种续航说明？厂商标称 vs 实测 vs 用户体验',
    question: '买手机时你更信哪种续航说明？',
    options: [
        { value: 'manufacturer-claim', label: '厂商标称容量与续航' },
        { value: 'third-party-test', label: '第三方媒体或测评实测' },
        { value: 'real-world-user-experience', label: '真实用户日常场景体验' }
    ],
    storageKey: 'buy_phone_battery_claims.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=buy-phone-battery-claims'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>买手机时你更信哪种续航说明？厂商标称 vs 实测 vs 用户体验结果</h2>';
