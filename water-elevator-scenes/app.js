...
const questionConfig = {
    title: '你被水上电梯的哪个场景惊艳到了？',
    question: '你被水上电梯的哪个场景惊艳到了？',
    options: [
        { value: 'sea-view-glass-cabin', label: '海景玻璃舱' },
        { value: 'underwater-aquarium-elevator', label: '水下鱼群环绕' },
        { value: 'waterfall-passage-elevator', label: '瀑布穿越式电梯' }
    ],
    storageKey: 'water_elevator_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=water-elevator-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你被水上电梯的哪个场景惊艳到了？结果</h2>';
