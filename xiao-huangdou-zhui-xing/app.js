...
const questionConfig = {
    title: '小黄豆追星成功你羡慕吗？她的变化惊艳了很多人',
    question: '小黄豆追星成功你羡慕吗？选一个符合你感受的反应：',
    options: [
        { value: 'zhenxin-envy', label: '真心羡慕' },
        { value: 'envy-but-not-easy', label: '羡慕但觉得不容易' },
        { value: 'not-envy-luck', label: '不羡慕，觉得靠运气' },
        { value: 'watch-the-scene', label: '看热闹，娱乐一下' }
    ],
    storageKey: 'xiao_huangdou_zhui_xing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xiao-huangdou-zhui-xing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小黄豆追星成功你羡慕吗？她的变化惊艳了很多人结果</h2>';
