 ...
 * Logic for the "哪种方法更有助于睡眠质量？" survey
 */

const questionConfig = {
    "title": "哪种方法更有助于睡眠质量？",
    "question": "亲，你最支持哪个改善睡眠的方法？",
    "options": [
        {
        ...
        {
            "value": "reduce-stimulants",
            "label": "减少刺激饮品"
        }
    ],
    "storageKey": "sleep_improvement_choice_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-improvement-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪种方法更有助于睡眠质量？”的最新态度</p>";
