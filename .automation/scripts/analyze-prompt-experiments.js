...
const EXPERIMENT_FILE = path.join(REPO_DIR, '.automation', '.local', 'state', 'prompt-experiments.jsonl');
const PERF_FILE = path.join(REPO_DIR, '.automation', '.local', 'state', 'topic-performance.jsonl');
