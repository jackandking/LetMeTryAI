/**
 * 手机拍照PK Survey Application
 * Logic for the "旗舰手机拍照大PK" survey
 */

const questionConfig = {
    "title": "旗舰手机拍照大PK",
    "question": "拍夜景/高感细节，你更愿把票投给哪款旗舰手机？",
    "options": [
        {
            "value": "iphone-15-pro-max",
            "label": "iPhone 15 Pro Max（色彩/视频）"
        },
        {
            "value": "galaxy-s24-ultra",
            "label": "Galaxy S24 Ultra（高倍与夜景）"
        },
        {
            "value": "pixel-8-pro",
            "label": "Pixel 8 Pro（算法/夜景）"
        }
    ],
    "storageKey": "flagship_phone_camera_pk_2026_03_24_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-camera-pk-2026-03-24'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>手机拍照PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“旗舰手机拍照大PK”的最新态度</p>";
