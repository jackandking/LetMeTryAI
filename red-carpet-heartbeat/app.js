...
const questionConfig = {
    title: '这届红毯谁的造型让你一眼心动',
    question: '这届红毯谁的造型让你一眼心动？',
    options: [
        { value: 'cool-queen-style', label: '冷艳御姐风' },
        { value: 'sweet-princess-style', label: '甜美公主风' },
        { value: 'retro-hongkong-style', label: '复古港风' },
        { value: 'fairy-style', label: '仙气飘飘风' }
    ],
    storageKey: 'red_carpet_heartbeat.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=red-carpet-heartbeat'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这届红毯谁的造型让你一眼心动结果</h2>';
