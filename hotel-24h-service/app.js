...
const questionConfig = {
    title: '酒店“24小时退房”来了，您住店图啥服务？',
    question: '您出门住酒店，更看重哪项服务？',
    options: [
        { value: 'quiet-sleep', label: '安静好眠' },
        { value: 'thoughtful-service', label: '贴心服务' },
        { value: 'elderly-friendly', label: '适老设施' },
        { value: 'clear-value', label: '实惠清楚' }
    ],
    storageKey: 'hotel_24h_service.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hotel-24h-service'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>酒店“24小时退房”来了，您住店图啥服务？结果</h2>';
