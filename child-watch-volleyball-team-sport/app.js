...
const questionConfig = {
    title: '孩子看女排比赛，会想学哪种团队运动？',
    question: '孩子看女排比赛，会想学哪种团队运动？哪个场景最能打动你家孩子？',
    options: [
        { value: 'volleyball', label: '排球' },
        { value: 'basketball', label: '篮球' },
        { value: 'football', label: '足球' },
        { value: 'other-team-sports', label: '其他团队运动' }
    ],
    storageKey: 'child_watch_volleyball_team_sport.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-watch-volleyball-team-sport'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看女排比赛，会想学哪种团队运动？结果</h2>';
