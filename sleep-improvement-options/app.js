 ...
 * Logic for the "关注：晚上更能助眠的好方法？" survey
 */

const questionConfig = {
    "title": "关注：晚上更能助眠的好方法？",
    "question": "亲，你最支持哪个助眠方法？",
    "options": [
        {
            "value": "pre-sleep-walk",
            "label": "睡前散步15分钟"
        },
        {
        ...
        {
            "value": "dim-lights-and-phone-off",
            "label": "调暗灯光与断开手机"
        },
        {
    ...
    "storageKey": "sleep_improvement_options_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-improvement-options'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：晚上更能助眠的好方法？”的最新态度</p>";
