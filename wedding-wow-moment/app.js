...
const questionConfig = {
    title: '结婚那天，你想在哪个瞬间惊艳全场？揭面回眸还是誓词对视？',
    question: '结婚那天，你想在哪个瞬间惊艳全场？',
    options: [
        { value: 'vow-eye-contact', label: '誓词深情对视' },
        { value: 'veil-reveal-smile', label: '揭面回眸一笑' },
        { value: 'swirl-back-silhouette', label: '裙摆转身背影杀' },
        { value: 'grand-entrance', label: '走红毯瞬间亮相' }
    ],
    storageKey: 'wedding_wow_moment.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wedding-wow-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>结婚那天，你想在哪个瞬间惊艳全场？揭面回眸还是誓词对视？结果</h2>';
