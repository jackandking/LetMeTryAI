...
const questionConfig = {
    title: '女星街拍风格投票',
    question: '你更喜欢哪种女星街拍风格？',
    options: [
        { value: 'casual-relaxed', label: '休闲随性' },
        { value: 'smart-tailored', label: '干练利落' },
        { value: 'vintage-glam', label: '复古性感' }
    ],
    storageKey: 'celebrity_street_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-street-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>女星街拍风格投票结果</h2>';
