...
const questionConfig = {
    title: '邓紫棋舞台上，你更爱哪种妆发？',
    question: '邓紫棋舞台上，你更爱哪种妆发？',
    options: [
        { value: 'shining-highlight-big-waves', label: '闪耀高光＋大波浪' },
        { value: 'clean-nude-makeup-sleek-ponytail', label: '干净裸妆＋利落马尾' },
        { value: 'smoky-eye-short-cut', label: '烟熏眼＋短发利落感' },
        { value: 'pink-girl-braids', label: '粉色少女感＋编发' }
    ],
    storageKey: 'deng_ziqi_stage_makeup_hair.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=deng-ziqi-stage-makeup-hair'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>邓紫棋舞台上，你更爱哪种妆发？结果</h2>';
