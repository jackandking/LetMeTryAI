...
const questionConfig = {
    title: '哪些隐藏高热量食物容易被忽视？',
    question: '在日常饮食中，你认为下面哪类隐藏高热量食物更容易被忽视？',
    options: [
        { value: 'sauces-dressings', label: '调味酱与沙拉酱' },
        { value: 'processed-snacks-bakery', label: '加工零食与烘焙品' },
        { value: 'drinks-sugary-alcohol', label: '饮料与含糖酒精' },
        { value: 'seemingly-healthy-takeout-salads', label: '“健康”外卖与沙拉' }
    ],
    storageKey: 'hidden_high_calorie_foods.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hidden-high-calorie-foods'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪些隐藏高热量食物容易被忽视？结果</h2>';
