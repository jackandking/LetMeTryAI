/**
 * 孙辈互动投票 Survey Application
 * Logic for the "关注：和孙辈相处，你最喜欢哪种方式？" survey
 */

const questionConfig = {
    "title": "关注：和孙辈相处，你最喜欢哪种方式？",
    "question": "亲，你最支持哪个和孙辈互动的方式？",
    "options": [
        {
            "value": "story-time",
            "label": "陪孩子讲故事"
    ...
    "storageKey": "grandchild_interaction_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandchild-interaction'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孙辈互动投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：和孙辈相处，你最喜欢哪种方式？”的最新态度</p>";
