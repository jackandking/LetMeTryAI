 ...
 * Logic for the "硬核对比：军用无人机对决" survey
 */

const questionConfig = {
    "title": "硬核对比：军用无人机对决",
    "question": "亲，你更看好哪款军用无人机？",
    "options": [
        {
            "value": "mq-9-reaper",
            "label": "MQ-9 Reaper"
    ...
    "storageKey": "military_drones_duel_2026_03_26_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-drones-duel-2026-03-26'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：军用无人机对决”的最新态度</p>";
