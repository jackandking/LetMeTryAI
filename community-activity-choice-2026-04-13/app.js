 ...
 * Logic for the "社区活动，你更愿意参加哪个？" survey
 */
...
const questionConfig = {
    ...
    "options": [
        ...
        {
            "value": "community-interest-classes",
            "label": "社区兴趣班"
        },
        {
            "value": "square-dance-or-taiji",
            "label": "广场舞或太极"
        },
        {
            "value": "neighborhood-walking-group",
            "label": "邻里散步小组"
        }
    ],
    "storageKey": "community_activity_choice_2026_04_13_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-13'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“社区活动，你更愿意参加哪个？”的最新态度</p>";
