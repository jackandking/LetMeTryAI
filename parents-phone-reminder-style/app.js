...
const questionConfig = {
    title: '爸妈看手机提醒哪个更顺眼？哪种样式更亲切好看',
    question: '爸妈看手机提醒哪个更顺眼？选出你觉得最亲切的样式。',
    options: [
        { value: 'red-dot-with-count', label: '红点带数字' },
        { value: 'plain-red-dot', label: '纯红点徽章' },
        { value: 'banner-text', label: '横幅文字提醒' },
        { value: 'voice-plus-icon', label: '语音+图标提醒' }
    ],
    storageKey: 'parents_phone_reminder_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parents-phone-reminder-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爸妈看手机提醒哪个更顺眼？哪种样式更亲切好看结果</h2>';
