/**
 * 睡眠小贴士 Survey Application
 * Logic for the "关注：哪个方法最能提升睡眠质量？" survey
 */

const questionConfig = {
    "title": "关注：哪个方法最能提升睡眠质量？",
    "question": "亲，你最支持哪个睡眠改善方法？",
    "options": [
        {
        ...
        {
            "value": "bedtime-relaxation",
            "label": "睡前放松"
        },
        {
            "value": "bedroom-environment",
            "label": "优化卧室环境"
        },
        {
            "value": "chinese-medicine-tips",
            "label": "中医与食疗小法"
        }
    ],
    "storageKey": "sleep_quality_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-quality-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>睡眠小贴士投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：哪个方法最能提升睡眠质量？”的最新态度</p>";
