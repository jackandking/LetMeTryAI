...
const questionConfig = {
    title: '巴西vs日本开踢，女生看球怎么妆？',
    question: '巴西vs日本这场球，你准备画什么妆去看？',
    options: [
        { value: 'sun-kissed-cheer-makeup', label: '元气腮红晒伤感' },
        { value: 'clean-water-makeup', label: '清透白开水妆' },
        { value: 'brazil-cheer-paint-makeup', label: '黄绿应援彩绘妆' },
        { value: 'cat-eye-bold-makeup', label: '御姐猫系上扬妆' }
    ],
    storageKey: 'brazil_japan_game_day_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=brazil-japan-game-day-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>巴西vs日本开踢，女生看球怎么妆？结果</h2>';
