 ...
 * Logic for the "跑车声浪PK：听谁最带感？" survey
 */

const questionConfig = {
    "title": "跑车声浪PK：听谁最带感？",
    "question": "男人宝热议：你最爱哪个跑车的声浪？",
    "options": [
        {
            "value": "ferrari-v8",
            "label": "法拉利 V8"
    ...
    "storageKey": "supercar_exhaust_pk_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supercar-exhaust-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“跑车声浪PK：听谁最带感？”的最新态度</p>";
