...
const questionConfig = {
    title: '杨紫这次领奖造型，哪个细节让你心动？',
    question: '杨紫这次领奖造型，哪个细节让你心动？',
    options: [
        { value: 'golden-gown-train', label: '星光裙摆' },
        { value: 'off-shoulder-line', label: '肩颈线条' },
        { value: 'sparkling-earrings', label: '闪耀耳饰' },
        { value: 'soft-curls', label: '温柔卷发' }
    ],
    storageKey: 'yangzi_award_look_detail.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yangzi-award-look-detail'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>杨紫这次领奖造型，哪个细节让你心动？结果</h2>';
