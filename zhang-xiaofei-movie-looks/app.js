...
const questionConfig = {
    title: '张小斐新电影里哪个造型让你惊艳？',
    question: '张小斐新电影里哪个造型让你惊艳？',
    options: [
        { value: 'retro-gown', label: '复古宫廷长裙' },
        { value: 'fresh-short-hair', label: '清新邻家短发' },
        { value: 'power-suit', label: '酷飒利落西装' },
        { value: 'elegant-red-gown', label: '优雅红毯礼服' }
    ],
    storageKey: 'zhang_xiaofei_movie_looks.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-xiaofei-movie-looks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张小斐新电影里哪个造型让你惊艳？结果</h2>';
