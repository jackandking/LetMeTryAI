...
const questionConfig = {
    title: '夏天爸妈喝水，你更认同哪种？',
    question: '夏天爸妈喝水，你更认同哪种？',
    options: [
        { value: 'chang-wen-bai-kai-shui', label: '常温白开水' },
        { value: 'bing-zhen-leng-shui', label: '冰镇冷水' },
        { value: 're-kai-shui-fang-liang', label: '热开水放凉到温度再喝' },
        { value: 'jia-ningmeng-honey', label: '加点柠檬或蜂蜜调味' }
    ],
    storageKey: 'summer_parents_drinking.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-parents-drinking'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天爸妈喝水，你更认同哪种？结果</h2>';
