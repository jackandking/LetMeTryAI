/**
 * 孩子说谎处理投票 Survey Application
 * Logic for the "家长话题：孩子说谎该怎么处理" survey
 */

const questionConfig = {
    "title": "家长话题：孩子说谎该怎么处理",
    "question": "站在家长视角，你会怎么选：孩子说谎应如何处理？",
    "options": [
        {
    ...
    "storageKey": "child_honesty_handling_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-honesty-handling'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子说谎处理投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子说谎该怎么处理”的最新态度</p>";
