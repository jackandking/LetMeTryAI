/**
 * 香水入门指南 Survey Application
 * Logic for the "香氛选择：你更爱哪类香调？" survey
 */

const questionConfig = {
    "title": "香氛选择：你更爱哪类香调？",
    "question": "如果第一次入手香水，你会选哪类香调？",
    "options": [
        {
            "value": "floral-fresh",
            "label": "花香系（清新/柔美）"
        ...
        {
            "value": "gourmand-sweet",
            "label": "甜点/美食系（甜蜜可爱）"
        }
    ],
    "storageKey": "beginner_perfume_tribe_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beginner-perfume-tribe'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>香水入门指南投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“香氛选择：你更爱哪类香调？”的最新态度</p>";
