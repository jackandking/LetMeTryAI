...
const questionConfig = {
    title: '孩子看到“有皮肤”的机器人会怎么想？',
    question: '如果孩子看到有皮肤的机器人，他们会怎么想？（选一个最贴近的反应）',
    options: [
        { value: 'curious-approach', label: '好奇想靠近' },
        { value: 'weird-and-scared', label: '有点害怕' },
        { value: 'see-as-human-friend', label: '当成会说话的朋友' },
        { value: 'indifferent-ignore', label: '不太在意，继续玩别的' }
    ],
    storageKey: 'kids_robot_skin_reaction.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-robot-skin-reaction'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看到“有皮肤”的机器人会怎么想？结果</h2>';
