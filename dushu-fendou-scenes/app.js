...
const questionConfig = {
    title: '你怀念的读书奋斗画面是哪种？',
    question: '你怀念的读书奋斗画面是哪种？',
    options: [
        { value: 'desk-lamp-scribble', label: '台灯下的奋笔疾书' },
        { value: 'blackboard-recitation', label: '黑板前被老师点名朗读' },
        { value: 'corridor-whisper', label: '走廊角落和同学低声讨论' },
        { value: 'early-morning-study', label: '清晨自习到天亮' }
    ],
    storageKey: 'dushu_fendou_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dushu-fendou-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你怀念的读书奋斗画面是哪种？结果</h2>';
