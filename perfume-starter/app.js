/**
 * 香水气质投票 Survey Application
 * Logic for the "哪种香调更打动你？" survey
 */

const questionConfig = {
    "title": "哪种香调更打动你？",
    "question": "你最喜欢哪种香调的香水？投一票告诉大家你的气质首选。",
    "options": [
        {
            "value": "floral-sweet",
            "label": "花香轻甜"
    ...
    "storageKey": "perfume_starter_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=perfume-starter'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>香水气质投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪种香调更打动你？”的最新态度</p>";
