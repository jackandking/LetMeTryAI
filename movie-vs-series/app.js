...
const questionConfig = {
    title: '电影和网剧你更喜欢哪个观影方式？',
    question: '空闲时间你倾向选择看电影还是追网剧？',
    options: [
        { value: 'watch-movie', label: '去电影院看电影' },
        { value: 'watch-series', label: '在家追网剧' },
        { value: 'both-movie-and-series', label: '电影和网剧都喜欢' },
        { value: 'rarely-watch', label: '很少看影视内容' }
    ],
    storageKey: 'movie_vs_series.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-vs-series'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>电影和网剧你更喜欢哪个观影方式？结果</h2>';
