...
const questionConfig = {
    title: '西瓜大降价，您家夏天怎么吃？',
    question: '西瓜大降价，您家夏天怎么吃？',
    options: [
        { value: 'direct-cut', label: '切块装盘' },
        { value: 'chilled-spoon', label: '冷藏挖着吃' },
        { value: 'watermelon-juice', label: '榨成西瓜汁' },
        { value: 'watermelon-salad', label: '做成水果沙拉' }
    ],
    storageKey: 'watermelon_summer_eat.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=watermelon-summer-eat'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>西瓜大降价，您家夏天怎么吃？结果</h2>';
