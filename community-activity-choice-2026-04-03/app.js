/**
 * 社区活动投票 Survey Application
 * Logic for the "关注：社区活动，你更想参加哪个？" survey
 */

const questionConfig = {
    "title": "关注：社区活动，你更想参加哪个？",
    "question": "亲，你最支持参加哪种社区活动？",
    "options": [
        {
            "value": "community-class",
            "label": "老年大学/兴趣课堂"
        },
        {
        ...
        {
            "value": "community-walking",
            "label": "社区健步走/广场活动"
        },
        {
            "value": "community-arts",
            "label": "文艺团体（唱歌/戏曲）"
        }
    ],
    "storageKey": "community_activity_choice_2026_04_03_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-03'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>社区活动投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：社区活动，你更想参加哪个？”的最新态度</p>";
