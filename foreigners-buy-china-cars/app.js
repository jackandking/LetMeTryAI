...
const questionConfig = {
    title: '外国人为什么更愿意买中国车？',
    question: '你认为外国人更愿意买中国车的主要原因是哪项？',
    options: [
        { value: 'price-value', label: '高性价比（价格/配置）' },
        { value: 'smart-technology', label: '智能化与科技配置' },
        { value: 'ev-and-range', label: '新能源与续航/成本优势' },
        { value: 'local-service', label: '本地化售后与服务便利' }
    ],
    storageKey: 'foreigners_buy_china_cars.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=foreigners-buy-china-cars'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>外国人为什么更愿意买中国车？结果</h2>';
