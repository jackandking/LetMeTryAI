...
const questionConfig = {
    title: '那只白色野生熊猫的画面，你被哪个瞬间震到了？',
    question: '那只白色野生熊猫的画面，你被哪个瞬间震到了？',
    options: [
        { value: 'snowy-look-up', label: '雪地抬头凝视' },
        { value: 'cliff-grab-branch', label: '悬岩抓枝的身姿' },
        { value: 'playful-chase', label: '与同伴追逐翻滚' },
        { value: 'windy-stare', label: '风雪掩面露目光' }
    ],
    storageKey: 'white_wild_panda_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=white-wild-panda-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>那只白色野生熊猫的画面，你被哪个瞬间震到了？结果</h2>';
