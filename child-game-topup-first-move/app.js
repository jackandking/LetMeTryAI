...
const questionConfig = {
    title: '孩子偷偷给游戏充值，你会先做什么？',
    question: '孩子偷偷给游戏充值，你会先做什么？',
    options: [
        { value: 'talk-calmly', label: '冷静沟通' },
        { value: 'refund-first', label: '申请退款' },
        { value: 'restrict-device', label: '限制设备' },
        { value: 'natural-consequence', label: '自己承担' }
    ],
    storageKey: 'child_game_topup_first_move.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-game-topup-first-move'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子偷偷给游戏充值，你会先做什么？结果</h2>';
