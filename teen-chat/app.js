/**
 * 青春期沟通小测 Survey Application
 * Logic for the "家长话题：如何跟青春期孩子聊心事" survey
 */

const questionConfig = {
    "title": "家长话题：如何跟青春期孩子聊心事",
    "question": "站在家长视角，你会怎么选：如何跟青春期孩子聊心事？",
    "options": [
        {
            "value": "schedule-regular-talk",
            "label": "约定固定时间聊"
        },
        {
            "value": "use-interests-to-start",
            "label": "用兴趣切入"
        },
        {
            "value": "seek-third-party",
            "label": "借助第三方支持"
        }
    ],
    "storageKey": "teen_chat_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=teen-chat'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>青春期沟通小测投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何跟青春期孩子聊心事”的最新态度</p>";
