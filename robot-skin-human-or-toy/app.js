...
const questionConfig = {
    title: '机器人穿上皮肤，你会觉得它更像人还是像玩具？',
    question: '机器人穿上皮肤，你会觉得它更像人还是像玩具？',
    options: [
        { value: 'more-human', label: '更像人' },
        { value: 'more-toy', label: '更像玩具' },
        { value: 'depends-scenario', label: '看场景/看距离' }
    ],
    storageKey: 'robot_skin_human_or_toy.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=robot-skin-human-or-toy'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机器人穿上皮肤，你会觉得它更像人还是像玩具？结果</h2>';
