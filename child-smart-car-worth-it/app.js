...
const questionConfig = {
    title: '那款儿童智能车，值不值得买？你家适合吗',
    question: '那款儿童智能车，值不值得买？你会怎么选？',
    options: [
        { value: 'buy-now', label: '立刻入手' },
        { value: 'buy-on-sale', label: '等到打折再买' },
        { value: 'not-worth', label: '不会买，太贵/不实用' },
        { value: 'wait-and-see', label: '先观望口碑' }
    ],
    storageKey: 'child_smart_car_worth_it.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-smart-car-worth-it'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>那款儿童智能车，值不值得买？你家适合吗结果</h2>';
