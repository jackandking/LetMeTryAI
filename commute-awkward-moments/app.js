...
const questionConfig = {
    title: '上班通勤的那些尴尬事，你遇到过哪种？',
    question: '上下班路上你最常遇到哪种尴尬行为？',
    options: [
        { value: 'seat-hoarding', label: '别人霸占座位/占位不让' },
        { value: 'loud-phone-call', label: '车厢内高声通话' },
        { value: 'cutting-in-line', label: '插队/拥挤时被挤' },
        { value: 'eating-on-transit', label: '随地吃喝/味道很重' }
    ],
    storageKey: 'commute_awkward_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=commute-awkward-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>上班通勤的那些尴尬事，你遇到过哪种？结果</h2>';
