...
const questionConfig = {
    title: 'C罗姐姐赛后发声，你更关注球星家人的哪一面？',
    question: 'C罗姐姐赛后发声，你更关注球星家人的哪一面？',
    options: [
        { value: 'passionate-cheer', label: '热血助威' },
        { value: 'warm-daily', label: '温暖日常' },
        { value: 'firm-protection', label: '坚定守护' }
    ],
    storageKey: 'cr7_sister_family_side.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cr7-sister-family-side'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗姐姐赛后发声，你更关注球星家人的哪一面？结果</h2>';
