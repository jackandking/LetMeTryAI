 ...
 * Logic for the "家务分工谁说了算？" survey
 */

const questionConfig = {
    "title": "家务分工谁说了算？",
    "question": "站在家长视角，你会怎么选：家务分工谁说了算？",
    "options": [
        {
            "value": "assign-by-age",
            "label": "按年龄分配"
        ...
        {
            "value": "rotation-system",
            "label": "轮流制"
        },
        {
            "value": "by-interest-and-skill",
            "label": "按兴趣与能力分配"
        },
        {
            "value": "parents-big-kids-small",
            "label": "家长负责大件，孩子做小件"
        }
    ],
    "storageKey": "family_chore_division_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=family-chore-division'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家务分工谁说了算？”的最新态度</p>";
