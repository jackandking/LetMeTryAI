...
const questionConfig = {
    title: '出门旅行遇到延误，你更希望得到哪种帮忙？',
    question: '出门旅行遇到延误，你更希望得到哪种帮忙？',
    options: [
        { value: 'help-rebook-refund', label: '帮我改签或退票' },
        { value: 'food-and-essentials', label: '买饭送水和日用品' },
        { value: 'arrange-rest-accommodation', label: '安排临时休息或住宿' },
        { value: 'contact-family-and-accompany', label: '联系家人并有人陪伴' }
    ],
    storageKey: 'travel_delay_help_elder.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=travel-delay-help-elder'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>出门旅行遇到延误，你更希望得到哪种帮忙？结果</h2>';
