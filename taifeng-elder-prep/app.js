...
const questionConfig = {
    title: '台风天，家里老人该准备什么？',
    question: '台风天，家里老人该准备哪些东西？',
    options: [
        { value: 'meds-health-list', label: '常用药与健康清单' },
        { value: 'emergency-comm-charging', label: '应急通讯与充电' },
        { value: 'food-water-supply', label: '储备易食物与饮水' },
        { value: 'home-safety-lighting', label: '居家安全与照明' }
    ],
    storageKey: 'taifeng_elder_prep.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-elder-prep'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天，家里老人该准备什么？结果</h2>';
