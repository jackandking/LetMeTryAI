/**
 * 香氛记忆投票 Survey Application
 * Logic for the "女人爱热议：哪个香水味最让人记住？" survey
 */

const questionConfig = {
    "title": "女人爱热议：哪个香水味最让人记住？",
    "question": "你会把这一票投给谁：哪个香水味最让人记住？",
    "options": [
        {
            "value": "floral-fragrance",
            "label": "花香调（清新/柔美）"
        },
        {
        ...
        {
            "value": "gourmand-fragrance",
            "label": "东方甜香（美食调/暖甜）"
        },
        {
            "value": "citrus-fragrance",
            "label": "清新柑橘（活力明亮）"
        }
    ],
    "storageKey": "perfume_memory_poll_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=perfume-memory-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>香氛记忆投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：哪个香水味最让人记住？”的最新态度</p>";
