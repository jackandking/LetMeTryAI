...
const questionConfig = {
    title: '听说有能管数月的降压疫苗，你想知道哪点？',
    question: '听说有能管数月的降压疫苗，你想知道哪方面？',
    options: [
        { value: 'side-effects', label: '副作用安全性' },
        { value: 'duration-months', label: '维持多长时间' },
        { value: 'cost-insurance', label: '费用和报销' },
        { value: 'who-suits', label: '适合哪些人' }
    ],
    storageKey: 'hypertension_vaccine_question.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hypertension-vaccine-question'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>听说有能管数月的降压疫苗，你想知道哪点？结果</h2>';
