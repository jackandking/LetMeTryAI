...
const questionConfig = {
    title: '课外学习方法：你会怎样安排孩子的课外时间',
    question: '课外学习方法：你会如何安排孩子的课外时间？',
    options: [
        { value: 'fixed-tutoring-home-review', label: '固定课外班 + 家庭复习' },
        { value: 'interest-based-projects', label: '以兴趣为主的项目学习' },
        { value: 'short-daily-practice', label: '短时日常练习 + 碎片化学习' },
        { value: 'family-time-reading', label: '减负为主的家庭活动与读书' }
    ],
    storageKey: 'after_school_time_plan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=after-school-time-plan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>课外学习方法：你会怎样安排孩子的课外时间结果</h2>';
