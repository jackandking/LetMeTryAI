...
const questionConfig = {
    title: '买运动鞋，你更吃哪一套？',
    question: '买运动鞋，你更吃哪一套？',
    options: [
        { value: 'brand-trend', label: '追品牌潮款' },
        { value: 'value-for-money', label: '拼性价比' },
        { value: 'sport-performance', label: '注重跑步性能' },
        { value: 'looks-style', label: '颜值百搭' }
    ],
    storageKey: 'buy_sneakers_which_set.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=buy-sneakers-which-set'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>买运动鞋，你更吃哪一套？结果</h2>';
