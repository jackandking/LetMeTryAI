...
const questionConfig = {
    title: '带孩子去博物馆，你先看哪件镇馆之宝？',
    question: '带孩子去博物馆时，你们会先看哪件镇馆之宝来开启参观？',
    options: [
        { value: 'dinosaur-fossil', label: '恐龙化石' },
        { value: 'ancient-jade', label: '古代玉器' },
        { value: 'famous-painting', label: '名画真迹' },
        { value: 'bronze-ritual-vessel', label: '青铜器礼器' }
    ],
    storageKey: 'parents_museum_treasure.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parents-museum-treasure'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去博物馆，你先看哪件镇馆之宝？结果</h2>';
