/**
 * 家长话题：孩子情绪回应 Survey Application
 * Logic for the "遇到孩子发脾气你会怎么做？" survey
 */

const questionConfig = {
    "title": "遇到孩子发脾气你会怎么做？",
    "question": "站在家长视角，你会怎么选：遇到孩子发脾气时？",
    "options": [
        {
            "value": "calm-listen",
            "label": "冷静倾听"
        ...
        {
            "value": "soothing-praise",
            "label": "适度安抚"
        },
        {
            "value": "set-consequences",
            "label": "设立后果"
        },
        {
            "value": "redirect-attention",
            "label": "转移注意力"
        }
    ],
    "storageKey": "how_to_respond_child_tantrum_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=how-to-respond-child-tantrum'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长话题：孩子情绪回应投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“遇到孩子发脾气你会怎么做？”的最新态度</p>";
