...
const questionConfig = {
    title: '张若昀梦回《庆余年》，哪个古装造型更让你惊艳？',
    question: '张若昀梦回《庆余年》，哪个古装造型更让你惊艳？',
    options: [
        { value: 'ruoyun-ruya-scholar', label: '儒雅书生' },
        { value: 'ruoyun-white-hero', label: '侠骨白衣' },
        { value: 'ruoyun-gilded-robe', label: '锦衣华服' },
        { value: 'ruoyun-shadow-traveler', label: '暗色行者' }
    ],
    storageKey: 'zhang_ruoyun_qyf_looks.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-ruoyun-qyf-looks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张若昀梦回《庆余年》，哪个古装造型更让你惊艳？结果</h2>';
