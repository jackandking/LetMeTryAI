...
const questionConfig = {
    ...
    question: '屈原到底姓什么？',
    options: [
        { value: 'surname-qu', label: '姓屈' },
        { value: 'surname-mi', label: '姓芈' },
        { value: 'surname-xiong', label: '姓熊' },
        { value: 'surname-chu', label: '姓楚' }
    ],
    storageKey: 'qu_yuan_surname_mystery.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qu-yuan-surname-mystery'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>屈原原来不姓屈？结果</h2>';
