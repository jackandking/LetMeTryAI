...
const questionConfig = {
    title: '机器人穿上皮肤，你会先在哪个场景碰到它？',
    question: '机器人穿上皮肤，你会先在哪个场景碰到它？',
    options: [
        { value: 'mall-service-robot', label: '商场 / 服务台' },
        { value: 'hospital-care-robot', label: '医院 / 护理场景' },
        { value: 'home-livingroom-robot', label: '家庭客厅' },
        { value: 'street-nightmarket-robot', label: '街头 / 夜市地铁站' }
    ],
    storageKey: 'robot_skin_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=robot-skin-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机器人穿上皮肤，你会先在哪个场景碰到它？结果</h2>';
