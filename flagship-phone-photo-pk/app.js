 ...
 * Logic for the "硬核对比：旗舰手机拍照谁更强？" survey
 */

const questionConfig = {
    "title": "硬核对比：旗舰手机拍照谁更强？",
    "question": "全网热议：在同场景样张下，你会投给谁？",
    "options": [
        {
            "value": "iphone-15-pro",
            "label": "iPhone 15 Pro"
    ...
    "storageKey": "flagship_phone_photo_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-photo-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：旗舰手机拍照谁更强？”的最新态度</p>";
