...
const questionConfig = {
    title: '一部手机走天下，你更爱哪种手机拍照妆？',
    question: '一部手机走天下，你更爱哪种手机拍照妆？',
    options: [
        { value: 'natural-nude', label: '自然裸光' },
        { value: 'dewy-glass-skin', label: '水光玻璃肌' },
        { value: 'high-contrast-look', label: '高对比镜头感' },
        { value: 'art-filter-look', label: '艺术滤镜妆' }
    ],
    storageKey: 'phone_photo_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=phone-photo-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>一部手机走天下，你更爱哪种手机拍照妆？结果</h2>';
