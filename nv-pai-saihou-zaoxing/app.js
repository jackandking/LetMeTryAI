...
const questionConfig = {
    title: '女排夺冠后，她们哪种赛后造型让你眼前一亮？',
    question: '女排夺冠后，你最被她们哪种赛后造型吸引？',
    options: [
        { value: 'wet-short-hair', label: '湿润短发运动感' },
        { value: 'sleek-ponytail', label: '干练高马尾' },
        { value: 'soft-glam-makeup', label: '淡雅自然妆' },
        { value: 'team-hoodie-casual', label: '队服休闲风' }
    ],
    storageKey: 'nv_pai_saihou_zaoxing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nv-pai-saihou-zaoxing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>女排夺冠后，她们哪种赛后造型让你眼前一亮？结果</h2>';
