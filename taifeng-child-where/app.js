...
const questionConfig = {
    title: '台风来时孩子该待哪里才省心？',
    question: '台风来时，孩子待在哪个地方更让你省心？',
    options: [
        { value: 'stay-home', label: '留在家里和家人一起' },
        { value: 'relative-home', label: '去可信亲友家暂避' },
        { value: 'community-shelter', label: '去社区或学校临时避难点' },
        { value: 'hotel-stay', label: '订酒店或临时民宿避风' }
    ],
    storageKey: 'taifeng_child_where.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-child-where'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风来时孩子该待哪里才省心？结果</h2>';
