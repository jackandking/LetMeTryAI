/**
 * 复古或裸妆 Survey Application
 * Logic for the "复古红唇 vs 轻薄裸妆" survey
 */

const questionConfig = {
    "title": "复古红唇 vs 轻薄裸妆",
    "question": "如果是女人爱用户，你会把这一票投给谁：复古红唇还是轻薄裸妆？",
    "options": [
        {
            "value": "retro-red-lip",
            "label": "复古红唇"
    ...
    "storageKey": "beauty_retro_vs_nude_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beauty-retro-vs-nude'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>复古或裸妆投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“复古红唇 vs 轻薄裸妆”的最新态度</p>";
