...
const questionConfig = {
    title: '孩子上大学想学哪类专业？家长更看重兴趣还是就业？',
    question: '孩子上大学想学哪类专业？你更支持孩子追兴趣还是更看重未来就业？',
    options: [
        { value: 'practical-stem', label: '实用类（工科/计算机/金融）' },
        { value: 'creative-arts', label: '兴趣类（艺术/设计/传媒）' },
        { value: 'humanities-social-science', label: '人文社科（教育/心理/社会学）' },
        { value: 'emerging-interdisciplinary', label: '交叉前沿（生物信息/人工智能/环境）' }
    ],
    storageKey: 'kids_college_major.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-college-major'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子上大学想学哪类专业？家长更看重兴趣还是就业？结果</h2>';
