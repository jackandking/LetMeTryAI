...
const questionConfig = {
    title: '朋友聚会你会点哪道下饭菜？',
    question: '朋友聚会时，你会优先点哪道下饭菜？',
    options: [
        { value: 'chi-huo-guo', label: '吃火锅' },
        { value: 'kao-rou-lu-chan', label: '烤肉撸串' },
        { value: 'hai-xian-pin-pan', label: '海鲜拼盘' },
        { value: 'jia-chang-cai', label: '家常菜套餐' }
    ],
    storageKey: 'ju_hui_dian_cai.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ju-hui-dian-cai'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>朋友聚会你会点哪道下饭菜？结果</h2>';
