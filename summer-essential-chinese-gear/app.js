...
const questionConfig = {
    title: '夏天出门，你离不开哪件中国神器？',
    question: '夏天出门，你离不开哪件中国神器？',
    options: [
        { value: 'portable-fan', label: '手持小风扇' },
        { value: 'cooling-sleeves', label: '防晒冰袖' },
        { value: 'cooling-spray', label: '降温喷雾' },
        { value: 'mini-umbrella', label: '便携遮阳伞' }
    ],
    storageKey: 'summer_essential_chinese_gear.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-essential-chinese-gear'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天出门，你离不开哪件中国神器？结果</h2>';
