...
const questionConfig = {
    title: '中国农机开进全球田野，哪个画面更带感？',
    question: '中国农机开进全球田野，哪个画面更带感？',
    options: [
        { value: 'african-wheat-harvester', label: '非洲麦田收割机' },
        { value: 'southeast-asia-paddy-tractor', label: '东南亚稻田拖拉机' },
        { value: 'south-america-soybean-planter', label: '南美大豆播种队' },
        { value: 'central-asia-cotton-picker', label: '中亚棉花采摘场' }
    ],
    storageKey: 'chinese_farm_machines_global_fields.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=chinese-farm-machines-global-fields'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>中国农机开进全球田野，哪个画面更带感？结果</h2>';
