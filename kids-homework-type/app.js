...
const questionConfig = {
    title: '你家孩子的作业更像哪种？',
    question: '你家孩子的作业更像哪种？请选择一个更符合的选项。',
    options: [
        { value: 'copying-style', label: '逐题抄写型' },
        { value: 'template-style', label: '模板刷题型' },
        { value: 'creative-style', label: '创造表达型' },
        { value: 'cramming-style', label: '临时冲刺型' }
    ],
    storageKey: 'kids_homework_type.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-homework-type'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你家孩子的作业更像哪种？结果</h2>';
