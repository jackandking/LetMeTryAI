...
const questionConfig = {
    title: '排队五小时买相机，你会想拍哪种上镜大片？',
    question: '排队五小时买到相机后，你先拍哪种上镜大片？',
    options: [
        { value: 'city-backlight', label: '城市背光·背影杀' },
        { value: 'soft-japanese', label: '日系柔光·清新人像' },
        { value: 'film-vintage', label: '胶片复古·时光感' },
        { value: 'high-fashion', label: '时尚高饱和·大片感' }
    ],
    storageKey: 'five_hours_camera_shoot.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=five-hours-camera-shoot'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>排队五小时买相机，你会想拍哪种上镜大片？结果</h2>';
