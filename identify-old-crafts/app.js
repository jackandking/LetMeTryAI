...
const questionConfig = {
    title: '这些老手艺你还能认出几样？',
    question: '这些老手艺你还能认出几样？选出你认得的几项并说说回忆',
    options: [
        { value: 'mu-jiang-sunmao', label: '木匠：榫卯与老刨子' },
        { value: 'zhi-bu-zhijia', label: '织布：手摇织布机' },
        { value: 'jian-zhi-chuanghua', label: '剪纸：窗花与年画' },
        { value: 'zhi-tao-shou-lapi', label: '制陶：手拉坯与瓷碗' }
    ],
    storageKey: 'identify_old_crafts.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=identify-old-crafts'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这些老手艺你还能认出几样？结果</h2>';
