...
const questionConfig = {
    title: '送孩子上大学，报到那天你会带什么去？',
    question: '送孩子上大学，报到那天你会带哪样东西去？',
    options: [
        { value: 'bedding-and-essentials', label: '生活床品' },
        { value: 'documents-and-stationery', label: '证件与学习用品' },
        { value: 'hometown-snacks', label: '家乡小吃' },
        { value: 'companionship-and-cash', label: '陪伴+生活费' }
    ],
    storageKey: 'college_checkin_what_to_bring.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=college-checkin-what-to-bring'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>送孩子上大学，报到那天你会带什么去？结果</h2>';
