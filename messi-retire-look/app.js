...
const questionConfig = {
    title: '梅西退役，你更怀念谁的赛场造型？',
    question: '梅西退役，你更怀念谁的赛场造型？选一个你印象深刻的画面。',
    options: [
        { value: 'cristiano-ronaldo-back', label: 'C罗的霸气背影' },
        { value: 'neymar-jr-hair', label: '内马尔的花式发型' },
        { value: 'zlatan-ibrahimovic-style', label: '伊布的霸气姿态' },
        { value: 'kylian-mbappe-speed', label: '姆巴佩的青春速度感' }
    ],
    storageKey: 'messi_retire_look.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=messi-retire-look'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>梅西退役，你更怀念谁的赛场造型？结果</h2>';
