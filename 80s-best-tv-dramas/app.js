/**
 * 80年代剧回忆投票 Survey Application
 * Logic for the "关注：80年代你最怀念哪类电视剧？" survey
 */

const questionConfig = {
    "title": "关注：80年代你最怀念哪类电视剧？",
    "question": "亲，你最支持哪个选项：80年代你最怀念哪类电视剧？",
    "options": [
        {
            "value": "classic-family-dramas",
            "label": "经典家庭伦理剧"
        },
        {
            "value": "martial-historical-dramas",
            "label": "武侠与历史剧"
        },
        {
            "value": "romance-idol-dramas",
            "label": "情感偶像剧"
        },
        {
            "value": "comedy-variety-shows",
            "label": "喜剧与综艺空间"
        }
    ],
    "storageKey": "80s_best_tv_dramas_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=80s-best-tv-dramas'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>80年代剧回忆投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：80年代你最怀念哪类电视剧？”的最新态度</p>";
