...
const questionConfig = {
    title: '孩子迷上机器人，你更看重哪一点？学习还是安全可控？',
    question: '孩子迷上机器人，你更看重哪一点？',
    options: [
        { value: 'learning-ability', label: '学习能力' },
        { value: 'hands-on-skills', label: '动手能力' },
        { value: 'safety-control', label: '安全与可控' },
        { value: 'social-collaboration', label: '社交与合作' }
    ],
    storageKey: 'kids_robot_focus.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-robot-focus'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子迷上机器人，你更看重哪一点？学习还是安全可控？结果</h2>';
