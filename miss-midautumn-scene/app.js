...
const questionConfig = {
    title: '错过十五月亮那晚，你想回到哪个中秋画面？',
    question: '错过十五月亮那晚，你想回到哪个中秋画面？',
    options: [
        { value: 'home-yard-lanterns', label: '老家院子挂灯笼' },
        { value: 'rooftop-with-spouse', label: '天台和老伴看月亮' },
        { value: 'grandpa-story', label: '听爷爷讲中秋故事' },
        { value: 'video-reunion', label: '视频连线与远方亲人' }
    ],
    storageKey: 'miss_midautumn_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=miss-midautumn-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>错过十五月亮那晚，你想回到哪个中秋画面？结果</h2>';
