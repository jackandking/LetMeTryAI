...
const questionConfig = {
    title: '六代机气动布局偏好',
    question: '你更看好哪种六代机气动布局方案？',
    options: [
        { value: 'flying-wing', label: '无尾翼飞翼布局' },
        { value: 'canard-delta', label: '鸭翼三角翼布局' },
        { value: 'variable-sweep', label: '可变后掠翼方案' }
    ],
    storageKey: 'sixth_gen_fighter_concept.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sixth-gen-fighter-concept'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>六代机气动布局偏好结果</h2>';
