/**
 * 孩子阅读习惯养成 Survey Application
 * Logic for the "家长话题：你觉得最能培养孩子阅读兴趣的方法？" survey
 */

const questionConfig = {
    "title": "家长话题：你觉得最能培养孩子阅读兴趣的方法？",
    "question": "站在家长视角，你会怎么选：最能让孩子爱上阅读的方法是？",
    "options": [
        {
            "value": "daily-short-read",
            "label": "每天短时间亲子共读"
        },
        {
            "value": "child-choose-books",
            "label": "让孩子自己选书主题"
        },
        {
            "value": "picture-books-storytime",
            "label": "用图画书与故事会吸引"
        },
        {
            "value": "home-book-corner-reward",
            "label": "建立家庭小书角+阅读奖励"
        }
    ],
    "storageKey": "kids_reading_habit_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-reading-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子阅读习惯养成投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：你觉得最能培养孩子阅读兴趣的方法？”的最新态度</p>";
