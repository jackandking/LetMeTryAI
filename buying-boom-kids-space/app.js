...
const questionConfig = {
    title: '买房热，你会先为孩子改哪一处家里空间？',
    question: '买房热，你会先为孩子改哪一处家里空间？',
    options: [
        { value: 'child-bedroom', label: '独立儿童房' },
        { value: 'study-zone', label: '安静学习间' },
        { value: 'living-room-activity-area', label: '客厅活动区' },
        { value: 'kitchen-family-hub', label: '餐厨陪伴角' }
    ],
    storageKey: 'buying_boom_kids_space.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=buying-boom-kids-space'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>买房热，你会先为孩子改哪一处家里空间？结果</h2>';
