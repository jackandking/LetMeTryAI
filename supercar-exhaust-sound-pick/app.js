/**
 * 声浪党 Survey Application
 * Logic for the "跑车声浪PK：你更喜欢哪种？" survey
 */

const questionConfig = {
    "title": "跑车声浪PK：你更喜欢哪种？",
    "question": "以下哪种跑车排气声最能燃起你的热血？",
    "options": [
        {
            "value": "v8-na",
            "label": "V8 自然吸气"
        ...
        {
            "value": "electric-sound",
            "label": "电动模拟声"
        }
    ],
    "storageKey": "supercar_exhaust_sound_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supercar-exhaust-sound-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>声浪党投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“跑车声浪PK：你更喜欢哪种？”的最新态度</p>";
