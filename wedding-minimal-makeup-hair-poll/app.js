...
const questionConfig = {
    title: '婚礼简约妆发偏好调查',
    question: '您在婚礼上更偏好哪种简约妆发风格？',
    options: [
        { value: 'natural-nude-makeup-low-bun', label: '自然裸妆 + 低盘发' },
        { value: 'fresh-daily-makeup-loose-curls', label: '清新日常妆 + 披肩卷发' },
        { value: 'glowy-makeup-low-topknot', label: '精致光泽妆 + 低位丸子头' },
        { value: 'vintage-soft-makeup-vintage-curls', label: '复古柔和妆 + 经典复古卷' }
    ],
    storageKey: 'wedding_minimal_makeup_hair_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wedding-minimal-makeup-hair-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>婚礼简约妆发偏好调查结果</h2>';
