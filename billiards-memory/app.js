...
const questionConfig = {
    title: '小时候和爸妈看台球比赛，你记得哪个画面？',
    question: '小时候和爸妈看台球比赛，你记得哪个画面？',
    options: [
        { value: 'cue-strike', label: '台球杆击球瞬间' },
        { value: 'parents-whisper', label: '爸妈低声讨论比分' },
        { value: 'audience-cheer', label: '观众起立鼓掌那刻' },
        { value: 'child-watching', label: '孩子抬头看球进袋' }
    ],
    storageKey: 'billiards_memory.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=billiards-memory'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小时候和爸妈看台球比赛，你记得哪个画面？结果</h2>';
