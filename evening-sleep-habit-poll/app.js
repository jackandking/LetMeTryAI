/**
 * 睡眠小习惯投票 Survey Application
 * Logic for the "关注：晚上助眠你更习惯哪种小方法？" survey
 */

const questionConfig = {
    "title": "关注：晚上助眠你更习惯哪种小方法？",
    "question": "亲，你最支持哪个助眠小方法？",
    "options": [
        {
            "value": "gentle-stretch",
            "label": "温和拉伸放松"
        },
        {
            "value": "warm-drink",
    ...
    "storageKey": "evening_sleep_habit_poll_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=evening-sleep-habit-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>睡眠小习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：晚上助眠你更习惯哪种小方法？”的最新态度</p>";
