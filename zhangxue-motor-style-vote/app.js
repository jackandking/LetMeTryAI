...
const questionConfig = {
    title: '张雪机车赛场上的飒爽造型，你被哪一面吸引？',
    question: '张雪机车赛场上的飒爽造型，你被哪一面吸引？',
    options: [
        { value: 'leather-rider-style', label: '皮衣骑士风' },
        { value: 'sunglasses-cool-style', label: '墨镜冷艳风' },
        { value: 'full-helmet-style', label: '头盔全盔风' },
        { value: 'track-heroine-style', label: '赛道巾帼风' }
    ],
    storageKey: 'zhangxue_motor_style_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhangxue-motor-style-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张雪机车赛场上的飒爽造型，你被哪一面吸引？结果</h2>';
