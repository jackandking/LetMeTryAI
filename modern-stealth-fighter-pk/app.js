 ...
 * Logic for the "现代隐身战机对决：谁称霸天空？" survey
 */

const questionConfig = {
    "title": "现代隐身战机对决：谁称霸天空？",
    "question": "男人宝热议：第五代隐身战机谁更强，你的选择是？",
    "options": [
        {
            "value": "f-22",
            "label": "F-22（猛禽）"
    ...
    "storageKey": "modern_stealth_fighter_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-stealth-fighter-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“现代隐身战机对决：谁称霸天空？”的最新态度</p>";
