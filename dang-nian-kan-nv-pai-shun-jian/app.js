...
const questionConfig = {
    title: '当年看女排，你被哪个瞬间感动？',
    question: '当年看女排，你被哪个瞬间感动？',
    options: [
        { value: 'wan-qiang-jiu-qiu', label: '顽强救球' },
        { value: 'duiyou-jin-yongbao', label: '队友紧拥抱' },
        { value: 'jiaolian-na-ju-gu-li', label: '教练那句鼓励' },
        { value: 'kan-tai-qi-sheng-jia-you', label: '看台齐声加油' }
    ],
    storageKey: 'dang_nian_kan_nv_pai_shun_jian.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dang-nian-kan-nv-pai-shun-jian'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>当年看女排，你被哪个瞬间感动？结果</h2>';
