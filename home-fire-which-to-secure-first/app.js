...
const questionConfig = {
    title: '家里哪些东西容易着火？先收哪样更保险？',
    question: '家里哪些东西容易着火？你会先收哪样更保险？',
    options: [
        { value: 'kitchen-stove', label: '厨房灶具' },
        { value: 'charging-devices', label: '充电设备' },
        { value: 'heaters', label: '取暖电器' },
        { value: 'combustible-clutter', label: '可燃杂物' }
    ],
    storageKey: 'home_fire_which_to_secure_first.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=home-fire-which-to-secure-first'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里哪些东西容易着火？先收哪样更保险？结果</h2>';
