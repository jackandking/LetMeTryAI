/**
 * 护眼台灯选购投票 Survey Application
 * Logic for the "家长话题：护眼台灯怎么选，哪种更适合孩子？" survey
 */

const questionConfig = {
    "title": "家长话题：护眼台灯怎么选，哪种更适合孩子？",
    "question": "站在家长视角，你会怎么选：护眼台灯哪种更适合孩子？",
    "options": [
        {
        ...
        {
            "value": "combo-reading-light",
            "label": "组合式（主灯＋阅读夹灯）"
        }
    ],
    "storageKey": "kids_desk_lamp_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-desk-lamp'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>护眼台灯选购投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：护眼台灯怎么选，哪种更适合孩子？”的最新态度</p>";
