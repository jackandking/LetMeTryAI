...
const questionConfig = {
    title: '宝石色系妆容你会怎么选？绿宝石电眼还是红宝石唇？',
    question: '宝石色系妆容你会怎么选？约会、出街还是派对时更想画哪款？',
    options: [
        { value: 'emerald-electric-eye', label: '绿宝石电眼' },
        { value: 'sapphire-smoky-eye', label: '蓝宝石烟熏' },
        { value: 'ruby-stain-lip', label: '红宝石绯唇' },
        { value: 'amethyst-dream', label: '紫水晶梦幻感' }
    ],
    storageKey: 'baoshi_color_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=baoshi-color-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>宝石色系妆容你会怎么选？绿宝石电眼还是红宝石唇？结果</h2>';
