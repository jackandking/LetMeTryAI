...
const questionConfig = {
    title: '家庭地震应急准备投票：家长会先准备什么？',
    question: '在家庭地震应急准备中，你会优先准备哪一项？',
    options: [
        { value: 'food-water-supply', label: '食物与饮水储备' },
        { value: 'evacuation-plan', label: '避难与疏散计划' },
        { value: 'communication-meeting-point', label: '家庭通讯与集合点' },
        { value: 'child-psych-support', label: '儿童情绪安抚与安全教育' }
    ],
    storageKey: 'family_earthquake_emergency_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=family-earthquake-emergency-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家庭地震应急准备投票：家长会先准备什么？结果</h2>';
