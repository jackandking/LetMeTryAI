/**
 * 女人爱热议 Survey Application
 * Logic for the "女人爱热议：最让你心动的想念方式" survey
 */

const questionConfig = {
    "title": "女人爱热议：最让你心动的想念方式",
    "question": "你会把这一票投给谁：最让你心动的想念方式？",
    "options": [
        {
            "value": "late-night-message",
            "label": "深夜一句贴心话"
        },
        {
            "value": "morning-i-miss-you",
            "label": "清晨的第一条想你"
        },
        {
            "value": "unexpected-gift",
            "label": "意外的小礼物惊喜"
        },
        {
    ...
    "storageKey": "most_heartfelt_miss_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=most-heartfelt-miss'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>女人爱热议投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：最让你心动的想念方式”的最新态度</p>";
