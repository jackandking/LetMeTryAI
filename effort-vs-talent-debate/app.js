...
const questionConfig = {
    title: '孩子成绩拔尖，努力和天赋哪个更关键？',
    question: '孩子成绩拔尖，努力和天赋哪个更关键？',
    options: [
        { value: 'effort-matters', label: '努力更关键' },
        { value: 'talent-matters', label: '天赋更关键' },
        { value: 'both-needed', label: '两者缺一不可' },
        { value: 'method-first', label: '方法比苦学重要' }
    ],
    storageKey: 'effort_vs_talent_debate.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=effort-vs-talent-debate'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子成绩拔尖，努力和天赋哪个更关键？结果</h2>';
