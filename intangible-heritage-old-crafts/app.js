...
const questionConfig = {
    title: '非遗里的老手艺，哪个让你想起小时候？',
    question: '非遗里的老手艺，哪个让你想起小时候？',
    options: [
        { value: 'sugar-painting', label: '糖画' },
        { value: 'paper-cutting', label: '剪纸' },
        { value: 'bamboo-weaving', label: '竹编' },
        { value: 'dough-figurine', label: '捏面人' }
    ],
    storageKey: 'intangible_heritage_old_crafts.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=intangible-heritage-old-crafts'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>非遗里的老手艺，哪个让你想起小时候？结果</h2>';
