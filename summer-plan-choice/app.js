/**
 * 暑假计划投票 Survey Application
 * Logic for the "暑假安排：平衡成长还是侧重兴趣？" survey
 */

const questionConfig = {
    "title": "暑假安排：平衡成长还是侧重兴趣？",
    "question": "站在家长视角，你会怎么选：孩子的暑假计划你更倾向哪种安排？",
    "options": [
        {
            "value": "self-reading-goals",
            "label": "自主阅读+小目标打卡"
        },
        {
        ...
        {
            "value": "family-travel-experience",
            "label": "家庭旅行+生活实践"
        }
    ],
    "storageKey": "summer_plan_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-plan-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>暑假计划投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“暑假安排：平衡成长还是侧重兴趣？”的最新态度</p>";
