/**
 * 睡前习惯投票 Survey Application
 * Logic for the "睡前好习惯投票：哪种最帮你入睡？" survey
 */

const questionConfig = {
    "title": "睡前好习惯投票：哪种最帮你入睡？",
    "question": "亲，你最支持哪个选项：哪种睡前习惯让你睡得更香？",
    "options": [
        {
            "value": "no-phone-30-min",
            "label": "睡前关手机半小时"
        },
        {
            "value": "warm-milk-or-tea",
            "label": "泡杯温牛奶或花草茶"
        },
        {
            "value": "listen-light-music",
            "label": "听轻柔音乐或播客"
        },
        {
            "value": "five-minute-stretch",
            "label": "做5分钟伸展放松"
        }
    ],
    "storageKey": "sleep_habit_choices_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-habit-choices'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>睡前习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“睡前好习惯投票：哪种最帮你入睡？”的最新态度</p>";
