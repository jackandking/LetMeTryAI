...
const questionConfig = {
    title: '五一档你更期待哪类影片？',
    question: '五一档你更期待哪类影片？',
    options: [
        { value: 'action-blockbuster', label: '动作/商业片' },
        { value: 'comedy-family', label: '喜剧/家庭片' },
        { value: 'romance-drama', label: '爱情/文艺片' },
        { value: 'sci-fi-fantasy', label: '科幻/奇幻片' }
    ],
    storageKey: 'wu_yi_dang_lei_xing_piao.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wu-yi-dang-lei-xing-piao'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>五一档你更期待哪类影片？结果</h2>';
