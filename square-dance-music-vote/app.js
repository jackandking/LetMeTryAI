...
const questionConfig = {
    title: '超好听广场舞曲目投票',
    question: '您平时跳广场舞时，更喜欢哪种风格的伴奏曲目？',
    options: [
        { value: 'classic-pop', label: '经典流行' },
        { value: 'folk-style', label: '民族风情' },
        { value: 'slow-ballad', label: '抒情慢板' },
        { value: 'upbeat-rhythm', label: '动感节拍' }
    ],
    storageKey: 'square_dance_music_vote.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=square-dance-music-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>超好听广场舞曲目投票结果</h2>';
