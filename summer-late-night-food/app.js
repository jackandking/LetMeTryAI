...
const questionConfig = {
    title: '夏天夜宵你必点啥？',
    question: '夏天晚上撸串，你必点的主角是啥？',
    options: [
        { value: 'spicy-crayfish', label: '麻辣小龙虾' },
        { value: 'lamb-skewers', label: '烤羊肉串' },
        { value: 'garlic-oysters', label: '蒜蓉生蚝' },
        { value: 'iced-draft-beer', label: '冰镇扎啤' }
    ],
    storageKey: 'summer_late_night_food.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-late-night-food'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天夜宵你必点啥？结果</h2>';
