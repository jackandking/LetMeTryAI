/**
 * 家长话题：周末亲子活动 Survey Application
 * Logic for the "家长话题：周末亲子活动，哪种安排更合适？" survey
 */

const questionConfig = {
    "title": "家长话题：周末亲子活动，哪种安排更合适？",
    "question": "站在家长视角，你会怎么选：周末亲子活动以哪种方式为主？",
    "options": [
        {
    ...
    "storageKey": "weekend_family_activities_2026_04_08_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=weekend-family-activities-2026-04-08'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长话题：周末亲子活动投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：周末亲子活动，哪种安排更合适？”的最新态度</p>";
