/**
 * 心动告白榜 Survey Application
 * Logic for the "女人爱热议：最让人心动的告白方式" survey
 */

const questionConfig = {
    "title": "女人爱热议：最让人心动的告白方式",
    "question": "哪种告白方式最让你心动？",
    "options": [
        {
            "value": "public-romantic-surprise",
            "label": "浪漫惊喜（公众场合）"
        },
        {
    ...
    "storageKey": "most_heart_melting_confessions_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=most-heart-melting-confessions'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>心动告白榜投票结果</h2>";
