...
const questionConfig = {
    title: '被哪个美人背影杀到了？',
    question: '被哪个美人背影杀到了？选一个你有感觉的',
    options: [
        { value: 'red-gown-long-hair', label: '红裙长发背影' },
        { value: 'nude-gown-slanted-shoulder', label: '裸色长裙斜肩' },
        { value: 'bright-skirt-playful-back', label: '亮色短裙活力背影' },
        { value: 'casual-denim-back', label: '随性牛仔外套背影' }
    ],
    storageKey: 'beauty_backview_killer.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beauty-backview-killer'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>被哪个美人背影杀到了？结果</h2>';
