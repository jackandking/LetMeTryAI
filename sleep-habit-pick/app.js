/**
 * 睡眠习惯对比 Survey Application
 * Logic for the "改善睡眠的小习惯投票" survey
 */

const questionConfig = {
    "title": "改善睡眠的小习惯投票",
    "question": "亲，哪个小习惯最能帮你睡个好觉？",
    "options": [
        {
            "value": "wen-niunai",
            "label": "睡前喝一杯温牛奶"
        ...
        {
            "value": "fixed-sleep-schedule",
            "label": "固定睡眠时间（早睡早起）"
        },
        {
            "value": "read-or-soft-music",
            "label": "睡前读书或听轻音乐"
        },
        {
            "value": "avoid-phone-before-bed",
            "label": "睡前减少手机/屏幕使用"
        }
    ],
    "storageKey": "sleep_habit_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-habit-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>睡眠习惯对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“改善睡眠的小习惯投票”的最新态度</p>";
