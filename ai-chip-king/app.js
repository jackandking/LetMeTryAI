/**
 * AI芯片王者 Survey Application
 * Logic for the "男人宝热榜：谁是下一代AI芯片王者" survey
 */

const questionConfig = {
    "title": "男人宝热榜：谁是下一代AI芯片王者",
    "question": "站在男人宝用户视角，你更想把票投给谁：谁是下一代AI芯片王者？",
    "options": [
        {
            "value": "domestic-ai-chip",
            "label": "国产新一代芯片"
        },
        {
            "value": "foreign-flagship-chip",
            "label": "外产旗舰芯片"
        },
        {
            "value": "mobile-edge-chip",
            "label": "手机/终端算力芯片"
        },
        {
            "value": "custom-accelerator",
            "label": "定制加速器/FPGA"
        }
    ],
    "storageKey": "ai_chip_king_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-chip-king'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>AI芯片王者投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：谁是下一代AI芯片王者”的最新态度</p>";
