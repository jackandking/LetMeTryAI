...
const questionConfig = {
    title: '成就展的镇馆之宝，孩子会被哪一件吸引？',
    question: '成就展的镇馆之宝，孩子会被哪一件吸引？',
    options: [
        { value: 'hudong-guangying-zhuangzhi', label: '互动光影装置' },
        { value: 'juxing-jixie-moxing', label: '巨型机械模型' },
        { value: 'fugu-wanju-jiao', label: '复古玩具角' },
        { value: 'lishi-renwu-fushi', label: '历史人物服饰' }
    ],
    storageKey: 'chengjiuzhan_zhen_guan_zhi_bao.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=chengjiuzhan-zhen-guan-zhi-bao'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>成就展的镇馆之宝，孩子会被哪一件吸引？结果</h2>';
