...
const questionConfig = {
    title: '湖南卫视那只“AI猴子”，哪个表情更有画面感？',
    question: '湖南卫视那只“AI猴子”，哪个表情更有画面感？',
    options: [
        { value: 'jing-ya-deng-yan', label: '惊讶瞪眼' },
        { value: 'huai-xiao-pie-zui', label: '坏笑撇嘴' },
        { value: 'yi-huo-wai-tou', label: '疑惑歪头' },
        { value: 'chen-si-ning-shi', label: '沉思凝视' }
    ],
    storageKey: 'hunan_ai_monkey_expression.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hunan-ai-monkey-expression'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>湖南卫视那只“AI猴子”，哪个表情更有画面感？结果</h2>';
