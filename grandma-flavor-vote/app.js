...
const questionConfig = {
    title: '哪种“外婆味道”让你一想就馋？',
    question: '哪种“外婆味道”让你一想就馋？',
    options: [
        { value: 'hong-shao-rou', label: '红烧肉' },
        { value: 'hand-made-dumplings', label: '手工饺子' },
        { value: 'pickled-vegetables', label: '腌菜下饭' },
        { value: 'steamed-egg', label: '嫩嫩蒸蛋' }
    ],
    storageKey: 'grandma_flavor_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandma-flavor-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪种“外婆味道”让你一想就馋？结果</h2>';
