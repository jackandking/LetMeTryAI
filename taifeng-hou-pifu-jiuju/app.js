...
const questionConfig = {
    title: '台风过后皮肤急救，你先做哪一步？',
    question: '台风过后皮肤急救，你先做哪一步？',
    options: [
        { value: 'cleanse-first', label: '先温和清洁' },
        { value: 'hydra-boost', label: '急速补水' },
        { value: 'calm-and-repair', label: '局部镇静修护' },
        { value: 'simplify-routine', label: '减少护肤步骤' }
    ],
    storageKey: 'taifeng_hou_pifu_jiuju.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-hou-pifu-jiuju'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风过后皮肤急救，你先做哪一步？结果</h2>';
