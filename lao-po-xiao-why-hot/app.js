...
const questionConfig = {
    title: '老破小突然成了抢手货，你心动的原因是？',
    question: '老破小突然成了抢手货，你心动的原因是？',
    options: [
        { value: 'low-total-price', label: '总价友好' },
        { value: 'great-location', label: '地段真香' },
        { value: 'renovation-potential', label: '改造有料' },
        { value: 'old-neighborhood-vibe', label: '烟火气足' }
    ],
    storageKey: 'lao_po_xiao_why_hot.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=lao-po-xiao-why-hot'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老破小突然成了抢手货，你心动的原因是？结果</h2>';
