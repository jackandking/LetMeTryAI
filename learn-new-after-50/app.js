...
const questionConfig = {
    title: '50岁后学新东西，你会选哪样？',
    question: '50岁后学新东西，你会选哪样？',
    options: [
        { value: 'phone-photo-video', label: '手机拍照剪视频' },
        { value: 'taiji-baduanjin', label: '太极八段锦' },
        { value: 'calligraphy-painting', label: '书法或国画' },
        { value: 'instrument-singing', label: '乐器或唱歌' }
    ],
    storageKey: 'learn_new_after_50.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=learn-new-after-50'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>50岁后学新东西，你会选哪样？结果</h2>';
