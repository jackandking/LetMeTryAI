...
const questionConfig = {
    title: '放学回来孩子饿，你会给他哪种快手晚饭？',
    question: '放学回来孩子饿，你会给他哪种快手晚饭？',
    options: [
        { value: 'reheat-leftovers', label: '家里加热剩菜' },
        { value: 'quick-noodles', label: '快手面/汤面' },
        { value: 'sandwich-fruit', label: '三明治+水果' },
        { value: 'healthy-takeout', label: '点外卖/便利店轻食' }
    ],
    storageKey: 'after_school_quick_dinner.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=after-school-quick-dinner'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>放学回来孩子饿，你会给他哪种快手晚饭？结果</h2>';
