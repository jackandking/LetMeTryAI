...
const questionConfig = {
    title: '轻松带孩子逛河南博物院',
    question: '你带孩子逛河南博物院，更倾向于哪种方式？',
    options: [
        { value: 'pre-study', label: '提前做功课' },
        { value: 'treasure-hunt', label: '寻宝打卡' },
        { value: 'guided-tour', label: '听讲解跟随' },
        { value: 'free-explore', label: '自由探索' }
    ],
    storageKey: 'visit_henan_museum.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=visit-henan-museum'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>轻松带孩子逛河南博物院结果</h2>';
