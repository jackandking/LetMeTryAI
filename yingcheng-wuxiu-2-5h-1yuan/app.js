...
const questionConfig = {
    title: '影城午睡2.5小时只要1元多，你会去体验吗？',
    question: '如果附近影城推出2.5小时只要1元多的午睡体验，你会怎么选？',
    options: [
        { value: 'go-now', label: '立刻去体验' },
        { value: 'decide-after-seeing', label: '看环境再决定' },
        { value: 'curious-but-wont', label: '好奇但不会去' },
        { value: 'not-going-awkward', label: '不会去，太尴尬' }
    ],
    storageKey: 'yingcheng_wuxiu_2_5h_1yuan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yingcheng-wuxiu-2-5h-1yuan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>影城午睡2.5小时只要1元多，你会去体验吗？结果</h2>';
