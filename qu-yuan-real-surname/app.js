...
const questionConfig = {
    title: '屈原其实不姓屈，你知道他姓啥吗？',
    question: '屈原其实不姓屈，你知道他姓啥吗？',
    options: [
        { value: 'mi', label: '姓芈' },
        { value: 'xiong', label: '姓熊' },
        { value: 'chu', label: '姓楚' },
        { value: 'yuan', label: '姓原' }
    ],
    storageKey: 'qu_yuan_real_surname.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qu-yuan-real-surname'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>屈原其实不姓屈，你知道他姓啥吗？结果</h2>';
