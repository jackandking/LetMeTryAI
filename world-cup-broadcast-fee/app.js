...
const questionConfig = {
    title: '世界杯转播费你怎么看？付费、公共转播还是订阅？',
    question: '世界杯转播费你怎么看？你更倾向哪种观看方式？',
    options: [
        { value: 'pay-for-hd', label: '愿意付费看高清独家' },
        { value: 'public-broadcast', label: '应保持公共转播让更多人观看' },
        { value: 'streaming-subscription', label: '选择流媒体订阅追比赛' },
        { value: 'group-watch-or-highlights', label: '更倾向和朋友去酒吧或看官方回放' }
    ],
    storageKey: 'world_cup_broadcast_fee.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=world-cup-broadcast-fee'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>世界杯转播费你怎么看？付费、公共转播还是订阅？结果</h2>';
