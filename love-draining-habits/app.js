/**
 * 恋爱心累排行 Survey Application
 * Logic for the "女人爱热议：恋爱中最让你心累的小事" survey
 */

const questionConfig = {
    "title": "女人爱热议：恋爱中最让你心累的小事",
    "question": "恋爱中哪种行为最让你感到心累？",
    "options": [
        {
            "value": "late-or-no-reply",
            "label": "不及时回复消息"
        },
        {
            "value": "say-one-do-another",
            "label": "说一套做一套"
        },
        {
            "value": "ignore-feelings-complain",
            "label": "无视感受爱抱怨"
        },
        {
            "value": "absent-on-important-moments",
            "label": "重要时刻缺席"
        }
    ],
    "storageKey": "love_draining_habits_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-draining-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>恋爱心累排行投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：恋爱中最让你心累的小事”的最新态度</p>";
