/**
 * 闺蜜情感投票 Survey Application
 * Logic for the "闺蜜翻脸的原因排行 — 最让你受不了的是？" survey
 */

const questionConfig = {
    "title": "闺蜜翻脸的原因排行 — 最让你受不了的是？",
    "question": "你会把这一票投给谁：闺蜜翻脸的原因排行？",
    "options": [
        {
            "value": "bei-hou-shuo-huai-hua",
            "label": "背后说我坏话"
        },
        {
            "value": "qiang-wo-duixiang",
            "label": "抢我的对象"
        },
        {
            "value": "jian-qi-shi-ke-bu-zhandui",
            "label": "关键时刻不站队"
        },
        {
            "value": "changqi-hulue",
    ...
    "storageKey": "guimi_fenlian_reasons_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guimi-fenlian-reasons'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>闺蜜情感投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜翻脸的原因排行 — 最让你受不了的是？”的最新态度</p>";
