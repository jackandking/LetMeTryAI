...
const questionConfig = {
    title: '《给阿嬷的情书》唤起了哪些旧时光？揭秘你心底的温暖记忆',
    question: '读完《给阿嬷的情书》，下面哪类旧时光更触动你？',
    options: [
        { value: 'home-flavors', label: '老家味道' },
        { value: 'yard-and-neighbors', label: '院子与邻里' },
        { value: 'photos-and-festivals', label: '年节老照片' },
        { value: 'toys-and-school', label: '童年玩具与学堂' }
    ],
    storageKey: 'gei_ama_de_qing_shu_jiu_shiguang.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gei-ama-de-qing-shu-jiu-shiguang'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>《给阿嬷的情书》唤起了哪些旧时光？揭秘你心底的温暖记忆结果</h2>';
