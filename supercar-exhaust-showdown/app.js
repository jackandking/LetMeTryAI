 ...
 * Logic for the "跑车排气声浪对决——听觉刺激谁更带感？" survey
 */

const questionConfig = {
    "title": "跑车排气声浪对决——听觉刺激谁更带感？",
    "question": "听到哪种排气声你觉得最燃、最带感？",
    "options": [
        {
        ...
        },
        {
            ...
            "label": "改装排气 (Aftermarket)"
        }
    ],
    "storageKey": "supercar_exhaust_showdown_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supercar-exhaust-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“跑车排气声浪对决——听觉刺激谁更带感？”的最新态度</p>";
