/**
 * 演员转型榜 Survey Application
 * Logic for the "转型成功：你心目中最出色的女演员是谁？" survey
 */

const questionConfig = {
    "title": "转型成功：你心目中最出色的女演员是谁？",
    "question": "你会把这一票投给谁：转型最成功的女演员？",
    "options": [
        {
            "value": "zhou-xun",
            "label": "周迅"
    ...
    "storageKey": "actress_transformation_poll_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=actress-transformation-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>演员转型榜投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“转型成功：你心目中最出色的女演员是谁？”的最新态度</p>";
