...
const questionConfig = {
    title: '你自拍更爱哪种滤镜风格？奶油感、日系还是胶片背影杀',
    question: '你自拍更爱哪种滤镜风格？选一个你常用的',
    options: [
        { value: 'qing-xin-ri-xi', label: '清新日系' },
        { value: 'wen-rou-nai-you', label: '温柔奶油' },
        { value: 'gao-ji-leng-yan', label: '高级冷艳' },
        { value: 'fu-gu-jiao-pian', label: '复古胶片' }
    ],
    storageKey: 'selfie_filter_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=selfie-filter-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你自拍更爱哪种滤镜风格？奶油感、日系还是胶片背影杀结果</h2>';
