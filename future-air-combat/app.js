...
const questionConfig = {
    title: '未来空战主力会是谁？',
    question: '你认为未来空战的主力会是什么？',
    options: [
        { value: 'sixth-gen-fighter', label: '六代隐身战机' },
        { value: 'ai-wingman-drone', label: 'AI无人僚机' },
        { value: 'swarm-drones', label: '蜂群无人机' }
    ],
    storageKey: 'future_air_combat.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=future-air-combat'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>未来空战主力会是谁？结果</h2>';
