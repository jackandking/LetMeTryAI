...
const questionConfig = {
    title: '怀念的同学聚会记忆：哪些瞬间令你难忘',
    question: '在同学聚会上，你怀念哪类记忆？',
    options: [
        { value: 'old-photos', label: '翻看老照片' },
        { value: 'home-style-meal', label: '一起吃家常菜' },
        { value: 'singing-karaoke', label: '唱歌跳舞或卡拉OK' },
        { value: 'sharing-stories', label: '讲述旧日趣事' }
    ],
    storageKey: 'huainian_tongxue_juhe_jiyi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huainian-tongxue-juhe-jiyi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>怀念的同学聚会记忆：哪些瞬间令你难忘结果</h2>';
