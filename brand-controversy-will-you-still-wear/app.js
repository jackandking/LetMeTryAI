...
const questionConfig = {
    title: '品牌有争议，你还会继续穿它吗？',
    question: '品牌有争议，你还会继续穿它吗？',
    options: [
        { value: 'still-wear', label: '我还会穿' },
        { value: 'pause-wearing', label: '暂时停穿' },
        { value: 'home-only', label: '只在家穿' },
        { value: 'switch-brand', label: '直接换品牌' }
    ],
    storageKey: 'brand_controversy_will_you_still_wear.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=brand-controversy-will-you-still-wear'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>品牌有争议，你还会继续穿它吗？结果</h2>';
