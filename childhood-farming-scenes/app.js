...
const questionConfig = {
    title: '国产农机走向世界，你小时候见过哪种耕作场景？',
    question: '你小时候见过哪种耕作场景？',
    options: [
        { value: 'ox-plow', label: '老牛拉犁耕田' },
        { value: 'walking-tractor', label: '手扶拖拉机突突跑' },
        { value: 'combine-harvester', label: '联合收割机割麦' },
        { value: 'rice-planting', label: '水牛稻田插秧' }
    ],
    storageKey: 'childhood_farming_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=childhood-farming-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产农机走向世界，你小时候见过哪种耕作场景？结果</h2>';
