/**
 * 经典电视剧投票 Survey Application
 * Logic for the "关注：80年代更好看的电视剧" survey
 */

const questionConfig = {
    "title": "关注：80年代更好看的电视剧",
    "question": "亲，你最支持哪个选项：80年代最好看的电视剧？",
    "options": [
        {
            "value": "legend-condor-heroes",
            "label": "《射雕英雄传》"
        },
        {
        ...
        {
            "value": "dream-red-mansion",
            "label": "《红楼梦》"
        }
    ],
    "storageKey": "classic_tv_drama_vote_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-tv-drama-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>经典电视剧投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：80年代更好看的电视剧”的最新态度</p>";
