/**
 * Sha Yi Weight Loss Vote Application
 */

const questionConfig = {
    title: '沙溢狂减36斤逆袭，中年男人还该折腾吗？',
    question: '沙溢一年狂减36斤颜值回春，中年男人还该折腾吗？',
    options: [
        { value: 'fight', label: '该拼，男人至死是少年' },
        { value: 'buddha', label: '佛系就好，开心最重要' },
        { value: 'money', label: '看钱包，有钱再折腾' },
        { value: 'lay', label: '已经放弃，躺平了' }
    ],
    storageKey: 'sha_yi_36jin_comeback.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sha-yi-36jin-comeback'
        });
        return;
    }
