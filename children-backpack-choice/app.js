/**
 * 书包选购指南 Survey Application
 * Logic for the "家长话题：儿童书包你更看重哪一点" survey
 */

const questionConfig = {
    "title": "家长话题：儿童书包你更看重哪一点",
    "question": "站在家长视角，你会怎么选：儿童书包你更看重哪一点？",
    "options": [
        {
            "value": "spine-support-backpack",
            "label": "护脊支撑型"
        },
        {
        ...
        {
            "value": "durable-waterproof-backpack",
            "label": "耐用防水型"
        },
        {
            "value": "multi-pocket-backpack",
            "label": "多功能收纳型"
        }
    ],
    "storageKey": "children_backpack_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-backpack-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>书包选购指南投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：儿童书包你更看重哪一点”的最新态度</p>";
