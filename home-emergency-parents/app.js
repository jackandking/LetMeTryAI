...
const questionConfig = {
    title: '家里停水停电，爸妈先准备哪样应急物资？',
    question: '家里停水停电，爸妈会先准备哪样应急物资？',
    options: [
        { value: 'reserve-water', label: '备用饮用水' },
        { value: 'power-bank', label: '移动电源（充电宝）' },
        { value: 'emergency-light', label: '应急照明（手电/应急灯）' },
        { value: 'emergency-food', label: '应急食品（罐头/干粮）' }
    ],
    storageKey: 'home_emergency_parents.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=home-emergency-parents'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里停水停电，爸妈先准备哪样应急物资？结果</h2>';
