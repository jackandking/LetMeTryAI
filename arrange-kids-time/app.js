...
const questionConfig = {
    title: '一天像不够用，你会怎么安排陪娃时间？',
    question: '一天像不够用，你会怎么安排陪娃时间？',
    options: [
        { value: 'daily-focused-half-hour', label: '每日高质半小时' },
        { value: 'fragmented-short-sessions', label: '碎片化多次陪伴' },
        { value: 'weekend-extended-day', label: '周末长陪伴日' },
        { value: 'integrated-chores-as-teaching', label: '边做家务边教学' }
    ],
    storageKey: 'arrange_kids_time.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=arrange-kids-time'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>一天像不够用，你会怎么安排陪娃时间？结果</h2>';
