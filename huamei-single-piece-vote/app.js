...
const questionConfig = {
    title: '话梅卖到单颗高价，你会怎么选？',
    question: '话梅卖到单颗高价，你会怎么选？',
    options: [
        { value: 'buy-single-try', label: '只买一颗尝鲜' },
        { value: 'buy-full-box', label: '整盒入手更划算' },
        { value: 'wait-discount', label: '等折扣或促销' },
        { value: 'make-or-alternative', label: '不买，自己做或替代' }
    ],
    storageKey: 'huamei_single_piece_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huamei-single-piece-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>话梅卖到单颗高价，你会怎么选？结果</h2>';
