...
const questionConfig = {
    title: '提升家庭效率的小方法：实用工具与日常习惯',
    question: '下面哪种做法更能帮助你在日常家庭生活中提升效率？',
    options: [
        { value: 'time-blocking', label: '时间分块法' },
        { value: 'shared-chore-chart', label: '任务共享表' },
        { value: 'single-task-focus', label: '一次专注一件' },
        { value: 'family-5min-sync', label: '家庭五分钟同步' }
    ],
    storageKey: 'boost_home_efficiency.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=boost-home-efficiency'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>提升家庭效率的小方法：实用工具与日常习惯结果</h2>';
