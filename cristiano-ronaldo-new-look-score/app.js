...
const questionConfig = {
    ...
    options: [
        { value: 'perfect-score', label: '满分，气场全开' },
        { value: 'bold-but-picky', label: '有想法，但挑人' },
        { value: 'average-look', label: '中规中矩' },
        { value: 'not-his-best', label: '不如经典造型' }
    ],
    storageKey: 'cristiano_ronaldo_new_look_score.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cristiano-ronaldo-new-look-score'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗新造型亮相，你给打几分？结果</h2>';
