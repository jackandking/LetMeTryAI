/**
 * AI芯片对决 Survey Application
 * Logic for the "AI芯片对决：国产芯片能否撼动进口王者？" survey
 */

const questionConfig = {
    "title": "AI芯片对决：国产芯片能否撼动进口王者？",
    "question": "站在男人宝用户视角，你更想把票投给谁：AI芯片国产vs进口对决？",
    "options": [
        {
        ...
        {
            "value": "import-ai-chip",
            "label": "进口芯片（性能领先）"
        },
        {
            "value": "hybrid-ai-chip",
            "label": "混合方案（兼顾性能与可控）"
        }
    ],
    "storageKey": "ai_chip_showdown_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-chip-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>AI芯片对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“AI芯片对决：国产芯片能否撼动进口王者？”的最新态度</p>";
