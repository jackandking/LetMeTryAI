...
const questionConfig = {
    title: '换季护肤你更在意什么',
    question: '换季护肤时，你会把精力放在哪个环节？',
    options: [
        { value: 'use-hydration-serum', label: '加强保湿精华' },
        { value: 'light-oil-control', label: '清爽控油步骤' },
        { value: 'hydration-mask-boost', label: '急救补水面膜' },
        { value: 'soothing-repair', label: '舒缓修护方案' }
    ],
    storageKey: 'seasonal_skincare_habits.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=seasonal-skincare-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>换季护肤你更在意什么结果</h2>';
