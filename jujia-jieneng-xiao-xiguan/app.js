...
const questionConfig = {
    title: '居家节能小习惯投票：你现在常做哪一项？',
    question: '下面这些居家节能小习惯，你平时会做哪一项？',
    options: [
        { value: 'sui-shou-guan-deng', label: '随手关灯' },
        { value: 'huan-led-jieneng-deng', label: '换节能/LED灯' },
        { value: 'shezhi-reshuiqi-dingshi', label: '热水器定时' },
        { value: 'ba-diao-dai-ji-dian-yuan', label: '拔掉待机电源' }
    ],
    storageKey: 'jujia_jieneng_xiao_xiguan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jujia-jieneng-xiao-xiguan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>居家节能小习惯投票：你现在常做哪一项？结果</h2>';
