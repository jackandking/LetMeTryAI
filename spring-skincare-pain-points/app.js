...
const questionConfig = {
    title: '春夏换季护肤痛点小调查',
    question: '春夏换季时，你的皮肤最容易出现什么问题？',
    options: [
        { value: 'dry-flaky', label: '干燥起皮' },
        { value: 'oily-acne', label: '出油长痘' },
        { value: 'sensitive-red', label: '敏感泛红' },
        { value: 'dull-skin', label: '暗沉无光' }
    ],
    storageKey: 'spring_skincare_pain_points.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-skincare-pain-points'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春夏换季护肤痛点小调查结果</h2>';
