...
const questionConfig = {
    title: '42元一根的头绳火出圈，你会为这种颜值单品买单吗',
    question: '42元一根的头绳火出圈，你会为这种颜值单品买单吗？',
    options: [
        { value: 'buy-it-yes', label: '颜值即正义，买它' },
        { value: 'buy-if-stunning', label: '看设计，心动就入手' },
        { value: 'price-too-high', label: '42元太贵，9.9更香' },
        { value: 'no-practical-first', label: '不买单，实用优先' }
    ],
    storageKey: 'hair_tie_42_yuan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hair-tie-42-yuan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>42元一根的头绳火出圈，你会为这种颜值单品买单吗结果</h2>';
