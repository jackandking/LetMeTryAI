...
const questionConfig = {
    title: 'AI能偷偷修图，你愿意让它微调你的妆容吗？',
    question: 'AI能偷偷修图，你愿意让它微调你的妆容吗？',
    options: [
        { value: 'yes-natural-enhance', label: '当然愿意，微调让我更上镜' },
        { value: 'yes-limited-touch', label: '愿意但有限度，只修小瑕疵' },
        { value: 'no-worried-authenticity', label: '不太愿意，怕看起来不真实' },
        { value: 'no-keep-it-real', label: '坚决不愿意，真实才是美' }
    ],
    storageKey: 'ai_makeup_micro_adjust.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-makeup-micro-adjust'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI能偷偷修图，你愿意让它微调你的妆容吗？结果</h2>';
