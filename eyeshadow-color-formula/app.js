 ...
 * Logic for the "女人爱热议：眼影配色公式" survey
 */

const questionConfig = {
    "title": "女人爱热议：眼影配色公式",
    "question": "你会把这一票投给谁：眼影配色公式？",
    "options": [
        {
            "value": "earth-tone",
            "label": "经典大地色"
    ...
    "storageKey": "eyeshadow_color_formula_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eyeshadow-color-formula'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：眼影配色公式”的最新态度</p>";
