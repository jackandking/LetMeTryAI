...
const questionConfig = {
    title: '熊猫要去美国，带孩子怎么一起认识它们？',
    question: '熊猫要去美国，带孩子怎么一起认识它们？',
    options: [
        { value: 'zoo-live-guide', label: '动物园近距观察' },
        { value: 'museum-exhibit-tour', label: '博物馆文化展' },
        { value: 'home-ar-play', label: '居家互动体验' }
    ],
    storageKey: 'panda_us_family_play.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=panda-us-family-play'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>熊猫要去美国，带孩子怎么一起认识它们？结果</h2>';
