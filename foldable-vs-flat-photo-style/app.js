...
const questionConfig = {
    title: '折叠屏拍照和直板手机，你更被哪种上镜风格圈粉？',
    question: '折叠屏拍照和直板手机，你更被哪种上镜风格圈粉？',
    options: [
        { value: 'foldable-soft-glow', label: '温柔高光派' },
        { value: 'foldable-art-composition', label: '艺术构图派' },
        { value: 'slab-natural-clear', label: '自然清透派' },
        { value: 'slab-vivid-impact', label: '鲜艳冲击派' }
    ],
    storageKey: 'foldable_vs_flat_photo_style.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=foldable-vs-flat-photo-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>折叠屏拍照和直板手机，你更被哪种上镜风格圈粉？结果</h2>';
