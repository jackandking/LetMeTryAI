...
const questionConfig = {
    title: '孩子上台紧张，你会怎么帮她放松？',
    question: '孩子上台紧张，你会怎么帮她放松？',
    options: [
        { value: 'deep-breathing-relax', label: '深呼吸＋放松身体' },
        { value: 'tell-joke-distract', label: '讲笑话或聊轻松话题' },
        { value: 'quick-rehearsal-praise', label: '短排练＋鼓励肯定' },
        { value: 'lucky-charm-comfort', label: '递小幸运物安抚' }
    ],
    storageKey: 'kids_stage_relax.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-stage-relax'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子上台紧张，你会怎么帮她放松？结果</h2>';
