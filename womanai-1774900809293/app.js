/**
 * 闺蜜最暖心瞬间投票 Survey Application
 * Logic for the "闺蜜最暖心瞬间投票" survey
 */

const questionConfig = {
    "title": "闺蜜最暖心瞬间投票",
    "question": "你认为：闺蜜最暖心瞬间投票？",
    "options": [
        {
            "value": "1",
            "label": "选项1"
    ...
    "storageKey": "womanai_1774900809293_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=womanai-1774900809293'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>闺蜜最暖心瞬间投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜最暖心瞬间投票”的最新态度</p>";
