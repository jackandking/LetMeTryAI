...
const questionConfig = {
    title: '西班牙vs沙特，这场比赛你更期待看到什么？',
    question: '西班牙vs沙特，这场比赛你更期待看到什么？',
    options: [
        { value: 'spain-tiki-taka', label: '西班牙传控美学' },
        { value: 'saudi-upset', label: '沙特爆冷时刻' },
        { value: 'star-highlight', label: '球星高光表演' },
        { value: 'goal-festival', label: '进球大战' }
    ],
    storageKey: 'spain_vs_saudi_match.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spain-vs-saudi-match'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>西班牙vs沙特，这场比赛你更期待看到什么？结果</h2>';
