/**
 * 阅读习惯投票 Survey Application
 * Logic for the "家长话题：孩子阅读习惯怎么养成" survey
 */

const questionConfig = {
    "title": "家长话题：孩子阅读习惯怎么养成",
    "question": "站在家长视角，你会怎么选：养成孩子阅读习惯，哪种方式最可行？",
    "options": [
        {
        ...
        {
            "value": "parent-child-reading",
            "label": "亲子共读一起讨论"
        },
        {
            "value": "reading-corner-rewards",
            "label": "设置阅读角与奖励"
        },
        {
            "value": "library-bookstore-trip",
            "label": "图书馆/书店定期探险"
        }
    ],
    "storageKey": "children_reading_habit_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-reading-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>阅读习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子阅读习惯怎么养成”的最新态度</p>";
