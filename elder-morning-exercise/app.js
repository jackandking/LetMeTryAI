...
const questionConfig = {
    title: '老人晨练，你家长辈更喜欢哪种？',
    question: '你家里长辈早上更常做什么活动？',
    options: [
        { value: 'morning-walk', label: '晨间散步' },
        { value: 'tai-chi', label: '太极拳' },
        { value: 'square-dance', label: '广场舞' },
        { value: 'home-stretch', label: '居家舒展' }
    ],
    storageKey: 'elder_morning_exercise.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-morning-exercise'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老人晨练，你家长辈更喜欢哪种？结果</h2>';
