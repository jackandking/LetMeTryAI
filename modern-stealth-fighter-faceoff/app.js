/**
 * 现代战机对决 Survey Application
 * Logic for the "硬核对比：现代隐身战机谁更具空优？" survey
 */

const questionConfig = {
    "title": "硬核对比：现代隐身战机谁更具空优？",
    "question": "亲，你更看好哪款隐身战机的空中优势？",
    "options": [
        {
            "value": "f-22",
            "label": "F-22（美制隐身战斗机）"
    ...
    "storageKey": "modern_stealth_fighter_faceoff_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-stealth-fighter-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>现代战机对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代隐身战机谁更具空优？”的最新态度</p>";
