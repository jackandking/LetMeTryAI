...
const questionConfig = {
    title: '换手机你更看重哪个功能？电池、声音还是操作简单？',
    question: '换手机你更看重哪个功能？',
    options: [
        { value: 'long-battery', label: '电池续航长' },
        { value: 'loud-clear-sound', label: '声音大且清晰' },
        { value: 'big-screen-easy-read', label: '屏幕大字好看' },
        { value: 'simple-ops-large-buttons', label: '操作简单按键大' }
    ],
    storageKey: 'elder_love_phone_feature_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-love-phone-feature-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>换手机你更看重哪个功能？电池、声音还是操作简单？结果</h2>';
