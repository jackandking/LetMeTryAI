/**
 * 好睡一票 Survey Application
 * Logic for the "关注：哪种睡前小习惯最管用？" survey
 */

const questionConfig = {
    "title": "关注：哪种睡前小习惯最管用？",
    "question": "亲，你觉得哪种睡前习惯最能帮你睡得好？",
    "options": [
        {
            "value": "consistent-schedule",
            "label": "固定作息"
        },
        {
            "value": "less-screen-before-bed",
            "label": "睡前少看屏"
        },
        {
            "value": "foot-bath-before-sleep",
            "label": "睡前泡脚"
        },
        {
    ...
    "storageKey": "sleep_habit_choices_2026_04_04_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-habit-choices-2026-04-04'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>好睡一票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：哪种睡前小习惯最管用？”的最新态度</p>";
