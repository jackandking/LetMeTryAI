/**
 * 家长话题：错题整理 Survey Application
 * Logic for the "家长话题：错题整理，你更支持哪种方法？" survey
 */

const questionConfig = {
    "title": "家长话题：错题整理，你更支持哪种方法？",
    "question": "站在家长视角，你会怎么选：错题整理方法对比？",
    "options": [
        {
            "value": "by-subject",
            "label": "按学科分类整理"
        ...
        {
            "value": "by-mistake-type",
            "label": "按错因类型整理"
        },
        {
            "value": "by-revision-cycle",
            "label": "按时间/章节轮回复习"
        }
    ],
    "storageKey": "mistake_notes_methods_2026_04_11_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mistake-notes-methods-2026-04-11'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长话题：错题整理投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：错题整理，你更支持哪种方法？”的最新态度</p>";
