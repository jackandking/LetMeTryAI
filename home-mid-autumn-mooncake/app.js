...
const questionConfig = {
    title: '家里中秋，你怀念哪种月饼味道？',
    question: '家里中秋，你怀念哪种月饼味道？',
    options: [
        { value: 'dou-sha', label: '豆沙月饼' },
        { value: 'lian-rong', label: '莲蓉月饼' },
        { value: 'xian-dan-huang', label: '咸蛋黄月饼' },
        { value: 'wu-ren', label: '五仁月饼' }
    ],
    storageKey: 'home_mid_autumn_mooncake.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=home-mid-autumn-mooncake'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里中秋，你怀念哪种月饼味道？结果</h2>';
