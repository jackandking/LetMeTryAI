/**
 * 哪个国产龙虾机器人便宜？ Survey Application
 * Logic for the "哪个国产龙虾机器人便宜？" survey
 */

const questionConfig = {
    "title": "哪个国产龙虾机器人便宜？",
    "question": "你认为：哪个国产龙虾机器人便宜？？",
    "options": [
        {
            "value": "1",
            "label": "选项1"
    ...
    "storageKey": "nanrenbao_1773842007504_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nanrenbao-1773842007504'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>哪个国产龙虾机器人便宜？投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪个国产龙虾机器人便宜？”的最新态度</p>";
