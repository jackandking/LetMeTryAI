...
const questionConfig = {
    title: '夏日底妆谁更清透？',
    question: '你更爱哪种夏日底妆风格？',
    options: [
        { value: 'water-glow-base', label: '水光感底妆' },
        { value: 'airy-bare-foundation', label: '无感轻薄底妆' },
        { value: 'coverage-longwear', label: '遮瑕持久底妆' }
    ],
    storageKey: 'summer_light_base.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-light-base'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏日底妆谁更清透？结果</h2>';
