...
const questionConfig = {
    title: '世界杯上哪个神仙画面戳中了你？',
    question: '世界杯上哪个神仙画面戳中了你？',
    options: [
        { value: 'last-second-goal', label: '读秒绝杀庆祝' },
        { value: 'goalkeeper-save', label: '门将飞身神扑' },
        { value: 'star-face', label: '球星神仙颜值' },
        { value: 'team-celebration', label: '全队拥抱庆祝' }
    ],
    storageKey: 'world_cup_magic_moment.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=world-cup-magic-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>世界杯上哪个神仙画面戳中了你？结果</h2>';
