...
const questionConfig = {
    title: '龙舟上热搜了，你家端午还留着哪一幕？',
    question: '龙舟上热搜了，你家端午还留着哪一幕？',
    options: [
        { value: 'dragon-boat-racing', label: '龙舟竞渡' },
        { value: 'making-zongzi', label: '一家人包粽子' },
        { value: 'listening-to-stories', label: '听长辈讲故事' },
        { value: 'hanging-wormwood', label: '门挂艾草菖蒲' }
    ],
    storageKey: 'elder_love_duanwu_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-love-duanwu-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>龙舟上热搜了，你家端午还留着哪一幕？结果</h2>';
