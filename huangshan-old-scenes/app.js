...
const questionConfig = {
    title: '去黄山你会想起哪个老画面？哪一幕更触动你的回忆',
    question: '去黄山你会想起哪个老画面？',
    options: [
        { value: 'yingkesong-photo', label: '迎客松下的合影' },
        { value: 'cable-car-cloud-sea', label: '坐缆车俯瞰云海' },
        { value: 'sunrise-silhouette-pines', label: '日出时的背影与松林' },
        { value: 'old-tour-group', label: '老旅行团排队登山' }
    ],
    storageKey: 'huangshan_old_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huangshan-old-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>去黄山你会想起哪个老画面？哪一幕更触动你的回忆结果</h2>';
