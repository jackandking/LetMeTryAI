...
const questionConfig = {
    title: '张凌赫穿搭风格对比：你偏爱哪种造型？',
    question: '你更喜欢张凌赫的哪种穿搭风格？',
    options: [
        { value: 'casual-relaxed', label: '休闲随性' },
        { value: 'formal-elegant', label: '正式优雅' },
        { value: 'street-trend', label: '潮流街头' }
    ],
    storageKey: 'zhang_linghe_style_compare.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-linghe-style-compare'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张凌赫穿搭风格对比：你偏爱哪种造型？结果</h2>';
