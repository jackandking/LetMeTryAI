/**
 * 儿童书包选购指南 Survey Application
 * Logic for the "家长话题：儿童书包怎么选" survey
 */

const questionConfig = {
    "title": "家长话题：儿童书包怎么选",
    "question": "站在家长视角，你会怎么选：儿童书包怎么选？",
    "options": [
        {
            "value": "spine-protect",
            "label": "护脊减负款"
        ...
        {
            "value": "durable-classic",
            "label": "耐用经典款"
        }
    ],
    "storageKey": "school_bag_guide_2026_04_16_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=school-bag-guide-2026-04-16'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>儿童书包选购指南投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：儿童书包怎么选”的最新态度</p>";
