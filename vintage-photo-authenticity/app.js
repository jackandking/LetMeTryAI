...
const questionConfig = {
    title: '这些老照片真还是假的？你能看出破绽吗？揭秘藏在细节的线索',
    question: '这些老照片真还是假的？你能看出破绽吗？你觉得更像哪种情况？',
    options: [
        { value: 'looks-authentic', label: '看着像真实老片' },
        { value: 'obvious-retouch', label: '像被修图或合成过' },
        { value: 'possible-rephotograph', label: '可能是翻拍或复原作品' },
        { value: 'undecided-expert-needed', label: '看不出来，需专家或家人确认' }
    ],
    storageKey: 'vintage_photo_authenticity.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=vintage-photo-authenticity'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这些老照片真还是假的？你能看出破绽吗？揭秘藏在细节的线索结果</h2>';
