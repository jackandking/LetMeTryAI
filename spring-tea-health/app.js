...
const questionConfig = {
    title: '春季养生茶饮',
    question: '您平时最喜欢喝哪种养生茶？',
    options: [
        { value: 'chrysanthemum-tea', label: '菊花茶' },
        { value: 'goji-tea', label: '枸杞茶' },
        { value: 'red-date-longan-tea', label: '红枣桂圆茶' },
        { value: 'green-tea', label: '绿茶' }
    ],
    storageKey: 'spring_tea_health.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-tea-health'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季养生茶饮结果</h2>';
