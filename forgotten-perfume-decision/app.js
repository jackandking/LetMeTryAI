...
const questionConfig = {
    title: '家里有被忘好久的香水，你会怎么处理？留着当回忆还是改造再用？',
    question: '家里有被忘好久的香水，你会怎么处理？',
    options: [
        { value: 'throw-away', label: '直接丢掉' },
        { value: 'mix-and-use', label: '留着偶尔兑用' },
        { value: 'gift-to-friend', label: '送给闺蜜/亲友' },
        { value: 'repurpose-diffuser', label: '改造成居家香氛' }
    ],
    storageKey: 'forgotten_perfume_decision.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=forgotten-perfume-decision'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里有被忘好久的香水，你会怎么处理？留着当回忆还是改造再用？结果</h2>';
