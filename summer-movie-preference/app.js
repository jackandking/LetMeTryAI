...
const questionConfig = {
    title: '暑期看大片，你更想看哪种类型？',
    question: '暑期看大片，你更想看哪种类型？',
    options: [
        { value: 'effects-heavy', label: '特效炸裂' },
        { value: 'emotion-driven', label: '情感打动' },
        { value: 'comedy-relief', label: '喜剧解压' },
        { value: 'mystery-thriller', label: '悬疑烧脑' }
    ],
    storageKey: 'summer_movie_preference.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-movie-preference'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>暑期看大片，你更想看哪种类型？结果</h2>';
