...
const questionConfig = {
    title: "全球无人机：谁是天空新霸主？",
    question: "在未来战争中，哪款无人机将成为战场主宰？",
    options: [
        { value: "gj11", label: "GJ-11 利剑 (China)" },
        { value: "xq58a", label: "XQ-58A 女武神 (USA)" },
        { value: "s70", label: "S-70 猎人 (Russia)" },
        { value: "tb3", label: "TB3 旗手 (Turkey)" },
        { value: "mq28", label: "MQ-28 幽灵蝙蝠 (Australia)" }
    ],
    storageKey: "drone_kings_v1.data"
};
