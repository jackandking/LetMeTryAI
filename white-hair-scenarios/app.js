...
const questionConfig = {
    title: '白头发多了，你觉得更像哪种情况？',
    question: '白头发多了，你觉得更像哪种情况？',
    options: [
        { value: 'natural-aging', label: '岁月痕迹（自然变多）' },
        { value: 'stress-lifestyle', label: '作息压力（熬夜/劳累）' },
        { value: 'family-trait', label: '家族遗传（父母也早白）' }
    ],
    storageKey: 'white_hair_scenarios.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=white-hair-scenarios'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>白头发多了，你觉得更像哪种情况？结果</h2>';
