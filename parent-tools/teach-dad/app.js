/**
 * Teach Dad Application
 * Allows users to share videos and links
 */

/**
 * Configuration
 */
const teachDadConfig = {
    dancesKey: "parent-tools-teach-dad-videos",
    votingKey: "parent-tools-teach-dad-votes"
};
...
function saveDances() {
    ...
    return new Promise((resolve, reject) => {
        updateKeyValueStore(teachDadConfig.dancesKey, dancesData)
            .then(() => resolve())
...
function loadDances() {
    ...
    readKeyValueStore(teachDadConfig.dancesKey, (data) => {
        ...
        if (data) {
            ...
            dances = [];
            dancesList.innerHTML = '<p style="text-align: center; color: #888;">还没有人分享视频，快来做第一个吧！</p>';
        }
    });
}
