/**
 * Human vs AI Survey Application
 * Logic for "Human Pilots vs AI Drones" survey
 */
...
const questionConfig = {
    title: "未来空战：人类飞行员 vs AI无人机",
    question: "在未来的空战中，你认为谁将主宰天空？",
    options: [
        { value: "human", label: "人类王牌 (Human)" },
        { value: "ai_drone", label: "AI无人机 (AI Drone)" },
        { value: "human_ai", label: "人机共生 (Human-AI)" }
    ],
    storageKey: "human_vs_ai_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: "/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=human-vs-ai",
        });
        return;
    }
...
function showResult(voteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2c3e50;'>未来战力投票结果</h2>";
...
function createBarChart(voteData) {
    ...
    for (const [option, count] of sortedEntries) {
        ...
        optionLabel.innerText = option.split(' ')[0]; // Just show short name
