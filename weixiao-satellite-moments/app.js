...
const questionConfig = {
    title: '国产“微笑”卫星上天，哪个瞬间更让你热血沸腾？',
    question: '看到国产“微笑”卫星上天，你觉得哪个瞬间更让你热血沸腾？',
    options: [
        { value: 'liftoff-through-cloud', label: '升空穿云' },
        { value: 'stage-separation-orbit', label: '舱段分离入轨' },
        { value: 'solar-array-deploy', label: '太阳翼展开' },
        { value: 'first-smile-image', label: '首张“微笑”回传' }
    ],
    storageKey: 'weixiao_satellite_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=weixiao-satellite-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产“微笑”卫星上天，哪个瞬间更让你热血沸腾？结果</h2>';
