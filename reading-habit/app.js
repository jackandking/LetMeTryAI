 ...
 * Logic for the "家长话题：如何帮孩子养成阅读习惯" survey
 */

const questionConfig = {
    "title": "家长话题：如何帮孩子养成阅读习惯",
    "question": "站在家长视角，你会怎么选：孩子的阅读习惯该怎么养？",
    "options": [
        {
        ...
        {
            "value": "parent-modeling",
            "label": "父母示范并讨论读后感"
        },
        {
            "value": "interest-booklist",
            "label": "兴趣书单与自由选书"
        },
        {
            "value": "reading-streak-reward",
            "label": "读书打卡或小奖励"
        }
    ],
    "storageKey": "reading_habit_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=reading-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何帮孩子养成阅读习惯”的最新态度</p>";
