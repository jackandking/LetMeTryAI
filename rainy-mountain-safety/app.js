...
const questionConfig = {
    title: '大雨山路遇险，给爸妈带哪样更能安心？',
    question: '遇到大雨山路遇险，给爸妈带哪样随身物品，你觉得更让人放心？',
    options: [
        { value: 'power-bank', label: '大容量移动电源＋充电线' },
        { value: 'rain-blanket', label: '防水保暖毯＋轻便雨披' },
        { value: 'torch-warning', label: '强光手电＋反光警示牌' },
        { value: 'car-emergency-kit', label: '车载应急救援包（工具绳具）' }
    ],
    storageKey: 'rainy_mountain_safety.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-mountain-safety'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>大雨山路遇险，给爸妈带哪样更能安心？结果</h2>';
