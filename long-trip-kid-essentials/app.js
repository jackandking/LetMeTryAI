...
const questionConfig = {
    title: '长途出行带孩子，你常用哪些随身物品？',
    question: '长途出行带孩子，你常用哪些随身物品？',
    options: [
        { value: 'snacks-utensils', label: '零食与餐具' },
        { value: 'toys-activity-kit', label: '玩具与活动包' },
        { value: 'electronics-chargers', label: '电子设备与充电' },
        { value: 'hygiene-change-clothes', label: '换洗与清洁用品' }
    ],
    storageKey: 'long_trip_kid_essentials.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=long-trip-kid-essentials'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>长途出行带孩子，你常用哪些随身物品？结果</h2>';
