...
const questionConfig = {
    title: '碰到无人驾驶出租车，你敢上车吗？',
    question: '碰到无人驾驶出租车，你会怎么做？',
    options: [
        { value: 'ride-now', label: '马上上车' },
        { value: 'watch-first', label: '先观察' },
        { value: 'call-human', label: '叫人来开' },
        { value: 'never-ride', label: '不会尝试' }
    ],
    storageKey: 'dare_self_driving.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=dare-self-driving'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>碰到无人驾驶出租车，你敢上车吗？结果</h2>';
