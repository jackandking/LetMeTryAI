...
const questionConfig = {
    title: '这秋天给孩子穿秋裤吗？家长都怎么安排',
    question: '这秋天给孩子穿秋裤吗？在家、出门或晚上你会怎么安排？',
    options: [
        { value: 'wear-now', label: '一冷就先穿' },
        { value: 'wear-at-night-or-out', label: '白天活动多再等外出或晚上穿' },
        { value: 'decide-by-temp-activity', label: '看温度和衣服厚度灵活决定' },
        { value: 'no-fixed-rule', label: '不固定穿，喜欢薄款替代' }
    ],
    storageKey: 'wear_autumn_kids_long_johns.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wear-autumn-kids-long-johns'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这秋天给孩子穿秋裤吗？家长都怎么安排结果</h2>';
