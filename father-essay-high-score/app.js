...
const questionConfig = {
    title: '男生写去世父亲的高考作文获高分，你咋看？',
    question: '男生写去世父亲的高考作文获高分，你咋看？',
    options: [
        { value: 'true-feelings-deserve-score', label: '真情动人' },
        { value: 'emotional-manipulation-concern', label: '消费亲情' },
        { value: 'authenticity-is-key', label: '关键在真' },
        { value: 'parents-should-guide', label: '家长该引导' }
    ],
    storageKey: 'father_essay_high_score.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=father-essay-high-score'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>男生写去世父亲的高考作文获高分，你咋看？结果</h2>';
