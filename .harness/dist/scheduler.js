...
import { getHarnessMode, loadHarnessConfig, ensureDirectories } from './config/index.js';
    ...
    scheduleProfile(config) {
        ...
        const job = Cron(config.cron, { timezone: config.timezone }, async () => {
            ...
            try {
                ...
                console.error(`[Scheduler] ${config.profileId} failed:`, error.message);
