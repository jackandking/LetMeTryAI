 ...
 * 生成并下载图片
 */
export async function generateAndDownload(options, outputPath) {
 ...
 * 为投票应用生成选项图片
 */
export async function generateVoteOptionImages(appName, options, outputDir) {
 ...
 * 生成选项图片的提示词
 */
function generateOptionPrompt(appName, label, caption) {
 ...
 * 生成封面图片
 */
export async function generateCoverImage(title, subtitle, outputPath) {
...
//# sourceMappingURL=minimax-image.js.map