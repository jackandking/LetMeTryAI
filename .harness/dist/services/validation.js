 ...
 */
export function validateCodeCompleteness(code, rules = CORE_VALIDATION_RULES) {
    const passed = [];
    const failed = [];
 ...
 */
export function validateCssCompleteness(css) {
    const rules = [
        {
            name: 'bar_chart',
            pattern: /\.bar-chart/,
 ...
 */
export function validateScaffold(files, appId) {
