...
const questionConfig = {
    title: '太空里吃午饭、地球上吃晚饭：你想体验哪种太空画面？',
    question: '太空里吃午饭、地球上吃晚饭：你想体验哪种太空画面？',
    options: [
        { value: 'space-station-window-lunch', label: '太空站窗前午餐' },
        { value: 'moon-earthset-dinner', label: '月面看地球落日晚餐' },
        { value: 'spacewalk-floating-snack', label: '太空行走悬浮吃点心' },
        { value: 'earth-terrace-dinner-under-stars', label: '地球露台与朋友看星吃晚饭' }
    ],
    storageKey: 'space_lunch_earth_dinner.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=space-lunch-earth-dinner'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>太空里吃午饭、地球上吃晚饭：你想体验哪种太空画面？结果</h2>';
