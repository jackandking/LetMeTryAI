...
const questionConfig = {
    title: '老照片里那些地方，你会带爸妈重游哪一处？',
    question: '老照片里那些地方，你会带爸妈重游哪一处？选一个最想去的场景并说说原因。',
    options: [
        { value: 'old-home-alley', label: '老家小巷' },
        { value: 'old-cinema', label: '老电影院/戏院' },
        { value: 'riverside-park-bench', label: '河边公园长椅' },
        { value: 'old-market', label: '老菜市场/集市' }
    ],
    storageKey: 'revisit_old_photo_places.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=revisit-old-photo-places'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老照片里那些地方，你会带爸妈重游哪一处？结果</h2>';
