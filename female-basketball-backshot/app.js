...
const questionConfig = {
    title: '你被哪个女篮赛场造型的背影杀惊到了？',
    question: '你被哪个女篮赛场造型的背影杀惊到了？',
    options: [
        { value: 'high-ponytail-backshot', label: '高马尾动感背影' },
        { value: 'low-ponytail-soft-back', label: '低马尾柔和背影' },
        { value: 'short-hair-sharp-back', label: '短发干练背影' },
        { value: 'long-flowing-hair-back', label: '披肩长发飘逸背影' }
    ],
    storageKey: 'female_basketball_backshot.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=female-basketball-backshot'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你被哪个女篮赛场造型的背影杀惊到了？结果</h2>';
