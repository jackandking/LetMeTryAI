/**
 * 女人爱热议：春日香氛选择 Survey Application
 * Logic for the "春日香氛选择：哪款香氛更适合你的春天？" survey
 */

const questionConfig = {
    "title": "春日香氛选择：哪款香氛更适合你的春天？",
    "question": "你会把这一票投给谁：春日香氛你更想带哪款？",
    "options": [
        {
            "value": "fresh-floral",
            "label": "清新花香"
    ...
    "storageKey": "spring_fragrance_pick_2026_04_08_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-fragrance-pick-2026-04-08'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>女人爱热议：春日香氛选择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“春日香氛选择：哪款香氛更适合你的春天？”的最新态度</p>";
