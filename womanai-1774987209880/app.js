 ...
 * Logic for the "闺蜜暖心瞬间投票" survey
 */

const questionConfig = {
    "title": "闺蜜暖心瞬间投票",
    "question": "你认为：闺蜜暖心瞬间投票？",
    "options": [
        {
            "value": "1",
            "label": "选项1"
    ...
    "storageKey": "womanai_1774987209880_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=womanai-1774987209880'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜暖心瞬间投票”的最新态度</p>";
