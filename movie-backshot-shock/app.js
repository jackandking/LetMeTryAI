...
const questionConfig = {
    title: '这位演员的背影更让你惊艳?',
    question: '看预告或海报，谁的背影让你更记住这部片/这位演员？',
    options: [
        { value: 'young-charm-backshot', label: '少年感背影' },
        { value: 'mature-hero-backshot', label: '成熟硬汉背影' },
        { value: 'contrast-smile-backshot', label: '反差笑容背影' }
    ],
    storageKey: 'movie_backshot_shock.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-backshot-shock'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这位演员的背影更让你惊艳?结果</h2>';
