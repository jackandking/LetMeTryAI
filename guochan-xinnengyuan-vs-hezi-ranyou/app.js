...
const questionConfig = {
    title: '揭秘：国产新能源 vs 合资燃油，你会怎么选？',
    question: '如果准备买车，你倾向于选择国产新能源（电动车）还是合资燃油车？（可选最贴近你的理由）',
    options: [
        { value: 'guochan-xinnengyuan', label: '国产新能源（电动车）' },
        { value: 'hezi-ranyou', label: '合资燃油（传统汽油）' },
        { value: 'hunhe-dongli', label: '混合动力 / 折中方案' }
    ],
    storageKey: 'guochan_xinnengyuan_vs_hezi_ranyou.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guochan-xinnengyuan-vs-hezi-ranyou'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>揭秘：国产新能源 vs 合资燃油，你会怎么选？结果</h2>';
