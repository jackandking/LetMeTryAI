/**
 * 分手难忘瞬间 Survey Application
 * Logic for the "女人爱热议：分手后哪些瞬间让你难以忘怀？" survey
 */

const questionConfig = {
    "title": "女人爱热议：分手后哪些瞬间让你难以忘怀？",
    "question": "分手后哪些瞬间更让你难以忘怀？",
    "options": [
        {
            "value": "receive-ex-ex-message",
            "label": "收到旧爱消息"
        },
        {
            "value": "meet-mutual-friend",
            "label": "偶遇共同朋友"
        },
        {
            "value": "discover-ex-new-relationship",
            "label": "发现对方新恋情"
        },
        {
            "value": "spend-holiday-alone",
            "label": "节日独自度过"
        }
    ],
    "storageKey": "breakup_memorable_moments_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=breakup-memorable-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>分手难忘瞬间投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：分手后哪些瞬间让你难以忘怀？”的最新态度</p>";
