...
const questionConfig = {
    title: '听到齐豫《大海》，你脑海里先浮现哪个画面？',
    question: '听到齐豫《大海》，你脑海里先浮现哪个画面？',
    options: [
        { value: 'seaside-gaze', label: '海边凝望' },
        { value: 'living-room-vinyl', label: '客厅黑胶' },
        { value: 'stage-lights', label: '舞台灯光' },
        { value: 'train-window', label: '火车窗外' }
    ],
    storageKey: 'qiyu_da_hai_which_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qiyu-da-hai-which-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>听到齐豫《大海》，你脑海里先浮现哪个画面？结果</h2>';
