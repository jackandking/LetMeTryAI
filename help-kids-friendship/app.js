...
const questionConfig = {
    title: '如何帮助孩子维持同学友谊：日常策略选择',
    question: '在日常生活中，你会支持哪种方式帮助孩子维持同学友谊？',
    options: [
        { value: 'teach-initiate', label: '教孩子主动打招呼和邀请' },
        { value: 'regular-activities', label: '建立固定的小组活动' },
        { value: 'conflict-resolution', label: '教会解决冲突的技能' },
        { value: 'screen-time-guidelines', label: '减少社交压力，鼓励线下互动' }
    ],
    storageKey: 'help_kids_friendship.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=help-kids-friendship'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>如何帮助孩子维持同学友谊：日常策略选择结果</h2>';
