...
const questionConfig = {
    title: '上学背过的古文，哪句现在还能脱口而出？',
    question: '上学背过的古文，哪句现在还能脱口而出？',
    options: [
        { value: 'study-and-practice', label: '学而时习之' },
        { value: 'moonlight-before-bed', label: '床前明月光' },
        { value: 'wish-for-eternity', label: '但愿人长久' },
        { value: 'hardship-and-comfort', label: '生于忧患' }
    ],
    storageKey: 'memorable_classic_lines.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=memorable-classic-lines'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>上学背过的古文，哪句现在还能脱口而出？结果</h2>';
