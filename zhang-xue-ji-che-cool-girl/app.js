...
const questionConfig = {
    title: '张雪机车又赢了，这种酷女孩造型你爱吗？',
    question: '张雪机车造型又出圈，这种酷女孩风格你爱吗？',
    options: [
        { value: 'love-cool-girl-yyds', label: '爱惨了，酷女孩yyds' },
        { value: 'prefer-sweet-style', label: '更爱甜美风' },
        { value: 'face-is-everything', label: '看脸就行' },
        { value: 'occasionally-cool-fresh', label: '偶尔酷一下很新鲜' }
    ],
    storageKey: 'zhang_xue_ji_che_cool_girl.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-xue-ji-che-cool-girl'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张雪机车又赢了，这种酷女孩造型你爱吗？结果</h2>';
