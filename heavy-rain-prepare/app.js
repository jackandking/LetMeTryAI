...
const questionConfig = {
    title: '暴雨来临，家里先准备哪件事？',
    question: '暴雨来临，家里先准备哪件事？',
    options: [
        { value: 'prepare-power-light', label: '充电宝与照明' },
        { value: 'secure-windows-balcony', label: '窗门加固与收阳台物' },
        { value: 'stock-food-water', label: '备足食物與饮用水' },
        { value: 'family-safety-plan', label: '确定避险房间与看护计划' }
    ],
    storageKey: 'heavy_rain_prepare.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=heavy-rain-prepare'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>暴雨来临，家里先准备哪件事？结果</h2>';
