...
const questionConfig = {
    title: '高楼晃动时，你家老人会想要哪样安抚？',
    question: '高楼晃动时，你家老人会想要哪样安抚？',
    options: [
        { value: 'hold-handrail-sit', label: '握稳扶手、慢慢坐下' },
        { value: 'look-family-photo', label: '拿出家人照片或熟物' },
        { value: 'drink-warm-water', label: '喝口温开水或热茶' },
        { value: 'listen-familiar-song', label: '听熟悉的老歌或家人说话' }
    ],
    storageKey: 'highrise_calming_elder.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=highrise-calming-elder'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高楼晃动时，你家老人会想要哪样安抚？结果</h2>';
