...
const questionConfig = {
    title: '街头超美植物，你会带回家养吗？',
    question: '街头超美植物，你会带回家养吗？',
    options: [
        { value: 'bring-home', label: '抱回家养' },
        { value: 'take-photo', label: '先拍照留念' },
        { value: 'consider-conditions', label: '想养但要考虑' }
    ],
    storageKey: 'street_beauty_plants.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=street-beauty-plants'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>街头超美植物，你会带回家养吗？结果</h2>';
