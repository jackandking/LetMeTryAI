...
const questionConfig = {
    title: '看《给阿嬷的情书》，谁的妆容让你心动？惊艳细节揭秘',
    question: '看《给阿嬷的情书》，谁的妆容让你心动？',
    options: [
        { value: 'danya-fugu-nv-zhu', label: '淡雅复古女主' },
        { value: 'qingxin-keai-nvpei', label: '清新可爱女配' },
        { value: 'jingyan-chuangyi', label: '惊艳创意妆' }
    ],
    storageKey: 'give_grandma_letter_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=give-grandma-letter-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看《给阿嬷的情书》，谁的妆容让你心动？惊艳细节揭秘结果</h2>';
