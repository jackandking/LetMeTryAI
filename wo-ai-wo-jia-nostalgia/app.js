...
const questionConfig = {
    title: '《我爱我家》里的哪些桥段让你笑着怀念？',
    question: '《我爱我家》里的哪些桥段让你笑着怀念？哪一幕常在你脑海里回放？',
    options: [
        { value: 'dad-remote-scramble', label: '爸妈抢遥控的客厅小争执' },
        { value: 'hallway-neighbor-chatter', label: '楼道里互相打听八卦的邻居段子' },
        { value: 'family-dinner-awkward-gag', label: '家宴上尴尬变笑点的亲戚时刻' },
        { value: 'livingroom-singalong', label: '客厅围着电视合唱的小曲儿' }
    ],
    storageKey: 'wo_ai_wo_jia_nostalgia.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wo-ai-wo-jia-nostalgia'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>《我爱我家》里的哪些桥段让你笑着怀念？结果</h2>';
