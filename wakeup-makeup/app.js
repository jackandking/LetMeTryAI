...
const questionConfig = {
    title: '总是犯困，脸看起来没精神？哪款醒肤妆你会选？',
    question: '总是犯困，脸看起来没精神？哪款醒肤妆你会选？',
    options: [
        { value: 'daily-bright-light-makeup', label: '日常提亮轻妆' },
        { value: 'lifted-eye-makeup', label: '精致眼妆拉提' },
        { value: 'glow-highlight-makeup', label: '高光水光打亮' }
    ],
    storageKey: 'wakeup_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wakeup-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>总是犯困，脸看起来没精神？哪款醒肤妆你会选？结果</h2>';
