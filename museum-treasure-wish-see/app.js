...
const questionConfig = {
    title: '博物馆里哪个镇馆之宝想去看？',
    question: '在博物馆里，你想近距离看哪个镇馆之宝？',
    options: [
        { value: 'qin-shi-huang-terracotta-army', label: '秦始皇兵马俑' },
        { value: 'sanxingdui-bronze-mask', label: '三星堆青铜面具' },
        { value: 'dunhuang-flying-mural', label: '敦煌飞天壁画' },
        { value: 'gugong-gold-jade-armor', label: '故宫金缕玉衣' }
    ],
    storageKey: 'museum_treasure_wish_see.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-treasure-wish-see'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>博物馆里哪个镇馆之宝想去看？结果</h2>';
