...
const questionConfig = {
    title: '战机隐身与机动能力比较',
    question: '在隐身与机动之间，你更看重哪一项？',
    options: [
        { value: 'j-20', label: '歼-20' },
        { value: 'f-22', label: 'F-22' },
        { value: 'su-57', label: '苏-57' }
    ],
    storageKey: 'fighter_jet_comparison.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=fighter-jet-comparison'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>战机隐身与机动能力比较结果</h2>';
