/**
 * 显白口红PK Survey Application
 * Logic for the "女人爱热议：春季显白口红色号大盘点" survey
 */

const questionConfig = {
    "title": "女人爱热议：春季显白口红色号大盘点",
    "question": "如果是女人爱用户，你会把这一票投给哪个春季显白口红色号？",
    "options": [
        {
            "value": "coral-orange",
            "label": "珊瑚橘"
    ...
    "storageKey": "spring_brightening_lipstick_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-brightening-lipstick-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>显白口红PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：春季显白口红色号大盘点”的最新态度</p>";
