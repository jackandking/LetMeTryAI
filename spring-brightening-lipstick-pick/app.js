/**
 * Spring Whitening Lipstick Survey Application
 * Logic for the "女人爱热议：春季最显白口红" voting page
 */
        ...
        if (!overlay) {
            ...
            overlay.innerHTML = `
                <div class="ad-content">
                    <h3>正在分析"女人爱热议：春季最显白口红"的投票趋势...</h3>
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = `
        <h2>显白口红榜投票结果</h2>
        <p class="result-subtitle">看看大家对"女人爱热议：春季最显白口红"的最新态度</p>
    `;
