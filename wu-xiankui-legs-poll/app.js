...
const questionConfig = {
    title: '吴贤揆这腿，你觉得好看吗？',
    question: '吴贤揆这腿，你觉得好看吗？',
    options: [
        { value: 'good-looking-smooth', label: '好看，线条很流畅' },
        { value: 'average-not-noticed', label: '一般吧，没太注意' },
        { value: 'not-my-type', label: '不太get到' },
        { value: 'prefer-strong-legs', label: '更喜欢健康力量感' }
    ],
    storageKey: 'wu_xiankui_legs_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wu-xiankui-legs-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>吴贤揆这腿，你觉得好看吗？结果</h2>';
