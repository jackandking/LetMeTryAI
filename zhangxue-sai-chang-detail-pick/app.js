...
const questionConfig = {
    title: '张雪赛场妆，你更pick哪个细节？',
    question: '张雪赛场妆，你更pick哪个细节？',
    options: [
        { value: 'smoky-glitter-eyes', label: '烟熏眼＋亮片点缀' },
        { value: 'soft-nude-eye', label: '柔和裸色眼线' },
        { value: 'glowy-highlight', label: '额头鼻梁高光' },
        { value: 'matte-contour-blush', label: '哑光修容＋雾面腮红' }
    ],
    storageKey: 'zhangxue_sai_chang_detail_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhangxue-sai-chang-detail-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张雪赛场妆，你更pick哪个细节？结果</h2>';
