/**
 * 家长沟通投票 Survey Application
 * Logic for the "孩子发脾气怎么回应" survey
 */

const questionConfig = {
    "title": "孩子发脾气怎么回应",
    "question": "站在家长视角，你会怎么选：孩子发脾气时怎么回应？",
    "options": [
        {
            "value": "wait-calm-down",
            "label": "等情绪平复再谈"
        },
        {
            "value": "immediate-soothe",
            "label": "马上安抚抱抱"
        },
        {
            "value": "set-limits",
    ...
    "storageKey": "child_tantrum_response_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-tantrum-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长沟通投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子发脾气怎么回应”的最新态度</p>";
