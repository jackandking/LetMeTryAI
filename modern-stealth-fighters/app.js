/**
 * 隐身战机对决 Survey Application
 * Logic for the "硬核对比：现代隐身战机，你更看好哪款？" survey
 */

const questionConfig = {
    "title": "硬核对比：现代隐身战机，你更看好哪款？",
    "question": "站在男人宝用户视角，你更看好哪款现代隐身战机？",
    "options": [
        {
            "value": "f-22",
            "label": "F-22 猛禽"
    ...
    "storageKey": "modern_stealth_fighters_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-stealth-fighters'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>隐身战机对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代隐身战机，你更看好哪款？”的最新态度</p>";
