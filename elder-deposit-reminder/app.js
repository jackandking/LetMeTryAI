...
const questionConfig = {
    title: '老人定期存款到期忘取，你会怎么提醒？',
    question: '老人定期存款到期忘取，你会怎么提醒？',
    options: [
        { value: 'phone-call-remind', label: '电话/视频提醒' },
        { value: 'visit-in-person', label: '亲自上门陪同' },
        { value: 'delegate-child', label: '委托家人或邻居代办' },
        { value: 'bank-sms-reminder', label: '开通银行短信/网银提醒' }
    ],
    storageKey: 'elder_deposit_reminder.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-deposit-reminder'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老人定期存款到期忘取，你会怎么提醒？结果</h2>';
