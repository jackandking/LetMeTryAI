...
const questionConfig = {
    title: '你怀念的家常味是哪一种？厨房里的哪个味道让你瞬间回到小时候',
    question: '你怀念的家常味是哪一种？',
    options: [
        { value: 'lao-mu-ji-dun-tang', label: '老母鸡炖汤' },
        { value: 'mama-hong-shao-rou', label: '妈妈的红烧肉' },
        { value: 'cong-jiang-suan-re-cai', label: '葱姜蒜爆香的热菜' },
        { value: 'qingchen-xizhou-you-tiao', label: '清晨的稀粥配油条' }
    ],
    storageKey: 'nostalgic_home_flavors.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nostalgic-home-flavors'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你怀念的家常味是哪一种？厨房里的哪个味道让你瞬间回到小时候结果</h2>';
