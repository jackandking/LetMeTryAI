/**
 * 经典街机游戏排行 Survey Application
 * Logic for the "经典街机游戏排行 — 你心中的街机王者" survey
 */

const questionConfig = {
    "title": "经典街机游戏排行 — 你心中的街机王者",
    "question": "作为硬核玩家，你会把票投给哪一款经典街机游戏（按操作手感/对战性/怀旧度）？",
    "options": [
        {
            "value": "street-fighter-ii",
            "label": "街霸 II（Street Fighter II）"
        },
        {
            "value": "metal-slug",
            "label": "合金弹头（Metal Slug）"
        },
        {
            "value": "pac-man",
            "label": "吃豆人（Pac-Man）"
    ...
    "storageKey": "classic_arcade_games_ranking_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-arcade-games-ranking'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>经典街机游戏排行投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“经典街机游戏排行 — 你心中的街机王者”的最新态度</p>";
