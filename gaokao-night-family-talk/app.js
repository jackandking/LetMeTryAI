...
const questionConfig = {
    title: '高考结束那晚，你家聊的是啥？',
    question: '高考结束那晚，你家聊的是啥？',
    options: [
        { value: 'volunteer-major-planning', label: '志愿填报与专业方向' },
        { value: 'summer-travel-relax', label: '暑期旅行与放松计划' },
        { value: 'college-life-dream', label: '未来大学与生活畅想' },
        { value: 'score-review-backup', label: '成绩复盘与后路准备' }
    ],
    storageKey: 'gaokao_night_family_talk.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gaokao-night-family-talk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高考结束那晚，你家聊的是啥？结果</h2>';
