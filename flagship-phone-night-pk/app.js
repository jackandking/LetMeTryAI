/**
 * 科技数码对比：旗舰夜拍 Survey Application
 * Logic for the "旗舰夜拍：哪款更能拍出夜色质感？" survey
 */

const questionConfig = {
    "title": "旗舰夜拍：哪款更能拍出夜色质感？",
    "question": "全网热议：旗舰夜拍表现，你更投谁？",
    "options": [
        {
            "value": "iphone-15-pro",
            "label": "iPhone 15 Pro"
    ...
    "storageKey": "flagship_phone_night_pk_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-night-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>科技数码对比：旗舰夜拍投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“旗舰夜拍：哪款更能拍出夜色质感？”的最新态度</p>";
