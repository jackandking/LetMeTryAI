...
const questionConfig = {
    title: 'C罗这张球场照骗过好多人，你领先眼看到啥？',
    question: '这张球场照，你领先眼看到的是？',
    options: [
        { value: 'ronaldo-playing-match', label: 'C罗本人在比赛' },
        { value: 'ball-kid-holding-board', label: '场边举牌的球童' },
        { value: 'billboard-poster', label: '广告牌上的海报' },
        { value: 'bench-player-standing', label: '替补席站着的球员' }
    ],
    storageKey: 'c_ron_stadium_optical_illusion.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=c-ron-stadium-optical-illusion'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗这张球场照骗过好多人，你领先眼看到啥？结果</h2>';
