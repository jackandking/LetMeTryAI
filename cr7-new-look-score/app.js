...
const questionConfig = {
    title: 'C罗这个新造型，你给打几分？',
    question: 'C罗这个新造型，你给打几分？',
    options: [
        { value: 'full-marks-handsome-new-level', label: '满分，帅出新高度' },
        { value: 'passing-need-get-used', label: '及格，还得看习惯' },
        { value: 'no-points-old-look-better', label: '不加分，老造型更香' },
        { value: 'dont-understand-happy-works', label: '看不懂，他开心就好' }
    ],
    storageKey: 'cr7_new_look_score.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cr7-new-look-score'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗这个新造型，你给打几分？结果</h2>';
