/**
 * 豪车内饰PK Survey Application
 * Logic for the "装备党首选：百万豪车内饰对比" survey
 */

const questionConfig = {
    "title": "装备党首选：百万豪车内饰对比",
    "question": "作为资深玩家，你更想把票投给哪款豪车内饰？",
    "options": [
        {
    ...
    "storageKey": "million_luxury_interior_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=million-luxury-interior-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>豪车内饰PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“装备党首选：百万豪车内饰对比”的最新态度</p>";
