...
const questionConfig = {
    title: '052D驱逐舰雷达技术话题：哪种雷达能力更关键？',
    question: '在052D驱逐舰雷达技术话题中，你认为哪种雷达能力对舰艇作战更关键？',
    options: [
        { value: 'phased-array', label: '相控阵雷达' },
        { value: 'three-d-search', label: '三坐标搜索雷达' },
        { value: 'passive-esm', label: '被动电子侦察' },
        { value: 'data-fusion', label: '数据融合与目标识别' }
    ],
    storageKey: '052d_radar_tech.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=052d-radar-tech'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>052D驱逐舰雷达技术话题：哪种雷达能力更关键？结果</h2>';
