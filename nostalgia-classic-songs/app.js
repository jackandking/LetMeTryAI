 ...
 * Logic for the "关注：最让你回味的经典老歌" survey
 */

const questionConfig = {
    "title": "关注：最让你回味的经典老歌",
    "question": "亲，你最怀念哪类经典老歌？",
    "options": [
        {
            "value": "spring-festival-hits",
            "label": "春晚经典曲目"
        },
        {
            "value": "movie-theme-songs",
            "label": "电影主题曲"
        },
        {
            "value": "classic-opera-arias",
            "label": "老戏曲唱段"
        },
        {
            "value": "pop-gold-60s-80s",
            "label": "流行金曲（60s-80s）"
        }
    ],
    "storageKey": "nostalgia_classic_songs_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nostalgia-classic-songs'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：最让你回味的经典老歌”的最新态度</p>";
