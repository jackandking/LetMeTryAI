...
const questionConfig = {
    title: '烧烤摊上必点 你的快乐源泉是啥',
    question: '烧烤摊上必点 你的快乐源泉是啥？',
    options: [
        { value: 'yangrou-chuan', label: '羊肉串' },
        { value: 'kao-yaozi', label: '烤腰子' },
        { value: 'kao-jiucai', label: '烤韭菜' },
        { value: 'kao-qiezi', label: '烤茄子' }
    ],
    storageKey: 'shaokao_tan_bidian.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=shaokao-tan-bidian'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>烧烤摊上必点 你的快乐源泉是啥结果</h2>';
