...
const questionConfig = {
    title: '哪句“纸短情长”的情话更能戳中你？',
    question: '哪句“纸短情长”的情话更能戳中你？',
    options: [
        { value: 'wake-up-loving-you', label: '醒来觉得甚是爱你' },
        { value: 'tonight-moon-is-beautiful', label: '今晚月色真美' },
        { value: 'someone-like-rainbow', label: '斯人若彩虹' },
        { value: 'mountain-has-trees-heart-has-you', label: '山有木兮木有枝' }
    ],
    storageKey: 'which_love_letter_line.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=which-love-letter-line'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪句“纸短情长”的情话更能戳中你？结果</h2>';
