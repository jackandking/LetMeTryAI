...
const questionConfig = {
    title: '未来五年，爸妈的健康生活你更在意啥？',
    question: '未来五年，爸妈的健康生活你更在意哪一方面？',
    options: [
        { value: 'nutrition-meals-support', label: '营养和吃得稳定' },
        { value: 'regular-checkups-chronic-care', label: '定期体检与慢病管理' },
        { value: 'daily-activity-mobility-safety', label: '日常活动与行动安全' },
        { value: 'mental-companionship-social-life', label: '心理陪伴与社交生活' }
    ],
    storageKey: 'future_five_years_parents_health.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=future-five-years-parents-health'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>未来五年，爸妈的健康生活你更在意啥？结果</h2>';
