...
const questionConfig = {
    title: '你更想尝试哪种南京吃鸭方式？',
    question: '你更想尝试哪种南京吃鸭方式？',
    options: [
        { value: 'cold-sliced-salt-duck', label: '传统凉切盐水鸭' },
        { value: 'salt-duck-with-blood-soup', label: '盐水鸭配鸭血粉丝汤' },
        { value: 'duck-in-pancake', label: '夹饼吃法（鸭肉夹饼）' },
        { value: 'spicy-marinated-duck', label: '香辣卤味改良吃法' }
    ],
    storageKey: 'nanjing_duck_ways.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nanjing-duck-ways'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你更想尝试哪种南京吃鸭方式？结果</h2>';
