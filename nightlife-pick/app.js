...
const questionConfig = {
    title: '下班后你爱去哪种夜生活？',
    question: '下班后你最想去哪种夜生活场景？',
    options: [
        { value: 'bbq-street', label: '街边烧烤摊' },
        { value: 'craft-bar', label: '精酿小酒吧' },
        { value: 'late-night-diner', label: '深夜食堂' },
        { value: 'esports-cafe', label: '电竞网咖' }
    ],
    storageKey: 'nightlife_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nightlife-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>下班后你爱去哪种夜生活？结果</h2>';
