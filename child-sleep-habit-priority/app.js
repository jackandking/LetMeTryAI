...
const questionConfig = {
    title: '孩子睡眠习惯你更看重什么？',
    question: '孩子睡眠习惯你更看重什么？',
    options: [
        { value: 'regular-schedule', label: '规律生物钟' },
        { value: 'enough-duration', label: '睡够时长' },
        { value: 'deep-sleep', label: '安稳不醒' },
        { value: 'self-soothe', label: '自己入睡' }
    ],
    storageKey: 'child_sleep_habit_priority.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-sleep-habit-priority'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子睡眠习惯你更看重什么？结果</h2>';
