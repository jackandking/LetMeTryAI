...
const questionConfig = {
    title: 'AI 助手与工作：你更担心还是期待？',
    question: '面对 AI 助手进入工作场景，你更倾向哪种态度？',
    options: [
        { value: 'accept-ai', label: '积极接受' },
        { value: 'stay-cautious', label: '保持警惕' },
        { value: 'support-regulation', label: '倡导监管' },
        { value: 'wait-and-see', label: '短期观望' }
    ],
    storageKey: 'ai_work_attitude.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-work-attitude'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI 助手与工作：你更担心还是期待？结果</h2>';
