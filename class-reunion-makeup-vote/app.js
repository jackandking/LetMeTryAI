...
const questionConfig = {
    title: '同学聚会妆容风格投票 — 你会选择哪个妆容?',
    question: '同学聚会你会选哪种妆容风格？',
    options: [
        { value: 'natural-fresh', label: '自然清新' },
        { value: 'glam-evening', label: '精致闪耀' },
        { value: 'retro-classic', label: '复古经典' },
        { value: 'cute-playful', label: '可爱俏皮' }
    ],
    storageKey: 'class_reunion_makeup_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=class-reunion-makeup-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>同学聚会妆容风格投票 — 你会选择哪个妆容?结果</h2>';
