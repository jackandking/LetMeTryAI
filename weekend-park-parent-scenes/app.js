...
const questionConfig = {
    title: '周末公园带娃，你更想看到哪种画面？',
    question: '周末公园带娃，你更想看到哪种画面？',
    options: [
        { value: 'picnic-reading', label: '野餐读绘本' },
        { value: 'chasing-butterflies', label: '草地追蝴蝶' },
        { value: 'kite-flying-silhouette', label: '放风筝背影' },
        { value: 'swing-laughter', label: '秋千嬉笑' }
    ],
    storageKey: 'weekend_park_parent_scenes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=weekend-park-parent-scenes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>周末公园带娃，你更想看到哪种画面？结果</h2>';
