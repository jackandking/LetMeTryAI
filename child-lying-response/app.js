/**
 * 孩子说谎怎么回应 Survey Application
 * Logic for the "孩子说谎你会怎么处理？" survey
 */

const questionConfig = {
    "title": "孩子说谎你会怎么处理？",
    "question": "站在家长视角，你会怎样回应孩子说谎？",
    "options": [
        {
    ...
    "storageKey": "child_lying_response_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-lying-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子说谎怎么回应投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子说谎你会怎么处理？”的最新态度</p>";
