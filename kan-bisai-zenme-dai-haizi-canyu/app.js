...
const questionConfig = {
    title: '看比赛时你会怎么带孩子参与？',
    question: '看比赛时你会怎么带孩子参与？',
    options: [
        { value: 'xianchang-lalaidui', label: '现场做小啦啦队' },
        { value: 'fen-juese-jiangjie-guize', label: '分角色讲解规则' },
        { value: 'bisai-xiao-renwu-ka', label: '比赛小任务卡' },
        { value: 'anjing-guansai-saihou-taolun', label: '安静观赛+赛后讨论' }
    ],
    storageKey: 'kan_bisai_zenme_dai_haizi_canyu.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kan-bisai-zenme-dai-haizi-canyu'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看比赛时你会怎么带孩子参与？结果</h2>';
