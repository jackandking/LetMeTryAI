/**
 * 钓鱼十大梦寐之鱼 Survey Application
 * Logic for the "钓鱼人梦寐以求的十种鱼 — 你最想钓到哪一条？" survey
 */

const questionConfig = {
    "title": "钓鱼人梦寐以求的十种鱼 — 你最想钓到哪一条？",
    "question": "亲，你更想把票投给谁：钓鱼人梦寐以求的十种鱼里，哪一条让你最想挑战？",
    "options": [
        {
            "value": "ju-xing-qingyu",
            "label": "巨型青鱼（江河霸主）"
        },
        {
            "value": "da-kou-heilv",
        ...
        {
            "value": "lanqi-jinqiangyu",
            "label": "蓝鳍金枪鱼（海钓霸主）"
        },
        {
            "value": "caoyu-laojiang",
            "label": "草鱼老将（技巧与耐心的回报）"
        }
    ],
    "storageKey": "diaoyu_ren_mengmei_10_zhong_yu_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=diaoyu-ren-mengmei-10-zhong-yu'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>钓鱼十大梦寐之鱼投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“钓鱼人梦寐以求的十种鱼 — 你最想钓到哪一条？”的最新态度</p>";
