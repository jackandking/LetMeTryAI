/**
 * 助眠小习惯投票 Survey Application
 * Logic for the "关注：晚上你会尝试哪种助眠小习惯？" survey
 */

const questionConfig = {
    "title": "关注：晚上你会尝试哪种助眠小习惯？",
    "question": "亲，你最支持哪个选项：晚上你会尝试哪种助眠小习惯？",
    "options": [
        {
            "value": "warm-milk",
            "label": "喝一杯温牛奶"
        ...
        {
            "value": "stretching-breathing",
            "label": "简单伸展与深呼吸"
        }
    ],
    "storageKey": "evening_sleep_habit_choice_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=evening-sleep-habit-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>助眠小习惯投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：晚上你会尝试哪种助眠小习惯？”的最新态度</p>";
