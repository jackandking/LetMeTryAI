/**
 * 分手回忆投票 Survey Application
 * Logic for the "女人爱热议：分手后最难忘的瞬间" survey
 */

const questionConfig = {
    "title": "女人爱热议：分手后最难忘的瞬间",
    "question": "分手后哪个瞬间最让你难忘？",
    "options": [
        {
            "value": "first-breakup-proposal",
            "label": "第一次提出分手"
        },
        {
            "value": "last-meeting-or-call",
            "label": "最后一次见面/通话"
        },
        {
            "value": "discover-partner-new",
            "label": "发现对方有新对象"
        },
        {
            "value": "shared-memories-deleted",
            "label": "共同回忆被删除或抹除"
        }
    ],
    "storageKey": "breakup_most_memorable_moment_2026_03_22_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=breakup-most-memorable-moment-2026-03-22'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>分手回忆投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：分手后最难忘的瞬间”的最新态度</p>";
