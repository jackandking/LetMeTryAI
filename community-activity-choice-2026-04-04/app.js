/**
 * 社区活动选择 Survey Application
 * Logic for the "关注：社区活动你更想参加哪个？" survey
 */

const questionConfig = {
    "title": "关注：社区活动你更想参加哪个？",
    "question": "亲，你最支持哪个社区活动？",
    "options": [
        {
            "value": "calligraphy-handicraft-class",
            "label": "书画与手工班"
        },
        {
            "value": "neighbour-help-group",
            "label": "邻里互助小组"
        },
        {
            "value": "volunteer-service-team",
            "label": "志愿服务队"
        },
        {
            "value": "square-dance-exercise-class",
            "label": "广场舞/健身操班"
        }
    ],
    "storageKey": "community_activity_choice_2026_04_04_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-04'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>社区活动选择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：社区活动你更想参加哪个？”的最新态度</p>";
