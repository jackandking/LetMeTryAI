/**
 * 四大名著你站哪一部 Survey Application
 * Logic for the "四大名著你站哪一部" survey
 */

const questionConfig = {
    "title": "四大名著你站哪一部",
    "question": "你认为：四大名著你站哪一部？",
    "options": [
        {
            "value": "1",
            "label": "选项1"
    ...
    "storageKey": "nanrenbao_1774998011775_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nanrenbao-1774998011775'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>四大名著你站哪一部投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“四大名著你站哪一部”的最新态度</p>";
