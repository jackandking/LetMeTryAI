...
const questionConfig = {
    title: '爸妈身边哪些生活小事里藏着糖？揭秘那些让人暖心的小瞬间',
    question: '爸妈身边哪些生活小事里藏着糖？你常遇到哪种让人心里甜的瞬间？',
    options: [
        { value: 'qin-shou-nuan-fan-cai', label: '亲手做的暖饭菜' },
        { value: 'ye-liu-zhan-deng', label: '夜里留一盏灯' },
        { value: 'bu-jing-yi-xiao-li-wu', label: '不经意的小礼物' },
        { value: 'yi-ju-nuan-xin-duan-xin', label: '一句暖心的问候短信' }
    ],
    storageKey: 'ba_ma_shen_bian_tang.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ba-ma-shen-bian-tang'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爸妈身边哪些生活小事里藏着糖？揭秘那些让人暖心的小瞬间结果</h2>';
