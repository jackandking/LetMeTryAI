 ...
 * Logic for the "闺蜜翻脸：最常见的原因是哪一个？" survey
 */

const questionConfig = {
    "title": "闺蜜翻脸：最常见的原因是哪一个？",
    "question": "你觉得闺蜜翻脸最常见的原因是哪一项？",
    "options": [
        {
            "value": "gossip-behind-back",
            "label": "背后说你坏话"
        },
        {
            "value": "secret-or-lie",
    ...
    "storageKey": "friendship_fallout_rank_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=friendship-fallout-rank'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜翻脸：最常见的原因是哪一个？”的最新态度</p>";
