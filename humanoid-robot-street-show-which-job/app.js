/**
 * 人形机器人街头秀 Survey Application
 * Logic for the "人形机器人街头秀｜你先投它去哪行？" survey
 */

const questionConfig = {
    "title": "人形机器人街头秀｜你先投它去哪行？",
    "question": "如果有人形机器人走上街头，你会先投票让它去做哪一行？请选最想看的场景。",
    "options": [
        {
            "value": "delivery-robot",
            "label": "外卖配送小哥"
        },
        {
            "value": "security-patrol-robot",
            "label": "城市安保巡逻"
        },
        {
            "value": "street-performer-robot",
            "label": "街头表演艺人"
        },
        {
            "value": "shop-guide-robot",
            "label": "商场导购机器人"
        }
    ],
    "storageKey": "humanoid_robot_street_show_which_job_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=humanoid-robot-street-show-which-job'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>人形机器人街头秀投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“人形机器人街头秀｜你先投它去哪行？”的最新态度</p>";
