...
const questionConfig = {
    title: '长者生活习惯你更认同哪种：作息与活动风格',
    question: '长者生活习惯你更认同哪种？',
    options: [
        { value: 'regular-routine', label: '作息规律型' },
        { value: 'flexible-pace', label: '灵活随性型' },
        { value: 'social-interest', label: '兴趣社交型' }
    ],
    storageKey: 'elder_habits_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-habits-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>长者生活习惯你更认同哪种：作息与活动风格结果</h2>';
