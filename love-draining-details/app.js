/**
 * 女人爱热议：恋爱细节投票 Survey Application
 * Logic for the "恋爱中让人心累的细节，你更不能忍哪一个？" survey
 */

const questionConfig = {
    "title": "恋爱中让人心累的细节，你更不能忍哪一个？",
    "question": "你会把这一票投给谁：恋爱中让人心累的细节？",
    "options": [
        {
            "value": "often-late",
            "label": "经常迟到或爽约"
        ...
        {
            "value": "phone-distracted",
            "label": "对话总是刷手机"
        },
        {
            "value": "insensitive-words",
            "label": "说话不顾及感受"
        },
        {
            "value": "avoid-responsibility",
            "label": "遇事不愿承担责任"
        }
    ],
    "storageKey": "love_draining_details_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-draining-details'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>女人爱热议：恋爱细节投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“恋爱中让人心累的细节，你更不能忍哪一个？”的最新态度</p>";
