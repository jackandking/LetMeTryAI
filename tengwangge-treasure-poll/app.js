...
const questionConfig = {
    title: '带孩子去滕王阁，你会先看哪种镇馆之宝？',
    question: '带孩子去滕王阁，你会先带他看哪一种镇馆之宝？',
    options: [
        { value: 'ancient-paintings', label: '古代书画' },
        { value: 'fine-ceramics', label: '精美瓷器' },
        { value: 'historic-sculptures', label: '名家雕塑' }
    ],
    storageKey: 'tengwangge_treasure_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tengwangge-treasure-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去滕王阁，你会先看哪种镇馆之宝？结果</h2>';
