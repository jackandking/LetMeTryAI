/**
 * 作业安排投票 Survey Application
 * Logic for the "作业先做还是先休息？" survey
 */
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>作业安排投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“作业先做还是先休息？”的最新态度</p>";
