 ...
 * Logic for the "二战最强坦克：你更看好谁？" survey
 */

const questionConfig = {
    "title": "二战最强坦克：你更看好谁？",
    "question": "男人宝热榜：二战最强坦克，你更投谁？",
    "options": [
        {
            "value": "tiger-i",
            "label": "虎式坦克 (Tiger I)"
    ...
    "storageKey": "ww2_best_tank_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ww2-best-tank'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“二战最强坦克：你更看好谁？”的最新态度</p>";
