...
const questionConfig = {
    title: '台风天出门，妆容怎么安排？哪种更安心？',
    question: '台风天要出门，你会怎么安排妆容，哪种更让你安心？',
    options: [
        { value: 'full-waterproof-makeup', label: '全防水持妆' },
        { value: 'lightweight-no-makeup-look', label: '轻薄无妆感（防晕）' },
        { value: 'spot-proof-essentials', label: '重点局部防护' },
        { value: 'bareface-with-gear', label: '素颜＋物理防护' }
    ],
    storageKey: 'typhoon_makeup_safety.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=typhoon-makeup-safety'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天出门，妆容怎么安排？哪种更安心？结果</h2>';
