...
const questionConfig = {
    title: '高考那天，你会做哪件事？家长会怎么做',
    question: '高考那天，你会做哪件事？',
    options: [
        { value: 'accompany-child-to-exam', label: '陪孩子走进考场' },
        { value: 'wait-outside-exam', label: '在考点外等信息' },
        { value: 'stay-home-prepare-meal', label: '留在家里做饭准备' },
        { value: 'send-encouraging-message', label: '不打扰，发条鼓励消息' }
    ],
    storageKey: 'gaokao_day_parent_actions.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gaokao-day-parent-actions'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高考那天，你会做哪件事？家长会怎么做结果</h2>';
