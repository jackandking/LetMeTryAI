...
const questionConfig = {
    title: '演唱会上出汗，你更信哪种底妆？',
    question: '演唱会上出汗，你更信哪种底妆？',
    options: [
        { value: 'matte-long-wear', label: '哑光持久粉底+妆前乳' },
        { value: 'waterproof-setting-spray', label: '防水定妆喷雾+轻薄粉底' },
        { value: 'cushion-touch-up', label: '气垫随手补妆' },
        { value: 'bb-sweat-control', label: '控油BB/隔离+吸汗小物' }
    ],
    storageKey: 'concert_foundation_sweat_trust.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=concert-foundation-sweat-trust'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>演唱会上出汗，你更信哪种底妆？结果</h2>';
