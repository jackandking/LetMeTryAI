/**
 * 坦克对决 Survey Application
 * Logic for the "硬核对比：现代主战坦克谁更能扛？" survey
 */

const questionConfig = {
    "title": "硬核对比：现代主战坦克谁更能扛？",
    "question": "如果上战场，你更信赖哪款主战坦克？",
    "options": [
        {
            "value": "t14-armata",
            "label": "T-14 阿玛塔"
    ...
    "storageKey": "modern_tank_faceoff_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-tank-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>坦克对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代主战坦克谁更能扛？”的最新态度</p>";
