...
const questionConfig = {
    title: '海边度假美妆与穿搭偏好投票',
    question: '去海边度假你更偏好哪种美妆与穿搭风格？',
    options: [
        { value: 'ziran-qingxin-fangshai', label: '自然清新防晒风' },
        { value: 'shimao-guangze-haiyang', label: '时髦光泽海洋风' },
        { value: 'tianmei-dujia-shaonv', label: '甜美度假少女感' },
        { value: 'yundong-xiuxian-haitan', label: '运动休闲海滩风' }
    ],
    storageKey: 'haibian_dujia_meizhuang_chuandai.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=haibian-dujia-meizhuang-chuandai'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>海边度假美妆与穿搭偏好投票结果</h2>';
