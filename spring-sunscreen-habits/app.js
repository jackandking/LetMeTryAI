...
const questionConfig = {
    title: '春夏防晒你更看重哪一点',
    question: '春夏季节，你选择防晒产品时更看重什么？',
    options: [
        { value: 'high-protection', label: '高倍防护' },
        { value: 'lightweight-texture', label: '清爽肤感' },
        { value: 'skincare-ingredients', label: '养肤成分' },
        { value: 'good-value', label: '性价比高' }
    ],
    storageKey: 'spring_sunscreen_habits.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-sunscreen-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春夏防晒你更看重哪一点结果</h2>';
