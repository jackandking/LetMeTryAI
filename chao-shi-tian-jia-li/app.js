...
const questionConfig = {
    ...
    question: '潮湿天家里你在意哪点？',
    options: [
        { value: 'clothes-damp-smell', label: '衣服和被褥潮臭' },
        { value: 'mold-on-walls-furniture', label: '墙面／家具发霉变色' },
        { value: 'slippery-floors-safety', label: '地面湿滑有摔倒风险' },
        { value: 'stuffy-air-breathing', label: '室内闷湿有霉味' }
    ],
    storageKey: 'chao_shi_tian_jia_li.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=chao-shi-tian-jia-li'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>潮湿天家里你在意哪点？结果</h2>';
