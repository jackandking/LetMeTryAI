/**
 * 闺蜜翻脸排行 Survey Application
 * Logic for the "女人爱热议：闺蜜翻脸的原因排行" survey
 */

const questionConfig = {
    "title": "女人爱热议：闺蜜翻脸的原因排行",
    "question": "你会把这一票投给谁：闺蜜翻脸最常见的原因是？",
    "options": [
        {
            "value": "talk-behind-back",
            "label": "背后说我坏话"
        },
        {
            "value": "money-or-benefits",
            "label": "利益冲突／金钱纠纷"
        },
        {
            "value": "romantic-betrayal",
            "label": "感情背叛（抢对象）"
        },
        {
            "value": "values-differ",
    ...
    "storageKey": "friendship_fallout_reasons_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=friendship-fallout-reasons'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>闺蜜翻脸排行投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：闺蜜翻脸的原因排行”的最新态度</p>";
