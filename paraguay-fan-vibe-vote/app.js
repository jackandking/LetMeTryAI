...
const questionConfig = {
    title: '巴拉圭女球迷火出圈，哪种氛围感更戳你？',
    question: '巴拉圭女球迷火出圈，哪种氛围感更戳你？',
    options: [
        { value: 'passionate-latin', label: '热烈奔放' },
        { value: 'sweet-cool', label: '甜酷元气' },
        { value: 'elegant-queen', label: '冷艳高级' },
        { value: 'sunny-athletic', label: '阳光运动' }
    ],
    storageKey: 'paraguay_fan_vibe_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=paraguay-fan-vibe-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>巴拉圭女球迷火出圈，哪种氛围感更戳你？结果</h2>';
