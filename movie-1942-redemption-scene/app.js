...
const questionConfig = {
    title: '哪场戏让《一九四二》口碑翻红了？',
    question: '哪场戏更戳中你？',
    options: [
        { value: 'exodus-long-take', label: '逃荒长镜头' },
        { value: 'huazhi-trades-herself', label: '花枝换粮' },
        { value: 'ending-foster-girl', label: '结尾遇孤女' },
        { value: 'chiang-report-scene', label: '重庆看报告' }
    ],
    storageKey: 'movie_1942_redemption_scene.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-1942-redemption-scene'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪场戏让《一九四二》口碑翻红了？结果</h2>';
