...
const questionConfig = {
    title: '现场舞台造型，你被谁的颜值电到了？',
    question: '现场舞台造型，你被谁的颜值电到了？',
    options: [
        { value: 'hong-qun-bei-ying-sha', label: '红裙背影杀' },
        { value: 'punk-pi-yi-ku-gan', label: '朋克皮衣酷感' },
        { value: 'tian-mei-pao-pao-xiu', label: '甜美泡泡袖' }
    ],
    storageKey: 'xianchang_wutai_yanzhi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xianchang-wutai-yanzhi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>现场舞台造型，你被谁的颜值电到了？结果</h2>';
