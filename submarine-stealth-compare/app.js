/**
 * 潜艇隐蔽对比 Survey Application
 * Logic for the "潜艇隐蔽性对比" survey
 */

const questionConfig = {
    "title": "潜艇隐蔽性对比",
    "question": "作为硬核玩家，你更认可哪种潜艇在现代海战中更占优势？",
    "options": [
        {
            "value": "diesel-aip-submarine",
            "label": "柴电潜艇（含AIP）"
        },
        {
            "value": "conventional-diesel-submarine",
            "label": "常规柴电潜艇"
        },
        {
            "value": "nuclear-attack-submarine",
            "label": "核动力攻击潜艇"
        }
    ],
    "storageKey": "submarine_stealth_compare_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=submarine-stealth-compare'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>潜艇隐蔽对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“潜艇隐蔽性对比”的最新态度</p>";
