...
const questionConfig = {
    "title": "硬核对比：军用无人机对决",
    "question": "作为硬核玩家，你更认可哪款军用无人机用于侦察/打击任务？",
    "options": [
        {
            "value": "mq-9-reaper",
            "label": "MQ-9 Reaper"
    ...
    "storageKey": "military_uav_duel_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-uav-duel'
        });
        return;
    }
