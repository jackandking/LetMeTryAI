...
const questionConfig = {
    title: '老师这样带班，孩子会更愿学吗？哪种做法你更认同',
    question: '老师这样带班，孩子会更愿学吗？你更赞同哪种做法？',
    options: [
        { value: 'encourage-small-goals', label: '鼓励与小目标' },
        { value: 'fun-interactive-lessons', label: '趣味互动教学' },
        { value: 'strict-discipline', label: '严格管理型' },
        { value: 'individual-support', label: '个别关注与陪伴' }
    ],
    storageKey: 'laoshi_dai_ban_xing_shi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=laoshi-dai-ban-xing-shi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>老师这样带班，孩子会更愿学吗？哪种做法你更认同结果</h2>';
