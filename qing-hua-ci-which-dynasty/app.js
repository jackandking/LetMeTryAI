...
const questionConfig = {
    title: '挪威海底捞出中国青花瓷，这玩意儿是哪个朝代的？',
    question: '挪威海底捞出中国青花瓷，这玩意儿你觉得是哪个朝代的？',
    options: [
        { value: 'ming-dynasty', label: '明朝' },
        { value: 'qing-dynasty', label: '清朝' },
        { value: 'song-yuan', label: '宋/元（更早）' },
        { value: 'modern-replica', label: '近代仿制/现代复制' }
    ],
    storageKey: 'qing_hua_ci_which_dynasty.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qing-hua-ci-which-dynasty'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>挪威海底捞出中国青花瓷，这玩意儿是哪个朝代的？结果</h2>';
