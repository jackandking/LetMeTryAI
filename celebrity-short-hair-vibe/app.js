...
const questionConfig = {
    title: '明星剪短发后，你更爱哪种气场？惊艳短发还是温柔气质？',
    question: '明星剪短发后，你更爱哪种气场？',
    options: [
        { value: 'bold-chic', label: '率性硬朗' },
        { value: 'soft-feminine', label: '温柔淑女' },
        { value: 'cool-glam', label: '冷艳高冷' },
        { value: 'playful-cute', label: '俏皮可爱' }
    ],
    storageKey: 'celebrity_short_hair_vibe.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=celebrity-short-hair-vibe'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>明星剪短发后，你更爱哪种气场？惊艳短发还是温柔气质？结果</h2>';
