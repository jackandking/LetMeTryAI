...
const questionConfig = {
    title: '爸妈想轻松锻炼，你会推荐哪种？',
    question: '爸妈想轻松锻炼，你会推荐哪种？',
    options: [
        { value: 'morning-walk', label: '早晨健步走' },
        { value: 'chair-exercises', label: '椅子体操' },
        { value: 'tai-chi', label: '太极慢功' },
        { value: 'gardening-housework', label: '园艺/家务活动' }
    ],
    storageKey: 'parents_easy_exercise.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parents-easy-exercise'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爸妈想轻松锻炼，你会推荐哪种？结果</h2>';
