...
const questionConfig = {
    title: '下雨天家里遇到跳闸或有电火花，你会怎么做？',
    question: '下雨天家里遇到跳闸或有电火花，你会怎么做？',
    options: [
        { value: 'cut-main-power-wait', label: '先切断总电源并撤离' },
        { value: 'call-electrician-or-property', label: '马上拨打电工或物业' },
        { value: 'try-reset-breaker', label: '尝试断路器复位观察' },
        { value: 'leave-and-ask-for-help', label: '先把家人带到安全处再求助' }
    ],
    storageKey: 'rainy_day_power_spark.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-day-power-spark'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>下雨天家里遇到跳闸或有电火花，你会怎么做？结果</h2>';
