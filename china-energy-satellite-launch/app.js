...
const questionConfig = {
    title: '中国能源卫星升空，你更想看哪个画面？',
    question: '中国能源卫星升空，你更想看哪个画面？',
    options: [
        { value: 'engine-flame', label: '推进器点火蓝焰' },
        { value: 'solar-array-deploy', label: '太阳能阵列展开' },
        { value: 'night-grid-orbit', label: '卫星俯瞰夜间电网' },
        { value: 'ground-control-cheer', label: '地面指挥与欢呼' }
    ],
    storageKey: 'china_energy_satellite_launch.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=china-energy-satellite-launch'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>中国能源卫星升空，你更想看哪个画面？结果</h2>';
