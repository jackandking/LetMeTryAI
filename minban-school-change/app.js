...
const questionConfig = {
    title: '民办学校换局，你看重哪点？',
    question: '民办学校换局，你看重哪点？',
    options: [
        { value: 'teacher-stability', label: '师资队伍稳定' },
        { value: 'curriculum-quality', label: '教学与课程质量' },
        { value: 'tuition-transparency', label: '学费与资费透明' },
        { value: 'campus-safety', label: '校园管理与安全' }
    ],
    storageKey: 'minban_school_change.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=minban-school-change'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>民办学校换局，你看重哪点？结果</h2>';
