...
const questionConfig = {
    title: '春季护肤步骤，你更认同哪一种？',
    question: '春季护肤时，你更认同哪一种护肤步骤？',
    options: [
        { value: 'simple-three-steps', label: '精简三步' },
        { value: 'layered-care', label: '分层护理' },
        { value: 'on-demand-adjust', label: '按需调整' }
    ],
    storageKey: 'spring_skincare_routine.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-skincare-routine'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季护肤步骤，你更认同哪一种？结果</h2>';
