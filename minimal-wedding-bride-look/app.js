...
const questionConfig = {
    title: '极简婚礼，你会怎么把自己打造成女主角？',
    question: '在极简婚礼，你会怎么把自己打造成女主角？想试哪个造型？',
    options: [
        { value: 'nude-makeup-low-chignon', label: '裸妆低盘发' },
        { value: 'vintage-red-lip-soft-waves', label: '复古红唇卷发' },
        { value: 'minimal-suit-slick-hair', label: '简约西装利落短发' },
        { value: 'floral-crown-natural-waves', label: '花环自然波浪' }
    ],
    storageKey: 'minimal_wedding_bride_look.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=minimal-wedding-bride-look'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>极简婚礼，你会怎么把自己打造成女主角？结果</h2>';
