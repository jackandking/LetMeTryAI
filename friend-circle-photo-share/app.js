...
const questionConfig = {
    title: '朋友圈更新后你如何分享孩子照片？家长分享策略',
    question: '朋友圈更新后你如何分享孩子照片？',
    options: [
        { value: 'private-family-group', label: '只在家庭/亲友群分享' },
        { value: 'public-story-post', label: '在朋友圈公开配成长记录' },
        { value: 'privacy-first-cropped', label: '发但裁剪/只露背影或打码' },
        { value: 'creative-alternative', label: '用作品或创意图代替真实照片' }
    ],
    storageKey: 'friend_circle_photo_share.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=friend-circle-photo-share'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>朋友圈更新后你如何分享孩子照片？家长分享策略结果</h2>';
