...
const questionConfig = {
    title: '孩子看球输球会沮丧，你怎么引导？',
    question: '孩子看球输球会沮丧，你怎么引导？',
    options: [
        { value: 'comfort-validate', label: '先安抚并肯定感觉' },
        { value: 'teach-sportsmanship', label: '引导体育精神+找改进点' },
        { value: 'give-space', label: '给孩子独处时间消化情绪' },
        { value: 'review-and-reframe', label: '看回放/讲趣事把失落转成学习' }
    ],
    storageKey: 'kids_soccer_loss_guidance.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-soccer-loss-guidance'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看球输球会沮丧，你怎么引导？结果</h2>';
