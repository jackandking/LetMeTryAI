...
const questionConfig = {
    title: '五一错峰出游，长者偏好的轻松出行方式',
    question: '五一错峰出游，你或家中长者更倾向哪种轻松出行方式？',
    options: [
        { value: 'nearby-short-drive', label: '近郊短途自驾' },
        { value: 'park-walk-outing', label: '周边步行公园游' },
        { value: 'small-group-guided-tour', label: '小团跟团轻松游' },
        { value: 'community-home-activities', label: '社区居家休闲活动' }
    ],
    storageKey: 'wuyi_elder_relaxed_travel.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wuyi-elder-relaxed-travel'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>五一错峰出游，长者偏好的轻松出行方式结果</h2>';
