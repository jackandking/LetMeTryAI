...
const questionConfig = {
    title: '空气炸锅用纸会有毒吗？你家也在用吗',
    question: '空气炸锅用纸会有毒吗？你家也在用吗',
    options: [
        { value: 'never-use-paper', label: '从不铺纸' },
        { value: 'occasionally-use-paper', label: '偶尔用一次性纸' },
        { value: 'use-food-grade-paper', label: '常用食品级隔油纸' },
        { value: 'use-silicone-mat', label: '用硅胶垫/可重复用' }
    ],
    storageKey: 'air_fryer_paper_safety.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=air-fryer-paper-safety'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>空气炸锅用纸会有毒吗？你家也在用吗结果</h2>';
