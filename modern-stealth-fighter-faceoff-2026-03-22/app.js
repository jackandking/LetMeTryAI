/**
 * 现代隐身战机对比 Survey Application
 * Logic for the "现代隐身战机：谁更占优势？" survey
 */

const questionConfig = {
    "title": "现代隐身战机：谁更占优势？",
    "question": "硬核对比：现代隐身战机，你更看好谁？",
    "options": [
        {
            "value": "j20",
            "label": "歼-20"
    ...
    "storageKey": "modern_stealth_fighter_faceoff_2026_03_22_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-stealth-fighter-faceoff-2026-03-22'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>现代隐身战机对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“现代隐身战机：谁更占优势？”的最新态度</p>";
