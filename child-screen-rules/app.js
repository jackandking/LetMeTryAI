/**
 * 孩子用手机管理 Survey Application
 * Logic for the "孩子用手机，你会怎么规定？" survey
 */

const questionConfig = {
    "title": "孩子用手机，你会怎么规定？",
    "question": "站在家长爱用户视角，你会怎么选：孩子手机使用规则？",
    "options": [
        {
            "value": "no-phone-during-study",
            "label": "学习时间禁止使用"
        },
        {
            "value": "limited-after-homework",
            "label": "作业后限时使用"
        },
        {
            "value": "only-weekends",
        ...
        {
            "value": "parent-supervised-and-graded",
            "label": "家长陪同+分级管理"
        }
    ],
    "storageKey": "child_screen_rules_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-screen-rules'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>孩子用手机管理投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子用手机，你会怎么规定？”的最新态度</p>";
