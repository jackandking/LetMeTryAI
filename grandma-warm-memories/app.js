...
const questionConfig = {
    title: '哪种阿嬷的记忆让你心头一暖？',
    question: '哪种阿嬷的记忆让你心头一暖？',
    options: [
        { value: 'kitchen-home-cooking', label: '厨房的饭菜香' },
        { value: 'old-photo-smile', label: '旧照片里的笑脸' },
        { value: 'handwritten-letters', label: '阿嬷的手写信' },
        { value: 'evening-walks', label: '傍晚一起散步的背影' }
    ],
    storageKey: 'grandma_warm_memories.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandma-warm-memories'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪种阿嬷的记忆让你心头一暖？结果</h2>';
