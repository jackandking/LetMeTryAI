...
const questionConfig = {
    title: "全球火箭大PK：谁是你的太空坐骑？",
    question: "在这些现役主力火箭中，你最信赖哪一款送你上太空？",
    options: [
        { value: "falcon9", label: "SpaceX Falcon 9 (USA)" },
        { value: "delta_iv", label: "ULA Delta IV Heavy (USA)" },
        { value: "ariane5", label: "ESA Ariane 5 (Europe)" },
        { value: "atlas_v", label: "ULA Atlas V (USA)" },
        { value: "soyuz", label: "Roscosmos Soyuz (Russia)" }
    ],
    storageKey: "rockets_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: "/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rockets-king",
        });
        return;
    }
