...
const questionConfig = {
    title: '孩子的安全公开课：哪些技能更实用？揭秘家长常忽略的能力',
    question: '在孩子的安全公开课中，你认为哪类技能对孩子更实用？',
    options: [
        { value: 'traffic-safety', label: '道路与交通自护' },
        { value: 'stranger-safety', label: '陌生人防范与求助' },
        { value: 'fire-escape', label: '居家火灾与紧急撤离' },
        { value: 'digital-privacy', label: '数字安全与隐私保护' }
    ],
    storageKey: 'child_safety_public_class.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-safety-public-class'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子的安全公开课：哪些技能更实用？揭秘家长常忽略的能力结果</h2>';
