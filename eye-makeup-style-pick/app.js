/**
 * 眼妆风格投票 Survey Application
 * Logic for the "最心机的眼妆风格" survey
 */

const questionConfig = {
    "title": "最心机的眼妆风格",
    "question": "你更常画或最想尝试哪种眼妆风格？",
    "options": [
        {
            "value": "natural-daily",
            "label": "自然日常眼妆"
    ...
    "storageKey": "eye_makeup_style_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eye-makeup-style-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>眼妆风格投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“最心机的眼妆风格”的最新态度</p>";
