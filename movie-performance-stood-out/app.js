...
const questionConfig = {
    title: '这部新片里谁的表演更戳你？',
    question: '在这部新片里，你被谁的表演打动？',
    options: [
        { value: 'protagonist-lowkey', label: '主角的低调演绎' },
        { value: 'antagonist-explosive', label: '反派的爆发瞬间' },
        { value: 'supporting-actor-subtle', label: '配角的细腻小戏份' }
    ],
    storageKey: 'movie_performance_stood_out.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-performance-stood-out'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这部新片里谁的表演更戳你？结果</h2>';
