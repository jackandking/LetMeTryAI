...
const questionConfig = {
    title: '春季换季，你的肌肤困扰是什么？',
    question: '春季换季，你的肌肤困扰是什么？',
    options: [
        { value: 'sensitive-redness', label: '敏感泛红' },
        { value: 'dry-flaking', label: '干燥起皮' },
        { value: 'oily-acne', label: '出油冒痘' },
        { value: 'dull-skin', label: '暗沉无光' }
    ],
    storageKey: 'spring_skin_troubles.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-skin-troubles'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季换季，你的肌肤困扰是什么？结果</h2>';
