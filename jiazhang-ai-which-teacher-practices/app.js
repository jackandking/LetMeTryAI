...
const questionConfig = {
    title: '哪些老师做法让你放心？',
    question: '哪些老师做法让你放心？选出你看重的老师行为。',
    options: [
        { value: 'clear-class-goals', label: '讲清课堂目标' },
        { value: 'timely-homework-feedback', label: '作业讲评及时' },
        { value: 'transparent-parent-communication', label: '与家长沟通透明' },
        { value: 'encourage-independent-thinking', label: '鼓励独立思考' }
    ],
    storageKey: 'jiazhang_ai_which_teacher_practices.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jiazhang-ai-which-teacher-practices'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪些老师做法让你放心？结果</h2>';
