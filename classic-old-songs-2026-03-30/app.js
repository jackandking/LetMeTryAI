 ...
 * Logic for the "怀旧：最经典的老歌" survey
 */

const questionConfig = {
    "title": "怀旧：最经典的老歌",
    "question": "亲，你最怀念下面哪首经典老歌？",
    "options": [
        {
            "value": "tian-mi-mi",
            "label": "甜蜜蜜"
    ...
    "storageKey": "classic_old_songs_2026_03_30_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-2026-03-30'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“怀旧：最经典的老歌”的最新态度</p>";
