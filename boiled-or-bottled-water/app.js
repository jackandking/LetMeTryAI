...
const questionConfig = {
    title: '烧水喝还是买桶装水？家里你怎么选，省钱又放心？',
    question: '烧水喝还是买桶装水？家里你怎么选？',
    options: [
        { value: 'boil-water', label: '烧开水喝' },
        { value: 'bottled-water', label: '买桶装水' },
        { value: 'filter-plus-storage', label: '净水器+储水' }
    ],
    storageKey: 'boiled_or_bottled_water.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=boiled-or-bottled-water'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>烧水喝还是买桶装水？家里你怎么选，省钱又放心？结果</h2>';
