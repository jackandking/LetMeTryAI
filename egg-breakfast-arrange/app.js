...
const questionConfig = {
    title: '鸡蛋涨价了，早餐你都怎么安排？',
    question: '鸡蛋涨价了，早餐你都怎么安排？',
    options: [
        { value: 'tofu-substitute', label: '改用豆制品或奶制品替代' },
        { value: 'reduce-egg-plus-veggies', label: '鸡蛋用量减少并搭配蔬菜谷物' },
        { value: 'batch-prep-eggs', label: '周末批量预制蛋类早点' },
        { value: 'no-egg-quickbreakfast', label: '改选无蛋快手早餐或外卖' }
    ],
    storageKey: 'egg_breakfast_arrange.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=egg-breakfast-arrange'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>鸡蛋涨价了，早餐你都怎么安排？结果</h2>';
