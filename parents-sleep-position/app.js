...
const questionConfig = {
    title: '爸妈睡哪种姿势你更放心？仰卧 / 侧卧 / 俯卧哪个画面更安心',
    question: '爸妈睡哪种姿势你更放心？仰卧 / 侧卧 / 俯卧哪个画面更安心',
    options: [
        { value: 'yang-wo', label: '仰卧' },
        { value: 'ce-wo', label: '侧卧' },
        { value: 'fu-wo', label: '俯卧' }
    ],
    storageKey: 'parents_sleep_position.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parents-sleep-position'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爸妈睡哪种姿势你更放心？仰卧 / 侧卧 / 俯卧哪个画面更安心结果</h2>';
