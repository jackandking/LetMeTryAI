/**
 * 腮红之选 Survey Application
 * Logic for the "奶油腮红还是珊瑚腮红？" survey
 */

const questionConfig = {
    "title": "奶油腮红还是珊瑚腮红？",
    "question": "如果是女人爱用户，你会把这一票投给谁：奶油腮红 还是 珊瑚腮红？",
    "options": [
        {
            "value": "creamy-blush",
            "label": "奶油腮红"
    ...
    "storageKey": "creamy_vs_coral_blush_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=creamy-vs-coral-blush'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>腮红之选投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“奶油腮红还是珊瑚腮红？”的最新态度</p>";
