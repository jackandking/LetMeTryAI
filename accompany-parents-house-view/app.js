...
const questionConfig = {
    title: '陪爸妈看房，你更在意哪个细节？',
    question: '陪爸妈看房，你更在意哪个细节？',
    options: [
        { value: 'floor-lighting', label: '楼层与采光' },
        { value: 'nearby-services', label: '交通与配套' },
        { value: 'elevator-accessibility', label: '电梯与无障碍' },
        { value: 'safety-cleanliness', label: '安全与卫生' }
    ],
    storageKey: 'accompany_parents_house_view.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=accompany-parents-house-view'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>陪爸妈看房，你更在意哪个细节？结果</h2>';
