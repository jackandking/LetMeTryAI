...
const questionConfig = {
    title: '孩子班级超80人，爸妈你会怎么应对？',
    question: '孩子班级超80人，爸妈你会怎么应对？',
    options: [
        { value: 'request-split-class', label: '向校方反映、争取分班或增师资' },
        { value: 'keep-and-home-tutoring', label: '接受现状、在家强化学习计划' },
        { value: 'parent-organized-groups', label: '组织家长小组或轮流辅导' },
        { value: 'change-school-or-extra-classes', label: '评估转校或报名小班兴趣班减负' }
    ],
    storageKey: 'kids_class_80_response.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-class-80-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子班级超80人，爸妈你会怎么应对？结果</h2>';
