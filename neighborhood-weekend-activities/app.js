/**
 * 邻里周末活动 Survey Application
 * Logic for the "邻里周末活动你更愿意参加哪类？" survey
 */

const questionConfig = {
    "title": "邻里周末活动你更愿意参加哪类？",
    "question": "亲，你更愿意参加哪类社区周末活动？",
    "options": [
        {
            "value": "neighborhood-volunteer",
            "label": "邻里志愿服务"
        },
        {
            "value": "square-dance-fitness",
            "label": "广场舞或健身活动"
        },
        {
            "value": "crafts-interest-club",
            "label": "手工或兴趣小组"
        },
        {
            "value": "tea-reading-club",
            "label": "邻里茶话会或读书会"
        }
    ],
    "storageKey": "neighborhood_weekend_activities_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=neighborhood-weekend-activities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>邻里周末活动投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“邻里周末活动你更愿意参加哪类？”的最新态度</p>";
