 ...
 * Logic for the "约会你会选哪种香水调性？" survey
 */

const questionConfig = {
    "title": "约会你会选哪种香水调性？",
    "question": "你会把这一票投给谁：约会你会选哪种香水调性？",
    "options": [
        {
            "value": "floral",
            "label": "花香调"
    ...
    "storageKey": "date_perfume_vibe_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=date-perfume-vibe'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“约会你会选哪种香水调性？”的最新态度</p>";
