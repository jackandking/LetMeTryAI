...
const questionConfig = {
    title: '带孩子逛博物馆，你会先看哪件镇馆之宝？',
    question: '带孩子逛博物馆，你会先看哪件镇馆之宝？',
    options: [
        { value: 'terra-cotta-warriors', label: '兵马俑' },
        { value: 'dinosaur-skeleton', label: '恐龙骨架' },
        { value: 'blue-and-white-porcelain', label: '青花瓷' },
        { value: 'imperial-robe', label: '宫廷服饰' }
    ],
    storageKey: 'parent_museum_treasure.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parent-museum-treasure'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子逛博物馆，你会先看哪件镇馆之宝？结果</h2>';
