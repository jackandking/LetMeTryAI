...
const questionConfig = {
    title: '怀旧冰箱贴，你更喜欢哪种款式？',
    question: '怀旧冰箱贴，你更喜欢哪种款式？',
    options: [
        { value: 'retro-movie-poster', label: '老电影海报风' },
        { value: 'sepia-photo-collage', label: '老照片拼贴' },
        { value: 'folk-patterns', label: '传统民俗花纹' },
        { value: 'calligraphy-poem', label: '书法诗词款' }
    ],
    storageKey: 'nostalgic_fridge_magnets.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nostalgic-fridge-magnets'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>怀旧冰箱贴，你更喜欢哪种款式？结果</h2>';
