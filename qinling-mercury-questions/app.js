...
const questionConfig = {
    title: '关于秦陵里水银的事，你想知道哪一点？',
    question: '关于秦陵里水银的事，你想知道哪一点？',
    options: [
        { value: 'why-mercury-in-qin-tomb', label: '为什么会有水银埋进墓里？' },
        { value: 'is-mercury-still-there', label: '水银现在还留在墓里吗？' },
        { value: 'mercury-effect-on-burials', label: '水银会怎样影响陪葬品？' },
        { value: 'how-archaeologists-handle-mercury', label: '考古队如何处理这些水银？' }
    ],
    storageKey: 'qinling_mercury_questions.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qinling-mercury-questions'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>关于秦陵里水银的事，你想知道哪一点？结果</h2>';
