...
const questionConfig = {
    title: '家庭电话与信息安全规则投票：家长守则选择',
    question: '在家庭中，你支持以下哪种家庭电话与信息安全规则？',
    options: [
        { value: 'confirm-caller-before-answer', label: '接听前确认身份' },
        { value: 'text-first-ignore-call', label: '遇陌生先发信息不接听' },
        { value: 'share-emergency-contacts', label: '共享紧急联系人名单' },
        { value: 'keep-call-content-private', label: '通话内容仅家庭内部讨论' }
    ],
    storageKey: 'family_phone_info_safety_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=family-phone-info-safety-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家庭电话与信息安全规则投票：家长守则选择结果</h2>';
