...
const questionConfig = {
    title: 'iPhone降价了，家里会趁机会给孩子换手机吗？',
    question: 'iPhone降价了，家里会趁机会给孩子换手机吗？',
    options: [
        { value: 'buy-new', label: '会，趁机换新的' },
        { value: 'keep-old', label: '不会，继续用现有手机' },
        { value: 'buy-with-rules', label: '会，但有限制' },
        { value: 'buy-alternative', label: '不买新机，改买平板或二手' }
    ],
    storageKey: 'iphone_price_drop_kids_phone.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=iphone-price-drop-kids-phone'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>iPhone降价了，家里会趁机会给孩子换手机吗？结果</h2>';
