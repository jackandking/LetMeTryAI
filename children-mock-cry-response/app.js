...
const questionConfig = {
    title: '孩子模考被压哭了，你会怎么说？哪句更能缓和情绪',
    question: '孩子模考被压哭了，你会怎么说？',
    options: [
        { value: 'empathy-hug', label: '先抱抱并共情' },
        { value: 'praise-effort', label: '肯定努力并鼓励下一步' },
        { value: 'calm-solve', label: '先冷静陪伴再解决' },
        { value: 'let-cry-then-treat', label: '允许发泄并用小奖励结束' }
    ],
    storageKey: 'children_mock_cry_response.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-mock-cry-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子模考被压哭了，你会怎么说？哪句更能缓和情绪结果</h2>';
