/**
 * 春季香水投票 Survey Application
 * Logic for the "女人爱热议：春季日常香调你会选哪款" survey
 */

const questionConfig = {
    "title": "女人爱热议：春季日常香调你会选哪款",
    "question": "你会把这一票投给谁：春季日常香调你更喜欢哪款？",
    "options": [
        {
            "value": "fresh-floral",
            "label": "清新花香"
    ...
    "storageKey": "spring_fragrance_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-fragrance-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>春季香水投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：春季日常香调你会选哪款”的最新态度</p>";
