...
const questionConfig = {
    title: '雨天居家与出行小准备：您平时怎么做？',
    question: '遇到下雨天，您在居家或外出前会优先准备哪一项？',
    options: [
        { value: 'umbrella-non-slip', label: '防风雨伞与防滑鞋' },
        { value: 'warm-dry-clothes', label: '保暖与干衣备用' },
        { value: 'emergency-kit', label: '应急小物与通讯' },
        { value: 'plan-or-delay', label: '提前规划或延后外出' }
    ],
    storageKey: 'rainy_day_prep.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-day-prep'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>雨天居家与出行小准备：您平时怎么做？结果</h2>';
