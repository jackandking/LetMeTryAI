...
const questionConfig = {
    title: '带孩子去博物馆，哪个镇馆之宝能点燃好奇心？',
    question: '带孩子去博物馆，哪个镇馆之宝能点燃好奇心？',
    options: [
        { value: 'dinosaur-skeleton', label: '恐龙化石' },
        { value: 'ancient-porcelain', label: '古代瓷器' },
        { value: 'immersive-space-exhibit', label: '沉浸式宇宙展' },
        { value: 'traditional-instruments', label: '传统乐器' }
    ],
    storageKey: 'museum_treasure_curiosity.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-treasure-curiosity'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去博物馆，哪个镇馆之宝能点燃好奇心？结果</h2>';
