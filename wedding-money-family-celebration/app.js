...
const questionConfig = {
    title: '结婚发钱，带孩子的家庭庆祝你会怎么安排？带娃去热闹还是在家静静庆祝？',
    question: '结婚发钱，带孩子的家庭庆祝你会怎么安排？',
    options: [
        { value: 'bring-kids-to-wedding', label: '带孩子参加婚礼' },
        { value: 'adult-only-with-grandparents', label: '夫妻到场，孩子交给长辈' },
        { value: 'home-parenting-party', label: '留在家办亲子派对' },
        { value: 'quiet-celebration-save-education', label: '低调庆祝并存入教育金' }
    ],
    storageKey: 'wedding_money_family_celebration.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wedding-money-family-celebration'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>结婚发钱，带孩子的家庭庆祝你会怎么安排？带娃去热闹还是在家静静庆祝？结果</h2>';
