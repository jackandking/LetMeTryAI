/**
 * 闺蜜情感榜 Survey Application
 * Logic for the "闺蜜翻脸：你最无法接受哪种行为？" survey
 */

const questionConfig = {
    "title": "闺蜜翻脸：你最无法接受哪种行为？",
    "question": "最容易让闺蜜翻脸的原因是哪一个？",
    "options": [
        {
            "value": "reveal-secret",
            "label": "出卖秘密"
        ...
        {
            "value": "borrow-and-not-return",
            "label": "借钱不还"
        },
        {
            "value": "ambiguous-affair",
            "label": "暧昧插足/优先另一方"
        }
    ],
    "storageKey": "girlfriend_fight_reasons_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=girlfriend-fight-reasons'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>闺蜜情感榜投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“闺蜜翻脸：你最无法接受哪种行为？”的最新态度</p>";
