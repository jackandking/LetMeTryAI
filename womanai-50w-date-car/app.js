...
const questionConfig = {
    title: '50万预算，开哪种车去约会更撩？宝马的稳成熟感还是蔚来的未来感',
    question: '50万预算，开哪种车去约会更撩？宝马的稳成熟感还是蔚来的未来感？',
    options: [
        { value: 'bmw-steady-mature', label: '宝马：稳成熟感' },
        { value: 'nio-future-tech', label: '蔚来：未来科技感' },
        { value: 'sporty-coupe', label: '跑车风：瞬间视觉冲击' }
    ],
    storageKey: 'womanai_50w_date_car.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=womanai-50w-date-car'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>50万预算，开哪种车去约会更撩？宝马的稳成熟感还是蔚来的未来感结果</h2>';
