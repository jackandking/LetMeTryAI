...
const questionConfig = {
    title: '深夜吃面，你更想冲哪家摊那碗拌面？',
    question: '现在深夜路边有四碗拌面，你会先去吃哪一碗？',
    options: [
        { value: 'la-you-ban-mian', label: '辣油拌面' },
        { value: 'hua-sheng-jiang-ban-mian', label: '花生酱拌面' },
        { value: 'suan-cai-ban-mian', label: '酸菜拌面' },
        { value: 'zha-jiang-ban-mian', label: '炸酱拌面' }
    ],
    storageKey: 'night_market_ban_mian.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=night-market-ban-mian'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>深夜吃面，你更想冲哪家摊那碗拌面？结果</h2>';
