...
const questionConfig = {
    title: '28斤榴莲只花300多，你觉得划算吗？',
    question: '看到“28斤榴莲只花300多”，你会如何判断它是否划算？',
    options: [
        { value: 'buy-now', label: '立刻入手' },
        { value: 'wait-and-see', label: '再观望' },
        { value: 'suspect-quality', label: '可能有问题' },
        { value: 'depends-on-variety', label: '看产地与品种' }
    ],
    storageKey: 'durian_28jin_300_deal.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=durian-28jin-300-deal'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>28斤榴莲只花300多，你觉得划算吗？结果</h2>';
