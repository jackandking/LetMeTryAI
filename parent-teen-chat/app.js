/**
 * 青春期沟通小抉择 Survey Application
 * Logic for the "如何跟青春期孩子聊天" survey
 */
...
const questionConfig = {
    ...
    "storageKey": "parent_teen_chat_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parent-teen-chat'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>青春期沟通小抉择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“如何跟青春期孩子聊天”的最新态度</p>";
