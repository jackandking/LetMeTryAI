...
const questionConfig = {
    title: '六代机核心技术方向',
    question: '你更看重六代机的哪项突破？',
    options: [
        { value: 'omnidirectional-stealth', label: '全向隐身' },
        { value: 'hypersonic-cruise', label: '高超音速巡航' },
        { value: 'ai-wingman', label: 'AI无人僚机协同' }
    ],
    storageKey: 'sixth_gen_fighter_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sixth-gen-fighter-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>六代机核心技术方向结果</h2>';
