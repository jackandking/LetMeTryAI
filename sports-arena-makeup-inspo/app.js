...
const questionConfig = {
    title: '赛场运动风妆容灵感：四种对比妆效',
    question: '你更喜欢哪种赛场运动风妆容灵感？',
    options: [
        { value: 'qing-shuang-kong-you-makeup', label: '清爽控油妆' },
        { value: 'huo-li-wen-se-makeup', label: '活力暖色妆' },
        { value: 'chao-ku-street-makeup', label: '潮酷街头妆' },
        { value: 'zi-ran-guang-ze-nude-makeup', label: '自然光泽裸妆' }
    ],
    storageKey: 'sports_arena_makeup_inspo.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sports-arena-makeup-inspo'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>赛场运动风妆容灵感：四种对比妆效结果</h2>';
