...
const questionConfig = {
    title: '手机也能当时髦配饰吗？哪种搭配更带感',
    question: '手机也能当时髦配饰吗？你更喜欢哪种搭配更带感？',
    options: [
        { value: 'bright-chain-case', label: '亮色链条壳' },
        { value: 'mini-bag-phone-chain', label: '精致手机链挂小包' },
        { value: 'mirror-art-case', label: '镜面或艺术壳' },
        { value: 'minimal-nude-jewels', label: '极简裸色配珠宝' }
    ],
    storageKey: 'phone_accessory_vibes.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=phone-accessory-vibes'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>手机也能当时髦配饰吗？哪种搭配更带感结果</h2>';
