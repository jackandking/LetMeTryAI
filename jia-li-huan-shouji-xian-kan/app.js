...
const questionConfig = {
    title: '家里换手机，你先看哪个？',
    question: '家里换手机，你先看哪个？',
    options: [
        { value: 'xiangji-xian-kan', label: '相机' },
        { value: 'xuchang-xian-kan', label: '续航' },
        { value: 'pingmu-xian-kan', label: '屏幕' },
        { value: 'jiage-xian-kan', label: '价位' }
    ],
    storageKey: 'jia_li_huan_shouji_xian_kan.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jia-li-huan-shouji-xian-kan'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里换手机，你先看哪个？结果</h2>';
