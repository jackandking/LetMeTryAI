...
const questionConfig = {
    title: '小时候的教室变成老人活动室，你会去哪个角落坐坐？哪个角落能把你带回当年？',
    question: '小时候的教室变成老人活动室，你会去哪个角落坐坐？',
    options: [
        { value: 'window-desk', label: '靠窗的旧课桌' },
        { value: 'front-teacher-chair', label: '讲台前的老师椅' },
        { value: 'bookcase-nook', label: '书柜旁的阅读角' },
        { value: 'windowledge-playground-view', label: '窗台或操场边' }
    ],
    storageKey: 'classroom_memory_corner.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classroom-memory-corner'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小时候的教室变成老人活动室，你会去哪个角落坐坐？哪个角落能把你带回当年？结果</h2>';
