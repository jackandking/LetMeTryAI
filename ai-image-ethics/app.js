...
const questionConfig = {
    title: 'AI合成影像的使用争议',
    question: '面对AI合成影像在影视与短视频中的广泛使用，你更倾向哪种观点？',
    options: [
        { value: 'support-regulated-use', label: '支持规范化使用' },
        { value: 'concern-privacy-copyright', label: '担忧隐私与版权风险' },
        { value: 'platform-labeling-review', label: '希望平台加强标注与审核' }
    ],
    storageKey: 'ai_image_ethics.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-image-ethics'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI合成影像的使用争议结果</h2>';
