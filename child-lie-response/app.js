/**
 * 家长话题 Survey Application
 * Logic for the "家长话题：孩子说谎时你会怎么处理？" survey
 */

const questionConfig = {
    "title": "家长话题：孩子说谎时你会怎么处理？",
    "question": "站在家长视角，你会怎么选：孩子说谎时你会怎么处理？",
    "options": [
        {
            "value": "ask-and-encourage",
            "label": "温和询问并鼓励说实话"
        },
        {
            "value": "scold-and-consequence",
            "label": "严肃批评并设置后果"
        },
        {
            "value": "guide-reflect",
        ...
        {
            "value": "timeout-then-talk",
            "label": "先冷静，过后再平和沟通"
        }
    ],
    "storageKey": "child_lie_response_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-lie-response'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长话题投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子说谎时你会怎么处理？”的最新态度</p>";
