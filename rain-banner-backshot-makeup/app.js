...
const questionConfig = {
    title: '遇到巨幕雨幡的天空，你会选哪种妆拍背影照？',
    question: '遇到巨幕雨幡的天空，你会选哪种妆拍背影照？',
    options: [
        { value: 'soft-glow-romantic', label: '柔光浪漫' },
        { value: 'neon-glam', label: '霓虹潮流' },
        { value: 'smoky-modern', label: '烟熏摩登' },
        { value: 'natural-no-makeup', label: '自然裸妆' }
    ],
    storageKey: 'rain_banner_backshot_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rain-banner-backshot-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>遇到巨幕雨幡的天空，你会选哪种妆拍背影照？结果</h2>';
