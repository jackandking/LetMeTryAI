...
const questionConfig = {
    title: 'C罗新造型亮相，哪个细节更吸睛？',
    question: 'C罗新造型亮相，哪个细节更吸睛？',
    options: [
        { value: 'hairstyle-change', label: '发型变化' },
        { value: 'beard-style', label: '胡须风格' },
        { value: 'accessories-detail', label: '耳饰/配饰' },
        { value: 'outfit-footwear', label: '服装/鞋履' }
    ],
    storageKey: 'cristiano_ronaldo_new_look_detail.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cristiano-ronaldo-new-look-detail'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>C罗新造型亮相，哪个细节更吸睛？结果</h2>';
