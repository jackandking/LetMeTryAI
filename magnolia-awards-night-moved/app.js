...
const questionConfig = {
    title: '白玉兰颁奖夜，谁的获奖瞬间更打动你？',
    question: '白玉兰颁奖夜，谁的获奖瞬间更打动你？',
    options: [
        { value: 'veteran-actor-tearful', label: '厚积薄发的实力派' },
        { value: 'newcomer-breakthrough', label: '逆袭突围的新生代' },
        { value: 'behind-scenes-creator', label: '幕后创作者的荣光' },
        { value: 'cast-reunion-honor', label: '同台致敬的温情时刻' }
    ],
    storageKey: 'magnolia_awards_night_moved.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=magnolia-awards-night-moved'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>白玉兰颁奖夜，谁的获奖瞬间更打动你？结果</h2>';
