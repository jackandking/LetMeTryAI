 ...
 * Logic for the "女人爱热议：恋爱中最不能忍的行为" survey
 */

const questionConfig = {
    "title": "女人爱热议：恋爱中最不能忍的行为",
    "question": "你会把这一票投给谁：恋爱中最不能忍的行为？",
    "options": [
        {
            "value": "lying-and-secrecy",
            "label": "说谎或隐瞒重要信息"
        },
        {
            "value": "long-term-cold-violence",
            "label": "长期冷暴力/忽视感受"
        },
        {
            "value": "disrespect-family-friends",
            "label": "不尊重家人或朋友"
        },
        {
            "value": "cheating-betrayal",
            "label": "出轨或背叛信任"
        }
    ],
    "storageKey": "love_dealbreakers_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-dealbreakers'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：恋爱中最不能忍的行为”的最新态度</p>";
