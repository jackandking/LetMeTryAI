...
const questionConfig = {
    title: '晚上出门你更担心哪种情况?',
    question: '晚上出门你最担心下面哪种情况?',
    options: [
        { value: 'phone-theft', label: '手机被盗/遭小偷' },
        { value: 'dark-street', label: '夜路光线暗' },
        { value: 'stranger-approach', label: '被陌生人搭讪' },
        { value: 'transport-delay', label: '交通工具临时晚点' }
    ],
    storageKey: 'night_out_concerns.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=night-out-concerns'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>晚上出门你更担心哪种情况?结果</h2>';
