...
const questionConfig = {
    title: '孩子要不要学AI？哪种起步方式更靠谱？',
    question: '孩子要不要学AI？哪种起步方式你更倾向在家里先试试？',
    options: [
        { value: 'block-based-programming', label: '图形化编程入门' },
        { value: 'chatgpt-and-prompting', label: '跟工具学（ChatGPT/AI助手）' },
        { value: 'robot-and-projects', label: '项目驱动＋机器人玩具' },
        { value: 'math-and-logical-thinking', label: '逻辑思维与数学基础' }
    ],
    storageKey: 'kids_learn_ai_start_methods.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-learn-ai-start-methods'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子要不要学AI？哪种起步方式更靠谱？结果</h2>';
