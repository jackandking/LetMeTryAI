...
const questionConfig = {
    title: '张雪赛后造型投票：你更喜欢哪套造型？',
    question: '在赛后发布会中，哪套张雪的造型更吸引你？',
    options: [
        { value: 'qingxin-yundong', label: '清新运动风' },
        { value: 'youya-hongtan', label: '优雅红毯风' },
        { value: 'ziran-changfa', label: '自然长发浪漫风' },
        { value: 'ganlian-duanfafu', label: '干练短发利落风' }
    ],
    storageKey: 'zhang_xue_saihou_zaoxing_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-xue-saihou-zaoxing-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张雪赛后造型投票：你更喜欢哪套造型？结果</h2>';
