...
const questionConfig = {
    title: '春季轻透底妆大比拼',
    question: '春天出门你更偏好哪种底妆风格？',
    options: [
        { value: 'dewy-glow', label: '轻薄水光底妆' },
        { value: 'natural-coverage', label: '自然无瑕妆感' },
        { value: 'matte-longlasting', label: '持久哑光控油' }
    ],
    storageKey: 'spring_dewy_foundation.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-dewy-foundation'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季轻透底妆大比拼结果</h2>';
