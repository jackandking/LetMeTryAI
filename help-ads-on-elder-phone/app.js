...
const questionConfig = {
    title: '家里老人手机老弹广告你会怎么帮？',
    question: '家里老人手机老弹广告你会怎么帮？',
    options: [
        { value: 'remote-setup', label: '远程代设' },
        { value: 'hand-holding-teach', label: '手把手教' },
        { value: 'install-ad-blocker', label: '装广告拦截' },
        { value: 'switch-senior-phone', label: '换简洁机/接管' }
    ],
    storageKey: 'help_ads_on_elder_phone.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=help-ads-on-elder-phone'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里老人手机老弹广告你会怎么帮？结果</h2>';
