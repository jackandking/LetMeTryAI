/**
 * 90后童年零食排行 Survey Application
 * Logic for the "90后童年零食排行 — 哪款让你瞬间回到童年？" survey
 */

const questionConfig = {
    "title": "90后童年零食排行 — 哪款让你瞬间回到童年？",
    "question": "作为90后男生，你最怀念下面哪款童年零食？把票投给唤起回忆的一款吧！",
    "options": [
        {
            "value": "bai-tu-nai-tang",
            "label": "白兔奶糖（入口奶香、经典拉丝）"
        },
        {
            "value": "wang-zai-xiao-man-tou",
            "label": "旺仔小馒头（酥脆小点心，嘴停不下）"
        },
        {
            "value": "tiao-tiao-tang",
            "label": "跳跳糖（舌尖爆裂的惊喜）"
        },
        {
            "value": "la-tiao",
            "label": "辣条（记忆中的辣味零食，记忆点强）"
        }
    ],
    "storageKey": "90hou_tongnian_lingshi_paihang_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=90hou-tongnian-lingshi-paihang'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>90后童年零食排行投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“90后童年零食排行 — 哪款让你瞬间回到童年？”的最新态度</p>";
