...
const questionConfig = {
    title: '带孩子去天坛，哪个画面更能吸引他？',
    question: '带孩子去天坛，哪个画面更能吸引他？',
    options: [
        { value: 'qinian-hall-running', label: '祈年殿前奔跑玩耍' },
        { value: 'echo-wall-play', label: '回音墙喊话玩回声' },
        { value: 'carving-closeup-explore', label: '檐角彩绘与石狮特写' },
        { value: 'lawn-kite-picnic', label: '草坪放风筝与亲子野餐' }
    ],
    storageKey: 'tian_tan_scene_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tian-tan-scene-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去天坛，哪个画面更能吸引他？结果</h2>';
