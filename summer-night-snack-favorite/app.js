...
const questionConfig = {
    ...
    question: '夏天夜宵吃什么才够爽？',
    options: [
        { value: 'crayfish-beer', label: '小龙虾+啤酒' },
        { value: 'bbq-skewers', label: '烧烤撸串' },
        { value: 'spicy-hotpot', label: '麻辣火锅' },
        { value: 'iced-watermelon', label: '冰镇西瓜' }
    ],
    storageKey: 'summer_night_snack_favorite.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-night-snack-favorite'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天夜宵吃什么才够爽结果</h2>';
