/**
 * 健康晨练投票 Survey Application
 * Logic for the "老人晨练方式：你更喜欢哪一种？" survey
 */

const questionConfig = {
    "title": "老人晨练方式：你更喜欢哪一种？",
    "question": "早晨起床后，你最常做/最想尝试的晨练方式是？",
    "options": [
        {
            "value": "park-walking",
            "label": "公园散步慢走"
        ...
        {
            "value": "tai-chi-qigong",
            "label": "太极或气功"
        },
        {
            "value": "home-stretch-exercise",
            "label": "家中拉伸/健身操"
        },
        {
            "value": "breathing-meditation",
            "label": "静坐呼吸/柔和冥想"
        }
    ],
    "storageKey": "morning_exercise_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=morning-exercise-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>健康晨练投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“老人晨练方式：你更喜欢哪一种？”的最新态度</p>";
