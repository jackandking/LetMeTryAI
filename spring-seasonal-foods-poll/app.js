/**
 * 春季应季菜投票 Survey Application
 * Logic for the "春季应季食物你最常吃哪类？" survey
 */

const questionConfig = {
    "title": "春季应季食物你最常吃哪类？",
    "question": "亲，你最支持哪类春季应季食物？",
    "options": [
        {
            "value": "seasonal-vegetables",
            "label": "seasonal-vegetables"
        },
        {
            "value": "seasonal-fruits",
        ...
        {
            "value": "grain-porridge",
            "label": "grain-porridge"
        }
    ],
    "storageKey": "spring_seasonal_foods_poll_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-seasonal-foods-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>春季应季菜投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“春季应季食物你最常吃哪类？”的最新态度</p>";
