...
const questionConfig = {
    title: '今晚巴西踢日本，你看好谁先进球？',
    question: '你看好今晚谁先进球？',
    options: [
        { value: 'brazil-strikes-first', label: '桑巴军团先进球' },
        { value: 'japan-strikes-first', label: '蓝武士先进球' },
        { value: 'second-half-goal', label: '下半场才见分晓' }
    ],
    storageKey: 'brazil_vs_japan_first_goal.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=brazil-vs-japan-first-goal'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>今晚巴西踢日本，你看好谁先进球？结果</h2>';
