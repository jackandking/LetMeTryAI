 ...
 * Logic for the "装备党首选：跑车声浪对比" survey
 */

const questionConfig = {
    "title": "装备党首选：跑车声浪对比",
    "question": "听声辨车，你更青睐哪种跑车的声浪质感？",
    "options": [
        {
            "value": "ferrari-488",
            "label": "Ferrari 488"
    ...
    "storageKey": "supercar_exhaust_showdown_2026_03_27_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supercar-exhaust-showdown-2026-03-27'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“装备党首选：跑车声浪对比”的最新态度</p>";
