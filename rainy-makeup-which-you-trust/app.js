...
const questionConfig = {
    title: '雨天出门，哪种妆你更放心？',
    question: '雨天出门，哪种妆你更放心？',
    options: [
        { value: 'waterproof-high-coverage', label: '防水持妆·高遮瑕' },
        { value: 'natural-sheer', label: '自然薄透·轻妆感' },
        { value: 'no-makeup-waterproof-mascara', label: '清新无妆感·防水睫毛' },
        { value: 'matte-longwear-lip', label: '口红焦点·哑光持色' }
    ],
    storageKey: 'rainy_makeup_which_you_trust.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-makeup-which-you-trust'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>雨天出门，哪种妆你更放心？结果</h2>';
