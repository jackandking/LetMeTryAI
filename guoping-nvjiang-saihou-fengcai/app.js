...
const questionConfig = {
    title: '国乒女将赛后风采投票：你更中意哪种赛后气质？',
    question: '国乒女将赛后风采投票：你更中意哪种赛后气质？',
    options: [
        { value: 'ganlian-liluo', label: '干练利落' },
        { value: 'wenwan-xiaorong', label: '温婉笑容' },
        { value: 'lengjing-zhuanzhu', label: '冷静专注' },
        { value: 'qingchun-huoli', label: '青春活力' }
    ],
    storageKey: 'guoping_nvjiang_saihou_fengcai.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guoping-nvjiang-saihou-fengcai'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国乒女将赛后风采投票：你更中意哪种赛后气质？结果</h2>';
