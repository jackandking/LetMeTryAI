...
const questionConfig = {
    title: '这些流失文物“回家”，哪件适合先带孩子认识？',
    question: '这些流失文物“回家”，哪件适合先带孩子认识？',
    options: [
        { value: 'yuanmingyuan-horse-head', label: '圆明园马首' },
        { value: 'min-fanglei', label: '皿方罍' },
        { value: 'tianlongshan-buddha-head', label: '天龙山石窟佛首' },
        { value: 'zeng-bokefu-bronzes', label: '曾伯克父青铜组器' }
    ],
    storageKey: 'lost_relics_home.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=lost-relics-home'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这些流失文物“回家”，哪件适合先带孩子认识？结果</h2>';
