...
const questionConfig = {
    title: '明星年纪差里，你被哪种气质惊艳到？',
    question: '明星年纪差里，你被哪种气质惊艳到？',
    options: [
        { value: 'qingchun-qingtou', label: '青春清透' },
        { value: 'chengshu-zhixing', label: '成熟知性' },
        { value: 'fanchai-keai', label: '反差可爱' },
        { value: 'lengyan-gaoji', label: '冷艳高级' }
    ],
    storageKey: 'mingxing_nianji_cha_qizhi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mingxing-nianji-cha-qizhi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>明星年纪差里，你被哪种气质惊艳到？结果</h2>';
