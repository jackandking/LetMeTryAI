/**
 * 买菜省钱投票 Survey Application
 * Logic for the "买菜省钱，哪招最实用？" survey
 */

const questionConfig = {
    "title": "买菜省钱，哪招最实用？",
    "question": "亲，你最支持哪个选项：买菜省钱小妙招？",
    "options": [
        {
            "value": "seasonal-produce",
            "label": "买当季食材更便宜"
        },
        {
            "value": "off-peak-market",
            "label": "错峰去菜市场避高峰"
        },
        {
            "value": "group-buying",
    ...
    "storageKey": "buy_vegetable_saving_tips_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=buy-vegetable-saving-tips'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>买菜省钱投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“买菜省钱，哪招最实用？”的最新态度</p>";
