/**
 * 香水种草投票 Survey Application
 * Logic for the "女人爱热议：香水入门推荐（轻香易上手）" survey
 */

const questionConfig = {
    "title": "女人爱热议：香水入门推荐（轻香易上手）",
    "question": "你会把这一票投给谁：香水入门推荐？",
    "options": [
        {
            "value": "floral-fresh",
            "label": "花香清新款"
    ...
    "storageKey": "perfume_beginner_recommendations_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=perfume-beginner-recommendations'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>香水种草投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：香水入门推荐（轻香易上手）”的最新态度</p>";
