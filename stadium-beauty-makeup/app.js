...
const questionConfig = {
    title: '看球时你被哪种球场美人妆惊艳到？背影杀还是烟熏猫眼？',
    question: '看球时你被哪种球场美人妆惊艳到？',
    options: [
        { value: 'natural-dewy', label: '自然清透' },
        { value: 'highlight-backshot', label: '高光背影杀' },
        { value: 'smoky-cat-eye', label: '烟熏猫眼' },
        { value: 'glitter-stadium', label: '亮片闪耀' }
    ],
    storageKey: 'stadium_beauty_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=stadium-beauty-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看球时你被哪种球场美人妆惊艳到？背影杀还是烟熏猫眼？结果</h2>';
