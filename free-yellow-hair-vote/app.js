...
const questionConfig = {
    ...
    question: '免费染黄毛，你敢试吗？',
    options: [
        { value: 'free-go', label: '敢，免费冲' },
        { value: 'skin-tone-check', label: '先测肤色' },
        { value: 'bleach-only', label: '只漂不染' },
        { value: 'pass-damage', label: '不了伤发' }
    ],
    storageKey: 'free_yellow_hair_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=free-yellow-hair-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>免费染黄毛你敢试吗？结果</h2>';
