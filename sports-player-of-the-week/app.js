/**
 * 球星排行 Survey Application
 * Logic for the "男人宝热榜：本周谁是球场之王？" survey
 */

const questionConfig = {
    "title": "男人宝热榜：本周谁是球场之王？",
    "question": "站在男人宝用户视角，你更想把票投给谁：本周谁是球场之王？",
    "options": [
        {
            "value": "super-scorer-a",
            "label": "超级得分手 A"
        },
        {
            "value": "allround-playmaker-b",
            "label": "全能组织者 B"
        },
        {
            "value": "defensive-anchor-c",
            "label": "防守悍将 C"
        }
    ],
    "storageKey": "sports_player_of_the_week_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sports-player-of-the-week'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>球星排行投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：本周谁是球场之王？”的最新态度</p>";
