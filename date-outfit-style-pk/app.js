/**
 * 女人爱 Survey Application
 * Logic for the "女人爱热议：约会穿搭风格PK" survey
 */

const questionConfig = {
    "title": "女人爱热议：约会穿搭风格PK",
    "question": "你会把这一票投给谁：约会穿搭风格PK？",
    "options": [
        {
            "value": "korean-style",
            "label": "温柔韩系"
    ...
    "storageKey": "date_outfit_style_pk_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=date-outfit-style-pk'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>女人爱投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：约会穿搭风格PK”的最新态度</p>";
