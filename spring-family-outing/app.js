...
const questionConfig = {
    title: '春天适合带娃的户外活动',
    question: '这个春天，你更想带娃体验哪种户外活动？',
    options: [
        { value: 'park-picnic', label: '公园野餐' },
        { value: 'hiking-trail', label: '郊野徒步' },
        { value: 'family-cycling', label: '亲子骑行' }
    ],
    storageKey: 'spring_family_outing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-family-outing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春天适合带娃的户外活动结果</h2>';
