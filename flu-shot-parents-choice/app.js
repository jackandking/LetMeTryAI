...
const questionConfig = {
    title: '今年秋冬给爸妈打流感针，你会怎么选？',
    question: '今年秋冬给爸妈打流感针，你会怎么选？',
    options: [
        { value: 'accompany-and-book', label: '我帮爸妈预约并陪同接种' },
        { value: 'remind-and-respect', label: '让爸妈自己决定，我只提醒' },
        { value: 'postpone-until-stable', label: '等身体状态更稳再打 / 暂时推迟' },
        { value: 'doctor-recommendation-only', label: '只在医生建议下才接种' }
    ],
    storageKey: 'flu_shot_parents_choice.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flu-shot-parents-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>今年秋冬给爸妈打流感针，你会怎么选？结果</h2>';
