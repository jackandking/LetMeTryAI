...
const questionConfig = {
    title: '电车后视镜维修费，你怎么看？',
    question: '面对电车后视镜维修费，你会怎么做？',
    options: [
        { value: 'pay-original', label: '自己付费修原厂' },
        { value: 'claim-insurance', label: '先走保险或找厂家处理' },
        { value: 'third-party-repair', label: '路边或第三方便宜修' },
        { value: 'delay-or-diy-repair', label: '暂时不修/自己临时替代' }
    ],
    storageKey: 'rearview_mirror_fee.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rearview-mirror-fee'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>电车后视镜维修费，你怎么看？结果</h2>';
