/**
 * 现代战舰对决 Survey Application
 * Logic for the "近海驱逐舰对决 — 火力、雷达、防空谁更强？" survey
 */

const questionConfig = {
    "title": "近海驱逐舰对决 — 火力、雷达、防空谁更强？",
    "question": "站在男人宝用户视角，你更看好哪艘驱逐舰承担远洋护航任务？",
    "options": [
        {
            "value": "type-055",
            "label": "Type 055（综合火力）"
        ...
        {
            "value": "arleigh-burke-flight-iii",
            "label": "Arleigh Burke Flight III（美）"
        },
        {
            "value": "daring-class",
            "label": "Daring-class（英）"
        }
    ],
    "storageKey": "surface_warship_duel_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=surface-warship-duel'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>现代战舰对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“近海驱逐舰对决 — 火力、雷达、防空谁更强？”的最新态度</p>";
