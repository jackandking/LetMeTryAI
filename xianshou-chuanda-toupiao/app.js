/**
 * 显瘦穿搭投票 Survey Application
 * Logic for the "显瘦穿搭投票 — 选出最显瘦的一套" survey
 */

const questionConfig = {
    "title": "显瘦穿搭投票 — 选出最显瘦的一套",
    "question": "显瘦穿搭投票：哪一种搭配最显瘦、最实用？",
    "options": [
        {
            "value": "high-waist-straight-jeans-short-boots",
            "label": "高腰直筒牛仔＋短靴拉长腿型"
        },
        {
            "value": "a-line-midi-skirt-waist-cincher-top",
            "label": "A字中长裙＋收腰上衣显腰线"
        },
        {
            "value": "monochrome-layering-long-coat",
            "label": "同色系叠穿＋长款外套纵向拉伸"
        },
        {
            "value": "v-neck-top-vertical-stripes",
            "label": "V领上衣＋竖条纹单品显瘦上身"
        }
    ],
    "storageKey": "xianshou_chuanda_toupiao_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xianshou-chuanda-toupiao'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>显瘦穿搭投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“显瘦穿搭投票 — 选出最显瘦的一套”的最新态度</p>";
