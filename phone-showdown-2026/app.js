...
const questionConfig = {
    title: '手机对比：iPhone 与安卓旗舰',
    question: '如果要换手机，你会选择哪一类？',
    options: [
        { value: 'iphone-2026', label: 'iPhone 系列' },
        { value: 'android-flagship', label: '安卓旗舰' },
        { value: 'wait-and-see', label: '再等等 / 观望' }
    ],
    storageKey: 'phone_showdown_2026.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=phone-showdown-2026'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>手机对比：iPhone 与安卓旗舰结果</h2>';
