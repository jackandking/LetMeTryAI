...
const questionConfig = {
    title: '夏日露肩穿搭你更想尝试哪种风格？',
    question: '夏天想试露肩穿搭，你更偏好哪种风格？',
    options: [
        { value: 'off-shoulder', label: '一字领（优雅）' },
        { value: 'one-shoulder', label: '单肩不对称' },
        { value: 'ruffle-shoulder', label: '露肩荷叶边' },
        { value: 'strapless', label: '抹胸/无肩带' }
    ],
    storageKey: 'summer_shoulder_styles.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-shoulder-styles'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏日露肩穿搭你更想尝试哪种风格？结果</h2>';
