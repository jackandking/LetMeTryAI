...
const questionConfig = {
    ...
    question: '你刷到AI脸时，真实反应是？',
    options: [
        { value: 'already-annoyed', label: '已经厌烦' },
        { value: 'slightly-awkward', label: '有点别扭' },
        { value: 'dont-care', label: '无所谓' },
        { value: 'actually-like', label: '还挺喜欢' }
    ],
    storageKey: 'ai_face_aversion_check.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-face-aversion-check'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你对AI脸产生生理性厌恶了吗？结果</h2>';
