...
const questionConfig = {
    title: '陈妤颉夺冠那刻，你被哪个瞬间击中了？',
    question: '陈妤颉夺冠那刻，你被哪个瞬间击中了？',
    options: [
        { value: 'tear-eyed-glance', label: '泪目神情' },
        { value: 'radiant-smile', label: '灿烂笑颜' },
        { value: 'steadfast-gaze', label: '坚定回望' },
        { value: 'fist-pump', label: '台上庆祝姿态' }
    ],
    storageKey: 'chen_yuxie_victory_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=chen-yuxie-victory-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>陈妤颉夺冠那刻，你被哪个瞬间击中了？结果</h2>';
