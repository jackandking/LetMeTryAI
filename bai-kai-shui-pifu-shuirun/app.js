...
const questionConfig = {
    title: '多喝白开水能让皮肤看起来更水润吗？你平时怎么喝水？',
    question: '多喝白开水能让皮肤看起来更水润吗？你平时怎么喝水？',
    options: [
        { value: 'daily-timed-water', label: '每天定时喝足' },
        { value: 'only-when-thirsty', label: '渴了才喝' },
        { value: 'prefer-drinks', label: '常喝果茶或饮料' },
        { value: 'night-heavy-morning-light', label: '白天少晚上多' }
    ],
    storageKey: 'bai_kai_shui_pifu_shuirun.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=bai-kai-shui-pifu-shuirun'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>多喝白开水能让皮肤看起来更水润吗？你平时怎么喝水？结果</h2>';
