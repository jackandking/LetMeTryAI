...
const questionConfig = {
    title: '理科班毕业照妆容风格投票：你会选哪种风格？',
    question: '哪种妆容风格更适合理科班的毕业照？',
    options: [
        { value: 'natural-fresh', label: '自然清新' },
        { value: 'preppy-academic', label: '学院风' },
        { value: 'korean-dewy', label: '韩系光感' },
        { value: 'vintage-arty', label: '复古文艺' }
    ],
    storageKey: 'rike_graduation_makeup_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rike-graduation-makeup-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>理科班毕业照妆容风格投票：你会选哪种风格？结果</h2>';
