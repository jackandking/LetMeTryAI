...
const questionConfig = {
    title: '国产电动车，你会买哪款上班通勤？',
    question: '上班通勤你会更看重哪款车的综合体验？',
    options: [
        { value: 'byd-seal', label: '比亚迪 海豹' },
        { value: 'tesla-model-3', label: '特斯拉 Model 3' },
        { value: 'nio-es6', label: '蔚来 ES6' }
    ],
    storageKey: 'guochan_ev_buy.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guochan-ev-buy'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产电动车，你会买哪款上班通勤？结果</h2>';
