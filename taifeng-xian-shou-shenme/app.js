...
const questionConfig = {
    title: '台风天你家先收哪样？',
    question: '台风天来临，你家会先把哪样收进屋里或固定好？',
    options: [
        { value: 'potted-plants', label: '花盆与盆栽' },
        { value: 'drying-laundry', label: '晾晒中的衣物/被子' },
        { value: 'balcony-furniture', label: '阳台小家具与杂物' },
        { value: 'bicycles-e-bikes', label: '自行车 / 电动车' }
    ],
    storageKey: 'taifeng_xian_shou_shenme.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-xian-shou-shenme'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天你家先收哪样？结果</h2>';
