...
const questionConfig = {
    title: '去天坛拍照，你更想哪个古风画面？',
    question: '去天坛拍照，你更想哪个古风画面？',
    options: [
        { value: 'gong-ting-shinv-bei-ying', label: '宫廷仕女背影' },
        { value: 'yan-xia-xie-yang-wu-qun', label: '檐下斜阳舞裙' },
        { value: 'chang-lang-dui-ying-ping-lan', label: '长廊对影凭栏' },
        { value: 'qi-nian-dian-qian-jing-zuo', label: '祈年殿前静坐' }
    ],
    storageKey: 'tian_tan_gu_feng_photo.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tian-tan-gu-feng-photo'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>去天坛拍照，你更想哪个古风画面？结果</h2>';
