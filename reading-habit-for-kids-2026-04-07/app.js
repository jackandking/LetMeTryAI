/**
 * 家长话题：阅读习惯 Survey Application
 * Logic for the "孩子每天读书，你支持哪种方式？" survey
 */

const questionConfig = {
    "title": "孩子每天读书，你支持哪种方式？",
    "question": "站在家长视角，你会怎么选：如何帮孩子养成每天读书的习惯？",
    "options": [
        {
            "value": "fixed-reading-time",
            "label": "固定时间一起读（每天15分钟）"
        },
        {
            "value": "reading-stamp-reward",
            "label": "读书打卡+小奖励"
        },
        {
            "value": "parent-read-15-min",
            "label": "父母陪读15分钟（陪读优先）"
        },
        {
            "value": "child-choice-share",
            "label": "让孩子自由选书并分享读后感"
        }
    ],
    "storageKey": "reading_habit_for_kids_2026_04_07_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=reading-habit-for-kids-2026-04-07'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长话题：阅读习惯投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子每天读书，你支持哪种方式？”的最新态度</p>";
