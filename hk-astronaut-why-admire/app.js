...
const questionConfig = {
    title: '她为何能成为来自香港的航天员，你佩服哪点？',
    question: '她为何能成为来自香港的航天员，你佩服哪点？',
    options: [
        { value: 'unyielding-perseverance', label: '坚韧毅力' },
        { value: 'strong-science-background', label: '专业科研背景' },
        { value: 'adventurous-spirit', label: '勇于挑战' },
        { value: 'symbolic-representative', label: '代表香港的象征' }
    ],
    storageKey: 'hk_astronaut_why_admire.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hk-astronaut-why-admire'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>她为何能成为来自香港的航天员，你佩服哪点？结果</h2>';
