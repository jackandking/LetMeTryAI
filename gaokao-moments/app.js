...
const questionConfig = {
    title: '高考现场那些瞬间，你遇过哪一条？',
    question: '高考现场那些瞬间，你遇过哪一条？',
    options: [
        { value: 'forgot-admission-ticket', label: '忘带准考证' },
        { value: 'power-out-or-equipment-fail', label: '考场突然停电或设备故障' },
        { value: 'desk-cheating-caught', label: '同桌被监考发现作弊' },
        { value: 'fill-wrong-subject-or-miss-mark', label: '答题卡写错科目或漏涂' }
    ],
    storageKey: 'gaokao_moments.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gaokao-moments'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高考现场那些瞬间，你遇过哪一条？结果</h2>';
