 ...
 * Logic for the "硬核对比：现代战机谁更强？" survey
 */

const questionConfig = {
    "title": "硬核对比：现代战机谁更强？",
    "question": "作为硬核玩家，你更认可哪款现代战机的综合作战力？",
    "options": [
        {
            "value": "f-22-raptor",
            "label": "F-22 Raptor"
    ...
    "storageKey": "modern_fighter_faceoff_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-fighter-faceoff'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代战机谁更强？”的最新态度</p>";
