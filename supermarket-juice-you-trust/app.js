...
const questionConfig = {
    title: '超市果汁你更信哪种？瓶装、现打、浓缩还是果味饮料？',
    question: '超市果汁你更信哪种？选出你平时更放心买的类型：',
    options: [
        { value: 'bottled-pure-juice', label: '瓶装纯果汁' },
        { value: 'concentrate-reconstituted', label: '浓缩还原果汁' },
        { value: 'fresh-made-juice', label: '超市现打/现做' },
        { value: 'fruit-flavored-drink', label: '果味饮料/加糖' }
    ],
    storageKey: 'supermarket_juice_you_trust.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=supermarket-juice-you-trust'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>超市果汁你更信哪种？瓶装、现打、浓缩还是果味饮料？结果</h2>';
