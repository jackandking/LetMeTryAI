/**
 * China Women Pingpong GOAT Survey
 */
const questionConfig = {
    "title": "谁是中国女乒历史第一人？",
    "question": "世乒赛国乒女团刚夺7连冠！如果只能选一位，谁是你心中的中国女乒历史一姐？",
    "options": [
        { "value": "deng-yaping", "label": "邓亚萍" },
        { "value": "wang-nan", "label": "王楠" },
        { "value": "zhang-yining", "label": "张怡宁" },
        { "value": "sun-yingsha", "label": "孙颖莎" }
    ],
    "storageKey": "china_women_pingpong_goat_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({ url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=china-women-pingpong-goat' });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    if (!resultDiv) return;
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#c0392b;'>女乒历史一姐投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对\"谁是中国女乒历史第一人？\"的最新态度</p>";
