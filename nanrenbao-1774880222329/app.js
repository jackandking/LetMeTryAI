/**
 * 中国四大名著哪部最好看 Survey Application
 * Logic for the "中国四大名著哪部最好看" survey
 */

const questionConfig = {
    "title": "中国四大名著哪部最好看",
    "question": "你认为：中国四大名著哪部最好看？",
    "options": [
        {
            "value": "1",
            "label": "选项1"
    ...
    "storageKey": "nanrenbao_1774880222329_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=nanrenbao-1774880222329'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>中国四大名著哪部最好看投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“中国四大名著哪部最好看”的最新态度</p>";
