/**
 * 早餐选择投票 Survey Application
 * Logic for the "爱老人关注：你更推荐哪种早餐给爸妈/长辈？" survey
 */

const questionConfig = {
    "title": "爱老人关注：你更推荐哪种早餐给爸妈/长辈？",
    "question": "如果是爱老人用户，你最支持哪个选项：最适合老年人的早餐首选？",
    "options": [
        {
            "value": "congee-and-side-dishes",
            "label": "清淡粥类"
        },
        {
            "value": "soy-milk-and-snack",
            "label": "豆浆与点心"
        },
        {
            "value": "milk-and-whole-grain",
            "label": "牛奶全麦"
        },
        {
    ...
    "storageKey": "healthy_breakfast_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=healthy-breakfast-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#8b6914;'>早餐选择投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7a6a4a;margin-bottom:20px;font-size:14px;'>看看大家对"爱老人关注：你更推荐哪种早餐给爸妈/长辈？"的最新态度</p>";
...
function addSummaryStatistics(container, latestVoteData) {
    ...
    statsDiv.style.cssText = 'text-align:center; margin-top:20px; padding-top:15px; border-top:1px dashed #c4a35a;';
    ...
    timestamp.style.cssText = 'font-size: 12px; color: #a08020; margin-top: 5px;';
