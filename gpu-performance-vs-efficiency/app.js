/**
 * 显卡性能对比 Survey Application
 * Logic for the "游戏显卡对比：你更看重性能还是功耗？" survey
 */

const questionConfig = {
    "title": "游戏显卡对比：你更看重性能还是功耗？",
    "question": "买显卡时，你更倾向于哪个方向？",
    "options": [
        {
            "value": "choose-high-performance",
            "label": "追求高性能"
        },
        {
            "value": "choose-low-power",
            "label": "追求低功耗"
        },
        {
            "value": "choose-balanced",
            "label": "追求均衡表现"
        }
    ],
    "storageKey": "gpu_performance_vs_efficiency_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gpu-performance-vs-efficiency'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>显卡性能对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“游戏显卡对比：你更看重性能还是功耗？”的最新态度</p>";
