...
const questionConfig = {
    ...
    options: [
        { value: "type99a", label: "99A式 (China)" },
        { value: "m1a2", label: "M1A2 艾布拉姆斯 (USA)" },
        { value: "leopard2", label: "豹2A8 (Germany)" },
        { value: "t14", label: "T-14 阿玛塔 (Russia)" },
        { value: "k2", label: "K2 黑豹 (South Korea)" }
    ],
