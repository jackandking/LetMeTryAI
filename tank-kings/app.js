/**
 * Tank Kings Vote Application
 */

const questionConfig = {
    title: '陆战之王：谁是地表最强坦克？',
    question: '在现代陆战体系中，你认为哪款坦克是当之无愧的陆战之王？',
    options: [
        { value: 'type99a', label: '99A式 (中国)' },
        { value: 'm1a2', label: 'M1A2 艾布拉姆斯' },
        { value: 'leopard2', label: '豹2A8 (德国)' },
        { value: 't14', label: 'T-14 阿玛塔' },
        { value: 'k2', label: 'K2 黑豹 (韩国)' }
    ],
    storageKey: 'tank_kings_v1.data'
};
...
function attachRadioHandlers() {
    const radios = document.querySelectorAll('input[name="tank"]');
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tank-kings'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>坦克战力投票结果</h2>';
