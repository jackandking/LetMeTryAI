/**
 * Guzhuang Meinv Application - Survey/Quiz functionality
 * Handles user interaction for ancient costume beauty voting
 */
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: "/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guzhuangmeinv",
        });
    } else {
