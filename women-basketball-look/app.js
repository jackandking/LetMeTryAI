...
const questionConfig = {
    title: '女篮球场上谁的造型更有镜头感？赛场瞬间你更心动谁',
    question: '女篮球场上谁的造型更有镜头感？选出你心动的赛场瞬间',
    options: [
        { value: 'short-hair-sporty', label: '短发利落+运动感' },
        { value: 'high-ponytail-elegant', label: '高马尾飘逸+动感' },
        { value: 'long-hair-soft-glow', label: '长发披肩+柔光美感' },
        { value: 'minimal-makeup-natural', label: '简约淡妆+自然力' }
    ],
    storageKey: 'women_basketball_look.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=women-basketball-look'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>女篮球场上谁的造型更有镜头感？赛场瞬间你更心动谁结果</h2>';
