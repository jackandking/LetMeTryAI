...
const questionConfig = {
    title: '你家的月饼记忆是哪一种？哪种味道把你带回童年？',
    question: '你家的月饼记忆是哪一种？选一个最像你家节日场景的答案。',
    options: [
        { value: 'home-handmade-mooncakes', label: '家里手工月饼' },
        { value: 'store-gift-box', label: '精美礼盒月饼' },
        { value: 'modern-creative-mooncakes', label: '创意新口味月饼' },
        { value: 'mooncake-as-snack', label: '随手当零食的月饼' }
    ],
    storageKey: 'ni_jia_de_yuebing_jiyi.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ni-jia-de-yuebing-jiyi'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你家的月饼记忆是哪一种？哪种味道把你带回童年？结果</h2>';
