...
const questionConfig = {
    title: '一桶食用油开封后还能放多久？真相揭秘',
    question: '一桶食用油开封后还能放多久？你家一般怎么保存？',
    options: [
        { value: 'within-2-weeks', label: '一两周内就用完' },
        { value: 'around-1-month', label: '大约1个月左右' },
        { value: '3-6-months', label: '3–6个月放深柜备用' },
        { value: 'check-appearance-smell', label: '看颜色和味道再决定' }
    ],
    storageKey: 'yitong_shiyongyou_kaifenghou_duojiu.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yitong-shiyongyou-kaifenghou-duojiu'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>一桶食用油开封后还能放多久？真相揭秘结果</h2>';
