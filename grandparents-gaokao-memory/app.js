...
const questionConfig = {
    title: '爷爷奶奶那辈高考，哪件事让你印象深刻？',
    question: '爷爷奶奶那辈高考，哪件事让你印象深刻？',
    options: [
        { value: 'lamp-night-study', label: '挑灯夜读' },
        { value: 'long-journey-exam', label: '翻山赶考' },
        { value: 'outdoor-exam-site', label: '露天考场' },
        { value: 'admission-letter-moment', label: '录取喜讯' }
    ],
    storageKey: 'grandparents_gaokao_memory.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandparents-gaokao-memory'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>爷爷奶奶那辈高考，哪件事让你印象深刻？结果</h2>';
