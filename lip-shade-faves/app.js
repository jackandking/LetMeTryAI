...
const questionConfig = {
    ...
    question: '你出门更会选哪种唇色？',
    options: [
        { value: 'orange-sun-lip', label: '橘色阳光' },
        { value: 'berry-vintage-lip', label: '复古浆果' },
        { value: 'nude-honey-lip', label: '裸色蜜糖' },
        { value: 'classic-red-lip', label: '正红经典' }
    ],
    storageKey: 'lip_shade_faves.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=lip-shade-faves'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你更爱的唇色是哪种？结果</h2>';
