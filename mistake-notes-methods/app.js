/**
 * 实用工具：错题整理方法 Survey Application
 * Logic for the "孩子做错题后怎么整理更有效？" survey
 */

const questionConfig = {
    "title": "孩子做错题后怎么整理更有效？",
    "question": "站在家长视角，你会怎么选：孩子错题整理更适合哪种方式？",
    "options": [
        {
            "value": "mistake-notebook",
            "label": "错题本"
        },
        {
            "value": "mistake-app",
        ...
        {
            "value": "scheduled-repractice",
            "label": "周期重做计划"
        }
    ],
    "storageKey": "mistake_notes_methods_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mistake-notes-methods'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>实用工具：错题整理方法投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子做错题后怎么整理更有效？”的最新态度</p>";
