...
const questionConfig = {
    title: '辽宁这座800年辽塔，石缝里为啥总钻出长蛇？',
    question: '你觉得辽塔石缝里为啥总钻出长蛇？',
    options: [
        { value: 'habitat-theory', label: '生态栖息说' },
        { value: 'legend-theory', label: '民间传说说' },
        { value: 'structure-theory', label: '建筑结构说' },
        { value: 'food-theory', label: '食物来源说' }
    ],
    storageKey: 'liao_tower_stone_snake.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=liao-tower-stone-snake'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>辽宁这座800年辽塔，石缝里为啥总钻出长蛇？结果</h2>';
