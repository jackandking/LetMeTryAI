/**
 * 青春期沟通投票 Survey Application
 * Logic for the "家长话题：如何和青春期孩子有效沟通" survey
 */

const questionConfig = {
    "title": "家长话题：如何和青春期孩子有效沟通",
    "question": "站在家长视角，你会怎么选：和青春期孩子聊天时你最常用哪种方式？",
    "options": [
        {
        ...
        {
            "value": "talk-about-daily-life",
            "label": "从日常小事切入，轻松开启对话"
        }
    ],
    "storageKey": "how_to_talk_to_teen_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=how-to-talk-to-teen'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>青春期沟通投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何和青春期孩子有效沟通”的最新态度</p>";
