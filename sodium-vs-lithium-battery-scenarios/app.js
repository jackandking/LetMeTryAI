...
const questionConfig = {
    title: '钠离子电池与锂电池，你更看好哪种应用场景？',
    question: '钠离子电池与锂电池，你更看好哪种应用场景？',
    options: [
        { value: 'sodium-grid-storage', label: '钠离子：电网储能/固定储能' },
        { value: 'sodium-economy-ev', label: '钠离子：低成本城市代步电动车' },
        { value: 'lithium-mobile-devices', label: '锂电：高性能手机与便携数码' },
        { value: 'lithium-high-performance-ev', label: '锂电：高续航电动车与高功率场景' }
    ],
    storageKey: 'sodium_vs_lithium_battery_scenarios.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sodium-vs-lithium-battery-scenarios'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>钠离子电池与锂电池，你更看好哪种应用场景？结果</h2>';
