/**
 * 现代战机对比 Survey Application
 * Logic for the "硬核对比：现代多用途战机你选谁" survey
 */

const questionConfig = {
    "title": "硬核对比：现代多用途战机你选谁",
    "question": "作为硬核玩家，你更认可哪款多用途战机的综合表现？",
    "options": [
        {
            "value": "j-20",
            "label": "歼-20"
    ...
    "storageKey": "modern_multirole_fighter_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-multirole-fighter-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>现代战机对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：现代多用途战机你选谁”的最新态度</p>";
