/**
 * China Women Pingpong Team Titles Survey
 */
const questionConfig = {
    "title": "中国女乒世乒赛团体冠军知多少",
    "question": "中国女乒刚实现世乒赛7连冠！你知道她们历史上总共拿过多少次世乒赛团体冠军吗？",
    "options": [
        { "value": "under-20", "label": "20次以下" },
        { "value": "20-to-22", "label": "20-22次" },
        { "value": "23-to-25", "label": "23-25次" },
        { "value": "over-26", "label": "26次以上" }
    ],
    "storageKey": "china_women_pingpong_team_titles_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({ url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=china-women-pingpong-team-titles' });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    if (!resultDiv) return;
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2980b9;'>女乒团体冠军投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对\"中国女乒世乒赛团体冠军次数\"的猜测</p>";
