...
const questionConfig = {
    title: '人形机器人参与马拉松应如何安排？——赛制与角色投票',
    question: '你支持哪种人形机器人参与马拉松的安排方式？',
    options: [
        { value: 'mixed-competition', label: '混合竞赛' },
        { value: 'separate-robot-category', label: '独立组别' },
        { value: 'support-role-assist', label: '辅助角色' },
        { value: 'demo-and-testing', label: '展示与测试' }
    ],
    storageKey: 'humanoid_robot_marathon_arrangement.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=humanoid-robot-marathon-arrangement'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>人形机器人参与马拉松应如何安排？——赛制与角色投票结果</h2>';
