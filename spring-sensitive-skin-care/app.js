...
const questionConfig = {
    title: '春季敏感肌，你更信赖哪种急救方式',
    question: '春季皮肤敏感泛红时，你更倾向用哪种方式急救？',
    options: [
        { value: 'minimal-routine', label: '精简护肤' },
        { value: 'repair-mask', label: '修护面膜' },
        { value: 'gentle-serum', label: '温和精华' }
    ],
    storageKey: 'spring_sensitive_skin_care.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-sensitive-skin-care'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季敏感肌，你更信赖哪种急救方式结果</h2>';
