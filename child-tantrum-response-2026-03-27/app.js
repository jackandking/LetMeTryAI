/**
 * 情绪回应投票 Survey Application
 * Logic for the "家长话题：孩子发脾气怎么回应" survey
 */

const questionConfig = {
    "title": "家长话题：孩子发脾气怎么回应",
    "question": "站在家长视角，你会怎么选：孩子发脾气时最可能采取哪种回应方式？",
    "options": [
        {
            "value": "listen-and-guide",
            "label": "耐心倾听并引导"
        },
        {
            "value": "give-calm-time",
            "label": "短暂冷静等待"
        },
        {
            "value": "stop-and-explain",
            "label": "立即设界限并讲道理"
        }
    ],
    "storageKey": "child_tantrum_response_2026_03_27_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-tantrum-response-2026-03-27'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>情绪回应投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子发脾气怎么回应”的最新态度</p>";
