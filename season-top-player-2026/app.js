...
const questionConfig = {
    "title": "本赛季谁最统治？",
    "question": "站在男人宝用户视角，你更想把票投给谁：本赛季最具统治力球星？",
    "options": [
        {
            "value": "lebron-james",
            "label": "詹姆斯（LeBron James）"
        },
        {
            "value": "giannis-antetokounmpo",
            "label": "字母哥（Giannis Antetokounmpo）"
        },
        {
            "value": "kevin-durant",
            "label": "杜兰特（Kevin Durant）"
        },
        {
            "value": "luka-doncic",
            "label": "东契奇（Luka Doncic）"
        }
    ],
    "storageKey": "season_top_player_2026_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=season-top-player-2026'
        });
        return;
    }
