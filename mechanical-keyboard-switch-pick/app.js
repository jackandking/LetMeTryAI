/**
 * 轴体手感PK Survey Application
 * Logic for the "硬核对比：机械键盘轴体选择" survey
 */

const questionConfig = {
    "title": "硬核对比：机械键盘轴体选择",
    "question": "你更喜欢哪种机械轴体的手感？",
    "options": [
        {
            "value": "red-switch",
            "label": "红轴（线性）"
    ...
    "storageKey": "mechanical_keyboard_switch_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mechanical-keyboard-switch-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>轴体手感PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：机械键盘轴体选择”的最新态度</p>";
