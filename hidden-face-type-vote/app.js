...
const questionConfig = {
    title: '哪种“隐藏款”长相更让人心动？',
    question: '哪种“隐藏款”长相更让人心动？',
    options: [
        { value: 'cool-distance-beauty', label: '清冷挂' },
        { value: 'sweet-salty-style', label: '甜盐系' },
        { value: 'retro-hongkong-glamour', label: '复古港风' },
        { value: 'soft-natural-look', label: '淡颜系' }
    ],
    storageKey: 'hidden_face_type_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hidden-face-type-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪种“隐藏款”长相更让人心动？结果</h2>';
