...
const questionConfig = {
    title: '被吐槽的快时尚，你会怎么选？',
    question: '被吐槽的快时尚，你会怎么选？',
    options: [
        { value: 'buy-for-trend', label: '追潮流换新' },
        { value: 'prioritize-quality', label: '挑质量少买' },
        { value: 'classic-invest', label: '选经典长期穿' },
        { value: 'reuse-resell', label: '二手/换购优先' }
    ],
    storageKey: 'beitucao_kuai_shishang_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beitucao-kuai-shishang-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>被吐槽的快时尚，你会怎么选？结果</h2>';
