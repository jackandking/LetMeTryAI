...
const questionConfig = {
    title: '你更被哪种男友感吸引？暖男背影杀、幽默邻家还是成熟安全感？',
    question: '你更被哪种男友感吸引？',
    options: [
        { value: 'nuan-nan-bei-ying-sha', label: '暖男背影杀' },
        { value: 'you-mo-lin-jia-nan', label: '幽默邻家男' },
        { value: 'cheng-shu-an-quan-gan', label: '成熟安全感' },
        { value: 'xiao-jing-xi-lang-man-xing', label: '小惊喜浪漫型' }
    ],
    storageKey: 'boyfriend_vibe.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=boyfriend-vibe'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你更被哪种男友感吸引？暖男背影杀、幽默邻家还是成熟安全感？结果</h2>';
