/**
 * 旗舰夜拍对比 Survey Application
 * Logic for the "旗舰夜景拍照PK：你更看好哪款？" survey
 */

const questionConfig = {
    "title": "旗舰夜景拍照PK：你更看好哪款？",
    "question": "亲，你更想把票投给哪款旗舰手机的夜景表现？",
    "options": [
        {
    ...
    "storageKey": "flagship_phone_night_pk_2026_04_10_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=flagship-phone-night-pk-2026-04-10'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>旗舰夜拍对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“旗舰夜景拍照PK：你更看好哪款？”的最新态度</p>";
