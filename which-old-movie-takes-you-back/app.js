...
const questionConfig = {
    title: '哪部老电影能把你带回年轻时候？哪一幕会把你带回去？',
    question: '哪部老电影能把你带回年轻时候？回忆里的哪一幕会把你带回去？',
    options: [
        { value: 'xiao-cheng-zhi-chun', label: '小城之春' },
        { value: 'yi-jiang-chun-shui', label: '一江春水向东流' },
        { value: 'tian-mi-mi', label: '甜蜜蜜' },
        { value: 'long-men-ke-zhan', label: '龙门客栈' }
    ],
    storageKey: 'which_old_movie_takes_you_back.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=which-old-movie-takes-you-back'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪部老电影能把你带回年轻时候？哪一幕会把你带回去？结果</h2>';
