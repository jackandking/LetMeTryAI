/**
 * 经典老歌回忆 Survey Application
 * Logic for the "关注：你心中的经典老歌是哪首" survey
 */

const questionConfig = {
    "title": "关注：你心中的经典老歌是哪首",
    "question": "亲，你最支持哪个选项：你心中的经典老歌是哪首？",
    "options": [
        {
            "value": "tian-mi-mi",
            "label": "甜蜜蜜"
        ...
        {
            "value": "nan-wang-jin-xiao",
            "label": "难忘今宵"
        }
    ],
    "storageKey": "classic_old_songs_poll_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>经典老歌回忆投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：你心中的经典老歌是哪首”的最新态度</p>";
