...
const questionConfig = {
    title: '带娃看电影，哪个桥段会让孩子一直回味？',
    question: '带娃看电影，哪个桥段会让孩子一直回味？',
    options: [
        { value: 'warm-hug-scene', label: '温馨拥抱' },
        { value: 'funny-gag-moment', label: '搞笑神来一脚' },
        { value: 'hero-rescue-scene', label: '英雄救援' },
        { value: 'magical-musical-scene', label: '奇幻歌舞' }
    ],
    storageKey: 'movie_moments_kids.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-moments-kids'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带娃看电影，哪个桥段会让孩子一直回味？结果</h2>';
