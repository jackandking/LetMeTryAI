...
const questionConfig = {
    title: '孩子问：火箭为什么会喷出那么大的火焰？你会怎么回答？',
    question: '孩子问：火箭为什么会喷出那么大的火焰？你会怎么回答？',
    options: [
        { value: 'metaphor-story', label: '比喻故事法' },
        { value: 'simple-science', label: '简化科学法' },
        { value: 'demo-experiment', label: '互动演示法' }
    ],
    storageKey: 'rocket_flame_answers.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rocket-flame-answers'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子问：火箭为什么会喷出那么大的火焰？你会怎么回答？结果</h2>';
