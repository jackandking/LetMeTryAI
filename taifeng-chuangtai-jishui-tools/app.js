...
const questionConfig = {
    title: '台风天窗台积水，哪个小工具更实用？',
    question: '台风天窗台积水，哪个小工具更实用？',
    options: [
        { value: 'window-squeegee', label: '窗台刮水器（带水槽）' },
        { value: 'absorbent-sponge', label: '超吸水海绵/吸水垫' },
        { value: 'mini-submersible-pump', label: '迷你潜水抽水泵（充电）' },
        { value: 'drainage-seal-strip', label: '引流密封条/防水胶条' }
    ],
    storageKey: 'taifeng_chuangtai_jishui_tools.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=taifeng-chuangtai-jishui-tools'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风天窗台积水，哪个小工具更实用？结果</h2>';
