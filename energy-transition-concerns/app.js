...
const questionConfig = {
    title: '能源转型关切：普通人更关注哪方面？',
    question: '在能源转型过程中，您更关注以下哪一方面？',
    options: [
        { value: 'cost-and-bills', label: '电费与生活成本' },
        { value: 'jobs-and-industry', label: '就业影响与产业机会' },
        { value: 'grid-reliability', label: '电力供应稳定性' },
        { value: 'environmental-benefits', label: '环境与空气质量改善' }
    ],
    storageKey: 'energy_transition_concerns.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=energy-transition-concerns'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>能源转型关切：普通人更关注哪方面？结果</h2>';
