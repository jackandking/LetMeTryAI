...
const questionConfig = {
    title: '退休后你想坚持哪项健康习惯？早晨散步、拉伸还是社交活动？',
    question: '退休后你想坚持哪项健康习惯？',
    options: [
        { value: 'morning-walk', label: '早晨散步' },
        { value: 'daily-stretch-taiji', label: '每日拉伸/太极' },
        { value: 'balanced-diet', label: '均衡饮食' },
        { value: 'regular-social-activities', label: '固定社交/兴趣班' }
    ],
    storageKey: 'retirement_health_habits.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retirement-health-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>退休后你想坚持哪项健康习惯？早晨散步、拉伸还是社交活动？结果</h2>';
