/**
 * 分手瞬间投票 Survey Application
 * Logic for the "女人爱热议：分手后最难忘的瞬间" survey
 */

const questionConfig = {
    "title": "女人爱热议：分手后最难忘的瞬间",
    "question": "分手后，哪一刻最让你至今难忘？",
    "options": [
        {
            "value": "received-reply-message",
            "label": "收到对方的道歉或复合消息"
        },
        {
            "value": "visit-memory-place",
            "label": "回到曾经一起去过的地方"
        },
        {
            "value": "see-photo-or-item",
            "label": "看到共同的照片或他留的物品"
        },
        {
            "value": "see-them-move-on",
            "label": "发现对方已开始新生活"
        }
    ],
    "storageKey": "post_breakup_memorable_moment_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=post-breakup-memorable-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>分手瞬间投票投票结果</h2>";
