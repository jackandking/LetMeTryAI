...
const questionConfig = {
    title: '熬夜追剧看球，夜宵你会选哪种？',
    question: '追剧或看球熬夜，你会点哪种夜宵？',
    options: [
        { value: 'kao-chuan', label: '烤串配啤酒' },
        { value: 'fried-chicken-burger', label: '炸鸡汉堡' },
        { value: 'hot-noodles-congee', label: '热汤面/粥' },
        { value: 'snack-platter', label: '小零食拼盘' }
    ],
    storageKey: 'movie_night_food.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-night-food'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>熬夜追剧看球，夜宵你会选哪种？结果</h2>';
