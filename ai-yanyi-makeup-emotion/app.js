...
const questionConfig = {
    title: 'AI演戏能骗眼：哪个明星妆容更像真实情绪？',
    question: 'AI演戏能骗眼：哪个明星妆容更像真实情绪？',
    options: [
        { value: 'wet-tearlook', label: '湿润泪眼感' },
        { value: 'clean-gloss-lip', label: '干净光感唇' },
        { value: 'dramatic-stage', label: '戏剧舞台浓妆' }
    ],
    storageKey: 'ai_yanyi_makeup_emotion.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-yanyi-makeup-emotion'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI演戏能骗眼：哪个明星妆容更像真实情绪？结果</h2>';
