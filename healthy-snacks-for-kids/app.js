/**
 * 儿童零食选择 Survey Application
 * Logic for the "家长话题：孩子放学或旅行时，你首选哪类零食？" survey
 */

const questionConfig = {
    "title": "家长话题：孩子放学或旅行时，你首选哪类零食？",
    "question": "站在家长视角，你会怎么选：给孩子准备零食时优先考虑哪类？",
    "options": [
        {
            "value": "fresh-fruit",
            "label": "当季新鲜水果"
        ...
        {
            "value": "low-sugar-yogurt",
            "label": "低糖酸奶或酸奶杯"
        },
        {
            "value": "homemade-snacks",
            "label": "自制小点心（烘焙/能量球）"
        },
        {
            "value": "nuts-dried-fruit",
            "label": "简单坚果与干果（适龄）"
        }
    ],
    "storageKey": "healthy_snacks_for_kids_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=healthy-snacks-for-kids'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>儿童零食选择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：孩子放学或旅行时，你首选哪类零食？”的最新态度</p>";
