...
const questionConfig = {
    title: 'AI脸和真人脸，哪种更耐看？',
    question: 'AI脸和真人脸，哪种更耐看？',
    options: [
        { value: 'ai-model-face', label: 'AI建模脸' },
        { value: 'real-star-face', label: '真人明星脸' },
        { value: 'natural-bare-face', label: '天然素颜脸' },
        { value: 'digital-art-face', label: '数字艺术脸' }
    ],
    storageKey: 'ai_face_vs_real_face.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-face-vs-real-face'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI脸和真人脸，哪种更耐看？结果</h2>';
