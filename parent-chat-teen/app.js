/**
 * 青春期聊天技巧 Survey Application
 * Logic for the "家长话题：如何跟青春期孩子聊天更有效" survey
 */

const questionConfig = {
    "title": "家长话题：如何跟青春期孩子聊天更有效",
    "question": "站在家长视角，你会怎么选：如何跟青春期孩子聊天更有效？",
    "options": [
        {
    ...
    "storageKey": "parent_chat_teen_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=parent-chat-teen'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>青春期聊天技巧投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何跟青春期孩子聊天更有效”的最新态度</p>";
