/**
 * 数字启蒙选择 Survey Application
 * Logic for the "孩子应该从哪门数字/编程课开始？" survey
 */

const questionConfig = {
    "title": "孩子应该从哪门数字/编程课开始？",
    "question": "站在家长爱用户视角，你会怎么选：孩子第一门数字课程选哪种？",
    "options": [
        {
            "value": "scratch-blocks",
            "label": "图形化入门（Scratch）"
        },
        {
            "value": "python-basics",
        ...
        {
            "value": "robot-play-kits",
            "label": "玩具机器人/硬件"
        },
        {
            "value": "logic-and-math",
            "label": "逻辑与数学训练"
        }
    ],
    "storageKey": "child_digital_first_language_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-digital-first-language'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>数字启蒙选择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子应该从哪门数字/编程课开始？”的最新态度</p>";
