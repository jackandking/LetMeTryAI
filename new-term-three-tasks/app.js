...
const questionConfig = {
    title: '新学期每天抓好这三件事，你会先做哪一项？',
    question: '新学期每天抓好这三件事，你会先做哪一项？',
    options: [
        { value: 'check-homework', label: '先检查并辅导作业' },
        { value: 'read-together', label: '先读书讲故事一段' },
        { value: 'plan-and-talk', label: '先定好作息并聊聊心情' }
    ],
    storageKey: 'new_term_three_tasks.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=new-term-three-tasks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>新学期每天抓好这三件事，你会先做哪一项？结果</h2>';
