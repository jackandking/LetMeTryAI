...
const questionConfig = {
    title: '衣服受潮了你先做啥？晒一晒、烘一烘还是直接洗？',
    question: '衣服受潮了你先做啥？',
    options: [
        { value: 'sun-dry', label: '阳台/窗边晾一阵' },
        { value: 'use-dryer', label: '用吹风机或烘干机' },
        { value: 'rewash', label: '赶紧重新洗一遍并脱水' },
        { value: 'dehumidify-store', label: '放除湿/暖气柜吸潮' }
    ],
    storageKey: 'wet_clothes_what_first.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wet-clothes-what-first'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>衣服受潮了你先做啥？晒一晒、烘一烘还是直接洗？结果</h2>';
