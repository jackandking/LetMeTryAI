...
const questionConfig = {
    title: '《永乐大典》回家了，你想带娃先看哪类国宝？',
    question: '《永乐大典》回家了，你想带娃先看哪类国宝？',
    options: [
        { value: 'bronze-treasures', label: '青铜重器' },
        { value: 'painting-calligraphy', label: '书画珍品' },
        { value: 'ancient-books', label: '古籍档案' },
        { value: 'gold-jade', label: '金玉华彩' }
    ],
    storageKey: 'yongle_dadian_national_treasures.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yongle-dadian-national-treasures'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>《永乐大典》回家了，你想带娃先看哪类国宝？结果</h2>';
