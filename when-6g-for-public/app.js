...
const questionConfig = {
    title: '普通人什么时候能用上 6G？',
    question: '你认为普通人什么时候能用上 6G？',
    options: [
        { value: 'within-3-years', label: '短期（3年内）' },
        { value: 'years-3-7', label: '中期（3-7年）' },
        { value: 'years-7-15', label: '长期（7-15年）' },
        { value: 'years-15-plus', label: '不确定/更久（15年以上或难以判断）' }
    ],
    storageKey: 'when_6g_for_public.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=when-6g-for-public'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>普通人什么时候能用上 6G？结果</h2>';
