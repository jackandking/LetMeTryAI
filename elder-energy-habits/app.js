...
const questionConfig = {
    title: '长辈日常精力小习惯投票',
    question: '您觉得哪些日常小习惯更有助于长辈保持日常精力？',
    options: [
        { value: 'morning-stretch', label: '晨间轻伸展' },
        { value: 'light-walk', label: '短程轻松散步' },
        { value: 'small-meals', label: '少量规律加餐' },
        { value: 'short-rest', label: '短时小憩恢复' }
    ],
    storageKey: 'elder_energy_habits.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-energy-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>长辈日常精力小习惯投票结果</h2>';
