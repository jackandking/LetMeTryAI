...
const questionConfig = {
    title: 'AI脸看多了，哪种自然妆容更让你心动？',
    question: 'AI脸看多了，哪种自然妆容更让你心动？',
    options: [
        { value: 'water-makeup', label: '白开水妆' },
        { value: 'no-makeup-look', label: '伪素颜妆' },
        { value: 'clear-makeup', label: '日杂清透妆' },
        { value: 'glow-makeup', label: '气血感妆容' }
    ],
    storageKey: 'natural_makeup_preference.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=natural-makeup-preference'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI脸看多了，哪种自然妆容更让你心动？结果</h2>';
