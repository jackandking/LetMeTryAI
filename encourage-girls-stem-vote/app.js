...
const questionConfig = {
    title: '鼓励女生参与理科活动投票',
    question: '针对“鼓励女生参与理科活动”，您更支持哪种方式帮助孩子培养兴趣？',
    options: [
        { value: 'school-science-club', label: '校内科学社团' },
        { value: 'home-parent-child-experiments', label: '家庭亲子实验' },
        { value: 'community-online-workshops', label: '社区或在线工作坊' },
        { value: 'classroom-questions-contests', label: '课堂提问与竞赛鼓励' }
    ],
    storageKey: 'encourage_girls_stem_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=encourage-girls-stem-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>鼓励女生参与理科活动投票结果</h2>';
