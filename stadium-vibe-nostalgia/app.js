...
const questionConfig = {
    title: '看球时你会怀念哪种球场氛围？',
    question: '看球时你会怀念哪种球场氛围？回想一下当年的画面哪种最戳你？',
    options: [
        { value: 'roaring-cheers', label: '人声鼎沸、整场呐喊' },
        { value: 'singalongs-and-flags', label: '老歌伴唱、挥旗合唱' },
        { value: 'family-corner', label: '带家人看球的温馨角落' },
        { value: 'quiet-tactical', label: '安静专注、听解说看战术' }
    ],
    storageKey: 'stadium_vibe_nostalgia.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=stadium-vibe-nostalgia'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>看球时你会怀念哪种球场氛围？结果</h2>';
