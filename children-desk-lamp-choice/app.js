/**
 * 实用工具投票 Survey Application
 * Logic for the "护眼台灯如何选？兼顾护眼、亮度与耐用性" survey
 */

const questionConfig = {
    "title": "护眼台灯如何选？兼顾护眼、亮度与耐用性",
    "question": "站在家长视角，你会怎么选：孩子用护眼台灯怎么选？",
    "options": [
        {
            "value": "adjustable-color-temp",
            "label": "可调色温台灯"
        },
        {
            "value": "three-level-brightness",
            "label": "三挡亮度台灯"
        },
        {
            "value": "certified-stable-light",
            "label": "带认证与稳定光源"
        }
    ],
    "storageKey": "children_desk_lamp_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-desk-lamp-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>实用工具投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“护眼台灯如何选？兼顾护眼、亮度与耐用性”的最新态度</p>";
