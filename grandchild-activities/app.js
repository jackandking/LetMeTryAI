/**
 * 代际亲情投票 Survey Application
 * Logic for the "和孙辈的快乐时光：你最喜欢做什么？" survey
 */

const questionConfig = {
    "title": "和孙辈的快乐时光：你最喜欢做什么？",
    "question": "亲，你最支持哪个选项：和孙辈在一起最让你开心的事是什么？",
    "options": [
        {
            "value": "making-handicrafts",
            "label": "做手工/画画"
        },
        {
            "value": "telling-stories",
            "label": "讲故事/读书"
        },
        {
            "value": "cooking-together",
            "label": "一起做饭/包饺子"
        },
        {
            "value": "outing-walk",
    ...
    "storageKey": "grandchild_activities_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandchild-activities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>代际亲情投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“和孙辈的快乐时光：你最喜欢做什么？”的最新态度</p>";
