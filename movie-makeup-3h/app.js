...
const questionConfig = {
    title: '坐3小时电影，妆还不脱你会怎么做？',
    question: '坐3小时电影，妆还不脱你会怎么做？',
    options: [
        { value: 'hold-makeup', label: '坚持不补' },
        { value: 'blot-only', label: '只吸油不补色' },
        { value: 'quick-touchup', label: '快速补一手' },
        { value: 'remove-makeup', label: '干脆卸掉' }
    ],
    storageKey: 'movie_makeup_3h.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=movie-makeup-3h'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>坐3小时电影，妆还不脱你会怎么做？结果</h2>';
