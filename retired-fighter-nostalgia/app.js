/**
 * 战机情怀投票 Survey Application
 * Logic for the "退役战机情怀对比" survey
 */

const questionConfig = {
    "title": "退役战机情怀对比",
    "question": "作为装备党，你更怀念哪款退役战机？",
    "options": [
        {
            "value": "jian-6",
            "label": "歼-6"
    ...
    "storageKey": "retired_fighter_nostalgia_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retired-fighter-nostalgia'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>战机情怀投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“退役战机情怀对比”的最新态度</p>";
