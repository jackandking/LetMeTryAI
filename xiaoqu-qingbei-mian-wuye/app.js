...
const questionConfig = {
    title: '小区说考上清北免物业，你会怎么跟孩子聊目标与压力？',
    question: '小区说考上清北免物业，你会怎么跟孩子聊目标与压力？',
    options: [
        { value: 'split-into-short-term-goals', label: '拆解到短期目标' },
        { value: 'focus-on-methods-and-interest', label: '强调方法与兴趣' },
        { value: 'teach-pressure-management', label: '教孩子管理压力' },
        { value: 'share-family-expectations-honestly', label: '坦诚说出家庭期望' }
    ],
    storageKey: 'xiaoqu_qingbei_mian_wuye.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xiaoqu-qingbei-mian-wuye'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小区说考上清北免物业，你会怎么跟孩子聊目标与压力？结果</h2>';
