...
const questionConfig = {
    title: '你被哪个蛇精造型惊到了？',
    question: '哪一款蛇精造型让你当场惊到说不出话？',
    options: [
        { value: 'stage-fox-snake', label: '舞台狐媚风' },
        { value: 'cold-highlight-face', label: '冷艳高光脸' },
        { value: 'vintage-oil-snake', label: '复古油画感' },
        { value: 'cute-contrast-snake', label: '反差可爱派' }
    ],
    storageKey: 'ni_bei_nage_shejing_zaoxing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ni-bei-nage-shejing-zaoxing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你被哪个蛇精造型惊到了？结果</h2>';
