...
const questionConfig = {
    title: '黄山迎客松开花了，带孩子去你想拍哪个画面?',
    question: '黄山迎客松开花了，带孩子去你想拍哪个画面?',
    options: [
        { value: 'family-front-smile', label: '全家正面笑脸合影' },
        { value: 'child-back-looking-cloudsea', label: '孩子背对镜头望云海' },
        { value: 'closeup-hand-touch-needle', label: '特写牵手触碰松针' },
        { value: 'silhouette-sunset-cloudsea', label: '剪影与霞光云海背景' }
    ],
    storageKey: 'huangshan_yingkesong_photo.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huangshan-yingkesong-photo'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>黄山迎客松开花了，带孩子去你想拍哪个画面?结果</h2>';
