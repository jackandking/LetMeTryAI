...
const questionConfig = {
    title: '孩子看到偶像想学运动，你会怎么引导？',
    question: '孩子看到偶像想学运动，你更倾向于哪种引导方式？',
    options: [
        { value: 'encourage-with-safety', label: '鼓励尝试并保障安全' },
        { value: 'sign-up-class', label: '报名正规兴趣班' },
        { value: 'practice-together-goals', label: '与孩子一起设小目标练习' },
        { value: 'wait-observe-balance', label: '先观察兴趣再平衡安排' }
    ],
    storageKey: 'child_idol_sport_guide.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=child-idol-sport-guide'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子看到偶像想学运动，你会怎么引导？结果</h2>';
