...
const questionConfig = {
    title: '国产人形机器人，谁家看起来更逼真？',
    question: '国产人形机器人，谁家看起来更逼真？',
    options: [
        { value: 'unitree-h1', label: '宇树 H1' },
        { value: 'zhiyuan-a2', label: '智元远征 A2' },
        { value: 'fourier-gr1', label: '傅利叶 GR-1' },
        { value: 'xiaopeng-iron', label: '小鹏 Iron' }
    ],
    storageKey: 'domestic_humanoid_robots.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=domestic-humanoid-robots'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产人形机器人，谁家看起来更逼真？结果</h2>';
