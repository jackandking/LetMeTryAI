...
const questionConfig = {
    title: 'AI 创作与人工原创态度调查',
    question: '在内容创作中，你更倾向于哪种方式？',
    options: [
        { value: 'support-ai-assisted', label: '支持 AI 辅助创作' },
        { value: 'prefer-human-original', label: '更偏好人工原创' },
        { value: 'case-by-case', label: '看情境决定' }
    ],
    storageKey: 'ai_creation_debate.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-creation-debate'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>AI 创作与人工原创态度调查结果</h2>';
