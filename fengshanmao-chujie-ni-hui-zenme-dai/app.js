...
const questionConfig = {
    title: '风扇帽出街，你会怎么戴？背影更惊艳还是随性慵懒？',
    question: '风扇帽出街，你会怎么戴？选一个符合你日常的戴法',
    options: [
        { value: 'e-qian-zhengdai', label: '额前正戴' },
        { value: 'fan-dai-yonglan', label: '反戴慵懒' },
        { value: 'ce-xie-shaonu-gan', label: '侧斜少女感' }
    ],
    storageKey: 'fengshanmao_chujie_ni_hui_zenme_dai.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=fengshanmao-chujie-ni-hui-zenme-dai'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>风扇帽出街，你会怎么戴？背影更惊艳还是随性慵懒？结果</h2>';
