/**
 * 战机对比 Survey Application
 * Logic for the "现代隐身战机对决" survey
 */

const questionConfig = {
    "title": "现代隐身战机对决",
    "question": "现代隐身战机中，你更看好哪款制空/突防能力？",
    "options": [
        {
            "value": "f-22-raptor",
            "label": "F-22 Raptor"
    ...
    "storageKey": "modern_stealth_fighter_faceoff_2026_03_26_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-stealth-fighter-faceoff-2026-03-26'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>战机对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“现代隐身战机对决”的最新态度</p>";
