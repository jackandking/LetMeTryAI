 ...
 * Logic for the "孩子发脾气：你会怎么回应？" survey
 */

const questionConfig = {
    "title": "孩子发脾气：你会怎么回应？",
    "question": "站在家长视角，你会怎么选：孩子发脾气时你会怎么回应？",
    "options": [
        {
            "value": "listen-and-support",
            "label": "冷静倾听与陪伴"
        },
        {
            "value": "time-out-and-calm",
            "label": "短时间分开冷静一下"
        },
        {
            "value": "set-boundaries-now",
            "label": "立即讲道理并设限"
        },
        {
            "value": "talk-after",
    ...
    "storageKey": "respond_to_kid_tantrum_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=respond-to-kid-tantrum'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子发脾气：你会怎么回应？”的最新态度</p>";
