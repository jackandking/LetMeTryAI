/**
 * 阅读习惯培养 Survey Application
 * Logic for the "如何让孩子爱上读书？家长怎么看？" survey
 */

const questionConfig = {
    "title": "如何让孩子爱上读书？家长怎么看？",
    "question": "站在家长视角，你会怎么选：培养孩子阅读习惯更应优先采取哪种方式？",
    "options": [
        {
        ...
        {
            "value": "reward-and-checkin",
            "label": "奖励与打卡（激励机制）"
        },
        {
            "value": "let-kid-choose",
            "label": "让孩子自由选书（兴趣驱动）"
        }
    ],
    "storageKey": "reading_habit_methods_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=reading-habit-methods'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>阅读习惯培养投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“如何让孩子爱上读书？家长怎么看？”的最新态度</p>";
