...
const questionConfig = {
    title: '下大雨雷雨，你家孩子该待哪儿？',
    question: '下大雨雷雨，你家孩子会待在哪儿？',
    options: [
        { value: 'livingroom-with-parents', label: '客厅和大人在一起' },
        { value: 'own-room-with-curtains', label: '自己的房间安静待着' },
        { value: 'basement-safe-room', label: '家里地下室或更安全的内室' },
        { value: 'go-to-neighbor-or-relative', label: '临时去邻居或亲戚家' }
    ],
    storageKey: 'xiayu_leiyu_kid_where.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=xiayu-leiyu-kid-where'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>下大雨雷雨，你家孩子该待哪儿？结果</h2>';
