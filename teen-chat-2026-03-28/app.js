/**
 * 亲子沟通投票 Survey Application
 * Logic for the "家长话题：如何跟青春期孩子聊天" survey
 */

const questionConfig = {
    "title": "家长话题：如何跟青春期孩子聊天",
    "question": "站在家长视角，你会怎么选：如何跟青春期孩子聊天？",
    "options": [
        {
            "value": "listen-first",
            "label": "先倾听少评价"
        ...
        {
            "value": "scheduled-chat",
            "label": "约定时间定期聊"
        },
        {
            "value": "activity-bonding",
            "label": "通过共同行动交流"
        },
        {
            "value": "third-party-help",
            "label": "必要时寻求第三方"
        }
    ],
    "storageKey": "teen_chat_2026_03_28_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=teen-chat-2026-03-28'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>亲子沟通投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何跟青春期孩子聊天”的最新态度</p>";
