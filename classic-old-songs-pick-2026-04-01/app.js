 ...
 * Logic for the "关注：最经典的老歌你选哪首" survey
 */

const questionConfig = {
    "title": "关注：最经典的老歌你选哪首",
    "question": "亲，你最支持哪个选项：最经典的老歌你选哪首？",
    "options": [
        {
            "value": "tian-mi-mi",
            "label": "甜蜜蜜"
        ...
        {
            "value": "wang-shi-zhi-neng-hui-wei",
            "label": "往事只能回味"
        }
    ],
    "storageKey": "classic_old_songs_pick_2026_04_01_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-pick-2026-04-01'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：最经典的老歌你选哪首”的最新态度</p>";
