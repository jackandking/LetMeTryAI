...
const questionConfig = {
    title: '长辈手机里“攒”了77万条未读消息，你猜哪类占大头？',
    question: '长辈手机里“攒”了77万条未读消息，你猜哪类占大头？',
    options: [
        { value: 'family-group', label: '家庭群消息' },
        { value: 'health-tips', label: '养生健康转发' },
        { value: 'promo-ads', label: '促销广告消息' },
        { value: 'short-video-notices', label: '短视频通知' }
    ],
    storageKey: 'elderly_phone_unread_messages.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elderly-phone-unread-messages'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>长辈手机里“攒”了77万条未读消息，你猜哪类占大头？结果</h2>';
