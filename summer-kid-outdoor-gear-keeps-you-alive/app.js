...
const questionConfig = {
    title: '夏天带娃出门，你靠哪样神器续命？',
    question: '夏天带娃出门，你靠哪样神器续命？',
    options: [
        { value: 'portable-mini-fan', label: '便携小风扇' },
        { value: 'kids-sun-hat', label: '儿童防晒帽' },
        { value: 'mosquito-repellent-spray', label: '驱蚊喷雾' },
        { value: 'insulated-water-bottle', label: '保温水壶' }
    ],
    storageKey: 'summer_kid_outdoor_gear_keeps_you_alive.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=summer-kid-outdoor-gear-keeps-you-alive'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>夏天带娃出门，你靠哪样神器续命？结果</h2>';
