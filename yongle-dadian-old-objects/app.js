...
const questionConfig = {
    title: '《永乐大典》回家了，您家里还留着哪种老物件？',
    question: '您家里还留着哪种老物件？',
    options: [
        { value: 'old-photos-albums', label: '老照片与相册' },
        { value: 'ration-tickets', label: '粮票与布票' },
        { value: 'enamel-mugs', label: '搪瓷缸与茶缸' },
        { value: 'old-radio-tapes', label: '老收音机与磁带' }
    ],
    storageKey: 'yongle_dadian_old_objects.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=yongle-dadian-old-objects'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>《永乐大典》回家了，您家里还留着哪种老物件？结果</h2>';
