 ...
 * Logic for the "你最想参加哪种社区活动？" survey
 */
...
const questionConfig = {
    ...
    "options": [
        {
            "value": "interest-groups-handicraft",
            "label": "兴趣小组/手作班"
        },
        {
        ...
        {
            "value": "short-group-trip",
            "label": "短途集合游"
        }
    ],
    "storageKey": "community_activities_choice_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activities-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“你最想参加哪种社区活动？”的最新态度</p>";
