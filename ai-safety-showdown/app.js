/**
 * AI防线PK Survey Application
 * Logic for the "硬核AI防线｜AI安全技术PK" survey
 */

const questionConfig = {
    "title": "硬核AI防线｜AI安全技术PK",
    "question": "站在男人宝用户视角，你更想把票投给谁：硬核AI防线——哪种技术更靠谱？",
    "options": [
        {
        ...
        {
            "value": "provenance-watermark",
            "label": "来源水印/可追溯"
        }
    ],
    "storageKey": "ai_safety_showdown_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ai-safety-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>AI防线PK投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核AI防线｜AI安全技术PK”的最新态度</p>";
