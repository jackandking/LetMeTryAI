...
const questionConfig = {
    title: '带孩子去博物馆，你想看哪类镇馆之宝？',
    question: '带孩子去博物馆，你想看哪类镇馆之宝？',
    options: [
        { value: 'ancient-artifacts', label: '古代文物（青铜、陶俑）' },
        { value: 'art-treasures', label: '艺术珍品（名画、瓷器）' },
        { value: 'natural-fossils', label: '自然化石（恐龙、标本）' },
        { value: 'science-exhibits', label: '科技展品（航天、古代发明）' }
    ],
    storageKey: 'museum_treasure_choices.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-treasure-choices'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去博物馆，你想看哪类镇馆之宝？结果</h2>';
