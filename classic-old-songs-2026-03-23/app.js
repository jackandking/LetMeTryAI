/**
 * 经典老歌投票 Survey Application
 * Logic for the "最经典的老歌，哪首触动你的回忆？" survey
 */

const questionConfig = {
    "title": "最经典的老歌，哪首触动你的回忆？",
    "question": "亲，你最支持哪首经典老歌？",
    "options": [
        {
            "value": "tian-mi-mi",
            "label": "甜蜜蜜 (邓丽君)"
        ...
        {
            "value": "yue-liang-dai-biao-wo-de-xin",
            "label": "月亮代表我的心 (邓丽君/多版本)"
        },
        {
            "value": "xiao-cheng-gu-shi",
            "label": "小城故事 (甄妮)"
        },
        {
            "value": "dan-yuan-ren-chang-jiu",
            "label": "但愿人长久 (王菲/古典版)"
        }
    ],
    "storageKey": "classic_old_songs_2026_03_23_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-2026-03-23'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>经典老歌投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“最经典的老歌，哪首触动你的回忆？”的最新态度</p>";
