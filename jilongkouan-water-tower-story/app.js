...
const questionConfig = {
    title: '带孩子看吉隆口岸水塔，你会怎么讲它的故事？',
    question: '带孩子看吉隆口岸水塔，你会怎么讲它的故事？',
    options: [
        { value: 'explain-engineering', label: '讲它的“工作原理”' },
        { value: 'tell-local-people-story', label: '讲口岸与人的故事' },
        { value: 'imaginative-adventure-tale', label: '编个小冒险故事' },
        { value: 'observe-draw-activity', label: '做观察游戏+绘画' }
    ],
    storageKey: 'jilongkouan_water_tower_story.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=jilongkouan-water-tower-story'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子看吉隆口岸水塔，你会怎么讲它的故事？结果</h2>';
