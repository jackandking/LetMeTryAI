...
const questionConfig = {
    title: '高速上主副驾同时打盹，原因你怎么猜？',
    question: '在高速上主副驾同时打盹，哪项是更可能的原因？',
    options: [
        { value: 'driver-fatigue', label: '司机疲劳驾驶' },
        { value: 'meds-or-alcohol', label: '药物或饮酒影响' },
        { value: 'cabin-air-issue', label: '车内空气或温度问题' },
        { value: 'contagious-sleepiness', label: '互相影响放松警惕' }
    ],
    storageKey: 'highway_main_passenger_nap_cause.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=highway-main-passenger-nap-cause'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>高速上主副驾同时打盹，原因你怎么猜？结果</h2>';
