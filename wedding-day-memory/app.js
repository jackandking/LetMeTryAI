...
const questionConfig = {
    ...
    question: '你结婚那天怀念哪一幕？',
    options: [
        { value: 'father-walk-aisle', label: '父亲牵手送你入场' },
        { value: 'first-look', label: '第一次看见对方的眼神' },
        { value: 'family-toast', label: '宴席上全家举杯欢笑' },
        { value: 'group-photo-with-elders', label: '和长辈一起拍的那张合影' }
    ],
    storageKey: 'wedding_day_memory.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=wedding-day-memory'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你结婚那天怀念哪一幕？结果</h2>';
