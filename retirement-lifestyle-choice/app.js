/**
 * 退休生活投票 Survey Application
 * Logic for the "爱老人关注：退休后你最想尝试的生活方式" survey
 */
...
const questionConfig = {
    ...
    "options": [
        {
            "value": "retirement-travel",
            "label": "周游各地"
        },
        {
            "value": "retirement-gardening",
            "label": "在家园艺养花"
        },
        {
            "value": "retirement-volunteering",
            "label": "参加志愿服务"
        },
        {
            "value": "retirement-learning",
            "label": "报班学新技能"
        }
    ],
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retirement-lifestyle-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>退休生活投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“爱老人关注：退休后你最想尝试的生活方式”的最新态度</p>";
