 ...
 * Logic for the "哪种表扬更能激励孩子？" survey
 */

const questionConfig = {
    "title": "哪种表扬更能激励孩子？",
    "question": "站在家长视角，你会怎么选：哪种表扬方式更能激励孩子？",
    "options": [
        {
            "value": "praise-effort",
            "label": "夸努力与过程"
        ...
        {
            "value": "praise-progress",
            "label": "夸小进步与改进"
        },
        {
            "value": "praise-character",
            "label": "夸品格与好习惯"
        },
        {
            "value": "praise-guided",
    ...
    "storageKey": "praise_methods_vote_2026_03_28_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=praise-methods-vote-2026-03-28'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“哪种表扬更能激励孩子？”的最新态度</p>";
