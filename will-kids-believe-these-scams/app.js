...
const questionConfig = {
    title: '孩子遇到这些骗局会信吗？',
    question: '你家孩子遇到哪种骗局更容易相信？',
    options: [
        { value: 'red-envelope-rebate', label: '红包返利' },
        { value: 'free-game-skin', label: '免费游戏皮肤' },
        { value: 'fake-teacher-fee', label: '冒充老师收费' },
        { value: 'celebrity-fan-benefit', label: '明星粉丝福利' }
    ],
    storageKey: 'will_kids_believe_these_scams.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=will-kids-believe-these-scams'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>孩子遇到这些骗局会信吗？结果</h2>';
