...
const questionConfig = {
    title: '家里遇到灾害，老人先做哪件事？',
    question: '家里遇到灾害，老人先做哪件事？',
    options: [
        { value: 'protect-head', label: '护住头部并找安全角落' },
        { value: 'grab-docs-meds', label: '带上证件与常用药迅速撤离' },
        { value: 'hide-under-furniture', label: '躲到坚固家具旁或承重墙下' },
        { value: 'wake-and-help', label: '叫醒家人并互相扶助撤离' }
    ],
    storageKey: 'elder_disaster_action.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=elder-disaster-action'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>家里遇到灾害，老人先做哪件事？结果</h2>';
