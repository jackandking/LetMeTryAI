...
const questionConfig = {
    title: '主战坦克对比：机动性、防护与火力',
    question: '在机动性、防护和火力的综合表现上，你更看好哪款主战坦克？',
    options: [
        { value: 'm1a2-abrams', label: 'M1A2 Abrams' },
        { value: 't-90m', label: 'T-90M' },
        { value: 'type-99', label: 'Type 99' }
    ],
    storageKey: 'main_battle_tank_comparison.data'
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=main-battle-tank-comparison'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>主战坦克对比：机动性、防护与火力结果</h2>';
