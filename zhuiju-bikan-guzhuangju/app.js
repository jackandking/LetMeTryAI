/**
 * 追剧必看古装剧投票 Survey Application
 * Logic for the "追剧必看古装剧｜你最想追哪一部？" survey
 */

const questionConfig = {
    "title": "追剧必看古装剧｜你最想追哪一部？",
    "question": "追剧必看古装剧投票：你会把这一票投给哪一部？",
    "options": [
        {
            "value": "zhen-huan-chuan",
            "label": "甄嬛传 — 后宫智斗与古风妆造"
        },
        {
            "value": "langya-bang",
        ...
        {
            "value": "yanxi-gonglue",
            "label": "延禧攻略 — 机智女主×宫廷成长史"
        },
        {
            "value": "sansheng-sanshi-taohua",
            "label": "三生三世十里桃花 — 爱情仙侠的大戏"
        }
    ],
    "storageKey": "zhuiju_bikan_guzhuangju_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhuiju-bikan-guzhuangju'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>追剧必看古装剧投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“追剧必看古装剧｜你最想追哪一部？”的最新态度</p>";
