...
const questionConfig = {
    title: '博物馆里的那抹色，哪种妆更带感？',
    question: '你觉得博物馆里的那抹色，哪种妆更带感？',
    options: [
        { value: 'warm-bronze-glow', label: '暖铜油光' },
        { value: 'museum-pure-white', label: '纯净博物白' },
        { value: 'artistic-rich-color', label: '艺术重彩' },
        { value: 'cool-smoky-silhouette', label: '冷烟熏背影杀' }
    ],
    storageKey: 'museum_makeup_mood.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-makeup-mood'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>博物馆里的那抹色，哪种妆更带感？结果</h2>';
