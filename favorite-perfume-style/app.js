/**
 * 香水风格投票 Survey Application
 * Logic for the "女人爱热议：你最心水的香水风格是哪种？" survey
 */

const questionConfig = {
    "title": "女人爱热议：你最心水的香水风格是哪种？",
    "question": "你会把这一票投给谁：你最心水的香水风格？",
    "options": [
        {
            "value": "floral-note",
            "label": "花香调"
    ...
    "storageKey": "favorite_perfume_style_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=favorite-perfume-style'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>香水风格投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：你最心水的香水风格是哪种？”的最新态度</p>";
