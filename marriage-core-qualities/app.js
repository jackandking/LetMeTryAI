/**
 * 婚姻品质投票 Survey Application
 * Logic for the "女人爱热议：婚姻里最重要的品质" survey
 */

const questionConfig = {
    "title": "女人爱热议：婚姻里最重要的品质",
    "question": "你会把这一票投给谁：婚姻里最重要的品质？",
    "options": [
        {
            "value": "understanding-tolerance",
            "label": "理解与包容"
        },
        {
            "value": "trust-honesty",
    ...
    "storageKey": "marriage_core_qualities_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=marriage-core-qualities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>婚姻品质投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：婚姻里最重要的品质”的最新态度</p>";
