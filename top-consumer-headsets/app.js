/**
 * 头显对决 Survey Application
 * Logic for the "谁是最值得入手的顶级头显？" survey
 */

const questionConfig = {
    "title": "谁是最值得入手的顶级头显？",
    "question": "站在男人宝用户视角，你更想把票投给谁：顶级沉浸头显硬核对决？",
    "options": [
        {
    ...
    "storageKey": "top_consumer_headsets_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=top-consumer-headsets'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>头显对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“谁是最值得入手的顶级头显？”的最新态度</p>";
