/**
 * 经典战略轰炸机投票 Survey Application
 * Logic for the "硬核对比：经典战略轰炸机你投谁？" survey
 */

const questionConfig = {
    "title": "硬核对比：经典战略轰炸机你投谁？",
    "question": "作为硬核玩家，你更认可哪款经典战略轰炸机？",
    "options": [
        {
            "value": "b-2-spirit",
            "label": "B-2 幽灵"
        ...
        {
            "value": "b-52-stratofortress",
            "label": "B-52 同温层堡垒"
        }
    ],
    "storageKey": "classic_strategic_bombers_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-strategic-bombers'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>经典战略轰炸机投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：经典战略轰炸机你投谁？”的最新态度</p>";
