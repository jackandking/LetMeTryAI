 ...
 * Logic for the "社区活动投票" survey
 */

const questionConfig = {
    "title": "社区活动投票",
    "question": "亲，你最支持哪个选项：邻里活动你最想参加哪种？",
    "options": [
        {
            "value": "community-calligraphy-class",
            "label": "书画/书法兴趣班"
        },
        {
            "value": "community-volunteer-service",
            "label": "邻里志愿服务"
        },
        {
            "value": "community-square-dance-group",
            "label": "广场舞/健身小组"
        },
        {
            "value": "community-weekend-market",
            "label": "社区集市/手工市集"
        }
    ],
    "storageKey": "community_activity_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“社区活动投票”的最新态度</p>";
