/**
 * 重拾兴趣投票 Survey Application
 * Logic for the "爱老人关注：退休后你最想重拾的兴趣？" survey
 */
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retirement-rekindle-hobby'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>重拾兴趣投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“爱老人关注：退休后你最想重拾的兴趣？”的最新态度</p>";
