/**
 * 代际陪伴活动投票 Survey Application
 * Logic for the "和孙辈在一起你最喜欢做什么？" survey
 */

const questionConfig = {
    "title": "和孙辈在一起你最喜欢做什么？",
    "question": "亲，你和孙辈一起最喜欢做哪个活动？",
    "options": [
        {
            "value": "story-reading",
            "label": "讲故事读书"
    ...
    "storageKey": "grandchild_activities_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=grandchild-activities-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>代际陪伴活动投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“和孙辈在一起你最喜欢做什么？”的最新态度</p>";
