...
const questionConfig = {
    title: '宇宙感妆你会pick哪款？惊艳背影还是梦幻极光？',
    question: '宇宙感妆你会pick哪款？',
    options: [
        { value: 'silver-stardust', label: '银色星尘' },
        { value: 'aurora-dream', label: '梦幻极光' },
        { value: 'deep-space-smokey', label: '深空烟熏' }
    ],
    storageKey: 'cosmic_makeup_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cosmic-makeup-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>宇宙感妆你会pick哪款？惊艳背影还是梦幻极光？结果</h2>';
