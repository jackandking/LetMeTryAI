...
const questionConfig = {
    title: '厄尔尼诺来了，家里先准备哪样应急物品？',
    question: '厄尔尼诺来了，家里先准备哪样应急物品？',
    options: [
        { value: 'water-storage', label: '储水与饮用水' },
        { value: 'baby-formula-dry-food', label: '宝宝奶粉与儿童干粮' },
        { value: 'power-lighting', label: '充电宝与手电照明' },
        { value: 'warm-bedding-shelter', label: '保暖被褥与临时帐篷' }
    ],
    storageKey: 'el_nino_emergency_items.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=el-nino-emergency-items'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>厄尔尼诺来了，家里先准备哪样应急物品？结果</h2>';
