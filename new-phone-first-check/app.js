...
const questionConfig = {
    title: '换新手机你会先看什么？自拍颜值还是外观颜色？',
    question: '换新手机你会先看什么？',
    options: [
        { value: 'selfie-effect', label: '自拍颜值' },
        { value: 'phone-design', label: '机身外观与颜色' },
        { value: 'night-photo', label: '夜拍画质' },
        { value: 'battery-life', label: '续航与快充' }
    ],
    storageKey: 'new_phone_first_check.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=new-phone-first-check'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>换新手机你会先看什么？自拍颜值还是外观颜色？结果</h2>';
