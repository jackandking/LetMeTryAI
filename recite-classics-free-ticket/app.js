...
const questionConfig = {
    title: '背古文能免票，你家孩子想挑战哪一篇？',
    question: '背古文能免票，你家孩子想挑战哪一篇？',
    options: [
        { value: 'tengwangge-xu', label: '《滕王阁序》' },
        { value: 'yueyang-louji', label: '《岳阳楼记》' },
        { value: 'chushi-biao', label: '《出师表》' },
        { value: 'pipa-xing', label: '《琵琶行》' }
    ],
    storageKey: 'recite_classics_free_ticket.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=recite-classics-free-ticket'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>背古文能免票，你家孩子想挑战哪一篇？结果</h2>';
