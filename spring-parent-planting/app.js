...
const questionConfig = {
    title: '春季亲子种植：你会怎么和孩子一起动手？',
    question: '在这个春天，你会选择哪种方式和孩子一起动手种植？',
    options: [
        { value: 'balcony-mini-garden', label: '阳台小菜园（种蔬菜）' },
        { value: 'flower-pot-play', label: '花盆观赏（种花学美感）' },
        { value: 'seed-science-observe', label: '种子发芽小实验' },
        { value: 'succulent-craft-garden', label: '手作微景观（多肉/瓶中园艺）' }
    ],
    storageKey: 'spring_parent_planting.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-parent-planting'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春季亲子种植：你会怎么和孩子一起动手？结果</h2>';
