 ...
 * Logic for the "社区活动：你愿意参加哪个？" survey
 */

const questionConfig = {
    "title": "社区活动：你愿意参加哪个？",
    "question": "亲，你更支持哪个社区活动？",
    "options": [
        {
            "value": "square-dance",
            "label": "广场舞"
    ...
    "storageKey": "community_activity_choice_2026_04_11_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-activity-choice-2026-04-11'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“社区活动：你愿意参加哪个？”的最新态度</p>";
