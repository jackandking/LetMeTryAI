/**
 * 国产越野车硬核对决 Survey Application
 * Logic for the "国产越野车硬核对决" survey
 */

const questionConfig = {
    "title": "国产越野车硬核对决",
    "question": "作为硬核玩家，你更认可哪款国产越野车的越野实力？",
    "options": [
        {
            "value": "tank-300-short-axle",
            "label": "坦克300·短轴硬派改装版"
        },
        {
            "value": "tank-500-flagship",
            "label": "坦克500·旗舰越野SUV"
        },
        {
            "value": "haval-h9-hardcore",
            "label": "哈弗H9·传统硬派底盘派"
        },
        {
            "value": "bj40-mod-potential",
            "label": "北京BJ40·越野改装潜力王"
        }
    ],
    "storageKey": "guochan_yueyeche_yingke_duijue_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guochan-yueyeche-yingke-duijue'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>国产越野车硬核对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“国产越野车硬核对决”的最新态度</p>";
