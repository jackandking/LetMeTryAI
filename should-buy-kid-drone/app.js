...
const questionConfig = {
    title: '眼见大牌降价，家里该给孩子买无人机吗？',
    question: '眼见大牌降价，家里该给孩子买无人机吗？你会怎么做？',
    options: [
        { value: 'buy-now', label: '趁降价买一台给孩子' },
        { value: 'buy-entry-supervised', label: '买入门机并陪玩' },
        { value: 'wait-and-see', label: '先不买，观察孩子兴趣' },
        { value: 'choose-alternative', label: '不买，选替代玩具或课程' }
    ],
    storageKey: 'should_buy_kid_drone.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=should-buy-kid-drone'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>眼见大牌降价，家里该给孩子买无人机吗？结果</h2>';
