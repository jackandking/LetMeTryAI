...
const questionConfig = {
    title: '考完一科孩子这反应，你遇到过哪种？',
    question: '考完一科孩子这反应，你遇到过哪种？选一个你常见的场景：',
    options: [
        { value: 'happy-relief', label: '开心放松' },
        { value: 'quiet-and-down', label: '低落沉默' },
        { value: 'review-and-learn', label: '主动复盘' },
        { value: 'make-excuses', label: '找借口推脱' }
    ],
    storageKey: 'post_exam_reactions.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=post-exam-reactions'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>考完一科孩子这反应，你遇到过哪种？结果</h2>';
