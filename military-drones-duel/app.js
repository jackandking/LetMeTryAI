/**
 * 军用无人机对决 Survey Application
 * Logic for the "硬核对比：军用无人机谁更强？" survey
 */

const questionConfig = {
    "title": "硬核对比：军用无人机谁更强？",
    "question": "男人宝热议：以下哪类军用无人机你更看好？",
    "options": [
        {
            "value": "long-endurance-drone",
            "label": "长航时侦察机（续航优先）"
        },
        {
            "value": "stealth-strike-drone",
            "label": "隐身突防无人机（低可探测）"
        },
        {
            "value": "multi-role-armed-drone",
            "label": "多用途武装无人机（通用打击）"
        }
    ],
    "storageKey": "military_drones_duel_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=military-drones-duel'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>军用无人机对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：军用无人机谁更强？”的最新态度</p>";
