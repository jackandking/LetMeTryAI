...
const questionConfig = {
    title: '买车时你更看重什么？',
    question: '买车时你更看重什么？选一个最符合你购车决策的因素。',
    options: [
        { value: 'you-hao-jing-ji-xing', label: '油耗与经济性' },
        { value: 'an-quan-pei-zhi', label: '安全与配置' },
        { value: 'dong-li-cao-kong', label: '动力与操控' },
        { value: 'pin-pai-shou-hou', label: '品牌与售后' }
    ],
    storageKey: 'mai_che_shen_me.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mai-che-shen-me'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>买车时你更看重什么？结果</h2>';
