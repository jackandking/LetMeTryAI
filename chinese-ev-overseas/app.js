...
const questionConfig = {
    title: '国产新能源车出海，你更看重哪一点？',
    question: '国产新能源车出海，你更看重哪一点？',
    options: [
        { value: 'range-solid', label: '续航扎实' },
        { value: 'smart-driving', label: '智驾好用' },
        { value: 'good-price', label: '价格实惠' },
        { value: 'cool-design', label: '设计拉风' }
    ],
    storageKey: 'chinese_ev_overseas.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=chinese-ev-overseas'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国产新能源车出海，你更看重哪一点？结果</h2>';
