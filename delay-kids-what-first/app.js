...
const questionConfig = {
    title: '带孩子出门遇延误，你会先准备哪样东西？',
    question: '带孩子出门遇延误，你会先准备哪样东西？',
    options: [
        { value: 'snacks-drinks', label: '零食与水' },
        { value: 'books-toys', label: '可携绘本与小玩具' },
        { value: 'power-bank', label: '充电宝与备用手机' },
        { value: 'wipes-change', label: '换洗与清洁用品' }
    ],
    storageKey: 'delay_kids_what_first.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=delay-kids-what-first'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子出门遇延误，你会先准备哪样东西？结果</h2>';
