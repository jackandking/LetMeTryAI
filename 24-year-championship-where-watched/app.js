...
const questionConfig = {
    title: '24年后夺冠，你当年在哪儿看球？',
    question: '24年后夺冠，你当年是在哪儿看球的？',
    options: [
        { value: 'at-home-with-family', label: '家里和家人一起' },
        { value: 'community-square-screen', label: '广场或社区大屏' },
        { value: 'restaurant-teahouse', label: '饭店或茶馆里' },
        { value: 'friends-fan-gathering', label: '朋友家或球迷聚会' }
    ],
    storageKey: '24_year_championship_where_watched.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=24-year-championship-where-watched'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>24年后夺冠，你当年在哪儿看球？结果</h2>';
