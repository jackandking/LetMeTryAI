...
const questionConfig = {
    title: '张雪机车极限反超夺冠，哪个画面更让你上头？',
    question: '张雪机车极限反超夺冠，哪个画面更让你上头？',
    options: [
        { value: 'corner-knee-down-smoke', label: '弯道贴地压弯，轮胎冒烟' },
        { value: 'straight-thruster-tail-light', label: '直线油门全开，尾灯绝杀' },
        { value: 'rainy-slide-save-control', label: '雨天湿滑救车，控车封神' },
        { value: 'final-lap-outside-overtake', label: '末圈外道超车，一剑封喉' }
    ],
    storageKey: 'zhang_xue_moto_overtake_moment.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=zhang-xue-moto-overtake-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>张雪机车极限反超夺冠，哪个画面更让你上头？结果</h2>';
