/**
 * 恋爱雷区投票 Survey Application
 * Logic for the "女人爱热议：恋爱中你不能忍受的行为" survey
 */

const questionConfig = {
    "title": "女人爱热议：恋爱中你不能忍受的行为",
    "question": "你会把这一票投给哪种恋爱中让人受不了的行为？",
    "options": [
        {
            "value": "ignore-communication",
            "label": "忽视沟通"
        },
        {
            "value": "frequent-lying",
            "label": "频繁撒谎"
        },
        {
            "value": "controlling-behavior",
            "label": "控制行踪"
        },
        {
            "value": "long-term-aloofness",
            "label": "长期冷漠"
        }
    ],
    "storageKey": "love_intolerable_behaviors_2026_04_09_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-intolerable-behaviors-2026-04-09'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>恋爱雷区投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“女人爱热议：恋爱中你不能忍受的行为”的最新态度</p>";
