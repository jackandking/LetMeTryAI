...
const questionConfig = {
    title: '遇到倒流瀑布，你会用哪种pose拍出电影感？',
    question: '遇到倒流瀑布，你会用哪种pose拍出电影感？',
    options: [
        { value: 'back-dress-sway', label: '背影长裙飘起' },
        { value: 'turn-and-glance', label: '转身回眸一笑' },
        { value: 'arms-open', label: '张臂迎风开阔感' },
        { value: 'low-squat-closeup', label: '低姿下蹲近景情绪' }
    ],
    storageKey: 'daoliu_waterfall_pose.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=daoliu-waterfall-pose'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>遇到倒流瀑布，你会用哪种pose拍出电影感？结果</h2>';
