/**
 * 四大名著站队 Survey Application
 * Logic for the "四大名著你站哪一部？三国 vs 水浒 vs 西游 vs 红楼" survey
 */

const questionConfig = {
    "title": "四大名著你站哪一部？三国 vs 水浒 vs 西游 vs 红楼",
    "question": "四大名著你站哪一部？从热血智谋到江湖豪气、从取经冒险到荣宁悲欢，你最认同哪本的魅力与影响？",
    "options": [
        {
            "value": "romance-of-three-kingdoms",
            "label": "三国演义 — 智谋与军略的史诗"
        },
        {
            "value": "water-margin",
        ...
        {
            "value": "dream-of-the-red-chamber",
            "label": "红楼梦 — 世情人性与细腻叙事"
        }
    ],
    "storageKey": "four_classics_which_one_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=four-classics-which-one'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>四大名著站队投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“四大名著你站哪一部？三国 vs 水浒 vs 西游 vs 红楼”的最新态度</p>";
