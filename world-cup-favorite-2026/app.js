...
const questionConfig = {
    ...
    storageKey: 'world_cup_favorite_2026.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=world-cup-favorite-2026'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>这届世界杯，你看好谁夺冠？结果</h2>';
