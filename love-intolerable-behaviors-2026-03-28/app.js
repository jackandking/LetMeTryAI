/**
 * 恋爱不能忍 Survey Application
 * Logic for the "恋爱中最不能忍的行为，你最在意哪一点？" survey
 */

const questionConfig = {
    "title": "恋爱中最不能忍的行为，你最在意哪一点？",
    ...
    "options": [
        ...
        {
            "value": "hide-major-facts",
            "label": "隐瞒重大事实/说谎"
        },
        {
            "value": "disrespect-family",
            "label": "不尊重家人和朋友"
        },
        {
            "value": "infidelity",
    ...
    "storageKey": "love_intolerable_behaviors_2026_03_28_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=love-intolerable-behaviors-2026-03-28'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>恋爱不能忍投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“恋爱中最不能忍的行为，你最在意哪一点？”的最新态度</p>";
