...
const questionConfig = {
    title: '春夏换季养生习惯',
    question: '春夏交替时节，您会特别注意以下哪个养生细节？',
    options: [
        { value: 'early-sleep-early-rise', label: '早睡早起' },
        { value: 'light-diet', label: '清淡饮食' },
        { value: 'moderate-exercise', label: '适度运动' },
        { value: 'happy-mood', label: '心情愉悦' }
    ],
    storageKey: 'spring_summer_health_habits.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-summer-health-habits'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>春夏换季养生习惯结果</h2>';
