/**
 * 女人爱口红榜 Survey Application
 * Logic for the "春季口红：你最想种草哪个？" survey
 */

const questionConfig = {
    "title": "春季口红：你最想种草哪个？",
    "question": "如果是女人爱用户，你会把这一票投给谁：春季口红色号，你最想种草哪个？",
    "options": [
        {
            "value": "coral-orange",
            "label": "珊瑚橘"
    ...
    "storageKey": "spring_lipstick_pick_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=spring-lipstick-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>女人爱口红榜投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“春季口红：你最想种草哪个？”的最新态度</p>";
