/**
 * 球星Carry对决 Survey Application
 * Logic for the "男人宝热榜：谁最有资格被称为carry之王？" survey
 */

const questionConfig = {
    "title": "男人宝热榜：谁最有资格被称为carry之王？",
    "question": "站在男人宝用户视角，你更想把票投给谁：谁是本赛季最能carry球队的球星？",
    "options": [
        {
            "value": "luka-doncic",
            "label": "Luka Doncic"
    ...
    "storageKey": "mvp_carry_war_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mvp-carry-war'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>球星Carry对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：谁最有资格被称为carry之王？”的最新态度</p>";
