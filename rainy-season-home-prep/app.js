...
const questionConfig = {
    title: '遇到汛期，下雨天家里怎么准备才安心？',
    question: '遇到汛期，下雨天家里怎么准备才安心？',
    options: [
        { value: 'stock-water-food', label: '储备水粮与常用食物' },
        { value: 'secure-windows-drainage', label: '加固门窗与清理排水' },
        { value: 'emergency-light-medkit', label: '备应急照明与常用药箱' },
        { value: 'temporary-evacuate-to-safe-place', label: '有条件就临时转移到安全处' }
    ],
    storageKey: 'rainy_season_home_prep.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=rainy-season-home-prep'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>遇到汛期，下雨天家里怎么准备才安心？结果</h2>';
