...
const questionConfig = {
    title: '主战坦克性能对比：火力 / 装甲 / 机动',
    question: '如果只选一项，你认为主战坦克最该优先强化哪方面？',
    options: [
        { value: 'firepower-focused', label: '火力优先' },
        { value: 'protection-focused', label: '防护优先' },
        { value: 'mobility-focused', label: '机动优先' },
        { value: 'balanced', label: '综合平衡' }
    ],
    storageKey: 'tank_performance_compare.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=tank-performance-compare'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>主战坦克性能对比：火力 / 装甲 / 机动结果</h2>';
