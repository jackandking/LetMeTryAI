...
const questionConfig = {
    title: '换季口红色系偏好投票',
    question: '换季时你偏好哪类口红色系？',
    options: [
        { value: 'nude-pink-warm-brown', label: '裸粉暖棕' },
        { value: 'classic-red', label: '经典正红' },
        { value: 'plum-purple', label: '梅子紫调' },
        { value: 'coral-orange', label: '珊瑚橘' }
    ],
    storageKey: 'huanji_kouhong_sexi_poll.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huanji-kouhong-sexi-poll'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>换季口红色系偏好投票结果</h2>';
