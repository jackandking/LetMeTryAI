...
const questionConfig = {
    title: '换季护肤：你早晚保养的首要侧重点是什么？',
    question: '换季时你的早晚护肤最重视哪一点？',
    options: [
        { value: 'moisturize-first', label: '以保湿为主' },
        { value: 'repair-first', label: '以修护为主' },
        { value: 'oil-control', label: '以控油为主' },
        { value: 'lightweight-care', label: '以轻薄为主' }
    ],
    storageKey: 'seasonal_skincare_vote.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=seasonal-skincare-vote'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>换季护肤：你早晚保养的首要侧重点是什么？结果</h2>';
