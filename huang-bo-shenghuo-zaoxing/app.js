...
const questionConfig = {
    title: '黄渤的生活感造型，你更喜欢哪一种？',
    question: '黄渤的生活感造型，你更喜欢哪一种？',
    options: [
        { value: 'ju-jia-sui-xing', label: '居家随性' },
        { value: 'cheng-shi-tong-xun', label: '城市通勤' },
        { value: 'xiu-xian-wen-yi', label: '休闲文艺' },
        { value: 'yun-dong-huo-li', label: '运动活力' }
    ],
    storageKey: 'huang_bo_shenghuo_zaoxing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=huang-bo-shenghuo-zaoxing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>黄渤的生活感造型，你更喜欢哪一种？结果</h2>';
