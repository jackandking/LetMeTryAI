...
const questionConfig = {
    title: '你想和哪位热播剧男主去吃夜宵?',
    question: '你想和哪位热播剧男主一起去吃夜宵？',
    options: [
        { value: 'warm-neighbor-boy', label: '暖心邻家男' },
        { value: 'cool-ceo', label: '高冷总裁型' },
        { value: 'romantic-musician', label: '浪漫音乐人' }
    ],
    storageKey: 'hot_drama_night_snack.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=hot-drama-night-snack'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你想和哪位热播剧男主去吃夜宵?结果</h2>';
