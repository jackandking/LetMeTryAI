/**
 * 阅读习惯养成 Survey Application
 * Logic for the "家长话题：如何培养孩子的阅读习惯" survey
 */

const questionConfig = {
    "title": "家长话题：如何培养孩子的阅读习惯",
    "question": "站在家长视角，你会怎么选：培养孩子的阅读习惯的方式？",
    "options": [
        {
            "value": "daily-parent-child-reading",
            "label": "每日亲子共读15分钟"
        },
        {
            "value": "reading-corner-fixed-time",
            "label": "固定阅读角+固定时间"
        },
        {
            "value": "interest-booklist-rewards",
            "label": "兴趣书单+小奖励"
        }
    ],
    "storageKey": "cultivate_reading_habit_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=cultivate-reading-habit'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>阅读习惯养成投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长话题：如何培养孩子的阅读习惯”的最新态度</p>";
