...
const questionConfig = {
    title: '带孩子逛博物馆，哪件国宝会让他记住民族英雄？',
    question: '带孩子逛博物馆，哪件国宝会让他记住民族英雄？',
    options: [
        { value: 'houmuwu-ding', label: '后母戊鼎' },
        { value: 'goujian-sword', label: '越王勾践剑' },
        { value: 'terracotta-warriors', label: '秦始皇兵马俑' },
        { value: 'siyang-fangzun', label: '四羊方尊' }
    ],
    storageKey: 'kids_museum_hero_treasure.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-museum-hero-treasure'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子逛博物馆，哪件国宝会让他记住民族英雄？结果</h2>';
