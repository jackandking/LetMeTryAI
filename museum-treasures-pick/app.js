...
const questionConfig = {
    title: '带孩子去博物馆，你更想看哪个镇馆之宝？',
    question: '带孩子去博物馆，你更想看哪个镇馆之宝？',
    options: [
        { value: 'tyrannosaurus-skeleton', label: '霸王龙骨架（自然史）' },
        { value: 'bronze-ding', label: '商周青铜大鼎（历史博物馆）' },
        { value: 'dunhuang-mural', label: '敦煌壁画局部（艺术馆）' },
        { value: 'imperial-robe', label: '宫廷服饰展（龙袍与绣品）' }
    ],
    storageKey: 'museum_treasures_pick.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=museum-treasures-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子去博物馆，你更想看哪个镇馆之宝？结果</h2>';
