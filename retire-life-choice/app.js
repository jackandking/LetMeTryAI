...
const questionConfig = {
    title: '以后退休生活你更想过哪种？院子种花慢日子，还是天天出门跟邻居聊？',
    question: '以后退休生活你更想过哪种？',
    options: [
        { value: 'garden-slow-life', label: '田园慢生活' },
        { value: 'urban-neighborhood-life', label: '城市邻里活跃' },
        { value: 'live-with-children', label: '和孩子一起生活' },
        { value: 'travel-style-retirement', label: '旅行式退休' }
    ],
    storageKey: 'retire_life_choice.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retire-life-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>以后退休生活你更想过哪种？院子种花慢日子，还是天天出门跟邻居聊？结果</h2>';
