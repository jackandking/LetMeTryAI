...
const questionConfig = {
    title: '哪段老回忆，一想起来就让你笑？',
    question: '哪段老回忆，一想起来就让你笑？',
    options: [
        { value: 'childhood-mischief', label: '童年捣蛋篇' },
        { value: 'old-games', label: '老游戏时光' },
        { value: 'first-date-awkward', label: '青涩约会糗事' },
        { value: 'neighborhood-fun', label: '街坊邻里热闹' }
    ],
    storageKey: 'old_memory_laugh.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=old-memory-laugh'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪段老回忆，一想起来就让你笑？结果</h2>';
