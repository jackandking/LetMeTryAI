...
const questionConfig = {
    title: '欧洲高温离不开中国空调，你怎么看？',
    question: '欧洲高温离不开中国空调，你怎么看？',
    options: [
        { value: 'made-in-china-wins', label: '中国制造真香' },
        { value: 'heatwave-warning', label: '高温更值得警惕' },
        { value: 'europe-dependence', label: '欧洲人也被打脸' },
        { value: 'business-risk', label: '商机也藏风险' }
    ],
    storageKey: 'eu_heatwave_china_ac.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=eu-heatwave-china-ac'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>欧洲高温离不开中国空调，你怎么看？结果</h2>';
