/**
 * 家长爱话题：课外班选择 Survey Application
 * Logic for the "家长爱话题：孩子上课外班，你更看重什么？" survey
 */

const questionConfig = {
    "title": "家长爱话题：孩子上课外班，你更看重什么？",
    "question": "站在家长爱用户视角，你会怎么选：孩子上课外班应以兴趣还是提分为主？",
    "options": [
        {
            "value": "focus-on-interest",
            "label": "以兴趣为主"
        },
        {
            "value": "focus-on-grades",
            "label": "以提分为主"
        },
        {
            "value": "balance-interest-and-grades",
            "label": "两者兼顾"
        },
        {
            "value": "defer-and-observe",
            "label": "暂缓观望"
        }
    ],
    "storageKey": "extracurricular_priority_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=extracurricular-priority'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>家长爱话题：课外班选择投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“家长爱话题：孩子上课外班，你更看重什么？”的最新态度</p>";
