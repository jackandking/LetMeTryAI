...
const questionConfig = {
    title: '哪个版本的司马懿更让你记住？',
    question: '哪个版本的司马懿更让你记住？',
    options: [
        { value: 'tv-drama-sima-yi', label: '古装电视剧版' },
        { value: 'modern-drama-sima-yi', label: '现代改编影视版' },
        { value: 'documentary-sima-yi', label: '纪录片/史书版' },
        { value: 'game-comic-sima-yi', label: '游戏/漫画版' }
    ],
    storageKey: 'which_sima_yi_version.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=which-sima-yi-version'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪个版本的司马懿更让你记住？结果</h2>';
