...
const questionConfig = {
    title: '国乒女团逆转日本：哪个比赛瞬间让你印象深刻？',
    question: '在国乒女团逆转日本的比赛中，哪个瞬间让你印象深刻？',
    options: [
        { value: 'wang-yidi-serve-comeback', label: '王艺迪关键发球反超' },
        { value: 'sun-yingsha-rally', label: '孙颖莎连得分追平逆转' },
        { value: 'chen-meng-block', label: '陈梦防守封网守住关键分' },
        { value: 'team-celebration-morale', label: '团队合力庆祝士气回升' }
    ],
    storageKey: 'guoping_nvtuan_nizhuan_riben.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=guoping-nvtuan-nizhuan-riben'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>国乒女团逆转日本：哪个比赛瞬间让你印象深刻？结果</h2>';
