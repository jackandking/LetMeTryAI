...
const questionConfig = {
    title: '618来了，你打算升级哪类装备？',
    question: '618来了，你打算先升级哪类装备？',
    options: [
        { value: 'smartphone', label: '手机' },
        { value: 'laptop', label: '电脑' },
        { value: 'headphones', label: '耳机' },
        { value: 'game-console', label: '游戏机' }
    ],
    storageKey: '618_gear_upgrade.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=618-gear-upgrade'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>618来了，你打算升级哪类装备？结果</h2>';
