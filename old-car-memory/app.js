...
const questionConfig = {
    title: '你小时候家里开的哪款老车？',
    question: '你小时候家里开的哪款老车？选出你家的那一辆，并说一句回忆。',
    options: [
        { value: 'dazhong-santana', label: '大众桑塔纳' },
        { value: 'hongqi-classic', label: '红旗老轿车' },
        { value: 'beetle-classic', label: '甲壳虫（老式小车）' },
        { value: 'minivan-breadvan', label: '面包车/微面' }
    ],
    storageKey: 'old_car_memory.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=old-car-memory'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你小时候家里开的哪款老车？结果</h2>';
