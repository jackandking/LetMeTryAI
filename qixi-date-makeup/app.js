...
const questionConfig = {
    title: '七夕约会你会画哪种妆？清新、温柔还是小性感的那一款？',
    question: '七夕约会你会画哪种妆？选出最符合你约会氛围的那一款。',
    options: [
        { value: 'qixi-clean-nude', label: '清新透亮裸妆' },
        { value: 'qixi-rose-soft', label: '温柔玫瑰粉' },
        { value: 'qixi-smoky-allure', label: '魅惑烟熏眼妆' },
        { value: 'qixi-pearl-glam', label: '精致珠光闪亮' }
    ],
    storageKey: 'qixi_date_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=qixi-date-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>七夕约会你会画哪种妆？清新、温柔还是小性感的那一款？结果</h2>';
