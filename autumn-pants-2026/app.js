...
const questionConfig = {
    title: '今年秋裤你还会穿吗？出门还是只在家穿？',
    question: '今年秋裤你还会穿吗？更常在哪种场景穿？',
    options: [
        { value: 'wear-outside', label: '外出也穿' },
        { value: 'home-only', label: '只在家穿' },
        { value: 'never-wear', label: '不穿秋裤' },
        { value: 'depends-on-situation', label: '看场合再决定' }
    ],
    storageKey: 'autumn_pants_2026.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=autumn-pants-2026'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>今年秋裤你还会穿吗？出门还是只在家穿？结果</h2>';
