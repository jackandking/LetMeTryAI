/**
 * 显卡性能对决 Survey Application
 * Logic for the "硬核对比：游戏显卡性能PK" survey
 */

const questionConfig = {
    "title": "硬核对比：游戏显卡性能PK",
    "question": "作为硬核玩家，你更认可哪款显卡？",
    "options": [
        {
    ...
    "storageKey": "gaming_gpu_showdown_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=gaming-gpu-showdown'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>显卡性能对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“硬核对比：游戏显卡性能PK”的最新态度</p>";
