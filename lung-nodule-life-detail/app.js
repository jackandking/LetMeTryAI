...
const questionConfig = {
    title: '更近很多不吸烟的人也查出肺结节，你会更在意哪个生活细节？',
    question: '更近很多不吸烟的人也查出肺结节，你会更在意哪个生活细节？',
    options: [
        { value: 'secondhand-smoke', label: '家中二手烟' },
        { value: 'home-renovation-formaldehyde', label: '新装修残留' },
        { value: 'urban-air-pollution', label: '长期雾霾/尾气' },
        { value: 'frequent-grilled-smoked-foods', label: '常吃烟熏/烧烤' }
    ],
    storageKey: 'lung_nodule_life_detail.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=lung-nodule-life-detail'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>更近很多不吸烟的人也查出肺结节，你会更在意哪个生活细节？结果</h2>';
