...
const questionConfig = {
    title: '台风夜停电，家里老人更需要哪样应急物品？',
    question: '台风夜停电，家里老人更需要哪样应急物品？',
    options: [
        { value: 'flashlight-batteries', label: '手电筒与备用电池' },
        { value: 'power-bank-cables', label: '充电宝与多口充电线' },
        { value: 'blanket-hand-warmers', label: '保暖被与暖手宝' },
        { value: 'food-water-pack', label: '应急食物与饮水' }
    ],
    storageKey: 'typhoon_night_power_out_elder.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=typhoon-night-power-out-elder'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>台风夜停电，家里老人更需要哪样应急物品？结果</h2>';
