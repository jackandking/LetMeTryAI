...
const questionConfig = {
    title: '机场又困又饿，你的旅行妆怎么救场？',
    question: '机场又困又饿，你的旅行妆怎么救场？',
    options: [
        { value: 'focus-lip-eye', label: '重点补唇眼' },
        { value: 'hydration-tint', label: '轻薄润色保湿' },
        { value: 'highlight-refresh', label: '高光提神法' },
        { value: 'minimal-conceal', label: '简约遮瑕速妆' }
    ],
    storageKey: 'airport_travel_makeup_rescue.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=airport-travel-makeup-rescue'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>机场又困又饿，你的旅行妆怎么救场？结果</h2>';
