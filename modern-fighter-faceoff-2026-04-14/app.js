/**
 * 战机对决 Survey Application
 * Logic for the "男人宝热榜：现代战机对比" survey
 */

const questionConfig = {
    "title": "男人宝热榜：现代战机对比",
    "question": "全网热议：男人宝热榜：现代战机对比，你的选择是？",
    "options": [
        {
            "value": "f-22",
            "label": "F-22 Raptor"
    ...
    "storageKey": "modern_fighter_faceoff_2026_04_14_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-fighter-faceoff-2026-04-14'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>战机对决投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“男人宝热榜：现代战机对比”的最新态度</p>";
