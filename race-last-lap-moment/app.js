...
const questionConfig = {
    title: '赛车更后一圈的画面，你记得哪一幕？',
    question: '回想那场赛车的决胜圈，你记得哪个画面？',
    options: [
        { value: 'overtake-final-straight', label: '冲刺超越' },
        { value: 'finish-line-celebration', label: '冲线庆祝' },
        { value: 'last-lap-incident', label: '擦碰惊险' },
        { value: 'crowd-cheer-finish', label: '看台欢呼' }
    ],
    storageKey: 'race_last_lap_moment.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=race-last-lap-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>赛车更后一圈的画面，你记得哪一幕？结果</h2>';
