/**
 * 主战坦克对比 Survey Application
 * Logic for the "现代主战坦克，你更选谁？" survey
 */

const questionConfig = {
    "title": "现代主战坦克，你更选谁？",
    "question": "作为硬核玩家，你更看好哪款现代主战坦克？",
    "options": [
        {
            "value": "t-14-armata",
            "label": "俄罗斯 T-14 阿玛塔"
    ...
    "storageKey": "modern_main_battle_tank_pick_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=modern-main-battle-tank-pick'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>主战坦克对比投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“现代主战坦克，你更选谁？”的最新态度</p>";
