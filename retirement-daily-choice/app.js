/**
 * 退休生活选择器 Survey Application
 * Logic for the "爱老人关注：退休后你最想坚持的日常" survey
 */

const questionConfig = {
    "title": "爱老人关注：退休后你最想坚持的日常",
    "question": "如果是爱老人用户，你最支持哪个选项：退休后你最想坚持的日常？",
    "options": [
        {
            "value": "learn-painting",
            "label": "学画画"
        },
        {
            "value": "short-trip-travel",
            "label": "短途旅行"
        },
        {
            "value": "gardening",
        ...
        {
            "value": "neighborhood-social",
            "label": "邻里社交"
        }
    ],
    "storageKey": "retirement_daily_choice_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=retirement-daily-choice'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>退休生活选择器投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“爱老人关注：退休后你最想坚持的日常”的最新态度</p>";
