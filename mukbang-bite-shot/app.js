...
const questionConfig = {
    title: '哪个吃播镜头让你想咬一口？',
    question: '哪个吃播镜头让你想咬一口？',
    options: [
        { value: 'cream-pull', label: '奶油拉丝甜点' },
        { value: 'sizzling-grill', label: '炭火烤肉滋滋声' },
        { value: 'slurp-noodles', label: '浓汤拌面大口吸' },
        { value: 'hotpot-dip', label: '热锅涮肉落汤' }
    ],
    storageKey: 'mukbang_bite_shot.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=mukbang-bite-shot'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪个吃播镜头让你想咬一口？结果</h2>';
