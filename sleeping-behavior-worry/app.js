...
const questionConfig = {
    title: '睡觉时经常这样，你会在意吗？',
    question: '睡觉时经常这样，你会在意吗？哪种情况更让你或家人注意？',
    options: [
        { value: 'light-snoring', label: '轻微打鼾' },
        { value: 'tossing-turning', label: '整夜翻来覆去' },
        { value: 'nightly-get-ups', label: '半夜频繁起床' },
        { value: 'talk-in-sleep', label: '睡着说话/梦话' }
    ],
    storageKey: 'sleeping_behavior_worry.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleeping-behavior-worry'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>睡觉时经常这样，你会在意吗？结果</h2>';
