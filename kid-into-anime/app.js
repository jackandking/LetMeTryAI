...
const questionConfig = {
    title: '当孩子迷上二次元，你会怎么做？家长应对方式投票',
    question: '当孩子迷上二次元，你会怎么做？',
    options: [
        { value: 'accompany-and-share', label: '陪同参与' },
        { value: 'set-limits-and-guide', label: '设限引导' },
        { value: 'encourage-and-expand', label: '鼓励兴趣延展' },
        { value: 'observe-and-wait', label: '观察再沟通' }
    ],
    storageKey: 'kid_into_anime.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kid-into-anime'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>当孩子迷上二次元，你会怎么做？家长应对方式投票结果</h2>';
