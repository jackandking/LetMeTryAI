...
const questionConfig = {
    title: '你被谁的赛场造型惊艳到了？哪种舞台瞬间让你记住Ta',
    question: '你被谁的赛场造型惊艳到了？',
    options: [
        { value: 'sparkle-gown', label: '亮片礼裙撑场' },
        { value: 'sporty-chic', label: '运动风潮流造型' },
        { value: 'retro-elegant', label: '复古优雅黑色礼服' },
        { value: 'bold-color-makeup', label: '大胆彩妆配色撞色' }
    ],
    storageKey: 'who_amazed_stage_looks.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=who-amazed-stage-looks'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>你被谁的赛场造型惊艳到了？哪种舞台瞬间让你记住Ta结果</h2>';
