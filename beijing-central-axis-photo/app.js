...
const questionConfig = {
    title: '在北京中轴线拍照，你会选哪个画面？',
    question: '在北京中轴线拍照，你会选哪个画面？',
    options: [
        { value: 'gongqiang-beiying-sha', label: '宫墙背影杀' },
        { value: 'duichen-changjie-xiantiao', label: '对称长街线条' },
        { value: 'chenxi-zhonglou-guangying', label: '晨曦钟楼光影' },
        { value: 'yemu-cheliu-dengdai', label: '夜幕车流灯带' }
    ],
    storageKey: 'beijing_central_axis_photo.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beijing-central-axis-photo'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>在北京中轴线拍照，你会选哪个画面？结果</h2>';
