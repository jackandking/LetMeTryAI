/**
 * 老歌回忆 Survey Application
 * Logic for the "关注：怀旧选歌 — 你更喜欢哪首老歌" survey
 */

const questionConfig = {
    "title": "关注：怀旧选歌 — 你更喜欢哪首老歌",
    "question": "亲，你更支持哪个选项：哪首老歌你更喜欢？",
    "options": [
        {
    ...
    "storageKey": "classic_old_songs_pick_2026_04_08_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=classic-old-songs-pick-2026-04-08'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>老歌回忆投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：怀旧选歌 — 你更喜欢哪首老歌”的最新态度</p>";
