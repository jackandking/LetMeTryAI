...
const questionConfig = {
    title: '熊猫出国，哪个萌态更想合照？',
    question: '熊猫出国，哪个萌态更想合照？',
    options: [
        { value: 'rolling-ball', label: '滚成球球' },
        { value: 'sleepy-blink', label: '眯眼小迷糊' },
        { value: 'stretching-yawn', label: '伸懒腰大作战' },
        { value: 'tree-hug-sweet', label: '抱树撒娇' }
    ],
    storageKey: 'panda_photo_moment.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=panda-photo-moment'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>熊猫出国，哪个萌态更想合照？结果</h2>';
