...
const questionConfig = {
    title: '760元一粒的护肤品，你会为它剁手吗？',
    question: '760元一粒的护肤品，你会为它剁手吗？',
    options: [
        { value: 'buy-immediately', label: '立刻买单' },
        { value: 'try-sample-first', label: '先试样品' },
        { value: 'buy-for-special-occasions', label: '只在重要场合买' },
        { value: 'never-buy-too-expensive', label: '不会买太贵' }
    ],
    storageKey: '760yuan_skin_care_will_you_buy.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=760yuan-skin-care-will-you-buy'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>760元一粒的护肤品，你会为它剁手吗？结果</h2>';
