/**
 * 买菜省钱小妙招 Survey Application
 * Logic for the "买菜省钱小妙招 | 爱老人" survey
 */

const questionConfig = {
    "title": "买菜省钱小妙招 | 爱老人",
    "question": "亲，你最常用的买菜省钱妙招是哪个？",
    "options": [
        {
            "value": "bang-wan-da-zhe",
            "label": "傍晚去买打折菜"
        },
        {
            "value": "dang-ji-shi-ling",
            "label": "认准当季时令菜"
        },
        {
            "value": "huo-bi-san-jia",
            "label": "去菜市场货比三家"
        },
        {
            "value": "shu-ke-guan-xi",
            "label": "和摊主建立熟客关系"
        },
        {
            "value": "kan-xin-xian-du",
            "label": "学会看新鲜度不浪费"
        }
    ],
    "storageKey": "daily_money_saving_tips_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=daily-money-saving-tips'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>买菜省钱小妙招投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“买菜省钱小妙招 | 爱老人”的最新态度</p>";
