...
const questionConfig = {
    title: '三伏天降温，您离不开哪样老物件？',
    question: '三伏天降温，您离不开哪样老物件？',
    options: [
        { value: 'palm-leaf-fan', label: '大蒲扇' },
        { value: 'bamboo-mat', label: '竹凉席' },
        { value: 'enamel-mug', label: '搪瓷茶缸' },
        { value: 'bamboo-recliner', label: '竹躺椅' }
    ],
    storageKey: 'sanfu_cooling_old_objects.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sanfu-cooling-old-objects'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>三伏天降温，您离不开哪样老物件？结果</h2>';
