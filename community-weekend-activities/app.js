 ...
 * Logic for the "周末社区活动你会选哪个？" survey
 */

const questionConfig = {
    "title": "周末社区活动你会选哪个？",
    "question": "亲，你最支持哪个选项：周末社区活动你更愿意参加哪类？",
    "options": [
        {
            "value": "square-dance",
            "label": "广场舞"
        ...
        {
            "value": "calligraphy-painting-class",
            "label": "书法与绘画兴趣班"
        },
        {
    ...
    "storageKey": "community_weekend_activities_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=community-weekend-activities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“周末社区活动你会选哪个？”的最新态度</p>";
