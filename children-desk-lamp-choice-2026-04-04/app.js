 ...
 * Logic for the "如何选护眼台灯？家长更看重哪点？" survey
 */

const questionConfig = {
    "title": "如何选护眼台灯？家长更看重哪点？",
    "question": "站在家长视角，你会怎么选：哪种护眼台灯更适合孩子？",
    "options": [
        {
        ...
        {
            "value": "anti-glare-desk-lamp",
            "label": "防眩光护眼台灯"
        },
        {
            "value": "smart-sensor-lamp",
            "label": "智能感应节能灯"
        }
    ],
    "storageKey": "children_desk_lamp_choice_2026_04_04_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=children-desk-lamp-choice-2026-04-04'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“如何选护眼台灯？家长更看重哪点？”的最新态度</p>";
