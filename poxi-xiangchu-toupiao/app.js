/**
 * 婆媳相处投票 Survey Application
 * Logic for the "婆媳相处：哪种相处方式最让你崩溃？" survey
 */

const questionConfig = {
    "title": "婆媳相处：哪种相处方式最让你崩溃？",
    "question": "在婆媳相处中，你最不能忍受哪种具体行为？",
    "options": [
        {
            "value": "interfere-child-rearing",
            "label": "动不动干涉孩子教养"
        },
        {
            "value": "criticize-habits",
            "label": "对你日常生活无休止挑剔"
        },
        {
        ...
        {
            "value": "demand-extra-chores-money",
            "label": "无理由增加家务或金钱负担"
        }
    ],
    "storageKey": "poxi_xiangchu_toupiao_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=poxi-xiangchu-toupiao'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>婆媳相处投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“婆媳相处：哪种相处方式最让你崩溃？”的最新态度</p>";
