...
const questionConfig = {
    title: '小时候街角那些老建筑，你更怀念哪种？',
    question: '小时候街角那些老建筑，你更怀念哪种？',
    options: [
        { value: 'corner-shop-grocery', label: '小卖部／杂货铺' },
        { value: 'brick-wood-courtyard', label: '砖木老院落' },
        { value: 'old-barbershop', label: '老式理发店' },
        { value: 'old-cinema-theatre', label: '旧电影院／文化戏院' }
    ],
    storageKey: 'childhood_corner_buildings.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=childhood-corner-buildings'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>小时候街角那些老建筑，你更怀念哪种？结果</h2>';
