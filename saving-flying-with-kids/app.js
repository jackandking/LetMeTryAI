...
const questionConfig = {
    title: '带孩子坐飞机，哪种省钱又轻松的策略？',
    question: '带孩子坐飞机，你更倾向哪种既省钱又相对轻松的做法？',
    options: [
        { value: 'early-booking-weekdays', label: '提前买平日早鸟' },
        { value: 'last-minute-deals', label: '抢促销/临近出票' },
        { value: 'transfer-and-offpeak', label: '转机或错峰出行' },
        { value: 'miles-points', label: '用里程或积分换票' }
    ],
    storageKey: 'saving_flying_with_kids.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=saving-flying-with-kids'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>带孩子坐飞机，哪种省钱又轻松的策略？结果</h2>';
