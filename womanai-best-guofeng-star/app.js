 ...
 * Logic for the "谁把国风穿出最高级感？" survey
 */

const questionConfig = {
    "title": "谁把国风穿出最高级感？",
    "question": "如果是女人爱用户，你会把这一票投给谁：谁把国风穿出最高级感？",
    "options": [
        {
            "value": "zhao-liying",
            "label": "赵丽颖"
    ...
    "storageKey": "womanai_best_guofeng_star_v1.data"
};
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=womanai-best-guofeng-star'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“谁把国风穿出最高级感？”的最新态度</p>";
