/**
 * 周末亲子活动推荐 Survey Application
 * Logic for the "家长话题：周末亲子活动怎么安排？" survey
 */

const questionConfig = {
    "title": "家长话题：周末亲子活动怎么安排？",
    "question": "站在家长视角，你会怎么选：周末亲子活动你更喜欢哪种安排？",
    "options": [
        {
            "value": "park-hike",
            "label": "公园徒步+野餐"
        ...
        {
            "value": "family-cooking",
            "label": "家庭厨房大作战"
        }
    ],
    "storageKey": "weekend_family_activities_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=weekend-family-activities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>周末亲子活动推荐投票结果</h2>";
