...
const questionConfig = {
    title: '哪种女神背影会让你多看一眼？',
    question: '遇到这样的背影，你会回头看哪一种？',
    options: [
        { value: 'flowing-dress', label: '长裙飘逸' },
        { value: 'casual-tee-jeans', label: '简约T恤牛仔' },
        { value: 'sporty-vibe', label: '运动风活力' }
    ],
    storageKey: 'beauty_backview.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=beauty-backview'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>哪种女神背影会让你多看一眼？结果</h2>';
