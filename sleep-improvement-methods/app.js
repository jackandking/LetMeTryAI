/**
 * 睡眠小贴士投票 Survey Application
 * Logic for the "关注：哪种睡眠提升方法更实用？" survey
 */

const questionConfig = {
    "title": "关注：哪种睡眠提升方法更实用？",
    "question": "亲，你最支持哪种改善睡眠的方法？",
    "options": [
        {
            "value": "sleep-warm-milk",
            "label": "睡前热牛奶"
        },
        {
            "value": "sleep-foot-soak",
            "label": "睡前泡脚"
        },
        {
            "value": "sleep-fixed-schedule",
            "label": "固定睡眠时间"
        },
        {
            "value": "sleep-less-screen-time",
            "label": "睡前少看屏幕"
        }
    ],
    "storageKey": "sleep_improvement_methods_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=sleep-improvement-methods'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>睡眠小贴士投票投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“关注：哪种睡眠提升方法更实用？”的最新态度</p>";
