/**
 * 书桌灯选购参考 Survey Application
 * Logic for the "孩子书桌灯，你更看重哪个功能？" survey
 */

const questionConfig = {
    "title": "孩子书桌灯，你更看重哪个功能？",
    "question": "站在家长视角，你会怎么选：孩子书桌灯最重要的功能是？",
    "options": [
        {
            "value": "brightness-adjust",
            "label": "亮度可调节"
        },
        {
        ...
        {
            "value": "portable-foldable",
            "label": "便携折叠设计"
        }
    ],
    "storageKey": "kids_desk_lamp_priorities_v1.data"
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=kids-desk-lamp-priorities'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = "<h2 style='text-align:center;color:#2f4858;'>书桌灯选购参考投票结果</h2>";
    resultDiv.innerHTML += "<p style='text-align:center;color:#7f8c8d;margin-bottom:20px;font-size:14px;'>看看大家对“孩子书桌灯，你更看重哪个功能？”的最新态度</p>";
