...
const questionConfig = {
    title: '早上时间不够，你的3分钟妆容是哪种？快手自然裸妆、名媛气场、温柔腮红还是精致眼线？',
    question: '早上时间不够，你的3分钟妆容是哪种？',
    options: [
        { value: 'cushion-nude', label: '气垫裸妆' },
        { value: 'defined-eyes', label: '精致眼线＋睫毛' },
        { value: 'blush-tint', label: '温柔腮红＋唇釉' },
        { value: 'concealer-fix', label: '遮瑕定妆速成' }
    ],
    storageKey: 'morning_3_minute_makeup.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=morning-3-minute-makeup'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>早上时间不够，你的3分钟妆容是哪种？快手自然裸妆、名媛气场、温柔腮红还是精致眼线？结果</h2>';
