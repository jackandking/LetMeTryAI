...
const questionConfig = {
    title: '她登太空前的造型，你更pick哪套？',
    question: '她登太空前的造型，你更pick哪套？',
    options: [
        { value: 'future-warrior-glam', label: '未来战姬' },
        { value: 'space-fairy', label: '太空仙女' },
        { value: 'professional-crew', label: '职业机组' },
        { value: 'retro-goddess', label: '复古女神' }
    ],
    storageKey: 'ta_deng_taikong_qian_de_zaoxing.data'
};
...
function showAd() {
    ...
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: '/pages/showRewardedVideoAd/showRewardedVideoAd?result_page_id=ta-deng-taikong-qian-de-zaoxing'
        });
        return;
    }
...
function showResult(latestVoteData) {
    ...
    resultDiv.innerHTML = '<h2>她登太空前的造型，你更pick哪套？结果</h2>';
